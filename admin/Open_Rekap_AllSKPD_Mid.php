...
<form name="myfrm" method="post" action="<?php echo "Open_Rekap_AllSKPD_Mid.php?IdL=".$_GET['IdL']?>">
  ...
  <table border="0" align="center" style="width:500px">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td valign="middle"><input type="button" name="B36" value="OPEN" onclick="P_View_Report('800','400','<?php echo $rCrt?>')"  style="width: 80px; height: 24px; border: 1px solid #C0C0C0; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
