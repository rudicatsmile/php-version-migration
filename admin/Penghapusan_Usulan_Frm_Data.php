...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="28"> 
	  ...
	  <td width="50" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; padding-right:3px; text-align:center"><a href="#" onClick="showEDIT('<?=$ReO?>','Edit','<?=$gIDT?>','<?=$IdL?>'); return false" class="ico edit">&nbsp;&nbsp;Edit</a></td>
	  ...
	  <a href="#" onClick="showEDIT('<?=$ReO?>','Img','<?=$gIDT?>','<?=$IdL?>'); return false" class="ico img">&nbsp;&nbsp;&nbsp;IMG</a></td>
	  <td width="50" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-right:1px #ccc solid">
	  <a href="#" onClick="showEDIT('<?=$ReO?>','Pdf','<?=$gIDT?>','<?=$IdL?>'); return false" class="ico pdf">&nbsp;&nbsp;&nbsp;PDF</a></td>
