...
<form name="myfrm" method="post" action="<?php echo "Open_Report_Mid.php?rCrt=".$rCrt."&IdL=".$_GET['IdL']?>">
  ...
  <table border="0" align="center" style="width:650px;">
    ...
    <tr> 
	  ...
	  <option value="1.3.1" <? if ($gAst=="1.3.1") {echo "selected";}?>>KIB-A (1.3.1 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.3.1","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.3.2" <? if ($gAst=="1.3.2") {echo "selected";}?>>KIB-B (1.3.2 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.3.2","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.3.3" <? if ($gAst=="1.3.3") {echo "selected";}?>>KIB-C (1.3.3 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.3.3","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.3.4" <? if ($gAst=="1.3.4") {echo "selected";}?>>KIB-D (1.3.4 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.3.4","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.3.5" <? if ($gAst=="1.3.5") {echo "selected";}?>>KIB-G (1.3.5 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.3.5","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.5.3" <? if ($gAst=="1.5.3") {echo "selected";}?>>KIB-J (1.5.3 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.5.3","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.5.4" <? if ($gAst=="1.5.4") {echo "selected";}?>>KIB-J (1.5.4 - <?=strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.5.4","=","",DatabaseSB,$ConSB,""))?> )</option>
      </select>
      </td>
    </tr>
    <tr> 
	...
	<? } ?>
    <tr> 
      <td align="right"><? if ($rCrt==1 || $rCrt==2) {echo "S.D ";}?>TAHUN</td>
      <td>&nbsp;</td>
      <td valign="middle">
