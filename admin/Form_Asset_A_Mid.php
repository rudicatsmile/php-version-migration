...
<form name="myfrm" method="post" action="<?php echo "Form_Asset_A_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      ...
      <td>JUMLAH SATUAN</td>
      <td>
	  <input name="fSatuan" type="text" id="fSatuan" maxlength="4" value="<?=$gSTN?>" <?=$rRead?> <?php if ($KeY=="Y") {echo "readonly";}?> onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" />
    ...
    <tr>
	  ...
	  <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="47%"> <input type="button" name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" <?php if ($ReO=='Y'){echo "disabled";}?> style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
    ...
    <tr> 
      <td>LETAK TANAH </td>
		<td>
			<input name="fAlmt" type="text" class="text" id="fAlmt" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gAlm?>" size="50" maxlength="50" />
