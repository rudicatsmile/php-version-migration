...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family:calibri; font-size:10pt">
  ...
  <tr style="font-weight:bold">
    <td>&nbsp;</td>
    <td>2.</td>
    <td colspan="5">Dokumen Sumber Perolehan/Penerimaan<br></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="padding-left:13px"><li>Nama Perjanjian/Kontrak</td>
    <td>:</td>
    <td colspan="2"><input type="text" name="fNmKo" id="fNmKo" value="<?=$NmKo?>" style="width:240px; background:#fff" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    ...
    <td style="padding-left:13px"><li>Nomor</td>
    <td>:</td>
    <td colspan="2"><input type="text" name="fNoKo" id="fNoKo" value="<?=$NoKo?>" style="width:240px; background:#fff" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    ...
    <td style="padding-left:13px"><li>Tanggal, Bulan, Tahun</td>
    <td>:</td>
    <td colspan="2"><input type="text" name="fTgKo" id="fTgKo" value="<?=$TgKo?>" style="width:90px; text-align:center" />&nbsp;&nbsp;(tgl/bln/thn)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td><a href="#" onClick="formCetakDok('Format_II_A_13','<?=$IdT?>','800','400','<?=$IdL?>'); return false" class="ico docu">&nbsp;&nbsp;Format II.A.13</a></td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
