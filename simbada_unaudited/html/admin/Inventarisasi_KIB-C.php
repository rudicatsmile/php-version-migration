...
<form name="myfrm" method="post" action="<?php echo "Inventarisasi_KIB-C_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="900px">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td align="right"><input type="button" name="B37" value="EXPORT DATA" onclick="P_ToExcel('800','400','center','ToExcel/KIB_C_ToExcel')" style="width: 90px; height: 24px; border: 1px solid #C0C0C0; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
    </tr>
    <tr> 
      <td width="92">UPB</td>
      <td width="519"> 
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
        ...
        <th width="32" align="left">No</th>
        <th width="83" align="left">Kode</th>
        <th width="64" align="left">Register</th>
        <th width="316" align="left">Nama Barang</th>
        <th width="10" align="left">&nbsp;</th>
        <th width="374" align="left">Uraian</th>
        <th width="85" align="left">Tgl.Perolehan</th>
        <th width="96" class="ar">Nilai Perolehan </th>
        <th width="95" class="ar">Nilai Akhir </th>
        <th width="115" class="ac">Actions</th>
            </tr>
            <?
		...
		if ($gFin!="")
		{$fFindSy = "AND (Harga LIKE '%".$gFin."%' OR Referensi LIKE '%".$gFin."%' OR Kd_Aset LIKE '%".$gFin."%' OR Keterangan LIKE '%".$gFin."%' OR Lokasi LIKE '%".$gFin."%')";}
		else
		{$fFindSy = "";}
		
		$nSQL= "SELECT * FROM ta_kib_c WHERE Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Kd_Aset, No_Register LIMIT $Offset, $DataPerPage";
		...
		do
			...
			<tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
              ...
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <?
				if  ((int) strlen($mRo['Keterangan']) > 70)
				{echo substr($mRo['Keterangan'],0,70)." .....";}
				else
				{echo $mRo['Keterangan'];}
				?>              </td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo fConvertDateShort($mRo['Tgl_Perolehan'])?>              </td>
              <td style="border-bottom: #999999 dotted 1px" align="right" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo fConvertToRupiah($mRo['Harga'])?>              </td>
              <td style="border-bottom: #999999 dotted 1px" align="right" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <? echo $ClR?>><? echo fConvertToRupiah($gNIL)?></td>
      ...
      <tr> 
		...
		<table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <tr> 
              ...
              <td width="11">&nbsp;</td>
              <td width="89">Bertingkat/Tidak</td>
              <td width="10">:</td>
              <td width="113">
                <? echo $mRo['Bertingkat']?>              </td>
              <td width="3">&nbsp;</td>
              <td width="105">Sertifikat Tanggal</td>
              <td width="10">:</td>
              <td width="290">
                <? echo fConvertDateShort($mRo['Dokumen_Tanggal'])?>              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Jenis</td>
            ...
            <tr> 
              ...
              <td>:</td>
              <td>
                <? echo $mRo['Asal_Usul']?>              </td>
              <td>&nbsp;</td>
              <td>Luas Lantai</td>
              <td>:</td>
              <td valign="top">
                <? echo fConvertToRupiah($mRo['Luas_Lantai'])?>&nbsp;m<sup>2</sup>              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Rincian</td>
		...
		?>
          ...
          <!-- Pagging -->
          <?
			$nSQL= "SELECT COUNT(*) AS JmlRc FROM ta_kib_c WHERE Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy;
...
<script language="javascript">
			...
			if (win!=null)
    			{
      				win.window.document.open()       			
					<?
						$URL_Top = "Find_Acc_Top.php?CrAcc=Inventarisasi_KIB-C&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
						$URL_Mid = "Find_Acc_Mid.php?CrAcc=Inventarisasi_KIB-C&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
	...
	{	var win=null;
		...
		{
			win.window.document.open()       			
			URL_Top = "Form_Invent_Asset_Top.php?"+"<?="FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
			URL_Mid = "Form_Invent_Asset_Opt.php?rKib=Kib_C&rIDT="+IDT+"<?="&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
