...
function UpdateSingleRecord($gUpb,$gSub,$rKib,$gRef,$DatabaseSB,$ConSB)
{
	...
	if (substr($gSub,0,5)=='1.5.4' && $yRef!='KDL')
	{
		...
		$SQ="UPDATE ta_kib_108 SET Kd_Aset_108='".$gSub."', Referensi='".$NewRefKIB."' WHERE Referensi='".$gRef."' AND Kd_UPB='".$gUpb."'";
	...
	{
		$SQ="UPDATE ta_kib_108 SET Kd_Aset_108='".$gSub."' WHERE Referensi='".$gRef."' AND Kd_UPB='".$gUpb."'";
		mysql_query($SQ) or die(mysql_error());
