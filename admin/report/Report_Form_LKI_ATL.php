...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:800px; border:1px solid #000; font-family:calibri;">
	<tr height="20">
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td>&nbsp;</td>
          <td width="100">Format : III.A.5</td>
        </tr>
      </table>
	  </td>
	</tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td width="122"><?=TChek($CkAda2,'Tidak Ada','80')?></td>
          <td width="69">Jumlahnya</td>
          <td width="19">:</td>
          <td width="321"><?=$JmlBRGJmL?></td>
        </tr>
        <tr height="18">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          ...
          <td width="23">:</td>
          <td colspan="4"><?=TChek($CkGun1,'Pemerintah Daerah','170')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td></td>
          <td colspan="3"><?=TChek($CkDsrPP2,'Tidak ada dasar penggunaan','180')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td></td>
          <td colspan="3"><?=TChek($CkDsrPDL2,'Tidak ada dasar penggunaan','180')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td></td>
          <td colspan="3"><?=TChek($CkDsrPL2,'Tidak ada dasar penggunaan','180')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          ...
          <td width="21">:</td>
          <td width="254"><?=TChek($CkMil1,'Pemerintah Daerah','180')?></td>
          <td width="340">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?=TChek($CkMil3,'Pemerintah Pusat','150')?></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?=TChek($CkMil4,'Pihak Lain, sebutkan :','150')?></td>
          <td><?=$CkMil4Memo?></td>
          <td>&nbsp;</td>
        </tr>
	  </table>
