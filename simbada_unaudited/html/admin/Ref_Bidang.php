  ...
  <input type="hidden" name="CritIDT" size="10">
    <table align="center" class="table-list" border="0" cellspacing="0" cellpadding="0" style="width:99%">
      ...
      <tr height="22" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
        ...
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><? echo $mRo['Kd_Bidang']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><? echo $mRo['Nm_Bidang']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" class="ac" <?=fBackCLR($iG)?>><a href="#" class="ico del" onclick="P_DeleteR('<? echo $mRo['IDT']?>','<? echo $nDel?>','<? echo $ReO?>')">DELETE</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="ico edit" onclick="EditData('800','450','center','<?=$mRo['IDT']?>')">EDIT</a></td>
      </tr>
      <tr> 
      ...
      <tr height="30">
		...
		[&nbsp;<a href="<? echo $_SERVER['PHP_SELF']."?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG'] ?>" class="ico reff">&nbsp;REFRESH</a>&nbsp;]</td>
        <td style="border-top:1px solid #CCCCCC">&nbsp;</td>
      </tr>
    </table>
	  <?
