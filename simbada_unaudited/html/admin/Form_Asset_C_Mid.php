...
if ($rIDT!="")
{
	...
	if ($tRo > 0)
	{
		...
		$gNIb = 0;//fGlobal("IfNull(sum(Kredit),0)","ta_kib_post_108","Referensi",$gREF,"=","","");
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_C_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      ...
      <td>
		...
		?>
		</select> &nbsp; <select class="boxs" name="fBlnM" tabindex="0" style="width:90px">
		<option value="00"></option>
		<?
		for($nBln=1; $nBln<=12; $nBln++)
		{
		...
		<select class="boxs" name="fThnM" style="width: 60px" tabindex="0" onchange="CekKeyStatus()">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td>UMUR EKONOMIS</td>
      <td><input name="fManfaat" type="text" id="fManfaat" value="<?=$gMSM?>" onblur="NumValidate(this)" style=" width:55px; text-align: center; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px"/>
      &nbsp;Tahun </td>
    </tr>
    <tr> 
      <td>OBJEK</td>
      ...
      <td>&nbsp;</td>
      <td>JUMLAH SATUAN</td>
      <td><input name="fSatuan" type="text" id="fSatuan" maxlength="4" value="<?=$gSTN?>" <? if ($KeY=="Y") {echo "readonly";}?> onblur="NumValidate(this)" onkeyup="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" /></td>
    </tr>
    <tr> 
      <td>RINCIAN</td>
      ...
      <td><input name="fHarga" type="text" id="fHarga" value="<?=fConvertToRupiah($gHRG)?>" <? if ($KeY=="Y") {echo "readonly";}?> onblur="NumValidate(this)" onkeyup="addSeparator(this)" style="width:130px; text-align: right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr> 
      <td>REGISTER</td>
      <td><input name="fNoREG" type="text" class="text" id="fNoREG" <? if ($rIDT==""){echo "readonly";}?> style="width:80px; padding-left:5px; background:#CCFF99; border: 1px solid #C0C0C0" value="<?=$gNoR?>" maxlength="8" /> (<i>Otomatis</i>)</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      ...
      <td colspan="2">
		<table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="47%"> 
			<input type="button" name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" <? if ($ReO=='Y'){echo "disabled";}?> style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
			<input type="button" name="B393" value="RESET" onclick="P_Reset('<?=$ReO?>')" <? if ($ReO=='Y'){echo "disabled";}?> style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /><? if ($KeY=='Y') { echo "<div style='float:right'><img src='css/images/keys.png' /></div>";}?></td>
            <td width="7%"> 
    ...
    <tr> 
	  ...
	  <tr>
		...
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="18"><a href="#" onClick="P_PRE('c','800','400','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico prev"></a></td>
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('<?=$ReO?>','c','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('<?=$ReO?>','c','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>	  </td>
    </tr>
    <tr> 
      ...
      <td>&nbsp;</td>
      <td colspan="2" rowspan="10"> <table border="0" width="430" style="border-collapse: collapse; color: #CC0000; border: 1px solid #8FA908; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
          <tr> 
          ...
          <tr> 
			...
			<table border="0" width="97" bgcolor="#FFFFFF" cellpadding="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
			  ...
			  <tr>
				...
				<? if ($gIMG!="") {?>
					<a href="#"><img src="<?="SourceIMG.php?rCRT=c&rIDT=".$rIDT?>" height="75" width="80" onclick="PreviewIMG('400','300','center')"></a>
				<? } else {?>
          ...
          <!--tr>
			...
			[&nbsp;<a href="#" class="ico doc" onclick="P_OpenDoc('800','400','KIB_C_Dokumen'); return false">DOKUMEN KIB</a>&nbsp;]			</td>
          </tr-->
          <tr>
            <td>&nbsp;</td>
            <td colspan="4"><table border="0" width="97%" cellpadding="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
              ...
              <tr height="20">
                <td width="96"><a href="<?="P47_Penggunaan.php?BckFrm=C&rIDT=".$_GET['rIDT']."&IdL=".$_GET['IdL']?>" class="ico use">Penggunaan</a></td>
                <td width="115"><a href="<?="P47_Pemanfaatan.php?BckFrm=C&rIDT=".$_GET['rIDT']."&IdL=".$_GET['IdL']?>" class="ico mesi">&nbsp;&nbsp;Pemanfaatan</a></td>
                <td width="92"><a href="<?="P47_Pengamanan.php?BckFrm=C&rIDT=".$_GET['rIDT']."&IdL=".$_GET['IdL']?>" class="ico key">&nbsp;&nbsp;Pengamanan</a></td>
                <td>&nbsp;</td>
              </tr>
            </table></td>
          </tr>
    ...
    <tr> 
      <td>NO. DOKUMEN</td>
      <td><input name="fNoDok" type="text" class="text" id="fNoDok" style="width:300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gNoD?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LUAS LANTAI</td>
      <td><input name="fLuasLantai" type="text" class="text" id="fLuasLantai" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="padding-right:5px; width:90px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?=$gLti?>" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>PENGHUNI</td>
      <td><input name="fNmHuni" type="text" class="text" id="fNmHuni" style="width:300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?=$NmHuni?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LETAK/ALAMAT</td>
		<td>
			<input name="fAlamat" type="text" class="text" id="fAlamat" style=" width:400px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?=$gLKS?>" />
			<a href="#" class="ico upl" onclick="OpenAccMAP('<?=$ReO?>','750','450','center'); return false;">&nbsp;&nbsp;Lokasi Pada Peta</a>		</td>
      <td>&nbsp;</td>
    </tr>
      ...
      <td>KOORDINAT</td>
		<td>
			...
			<input name="fPosisi_koordinat" type="text" class="text" id="fPosisi_koordinat" 
				...
				value="<? echo $posisi_koordinat?>" size="50" maxlength="50" disabled />		</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>KODE TANAH</td>
    ...
    <tr> 
      <td>STATUS TANAH</td>
      <td><input name="fStatusTnh" type="text" class="text" style="width:200px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gSTT?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LUAS TANAH</td>
      <td>
	  <input name="fLuasTanah" type="text" class="text" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="padding-right:5px; width:90px; border: 1px solid #C0C0C0; padding-left: 1px; padding-top: 1px; padding-bottom: 1px" value="<?=$gLTnh?>" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>KETERANGAN</td>
      <td><textarea name="fKeterangan" cols="57" rows="3" id="fKeterangan" style="border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td valign="top">&nbsp;</td>
...
<script language="javascript">
			...
			if (win!=null)
    			{
      				win.window.document.open()       			
					<?
					$URL_Top = "Form_Invent_Asset_Top.php?FrmG=INVENTARISASI -> PERUBAHAN NILAI -> KIB C (GEDUNG DAN BANGUNAN)";
					$URL_Mid = "Form_Invent_Asset_Ubh.php?rKib=Kib_C&IdL=".$_GET['IdL']."&rIDT=".$rIDT;
	...
	function P_ViewHistory(w,h,pos)
	{
		...
		<?
			{
			$URL="KIB_C_History.php?rIDT=".$rIDT."&IdL=".$_GET['IdL'];
			}
		?>
	...
	function P_MoveAccount(ReO,KeY,w,h,rIDT,IdL)
	{
		...
		{
			win.window.document.open()       			
			URL_Top = 'Move_Account_Top.php?FrmG=PEMINDAHAN REKENING ASET -> KIB C (Peralatan dan Mesin)';
			URL_Mid = 'Move_Account_Mid.php?rKib=Kib_C&IdL='+IdL+'&rIDT='+rIDT;
	...
	function P_MoveUPB(ReO,KeY,w,h,rIDT,IdL)
	{
		...
		{
			win.window.document.open()       			
			URL_Top = 'Move_Upb_Kib_Top.php?FrmG=PEMINDAHAN KODE UPB -> KIB C (Bangunan Gedung)';
			URL_Mid = 'Move_Upb_Kib_Mid.php?rKib=Kib_C&IdL='+IdL+'&rIDT='+rIDT;
	...
	function PreviewIMG(w,h,pos)
	{
		...
		<?
			{
			$URL="PreviewIMG.php?rCRT=c&rIDT=".$rIDT."&IdL=".$_GET['IdL'];
			}
		?>
	...
	{	
		...
		if (win!=null)
		{
			...
			URL_Mid = "UploadIMG_Mid.php?"+"<?="rCRT=c&rIDT=".$rIDT."&IdL=".$_GET['IdL']?>";
	...
	{	
		...
		{
			win.window.document.open()       			
			URL_Top = "UploadIMG_Top.php?FrmG=Lokasi Peta -> KIB B (PERLATAN DAN MESIN)";
			URL_Mid = "UploadMAP_Mid.php?"+"<?="rCRT=c&rIDT=".$rIDT."&IdL=".$_GET['IdL']?>";
			URL_Bot = "UploadIMG_Bot.php";
			txtHTML="<html><head><title>Simbada Kab. Hulu Sungai Tengah</title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFindAcc_Top' noresize src='"+URL_Top+"' scrolling='no'><frame name='WinFindAcc_Mid' src='"+URL_Mid+"' scrolling='auto'><frame name='WinFindAcc_Bot' src= '"+URL_Bot+"' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
			win.focus()
			win.window.document.clear()
