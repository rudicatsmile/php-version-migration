...
<div align="center">
	<table border="0" width="1500" cellspacing="1" style="font-size: 9pt; font-family: Calibri; border-collapse: collapse" id="table1">
		<tr>
			<td style="font-size: 11pt; font-weight: bold" align="center">HASIL PENELAAHAN RENCANA KEBUTUHAN PENGADAAN BARANG MILIK DAERAH</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<table border="1" width="100%" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
				<tr>
					...
					<td colspan="2" align="center" style="font-weight: bold">RENCANA KEBUTUHAN PENGADDAN BMD YANG DISETUJUI</td>
					<td rowspan="2" align="center" style="font-weight: bold">CARA PEMENUHAN </td>
				...
				<tr>
					...
					<td width="38" align="center" style="font-weight: bold; border-bottom: 3px double #000000">15</td>
					<td width="40" align="center" style="font-weight: bold; border-bottom: 3px double #000000">16</td>
					<td width="80" align="center" style="font-weight: bold; border-bottom: 3px double #000000">17</td>
					<td width="80"style="font-weight: bold; border-bottom: 3px double #000000" align="center">18</td>
				</tr>
				<?
				...
				#XXXUsulan_Jumlah as A2, 
				#XXXXMaksimum_Jumlah as A4, 
				#Optimalisasi_Jumlah as A6, 
				
				$nTT = fGlobalNEW("IfNull(sum(Jumlah_Yg_Disetujui),0)","ta_rkbmd_new_rekening","Referensi:Kd_Unit:Tahun:Apbd",$Ref.":".$UnT.":".$Thn.":".$Apb,"=:=:=:=","",$DatabaseSB,$ConSB,"");
				...
				while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
				{
					...
					$x1 = strtoupper($mRo[0]);
					$KdP = $mRo[1];
					detilROW($iG.".",$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$crt,DatabaseSB,$ConSB,$xB);
				...
				function detilKEG($Ref,$KdP,$UnT,$Thn,$Apb,$DatabaseSB,$ConSB,$fSH)
				{
					...
					while ($mRw = mysql_fetch_array($nRw, MYSQL_BOTH))
					{
						...
						$KdK = $mRw[1];
						detilROW("",$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$crt,$DatabaseSB,$ConSB,$xB);
				...
				function detilREK($Ref,$KdR,$UnT,$Thn,$Apb,$DatabaseSB,$ConSB,$fSH)
				{
					...
					Keterangan as A9, 
					Jumlah_Yg_Disetujui as A10,
					Disetujui_Satuan as A11
				...
				function detilROW($iG,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$crt,$DatabaseSB,$ConSB,$xB)
				{
				?>
					<tr height="20">
						...
						<td align="center" valign="top"><? if ($x16>0){echo $xB.$x16;}?></td>
						<td align="center" valign="top"><? if ($x16>0){echo $xB.$x17;}?></td>
				...
				<tr height="25">
					...
					<td align="center" style="font-weight: bold; border-top: 3px double #000000">&nbsp;</td>
					<td align="center" style="font-weight: bold; border-top: 3px double #000000"><?=fConvertToRupiahBulat($nTT)?></td>
					<td align="center" style="font-weight: bold; border-top: 3px double #000000">&nbsp;</td>
					<td align="center" style="font-weight: bold; border-top: 3px double #000000">&nbsp;</td>
		...
		<!--tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table9">
				...
				<tr>
					...
					<td align="center">&nbsp;</td>
					<td align="center" style="font-weight: bold" width="230">Kuasa Pengguna Barang</td>
