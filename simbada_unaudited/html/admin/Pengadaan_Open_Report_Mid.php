...
<form name="myfrm" method="post" action="<?php echo "Open_KIB_Choise_Mid.php?IdL=".$_GET['IdL']?>">
  ...
  <table border="0" align="center" style="width:640px">
    ...
    <tr>
	  ...
	  <select class="boxs" name="fDoK" style="width: 80px" tabindex="0">
	  <option value="">Rekap</option>
	  <option value="_Rinci">Rinci</option>
      </select></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td style="color:#0000FF">JENIS BELANJA</td>
      <td colspan="3" valign="middle">
	  <select class="boxs" name="fJns" style="width:200px" tabindex="0">
	  <option value="All">All</option>
	  <option value="5.1">5.1 BELANJA OPERASI</option>
	  <option value="5.2">5.2 BELANJA MODAL</option>
	  <option value="5.3">5.3 BELANJA TIDAK TERDUGA</option>
	  <option value="5.4">5.4 BELANJA TRANSFER</option>
      </select></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<script language="javascript">
	...
	function P_OpenDoc(w,h,IdL)
	{
		...
		gDoK= objfrm.fDoK.value;
		
		gTh = objfrm.fThnC.value;
		gBl = objfrm.fBlnC.value;
		gHr = objfrm.fHriC.value;
		
		Jns = objfrm.fJns.value;
		//if (Jns!='All'){gDoK = gDoK+'_PerRek';}
		LeftPosition=(screen.width)?(screen.width-w)/2:100; 
		TopPosition=(screen.height)?(screen.height-h)/2:100;
		URL= "Pengadaan_Report"+gDoK+".php?Jns="+Jns+"&gUnt="+gUnt+"&gThA="+gThA+"&gTh="+gTh+"&gBl="+gBl+"&gHr="+gHr+"&IdL="+IdL;
