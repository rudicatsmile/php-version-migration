...
$nSQ = "TRUNCATE TABLE ta_kib_d";
$nRs = mysql_query($nSQ) or die(mysql_error());

CallConnection(DatabaseSA,$ConSA);
$iG=1;
$nSQ = "SELECT * FROM ta_kib_d ORDER BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register";
$nRs = mysql_query($nSQ) or die(mysql_error());
