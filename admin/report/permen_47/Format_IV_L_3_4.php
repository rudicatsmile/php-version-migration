...
<table border="0" width="1500" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format IV.L.3.4</td>
  </tr>
</table>
<table border="0" width="1500" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:11pt">
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">REKAPITULASI PENJELASAN LAPORAN ASET LAINNYA MUTASI TAMBAH DAN MUTASI KURANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri"> <?php if ($nR!=''){ echo "ASET LAINNYA ".fGlobal("nm_aset","ref_rek_aset108_3","kd_aset",$nR,"=","","")." ";}?>MENURUT OBJEK</td>
  </tr>
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri; font-size:10pt">INTRAKOMPTABEL</td>
  </tr>
  <tr>
...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td colspan="6" style="border:1px solid #000">Nilai Mutasi Tambah<br>(Rp) </td>
    <td colspan="5" style="border:1px solid #000">Nilai Mutasi Kurang<br>
    (Rp) </td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Penerimaan<br>Dari Cara<br>Perolehan</td>
    <td style="border:1px solid #000">Penerimaan<br>Internal<br>Pengguna<br>Barang</td>
    <td style="border:1px solid #000">Penyerahan/<br>Pengalihan<br>Status<br>Penggunaan</td>
    <td style="border:1px solid #000">Koreksi</td>
    <td style="border:1px solid #000">Reklasifikasi</td>
    <td style="border:1px solid #000">Jumlah<br>Mutasi<br>Tambah</td>
    <td style="border:1px solid #000">Pengeluaran<br>Internal<br>Pengguna<br>Barang</td>
    <td style="border:1px solid #000">Koreksi</td>
    <td style="border:1px solid #000">Reklasifikasi</td>
    <td style="border:1px solid #000">Penghapusan</td>
    <td style="border:1px solid #000">Jumlah<br>Mutasi<br>Kurang</td>
  </tr>
  <tr style="text-align:center">
    <td width="60" style="border:1px solid #000; border-bottom:3px double #000">1</td>
    ...
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">6</td>
    ...
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">9</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">10</td>
	...
	function Level3($nR,$Mst,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB)
	{
		...
		else
		{
			...
			Kd_Aset as A1, 
			Nm_Aset as A2 
			FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '".$Mst.".%' AND Kd_Aset NOT LIKE '".$Mst.".5' AND Kd_Aset NOT LIKE '".$Mst.".6' ORDER BY Kd_Aset";
		}
		$nRc = mysql_query($SQc);
