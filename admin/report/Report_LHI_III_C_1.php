...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="800" style="border-collapse:collapse; font-family:calibri; font-size:10pt; font-weight:normal">
<tr>
	<td width="70">UNIT</td>
	<td width="20">:</td>
...
<tr style="text-align:center; font-weight:bold; height:20px">
  ...
  <td width="250" rowspan="2" style="border:1px solid #000"><?php if ($fUnt=="00.00.00.00") {echo "SKPD";} else {echo "Bidang";}?></td>
...
{
	$A_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.3.1%:".$ExT,"like:<=:like:like","","");
	$A_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.1%:".$ExT.":Y","like:<=:like:like:=","","");
	$A_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.1%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$B_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.3.2%:".$ExT,"like:<=:like:like","","");
	$B_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.2%:".$ExT.":Y","like:<=:like:like:=","","");
	$B_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.2%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$C_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.3.3%:".$ExT,"like:<=:like:like","","");
	$C_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.3%:".$ExT.":Y","like:<=:like:like:=","","");
	$C_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.3%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$D_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.3.4%:".$ExT,"like:<=:like:like","","");
	$D_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.4%:".$ExT.":Y","like:<=:like:like:=","","");
	$D_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.4%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$E_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.3.5%:".$ExT,"like:<=:like:like","","");
	$E_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.5%:".$ExT.":Y","like:<=:like:like:=","","");
	$E_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.3.5%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$T_KiB = fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.5.3%:".$ExT,"like:<=:like:like","","");
	$T_KiS = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.5.3%:".$ExT.":Y","like:<=:like:like:=","","");
	$T_KiP = fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.5.3%:".$ExT.":P","like:<=:like:like:=","","");
	...
	$F_KiB = 0;//fGlobal("count(*)","ta_kib_108_sensus_2023","Kd_UPB:Tgl_Perolehan:Kd_Aset_108:extracom",$mRo[0]."%:2025-12-31:1.5.4%:".$ExT,"like:<=:like:like","","");
	$F_KiS = 0;//fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.5.4%:".$ExT.":Y","like:<=:like:like:=","","");
	$F_KiP = 0;//fGlobal("count(*)","tb_lembar_kerja","KdUPB:TglPerolehan:KdAset108:Extracom:DataSensusFix",$mRo[0]."%:2025-12-31:1.5.4%:".$ExT.":P","like:<=:like:like:=","","");
	$F_KiN = 0;//$F_KiB - ($F_KiS + $F_KiP);
	$F_Pro = 0;
	#if ($F_KiB!=0 && $F_KiS!=0)
	#{
	#	$F_Pro = $F_KiS/$F_KiB*100;
	#}
	
	#total
	$m_KiB = $A_KiB + $B_KiB + $C_KiB + $D_KiB + $E_KiB + $T_KiB + $F_KiB;
	$m_KiS = $A_KiS + $B_KiS + $C_KiS + $D_KiS + $E_KiS + $T_KiS + $F_KiS;
	$m_Pro = 0;
	if ($m_KiB!=0 && $m_KiS!=0)
	{
	...
	<tr height="22">
	  ...
	  <tr height="20">
	    <td width="50" style="text-align:center; border-bottom:1px solid #000">A</td>
	  ...
	  <tr height="20">
	    <td style="text-align:center; border-bottom:1px solid #000">B</td>
	  ...
	  <tr height="20">
	    <td style="text-align:center; border-bottom:1px solid #000">C</td>
	  ...
	  <tr height="20">
	    <td style="text-align:center; border-bottom:1px solid #000">D</td>
	  ...
	  <tr height="20">
	    <td style="text-align:center; border-bottom:1px solid #000">E</td>
	  ...
	  <tr height="20">
	    <td style="text-align:center; border-bottom:1px solid #000">ATB</td>
	    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000"><?=fConvertToRupiahBulat($T_KiB)?></td>
	    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000"><?=fConvertToRupiahBulat($T_KiS)?></td>
	    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000"><?=fConvertToRupiahBulat($T_KiP)?></td>
	    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000"><?=fConvertToRupiahBulat($T_KiN)?></td>
	    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000"><?=fConvertToRupiah($T_Pro)?> %</td>
	  </tr>
	  <?php
	  $S_KiB = $A_KiB + $B_KiB + $C_KiB + $D_KiB + $E_KiB + $T_KiB + $F_KiB;
	  $S_KiS = $A_KiS + $B_KiS + $C_KiS + $D_KiS + $E_KiS + $T_KiS + $F_KiS;
	  $S_KiP = $A_KiP + $B_KiP + $C_KiP + $D_KiP + $E_KiP + $T_KiP + $F_KiP;
	  $S_KiN = $A_KiN + $B_KiN + $C_KiN + $D_KiN + $E_KiN + $T_KiN + $F_KiN;
	  $S_Pro = 0;
	  if ($S_KiS<>0 && $S_KiB<>0)
	  {
	  	$S_Pro = ($S_KiS/$S_KiB)*100;
	  }
	  ?>
	  <tr height="20" style="background:#ccc">
	    <td style="text-align:center; font-weight:bold">Sub Total</td>
	    <td style="text-align:center; border-left:1px solid #000; font-weight:bold"><?=fConvertToRupiahBulat($S_KiB)?></td>
	    <td style="text-align:center; border-left:1px solid #000; font-weight:bold"><?=fConvertToRupiahBulat($S_KiS)?></td>
	    <td style="text-align:center; border-left:1px solid #000; font-weight:bold"><?=fConvertToRupiahBulat($S_KiP)?></td>
	    <td style="text-align:center; border-left:1px solid #000; font-weight:bold"><?=fConvertToRupiahBulat($S_KiN)?></td>
	    <td style="text-align:center; border-left:1px solid #000; font-weight:bold"><?=fConvertToRupiah($S_Pro)?> %</td>
	  </tr>
	  </table>	  </td>
