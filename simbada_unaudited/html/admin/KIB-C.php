			...
			<tr>
				...
				<td>
					<select class="boxs" name="fKdBar" style="width: 120px" tabindex="0" onchange="this.form.submit()">
						<option <? if ($gKdBar == "All") {echo "selected";} ?> value="All">ALL</option>
						<option <? if ($gKdBar == "N") {echo "selected";} ?> value="N">Belum QR</option>
						<option <? if ($gKdBar == "Y") {echo "selected";} ?> value="Y">Sudah QR</option>
					</select>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
