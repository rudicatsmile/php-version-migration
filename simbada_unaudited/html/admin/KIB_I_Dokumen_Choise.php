      ...
      <td style="font-size: 13pt; font-weight: bold" align="center">ASET LAINNYA<br>KEMITERAAN DENGAN PIHAK KETIGA</td>
		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
			  <tr> 
				...
				<td width="17">:</td>
				<td width="484"><? echo $gNmUNT ?></td>
				<td width="96">BIDANG ASET </td>
				<td width="17">:</td>
				<td width="1287"><? echo $nAs1?></td>
			  </tr>
			  <tr> 
		...
		<tr>
          ...
          <?
				...
				#$gITM=$iG-1;
				?>
          <? function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$RefH,$Urai,$NilSS,$x17,$x18,$x19) 
		  {?>
          <tr height="30"> 
            ...
            <td style="border: 1px solid #000; padding-left:2px"><?=$x4?><? if ($Urai!=""){echo "<br>(<i>".$Urai."</i>)";}?><? if ($RefH!=""){echo "<br>(<i>Ref. Mutasi : ".$RefH."</i>)";}?></td>
