...
<table border="0" class="table-form" cellspacing="0" cellpadding="0" align="center" style="width:99%; height:30px">
  ...
  <tr height="25">
    ...
    <td>&nbsp;</td>
    <td><input name="fNmpr" id="fNmpr" type="text" value="<?=$Nmpr?>" <?php if ($CeK!=''){echo "readonly";}?> style=" width:300px; border: 1px solid #C0C0C0"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td><input name="fNmpi" id="fNmpi" type="text" value="<?=$Nmpi?>" <?php if ($CeK!=''){echo "readonly";}?> style=" width:300px; border: 1px solid #C0C0C0"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
