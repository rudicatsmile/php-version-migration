...
<table border="0" align="center" width="760" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
	...
	<tr>
		...
		<tr>
			<td width="97">SKPD</td>
			<td width="21">:</td>
			<td><? if ($xUnt=="") {echo "<i>SEMUA</i>";} else {echo strtoupper(fGlobal("Nm_Unit","Ref_Unit","Kd_Unit",$xUnt,"=","",""));}?></td>
	...
	<tr>
	  <td>
		<table border="1" width="760" cellspacing="1" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1" bordercolor="#000000">
			...
			?>
			<? function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$x7,$xB) {?>
			<tr>
				...
				<td width="52" align="center"><? if ($x5!=0) {echo $xB.fConvertToRupiahBulat($x5);} else {echo "-";}?></td>
				<td width="114" align="right"><? if ($x6!=0) {echo $xB.fConvertToRupiah($x6);} else {echo "-";}?></td>
				<td><? echo $xB.$x7?></td>
			</tr>
		 	<? } ?>
          	<? function ViewBlank() {?>
			...
			<tr>
				...
				<td width="52" align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($tCNT!=0) {echo fConvertToRupiahBulat($tCNT);} else {echo "-";}?></td>
				<td width="114" align="right" style="font-weight:bold; border-top: 3px double #000000"><? echo fConvertToRupiah($tHRG)?></td>
...
<tr>
	...
	<td align="center">&nbsp;</td>
	<td align="center" width="230"><? echo $NmIbKt.", ".$frHri." ".fNmBulan($frBln)." ".$gThn?></td>
  </tr>
<tr>
