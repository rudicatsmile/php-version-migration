...
require "Form_Asset_F_Mid_Temp_Posting.php";
...
if ($Smp=="Save")
{
	...
	if ($gKTR=="") 
	{
		$gKTR = fGlobalNEW("Uraian","ta_pengadaan","Nomor",$gNoM,"=","",DatabaseSB,$ConSB,"");
		$gKTR.= " Pengadaan Nomor : ".$gNoM;
	}
...
$URL="Form_Asset_F_Mid_Temp.php?".$urI."gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$IdL;
header("Location: ".$URL);
?>
