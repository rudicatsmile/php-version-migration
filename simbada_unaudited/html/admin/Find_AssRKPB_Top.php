    ...
    <tr> 
      ...
      <td width="370" valign="middle"><table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="15%">&nbsp; </td>
            <td width="44%">CARI</td>
            <td width="32%"> <input class="text" type="text" name="fFind" size="32" value="<? echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
            <td width="2%">&nbsp;</td>
