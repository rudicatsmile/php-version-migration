...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="3">Lokasi / Alamat</td>
    <td style="border:1px solid #000" colspan="5" rowspan="2">Penghuni</td>
    <td style="border:1px solid #000" colspan="4">Dokumen Sumber Penggunaan</td>
    <td style="border:1px solid #000" colspan="3" rowspan="2">Dokumen Pendukung 
	Lainnya</td>
    <td rowspan="3" style="border:1px solid #000">Keterangan</td>
  </tr>
  <tr height="25" style="font-weight:bold; text-align:center">
    <td style="border:1px solid #000" colspan="2">Surat Ijin Penghunian (SIP)</td>
    <td style="border:1px solid #000" colspan="2">BAST Pemakaian</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Nama Penghuni</td>
    <td style="border:1px solid #000">Status Penghuni</td>
