...
<select class="boxs" name="fThn" style="width: 60px" tabindex="0">
  <?php
    ...
    <tr> 
      ...
      <td><input name="fNom" type="text" id="fNom" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gNom?>" size="50" width="100px"/>	  </td>
      <td>&nbsp;</td>
    ...
    <tr> 
      ...
      <td colspan="2"><input name="fKet" type="text" id="fKet" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gKet?>" size="254" width="100px"/></td>
		...
		do
			...
			?>
			  <tr style="cursor: pointer" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
				...
				<td valign="top"><?php echo $mRo['No_Register']?></td>
				<td valign="top"><?php echo $NmB ?></td>
				<td valign="top" class="ac"><?php echo fConvertDateShort($mRo['Tgl_Perolehan'])?></td>
				<td valign="top" class="ac"><?php echo $mRo['Kondisi']?></td>
				<td valign="top" class="ar"><?php echo fConvertToRupiah($mRo['Nilai'])?></td>
				<td valign="top">&nbsp;</td>
				<td valign="top"><?php echo $mRo['Alasan']?></td>
				<td valign="top"><?php echo $mRo['Keterangan']?></td>
				<td valign="top" align="center">
				<a href="#" class="ico del" onclick="P_RemoveR('<?php echo $mRo['IDT']?>','<?php echo $RegGrp?>','<?=$ReO?>'); return false">REMOVE</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="#" class="ico edit" onclick="EditData('700','400','center','<?php echo $mRo['IDT']?>','<?php echo $rIDT?>'); return false">EDIT</a></td>
			  </tr>
			  <?php
				...
				if (win!=null)
					{
						...
						?>       			
					txtHTML="<html><head><title><?php require_once 'AppTitle.php'; echo APP_TITLE; ?></title></head><frameset framespacing='0' border='0' rows='35,*,30' frameborder='0'><frame name='WinFindItem_Top' noresize src='<?php echo $URL_Top?>' scrolling='no'><frame name='WinFindItem_Mid' src='<?php echo $URL_Mid?>' scrolling='auto'><frame name='WinFindItem_Bot' src= '<?php echo $URL_Bot?>' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
					win.focus()
