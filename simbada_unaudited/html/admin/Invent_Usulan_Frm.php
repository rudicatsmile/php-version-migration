...
if ($IdT)
{
	$nSQL= "SELECT Referensi,Kd_UPB,Nomor,Tanggal,Nma_Pengguna,Jab_Pengguna,Nip_Pengguna,Jenis,Dokumen_Nom,Dokumen_Tgl,Uraian 
...
<form name="myfrm" method="POST" action="<?="Invent_Usulan_Frm_.php?IdT=".$IdT."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>" enctype="multipart/form-data">
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%">
  ...
  <tr height="25">
	...
	<textarea name="fURA" style="border: 1px solid #C0C0C0; height:40px; width:400px"><?=$gURA?></textarea></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr height="25">
	...
	<input name="dJNS" type="text" readonly value="<?=$dJNS?>" style=" width:305px; border: 1px solid #C0C0C0"/>
	<? } else {?>
	<select class="boxs" name="fJNS" tabindex="0" style="width:301px">
      <option value=""></option>
		<?
  ...
  <tr height="25">
	...
	<input name="dUNT" id="dUNT" type="text" value="<?=$dUNT?>" <? if ($IdT=='' && $Lev <= 1) {?> onClick="showUNIT('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13) {showUNIT('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('unit'); return false;}" <? } else {echo "readonly";}?> style="padding-left:5px; width:332px; border: 1px solid #C0C0C0"/>
    ...
    <td align="center">:</td>
    <td valign="top">
	<input type="text" name="fFinA" id="fFinA" placeholder='Search' onkeypress="if (event.keyCode==13){RefreshDATA('<?=$IdL?>','0');}" style="width: 200px; background:#CCFF99">
	<input type="button" name="B112" value="GO" onclick="RefreshDATA('<?=$IdL?>','0')" style="width: 40px; height: 21px" />
	</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<script languange="javascript">
	...
	function proslNIL(crt,IdT,gTBL,IdL,AmBiL,rUPB)
	{
		...
		if (AmBiL=="ALL")
		{
			...
			{
				$("#loadingImg").show();
				$("#ViewDATA").load('Invent_Usulan_Frm_Find_Aset_Mid_CheckList.php?IdT='+IdT+'&gTBL='+gTBL+'&gUNT='+gUNT+'&rUPB='+rUPB+'&AmBiL='+AmBiL+'&gFnD='+gFnD+'&gTHN='+gTHN+'&gLST='+gLST+'&IdL='+IdL);
			});
		}
		else
		{
	...
	function showASET(ReO,CrT,Jns,IdT,gIdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#asetDiv2Cri").load('Invent_Usulan_Frm_Find_Aset_Mid.php?gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gTBL='+gTBL+'&gFnD='+gFnD+'&IdT='+IdT+'&gUPB='+gUPB+'&rUPB='+rUPB+'&Jns='+Jns+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#asetDiv1Cri").load('Invent_Usulan_Frm_Find_Aset_Top.php?IdT='+IdT+'&Jns='+Jns+'&IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#asetDiv2Cri").load('Invent_Usulan_Frm_Find_Aset_Mid.php?gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gTBL='+gTBL+'&IdT='+IdT+'&gUPB='+gUPB+'&Jns='+Jns+'&IdL='+gIdL);
			});
	...
	function RefreshDATA(IdL,PgE)
	{
		...
		if (AA==1)
		{
			$(document).ready(function()
			{
				$("#ViewDATA").load('Invent_Usulan_Frm_Data.php?gREF='+gREF+'&gFnD='+gFnD+'&IdL='+IdL);
			});
		}
		else
		{
			...
			{
				$.ajax({
					url:"Invent_Usulan_Frm_Data.php",
				...
				$("#ViewDATAaX").load('Invent_Usulan_Frm_Data_Pages.php?PgE='+PgE+'&gREF='+gREF+'&gFnD='+gFnD+'&IdL='+IdL);
			});
		}
	}
	...
	function showDATANew(IdL)
	{
		...
		window.open('Invent_Usulan.php?FrmG=DAFTAR USULAN MUTASI&gUNT='+gUNT+'&IdL='+IdL,'_self');
	}
	...
	function showDATA(CrT,IdT,gIdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#tranDiv2Cri").load('Invent_Usulan_Frm_Data_Mid.php?gFnD='+gFnD+'&gUPB='+gUPB+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#tranDiv1Cri").load('Invent_Usulan_Frm_Data_Top.php?IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#tranDiv2Cri").load('Invent_Usulan_Frm_Data_Mid.php?gUPB='+gUPB+'&IdL='+gIdL);
			});
	...
	function showEDIT(CrT,ReO,gIdT,gIdL)
	{
		if (ReO=='Y') {alert('Access denied, akses readony..!!'); return false;}
		var gRF = objfrm.fREF.value;
	...
	function updateALL(IdT,IdL)
	{
		$(document).ready(function()
		{
			$("#ViewDELL").load('Invent_Usulan_Frm_Data_Edit_Mid_UpdateAll.php?IdT='+IdT+'&IdL='+IdL);
		});
	}
