...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_B_Mid_Temp_.php?gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$_GET['IdL'] ?>">
...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
	  ...
	  <input name="mUnt" id="mUnt" type="text" readonly value="<?=$gUnt." : ".strtoupper($mUnt)?>" style="width:450px; border: 1px solid #C0C0C0; padding-left: 6px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" />
	  </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>NAMA BARANG</td>
      <td><input name="fNama" type="text" class="text" value="<?php echo $gNma?>" style="width: 450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>MERK</td>
      <td><input name="fMerk" type="text" class="text" value="<?php echo $gMrk ?>" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>TYPE</td>
      <td><input name="fType" type="text" class="text" value="<?php echo $gTyp ?>" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>UKURAN / CC</td>
      <td><input name="fUkuranCC" type="text" class="text" id="fUkuranCC" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gUcc?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gBHN?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR PABRIK</td>
      <td><input name="fPabrik" type="text" class="text" id="fPabrik" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gPBR?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR RANGKA</td>
      <td><input name="fRangka" type="text" class="text" id="fRangka" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gRKA?>"  /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR MESIN</td>
      <td><input name="fMesin" type="text" class="text" id="fMesin" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gMSN?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      ...
      <input name="fPolisi" type="text" class="text" value="<?php echo $gPLS?>" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" />
      </span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR BPKB</td>
      <td><input name="fBPKB" type="text" class="text" id="fBPKB" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gBPK?>" /></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td><textarea name="fKeterangan" rows="3" style="width: 450px; border: 1px solid #C0C0C0"><?php echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      ...
      <td>
	  <select class="boxs" name="fManfaat" style="width: 100px" tabindex="0">
      <option value=""></option>
 		<?php
    ...
    <tr>
      <td valign="top">&nbsp;</td>
      <td valign="top">JUMLAH BARANG (QTY)</td>
      <td><input name="fSatuan" type="text" id="fSatuan" value="<?php echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:50px; text-align:center; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /> 
      (unit/buah/ect...)</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
      <td valign="top">NILAI TOTAL (Rp)</td>
      <td><input name="fTotal" type="text" id="fTotal" value="<?=fConvertToRupiah($gTTL)?>" onKeyUp="addSeparator(this)" style="width:130px; text-align: right; background-color: #E1F986; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 3px; padding-top: 1px; padding-bottom: 1px" size="22" />
	  (** <i>Harga satuan barang akan otomatis oleh sistem</i>)
	  </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
	  ...
	  <input type="button" name="B40" value="RESET" onClick="P_Reset()" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
	  </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
