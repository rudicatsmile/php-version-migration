  ...
  <tr>
	...
	while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	{
		...
		<tr height="23">
		  ...
		  <td valign="top" style="text-align:center; border-bottom: 1px dotted #999; border-right: 1px solid #ccc <?php if ($mRo4=='Ditolak'){echo "; color:#ff0000";} if ($mRo4=='Belum'){echo "; color:#0000ff";}?>" <?=$gBG?>><?=$mRo4?></td>
