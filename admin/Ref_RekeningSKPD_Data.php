...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="28"> 
	  ...
	  <td style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; padding-left:3px" <?=$gBG?>><?=$mRo[3]?><?php if ($gPER==''){echo " ( <font style='color:#0000ff'><i>Peruntukan : ".$mRo[5]." </i></font>)";}?></td>
