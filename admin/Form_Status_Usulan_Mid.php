...
<table border="0" width="530" cellspacing="2" style="font-family: Calibri; font-size:9pt; border-collapse: collapse">
	...
	<tr>
	  <td width="17">&nbsp;</td>
	    ...
	    <td width="376"><input name="fTGL" type="text" class="text" id="fTGL" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gTGL?>" size="30" maxlength="100" /></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>NOMOR USULAN </td>
	...
	<tr>
	  <td>&nbsp;</td>
        ...
        <option <?php if ($gSTA=="") {echo "selected";}?> value=""></option>
        <option <?php if ($gSTA=="DISETUJUI") {echo "selected";}?> value="DISETUJUI">DISETUJUI</option>
        <option <?php if ($gSTA=="DITOLAK") {echo "selected";}?> value="DITOLAK">DITOLAK</option>
		</select>		</td>
	</tr>
	...
	<tr>
	  <td>&nbsp;</td>
	  <td> NOMOR SK </td>
	  <td><input name="fNoSK" type="text" class="text" id="fNoSK" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gNoSK?>" size="30" maxlength="100" /></td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>TANGGAL SK </td>
	...
	<tr>
	  <td>&nbsp;</td>
	  <td>CATATAN</td>
	  <td><textarea name="fCTT" cols="55" rows="4" id="fCTT" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px"><?php echo $gCTT ?></textarea></td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
