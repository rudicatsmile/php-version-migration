...
<div align="center">
	<table border="0" width="1200" cellspacing="1" style="font-size: 9pt; font-family: Calibri; border-collapse: collapse" id="table1">
		<tr>
			<td style="font-size: 12pt; font-weight: bold" align="center">PEMERINTAH <? echo $TiDaer." ".$NmDaer?></td>
		</tr>
		<tr>
			<td style="font-size: 11pt; font-weight: bold" align="center">RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH (RKPBMD)</td>
		</tr>
		<tr>
			<td style="font-size: 11pt; font-weight: bold" align="center">TAHUN <? echo $zThn?></td>
		</tr>
		<tr>
			<td>
			<table border="0" width="100%" style="font-family: Calibri; font-size: 9pt; font-weight: bold; border-collapse: collapse" id="table8">
				<tr>
					...
					<td width="16">:</td>
					<td width="1096"><? echo fGlobal("Nm_Unit","Ref_Unit","Kd_Unit",substr($zUpb,0,11),"=","","")?></td>
				</tr>
				<tr>
					<td width="74">Sub Unit</td>
					<td width="16">:</td>
					<td><? echo fGlobal("Nm_Sub","Ref_Sub_Unit","Kd_Sub",substr($zUpb,0,14),"=","","")?></td>
				</tr>
				<tr>
					<td width="74">UPB</td>
					<td width="16">:</td>
					<td><? echo fGlobal("Nm_UPB","Ref_UPB","Kd_Upb",$zUpb,"=","","")?></td>
				</tr>
				<tr>
					<td width="74">Urusan</td>
					<td width="16">:</td>
					<td><? echo fGlobal("Nm_Referensi","Ref_Kegiatan","Id_Referensi",substr($zKeg,0,7),"=","","")?></td>
				</tr>
				<tr>
					<td width="74">Program</td>
					<td width="16">:</td>
					<td><? echo fGlobal("Nm_Referensi","Ref_Kegiatan","Id_Referensi",substr($zKeg,0,10),"=","","")?></td>
				</tr>
				<tr>
					<td width="74">Kegiatan</td>
					<td width="16">:</td>
					<td><? echo fGlobal("Nm_Referensi","Ref_Kegiatan","Id_Referensi",$zKeg,"=","","")?></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table border="0" width="100%" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
				...
				if ($tRo > 0)
				{
					...
					do
						...
						?>
						<tr>
							<td width="2%" valign="top" align="center" height="20" style="border: 1px solid #000000"><? echo $iG?>.</td>
							<td width="15%" valign="top" height="20" style="border:1px solid #000000; font-weight: bold"><? echo $mRo['Nm_Aset']?></td>
							...
							<td width="10%" valign="top" height="20" style="border: 1px solid #000000"><? echo $mRo['Kd_Aset']?></td>
						...
						if ($rtRo > 0)
						{
							...
							<tr>
								...
								<td width="20%" valign="top" height="20" style="font-style: italic; border: 1px solid #000000"><? echo $rmRo['Deskripsi']?></td>
								<td width="9%" valign="top" height="20" style="font-style: italic; border: 1px solid #000000"><? echo $rmRo['Lokasi']?></td>
								<td width="10%" valign="top" height="20" style="font-style: italic; border: 1px solid #000000"></td>
								<td width="5%" valign="top" align="center" height="20" style="font-style: italic; border: 1px solid #000000"><? if ($rmRo['Qty']> 0) {echo $rmRo['Qty'];}?></td>
								<td width="7%" valign="top" align="right" height="20" style="font-style: italic; border: 1px solid #000000"><? if ($rmRo['Harga']> 0) {echo fConvertToRupiah($rmRo['Harga']);}?></td>
								<td width="8%" valign="top" align="right" height="20" style="font-style: italic; border: 1px solid #000000"><? if ($rmRo['Jumlah']> 0) {echo fConvertToRupiah($rmRo['Jumlah']);}?></td>
								<td width="5%" valign="top" align="center" height="20" style="font-style: italic; border: 1px solid #000000"><? echo $rmRo['Rekening']?></td>
								<td valign="top" height="20" style="font-style: italic; border: 1px solid #000000" width="15%"><? echo $rmRo['Nama_Rekening']?></td>
							</tr>
							<?
				...
				<tr>
					...
					TOTAL</td>
					<td width="8%" align="right" style="border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000; font-weight: bold; border-top: 3px double #000000"><? echo fConvertToRupiah($gTotal)?></td>
