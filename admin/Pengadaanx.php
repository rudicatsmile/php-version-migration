  ...
  <table border="0" align="center" width="1858" style="">
    ...
    <tr>
	  ...
	  <select class="boxs" name="fAst" style="width:200px; background:#FFFF00">
        <option value="%">ALL</option>
        <option value="1.3.1" <?php if ($gAst=='1.3.1'){echo "selected";}?>>Aset ( Tanah )</option>
        <option value="1.3.2" <?php if ($gAst=='1.3.2'){echo "selected";}?>>Aset ( Peratalan & Mesin )</option>
        <option value="1.3.3" <?php if ($gAst=='1.3.3'){echo "selected";}?>>Aset ( Gedung & Bangunan )</option>
        <option value="1.3.4" <?php if ($gAst=='1.3.4'){echo "selected";}?>>Aset ( Jalan, Jaringan & Irigasi )</option>
        <option value="1.3.5" <?php if ($gAst=='1.3.5'){echo "selected";}?>>Aset ( Tetap Lainnya )</option>
		<option value="1.5.3" <?php if ($gAst=='1.5.3'){echo "selected";}?>>Aset ( ATB )</option>
        <option value="1.5.4" <?php if ($gAst=='1.5.4'){echo "selected";}?>>Aset ( Lain-Lain )</option>
        <option value="1.3.6.01.01.01.001" <?php if ($gAst=='1.3.6.01.01.01.001'){echo "selected";}?>>KDP ( Tanah )</option>
        <option value="1.3.6.01.01.01.002" <?php if ($gAst=='1.3.6.01.01.01.002'){echo "selected";}?>>KDP ( Peralatan & Mesin )</option>
        <option value="1.3.6.01.01.01.003" <?php if ($gAst=='1.3.6.01.01.01.003'){echo "selected";}?>>KDP ( Gedung & Bangunan )</option>
        <option value="1.3.6.01.01.01.004" <?php if ($gAst=='1.3.6.01.01.01.004'){echo "selected";}?>>KDP ( Jalan, Jaringan & Irigasi )</option>
        <option value="1.3.6.01.01.01.005" <?php if ($gAst=='1.3.6.01.01.01.005'){echo "selected";}?>>KDP ( Aset Tetap Lainnya )</option>
      </select>	  </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td align="center">&nbsp;</td>
      <td><input class="text" type="text" name="fFind" value="<?php echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986; width:190px" /></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  CallConnection(DatabaseSB,$ConSB);
		...
		do
			...
			?>
		  <tr <?=fBackCLR($iG)?>> 
			<td valign="top" class="ac" style="border-bottom: #999999 dotted 1px; border-left: #999999 dotted 1px; border-right: #999999 dotted 1px"><?php echo $iG?>.</td>
			...
			<a href="#" class="ico <?=$edit?>" onclick="EditData('950','520','center','<?php echo $mRo['IDT']?>'); return false">EDIT</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<?php if ($Lev<=2){?>
