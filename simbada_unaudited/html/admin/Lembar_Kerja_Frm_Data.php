...
WHERE P1.Tgl_Perolehan NOT LIKE '2023-%' AND P1.Kd_UPB LIKE '".$UnT."%' $FiD AND P1.Extracom LIKE '".$ExT."' $SyT 
...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="28"> 
	  ...
	  <td width="60" style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; padding-right:3px; text-align:center" <?=$gBG?>><? if ($SnsCEK=='Y'){echo $mRo[67];}?></td>
	  <td width="40" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; padding-right:3px; text-align:center"><?=$SmD?></td>
