...
if ($Simpan=="Save")
{
	...
	$IdRek = fGlobalNEW("IdRekanan","ta_penerimaan_berkas","Nomor",$gNOM,"=","",DatabaseSB,$ConSB,"");
...
{
	#echo $fTRMt; return false;
	
	$URL="Pengadaan_Mid.php?gCrM=".$fMLT."&gUR=".$fUR."&gPOS=".$fPOS."&gCrT=".$fKe."&gTRMt=".$fTRMt."&gIdT=".$gIdT."&gNOM=".$gNOM."&gUnt=".$gUnt."&gBiA=".$fBiA."&gBid=".$fBid."&gKel=".$fKel."&gOBJ=".$fOBJ."&IdL=".$_GET['IdL'];
}
