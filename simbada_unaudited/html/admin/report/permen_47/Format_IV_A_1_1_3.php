...
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format IV.A.1.1.3</td>
  </tr>
</table>
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:11pt">
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">REKAPITULASI PENGADAAN BMD BERUPA ASET LANCAR PERSEDIAAN
     </td>
  </tr>
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">MENURUT SUB RINCIAN OBJEK</td>
  </tr>
...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  ...
  <tr style="text-align:center">
	...
	{ 
		...
		$x32  = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:Extracom:KdpToAset",$KdS."%:1.3.2.%:".$TG.":N:N","LIKE:LIKE:<$sm:LIKE:=","",$fs);
		$x32P = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.2.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
		$x4 = $x4 + ($x32-$x32P);
		#echo $x32-$x32P."<br>";
		
		$x33  = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:Extracom:KdpToAset",$KdS."%:1.3.3.%:".$TG.":N:N","LIKE:LIKE:<$sm:LIKE:=","",$fs);
		$x33P = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.3.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
		$x4 = $x4 + ($x33-$x33P);
		#echo $x33-$x33P."<br>";
		
		$x34  = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:Extracom:KdpToAset",$KdS."%:1.3.4.%:".$TG.":N:N","LIKE:LIKE:<$sm:LIKE:=","",$fs);
		$x34P = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.4.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
		$x4 = $x4 + ($x34-$x34P);
		#echo $x34-$x34P."<br>";
		
		$x35  = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:Extracom:KdpToAset",$KdS."%:1.3.5.%:".$TG.":N:N","LIKE:LIKE:<$sm:LIKE:=","",$fs);
		$x35P = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.5.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
		$x4 = $x4 + ($x35-$x35P);
		#echo $x35-$x35P."<br>";
		
		#penyusutan total
		$x4 = $x4 + fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
	...
	function Level3($Mst,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB)
	{
		...
		{ 
			...
			if ($x1=='1.3.1' || $x1=='1.3.6')
			{
				$x4 = $x3;
			}
			else if ($x1=='1.3.7')
			{
				$p132 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.2.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
				$p133 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.3.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
				$p134 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.4.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
				$p135 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.5.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
	...
	function Level4($Mst,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB)
	{
		...
		{ 
			...
			{
				$x4 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.2.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");;
			}
			else if ($x1=='1.3.7.02')
			{
				$x4 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.3.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");;
			}
			else if ($x1=='1.3.7.03')
			{
				$x4 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.4.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");;
			}
			else if ($x1=='1.3.7.04')
			{
				$x4 = fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:1.3.5.%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");;
			}
			else
			{
				$x4 = $x3 - fGlobal("ifnull(sum(Penyusutan_Akumulasi),0)","ta_kib_post_penyusutan_108","Kd_UPB:Kd_Aset_108:Tahun:Extracom",$KdS."%:".$x1."%:".($rThn-1).":N","LIKE:LIKE:=:LIKE","","");
			...
			$xB = "normal";
			TempRow($x0,$x1,$x2,$x3,$x4,$xB);
            Level5($x1,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB);
			$iGd++;
		}
	}
    ...
    function Level5($Mst,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB)
	{
		...
		{ 
			...
			$xB = "normal";
			TempRow($x0,$x1,$x2,$x3,$x4,$xB);
            Level6($x1,$KdS,$TG,$TGx,$TGz,$rSem,$rThn,$DatabaseSA,$ConSA,$DatabaseSB,$ConSB);
			$iGd++;
		}
	}
	...
	<? function TempRow($x0,$x1,$x2,$x3,$x4,$xB)
	{
	?>
