...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td>JUMLAH SATUAN</td>
      <td><input name="fSatuan" type="text" id="fSatuan" maxlength="4" value="<? echo $gSTN?>" <? if ($KeY=="Y") {echo "readonly";}?> onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" /></td>
    </tr>
    <tr> 
      <td>OBJEK</td>
      <td>
    ...
    <tr> 
      <td>REGISTER</td>
      <td>
	  <input name="fNoREG" type="text" class="text" id="fNoREG" <? if ($rIDT==""){echo "readonly";}?> style="width:80px; padding-left:5px; background:#CCFF99; border: 1px solid #C0C0C0" value="<?=$gNoR?>" maxlength="8" /> (<i>Otomatis</i>)
	  </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr> 
	  ...
	  <input name="fUkuranCC" type="text" class="text" id="fUkuranCC" style="width:130px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gUcc?>"/>	  </td>
      <td>&nbsp;</td>
    ...
    <tr> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="width:430px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBHN?>"/></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR PABRIK </td>
      <td><input name="fPabrik" type="text" class="text" id="fPabrik" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gPBR?>"/>&nbsp;*
	  &nbsp;&nbsp;&nbsp;NOMOR RANGKA&nbsp;&nbsp;&nbsp;
	  <input name="fRangka" type="text" class="text" id="fRangka" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gRKA?>"/>&nbsp;*</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR MESIN </td>
      <td><input name="fMesin" type="text" class="text" id="fMesin" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gMSN?>" />&nbsp;*
	  &nbsp;&nbsp;&nbsp;NOMOR BPKB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input name="fBPKB" type="text" class="text" id="fBPKB" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBPK?>" />&nbsp;*</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR POLISI </td>
    ...
    <tr> 
      <td>KETERANGAN</td>
      <td rowspan="2"><textarea name="fKeterangan" id="fKeterangan" style=" height:60px; width:431px; border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td valign="top">&nbsp;</td>
