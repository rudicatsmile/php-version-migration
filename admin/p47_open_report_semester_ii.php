...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:900px">
  ...
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('sewa','Format_II_E_8','<?=$IdL?>'); return false;">Format II.E.8/9 - Daftar Pemanfaatan BMD (Sewa)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('bgs/bsg','Format_II_E_8','<?=$IdL?>'); return false;">Format II.E.8/9 - Daftar Pemanfaatan BMD (BGS/BSG)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('pinjam pakai','Format_II_E_8','<?=$IdL?>'); return false;">Format II.E.8/9 - Daftar Pemanfaatan BMD (Pinjam Pakai)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('ksp/kspi','Format_II_E_8','<?=$IdL?>'); return false;">Format II.E.8/9 - Daftar Pemanfaatan BMD (KSP/KSPI)</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
function showDoc(nR,doc,IdL)
{
	...
	if (KdS=='00.00.00.00'){doc = 'Format_II_E_9';}
