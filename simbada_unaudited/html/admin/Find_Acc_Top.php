...
<table border="0" width="599" cellpadding="0" align="center" style="border-collapse: collapse">
  ...
  <tr> 
	...
	<td width="43%"> <input class="text" type="text" name="fFind" size="32" value="<? echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
