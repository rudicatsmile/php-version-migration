			...
			<tr style="cursor: pointer" <?=fBackCLR($iG)?> onmouseover="this.style.cursor=&#39;pointer&#39;"> 
			  ...
			  <table id="detail<? echo $iG?>" cellspacing="0" cellpadding="3" border="0" width="100%" style="font-style: italic; color: #808080; display: none;">
				  <tr> 
					...
					<td width="20">:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset108_4","Kd_Aset",$gK2,"=","","")?>					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					<td>Rincian Objek</td>
					<td>:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset108_5","Kd_Aset",$gK3,"=","","")?>					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					<td>Sub ROBJ</td>
					<td>:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset108_6","Kd_Aset",$gK4,"=","","")?>					</td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
					<td>Sub-Sub ROBJ</td>
