...
if ($JmREC <= 5000)
{
	$URL="KIB_I_Dokumen_Choise.php?gUnt=".$_GET['gUnt']."&gSub=".$_GET['gSub']."&gUpb=".$_GET['gUpb']."&gThA=".$_GET['gThA']."&gThB=".$_GET['gThB']."&gBid=".$_GET['gBid']."&gKel=".$_GET['gKel']."&gJns=".$_GET['gJns']."&gOBJ=".$_GET['gOBJ']."&gRin=".$_GET['gRin']."&gMLK=".$_GET['gMLK']."&gExt=".$_GET['gExt']."&IdL=".$_GET['IdL'];
	header("Location: ".$URL);
}
else
{
