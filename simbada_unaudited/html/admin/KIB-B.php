	...
	<form name="myfrm" method="post" action="<?php echo "KIB-B_.php?FrmG=" . $_GET['FrmG'] . "&IdL=" . $_GET['IdL'] ?>">
		...
		<table border="0" align="center" style="width:99%">
			...
			<tr>
				<td width="72">UNIT</td>
				<td width="467">
					<select class="boxs" name="fUnt" id="fUnt" tabindex="0" style="width: 415px"
				...
				<td align="right"><input type="button" name="B35" value="INPUT DATA"
						onclick="InputData('950','520','center')"
						style="width: 90px; height: 24px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
				</td>
			</tr>
			<tr>
				<td width="72">SUB UNIT</td>
				<td width="467">
					<select class="boxs" name="fSub" id="fSub" tabindex="0" style="width: 415px"
						onchange="this.form.submit()">
						<?
						if ($Lev <= 3) {
				...
				<td colspan="6"> <select class="boxs" name="fKel" tabindex="0" style="width: 480px"
						onchange="this.form.submit()">
						<option <? if ($gKel == "All") {
									echo "selected";
								} ?> value="All">All</option>
				...
				<td align="right">
					...
					<input type="button" name="B36" value="DOKUMEN KIB"
						onclick="P_OpenDoc('800','400','','','<?= $_GET['IdL'] ?>')"
						style="color:#0000FF; width: 90px; height: 24px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
				</td>
			</tr>
			<tr>
				<td width="72">UPB</td>
				<td width="467">
					<select class="boxs" name="fUpb" id="fUpb" tabindex="0" style="width: 415px"
						onchange="this.form.submit()">
						<?
						if ($Lev <= 3) {
							echo "<option value='All'>All</option>";
				...
				<td colspan="6"> <select class="boxs" name="fOBJ" tabindex="0" style="width: 480px"
						onchange="this.form.submit()">
						<option <? if ($gOBJ == "All") {
									echo "selected";
								} ?> value="All">All</option>
				...
				<td align="right">
					...
					<input type="button" name="B36" value="TABULASI DATA"
						onclick="P_OpenDoc('800','400','TaB','ALT','<?= $_GET['IdL'] ?>')"
						style="color:#0000FF; width: 90px; height: 24px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
				</td>
			</tr>
			<tr>
				<td>RUANG</td>
				<td valign="middle">
					<select class="boxs" name="fRua" id="fRua" tabindex="0" style="width: 270px"
						onchange="this.form.submit()">
				...
				<td align="right"><input type="button" name="B38" value="CARI REKENING"
						onclick="OpenAccNumb('600','500','center')"
						style="width: 90px; height: 24px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
				</td>
			</tr>
			<tr>
				...
				<td valign="middle">
					<table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
						<tr>
							<td width="46%"> <input class="text" type="text" name="fFind" id="fFind"
									placeholder='Search' value="<? echo $gFin ?>"
									style="width: 200px; font-family: Calibri; font-size: 10pt; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" />
							</td>
							<td width="22%"> <input type="button" name="B39" value="GO" onclick="P_Find()"
									style="width: 50px; height: 21px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
								<? if ($Lev == "0" || $Lev == "1") { ?>
									<input type="hidden" name="B392" value="Import" disabled
										onclick="P_Import(); return false;"
										style="width: 55px; height: 21px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
								<? } ?>
							</td>
							<td width="32%">&nbsp;</td>
						</tr>
				...
				<td width="73">
					<select class="boxs" name="fThnA" style="width: 70px; color:#FF0000" tabindex="0"
						onchange="this.form.submit()">
						<!--option <? if ($gThn == "All") {
										echo "selected";
									} ?> value="All">All</option-->
				...
				<td width="80">
					<select class="boxs" name="fThn" style="width: 70px; color:#FF0000" tabindex="0"
						onchange="this.form.submit()">
						<!--option <? if ($gThn == "All") {
										echo "selected";
									} ?> value="All">All</option-->
				...
				<td width="134" valign="bottom"><label><input type="checkbox" <? if ($gMuT != "") {
																					echo "checked";
																				} ?>
							name="fMuT" value="ON" onclick="this.form.submit()" />MUTASI MASUK</label></td>
				<td width="119" align="right"><input type="button" name="B362" value="DOKUMEN KIR"
						onclick="P_KIR('650','350','<?= $_GET['IdL'] ?>')"
						style="width: 90px; height: 24px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
				</td>
			</tr>
			<tr>
				...
				<td>&nbsp;</td>
				<td>
					Kode Bar<div id="loadingImg" style="width:40px;height:10px;display:none"><img
							src="Images/loading3.gif" alt="" width="40" height="40"></div>
				</td>
				<td colspan="6">
					<select class="boxs" name="fKdBar" style="width: 120px" tabindex="0" onchange="this.form.submit()">
						<option <? if ($gKdBar == "All") {
									echo "selected";
								} ?> value="All">ALL</option>
						<option <? if ($gKdBar == "N") {
									echo "selected";
								} ?> value="N">Belum QR</option>
						<option <? if ($gKdBar == "Y") {
									echo "selected";
								} ?> value="Y">Sudah QR</option>
					</select>
				</td>
				<td><label style="float:right; color:#FF0000"><input type="checkbox" name="fSdhMutasi" <? if ($eMuT != "") {
																											echo "checked";
																										} ?> onclick="P_Find()" value="ON" />
		...
		<table border="0" align="center" id="tbViewData" style="width:99%">
			<tr>
				<td>
					<div id="ViewDATA" style="height:30px; width:500px; overflow:auto; display:none"></div>
				</td>
			</tr>
		</table>
		<table align="center" border="0" class="table-list" cellspacing="0" cellpadding="0" style="width:99%">
			...
			if ($gFin != "") {
				$fFindSy = "AND (IdTabelMaster LIKE '%" . $gFin . "%' OR Ref_KdpToAset LIKE '%" . $gFin . "%' OR No_Register LIKE '%" . $gFin . "%' OR Kd_Aset_108 LIKE '%" . $gFin . "%' OR Ref_Temp LIKE '%" . $gFin . "%' OR Nm_Aset LIKE '%" . $gFin . "%' OR Harga LIKE '%" . $gFin . "%' OR Referensi LIKE '%" . $gFin . "%' OR Ref_Group LIKE '%" . $gFin . "%' OR Nomor_Polisi LIKE '%" . $gFin . "%' OR Nomor_Rangka LIKE '%" . $gFin . "%' OR Nomor_BPKB LIKE '%" . $gFin . "%' OR Nomor_Mesin LIKE '%" . $gFin . "%' OR Keterangan LIKE '%" . $gFin . "%' OR Merk LIKE '%" . $gFin . "%' OR No_Pengadaan LIKE '%" . $gFin . "%')";
			} else {
				$fFindSy = "";
			}
			...
			AND Tgl_Perolehan >='" . $gThnA . "-01-01' AND Tgl_Perolehan <='" . $gThn . "-12-31' " . $fFindSy . $tMuT . $tKdBar . "ORDER BY Kd_UPB, Tgl_Perolehan, Kd_Aset_108, No_Register LIMIT $Offset, $DataPerPage";
			#echo $nSQL;
			...
			if ($tRo > 0) {
				do {
					...
					if ($mRo['kode_bar'] != "") {
						...
						$BARKODE = "<font style='background:#FF0000; color:#FFFFFF'>Scan QR SiLABEL tanggal : " . $tanggal_scan . " oleh : " . $user_scan . " [" . $mRo['kode_bar'] . "]</font><br>";
					}
					...
					$gNIa = fGlobal("IfNull(sum(debet),0)", "ta_kib_post_108" . $tMuTZ, "referensi:kd_upb", $mRo['Referensi'] . ":" . $mRo['Kd_UPB'], "=:=", "", "");
					$gNIb = 0;
					if ($gNIb != 0) {
						$gNIL = $gNIa - $gNIb;
					} else {
					...
					#if ($ImPORT == 'YA') 
					#{
					#	$aTR = fGlobal("count(*)", "atribusi_b", "kode_skpd:register_new", $gSK . ":" . $mRo['No_Register'], "=:=", "", "");
					#	$aTP = fGlobal("count(*)", "ta_kib_post_108", "referensi:kd_upb", $mRo['Referensi'] . ":" . $mRo['Kd_UPB'], "=:=", "", "");
					#	$aHR = fGlobal("IfNull(sum(Harga_Bertambah),0)", "atribusi_b", "kode_skpd:register_new", $gSK . ":" . $mRo['No_Register'], "=:=", "", "");

					#	if ($aTR > 1 && $aTR > $aTP && $aHR == $gNIL) {
					#		callImportAtribusi_B('atribusi_b', $mRo['No_Register'], $mRo['Referensi'], $mRo['Kd_Aset_108'], $mRo['Kd_UPB'], $mRo['Tgl_Perolehan'], $Dipla, $Exec);
					#	}
					#}
			...
			?>
					<tr height="40" style="cursor: pointer <?= $Blnk ?>" <?= fBackCLR($iG) ?>>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center">
							<?= $iG ?>.
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center">
							<?= $mRo['Referensi'] . $eP . $RfPTA ?>
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center">
							<? echo $mRo['No_Register'] . "<br>" . $aTR ?>
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px">
							<?= $BARKODE . $NmB . $TtK ?> <? if ($mRo['Kd_Ruang'] == '') {
																echo "<font style='color:#ff0000'><i><br>Belum Masuk KIR</i></font>";
															} ?>
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px">
							<? echo $mRo['Merk'] ?>
						...
						<td
							style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px; padding-right:2px">
							<?= $BV . $BT . $mRo['Keterangan'] ?>
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center">
							<?= fConvertDateShort($mRo['Tgl_Perolehan']) ?>
						</td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center"><? if ($mRo['Tgl_Mutasi'] != "0000-00-00") {
																																echo fConvertDateShort($mRo['Tgl_Mutasi']);
																															} ?><?= $gAda ?></td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px"
							align="right"><? echo fConvertToRupiah($mRo['Harga']) ?></td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px <?= $ClR ?>"
							align="right"><? echo fConvertToRupiah($gNIL) ?></td>
						<td style="border-bottom: #999999 dotted 1px" align="center">
							<a href="#" class="ico docu"
								onclick="P_OpenKibar('800','400','<?= $mRo['IDT'] ?>','<?= $_GET['IdL'] ?>'); return false">&nbsp;Kibar</a>&nbsp;|&nbsp;
							<a href="#" class="ico prev"
								onclick="P_Tabel('850','450','<?= $mRo['Referensi'] ?>','<?= substr($mRo['Kd_UPB'], 0, 11) ?>','<?= $_GET['IdL'] ?>'); return false">Ms.
								Manfaat</a>
							<? if ($eMuT == "") { ?>
								&nbsp;|&nbsp;
								<a href="#" class="ico edit"
									onclick="EditData('1020','550','center','<?= $mRo['IDT'] ?>'); return false">Edit</a>&nbsp;
								<? if ($Lev <= 1) { ?>
									|&nbsp;<a href="#" class="ico <?= $del ?>"
										onclick="P_DeleteR('<?= $CeK ?>','<?= $ThN ?>','<?= $KiB ?>','<?= $mRo['IDT'] ?>','<?= $RegGrp ?>','<?= $ReO ?>'); return false">Delete</a>
								<? } ?>
							<? } ?>
						</td>
					</tr>
					<tr>
						<td colspan="11">
							<table id="detail<? echo $iG ?>" cellpadding="3" border="0" width="900"
								style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
								<tr>
									<td width="20">&nbsp;</td>
									<td width="30">Kelompok</td>
									<td width="10">:</td>
									<td width="200">
										<? echo fGlobal("Nm_Aset", "Ref_Rek_Aset2", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 5), "=", "", "") ?>-------
									</td>
									<td width="10">&nbsp;</td>
									<td width="40">Merk</td>
									<td width="9">:</td>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<? echo fGlobal("Nm_Aset", "Ref_Rek_Aset3", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 8), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Type</td>
									<td>:</td>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<? echo fGlobal("Nm_Aset", "Ref_Rek_Aset4", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 11), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Ukuran/CC</td>
									<td>:</td>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<? echo fGlobal("Nm_Aset", "Ref_Rek_Aset5", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 15), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Kepemilikan</td>
									<td>:</td>
									<td><? echo fGlobal("Nm_Pemilik", "Ref_Pemilik", "Kd_Pemilik", substr($mRo['Kd_Pemilik'], 0, 11), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Referensi</td>
									<td>:</td>
