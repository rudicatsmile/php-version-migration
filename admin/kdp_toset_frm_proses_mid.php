...
<table border="0" width="600" height="25" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="23">
    ...
    <td rowspan="2" valign="bottom"><input type="button" name="B99" value="PROSES" <?php if ($rXec=='Y'){echo 'disabled';}?> onclick="prosToAsetSave('<?=$IdT?>','<?=$CrDiv?>','<?=$IdL?>')" style="width:95px; height:41px<?php if ($rXec=='N'){echo "; color:#0000ff";}?>" /></td>
  </tr>
  <tr height="23">
    <td>&nbsp;</td>
  ...
  <tr height="23">
    ...
    <td width="121" rowspan="3" valign="top" style="padding-top:4px"><input type="button" name="B99" value="BATALKAN" <?php if ($rXec=='N' || $rMut!=''){echo "disabled";}?> onclick="prosToAsetBatal('<?=$IdT?>','<?=$CrDiv?>','<?=$IdL?>')" style="width:95px; height:41px " /></td>
  </tr>
  <tr height="23">
    <td>&nbsp;</td>
