...
<form name="myfrm" method="post" action="<?="Ref_Kode_Aset108_2_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG']."&KdAst1=".$KdAst1 ?>">
  ...
  <input type="hidden" name="CritIDT" size="10">
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" class="table-list" style="width:99%">
      <tr> 
        ...
        <th width="776" align="left">JENIS</th>
      ...
      <?php
		...
		if ($KdAst1=='1.1')
		{
			$nSQL= "SELECT * FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '".$KdAst1.".__' ORDER BY Kd_Aset LIMIT $Offset, $DataPerPage";
		}
		else
		{
			$nSQL= "SELECT * FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '".$KdAst1."._' ORDER BY Kd_Aset LIMIT $Offset, $DataPerPage";
		}
		...
		do
			...
			{
				$mSQL= "SELECT * FROM ref_rek_aset108_4 WHERE Kd_Aset LIKE '".$mRo['Kd_Aset'].".__' ORDER BY Kd_Aset";
      ...
      <tr height="27" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
		...
		[&nbsp;<a href="<?="Ref_Kode_Aset108_3.php?FrmG=".$_GET['FrmG']."&KdAst1=".$_GET['KdAst1']."&IdL=".$_GET['IdL']."&KdAst2=".$mRo['Kd_Aset']?>" class="ico prev">VIEW</a>&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <tr height="30">
        ...
        <td style="border-top: 1px solid #CCCCCC">&nbsp;</td>
          ...
          <?php
			$nSQL= "SELECT COUNT(*) AS JmlRc FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '".$KdAst1.".__'";
...
<script language="javascript">
			...
			if (win!=null)
				{
					...
					<?php
						$URL_Top = "Form_Kode_Aset108_2_Top.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'];
						$URL_Mid = "Form_Kode_Aset108_2_Mid.php?KdAst1=".$KdAst1."&IdL=".$_GET['IdL'];
						$URL_Bot = "Form_Kode_Aset108_2_Bot.php";
					?>       			
	...
	function EditData(w,h,Lev,IDT)
	{
		...
		if (win!=null)
		{
			win.window.document.open()       			
			URL_Top = "Form_Kode_Aset108_2_Top.php?"+"<?="FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
			URL_Mid = "Form_Kode_Aset108_2_Mid.php?rIDT="+IDT+"<?="&IdL=".$_GET['IdL']?>";
			URL_Bot = "Form_Kode_Aset108_2_Bot.php";
			txtHTML="<html><head><title><?php require_once 'AppTitle.php'; echo APP_TITLE; ?></title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFormKIB_Top' noresize src='"+URL_Top+"' scrolling='no'><frame name='WinFormKIB_Mid' src='"+URL_Mid+"' scrolling='auto'><frame name='WinFormKIB_Bot' src= '"+URL_Bot+"' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
			win.focus()
			win.window.document.clear()
	...
	function P_Document(w,h,pos,gKD)
	{
		...
		LeftPosition=(screen.width)?(screen.width-w)/2:100; 
		TopPosition=(screen.height)?(screen.height-h)/2:100;
		URL = "Ref_Kode_Aset108_Doc.php?CrT=KEL&gKD="+gKD+"<?="&IdL=".$_GET['IdL']?>";
