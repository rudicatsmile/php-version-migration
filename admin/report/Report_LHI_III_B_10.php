...
?>
<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:1750px; font-family:calibri; text-align:center; font-weight:bold; font-size:11pt">
<tr>
  	<td style="text-align:right">Format : III.B.10&nbsp;</td>
</tr>
<tr>
  	<td>LAPORAN HASIL INVENTARISASI (LHI)</td>
</tr>
<tr>
  	<td>REKAPITULASI BMD BERDIRI DIATAS TANAH BUKAN MILIK PEMERINTAH DAERAH</td>
</tr>
<tr>
  	<td><?=$NmA?></td>
</tr>
...
?>
<table align="center" cellpadding="0" cellspacing="0" border="0" width="1750" style="border-collapse:collapse; font-family:calibri; font-size:9pt">
<tr height="20" style="text-align:center; font-weight:bold">
	...
	<td style="border:1px solid #000">Merk/Tipe</td>
	...
	<td style="border:1px solid #000">Tanggal, Bulan, Tahun Perolehan</td>
	<td style="border:1px solid #000">Alamat</td>
	<td style="border:1px solid #000">Dibangun Diatas<br>Tanah Milik</td>
...
<tr height="20" style="text-align:center">
  ...
  <td width="120" style="border:1px solid #000">15</td>
</tr>
<?php
$iG=1;
$mRo7 = 0;
...
P2.Tgl_Perolehan as A15,
P2.Alamat as A16,
P2.Lokasi as A17, 
P1.DiatasTanahMilik as A18 
...
AND (P1.DiatasTanahMilik='PDL' OR P1.DiatasTanahMilik='PP' OR P1.DiatasTanahMilik='PL') 
AND (P2.Referensi LIKE 'BNG.%' OR P2.Referensi LIKE 'JLN.%') 
...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="22">
	  ...
	  <td style="border:1px solid #000; text-align:center"><?=fConvertDateShort($mRo[15])?></td>
	  <td style="border:1px solid #000; padding-left:2px"><?=$Alm?></td>
	  <td style="border:1px solid #000; padding-left:2px"><?=fNmDaerah($mRo[18])?></td>
...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="1750" style="font-family:calibri; font-size:10pt">
  <tr>
    <td width="481">&nbsp;</td>
    <td>&nbsp;</td>
    <td width="481">&nbsp;</td>
