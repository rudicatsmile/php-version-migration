...
<div align="center">
	...
	<tr>
	  <td style="font-size: 11pt; font-weight: bold; text-align:center">REKAPITULASI PENGADAAN ASET</td>
	</tr>
	<tr>
		<tr>
			<td>
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
			  ...
			  <tr>
				<td>JENIS BELANJA</td>
				<td>:</td>
				<td><? if ($Jns!='%') {echo  fGlobal("Nm_Rek","ref_rek_90_2","Kd_Rek",$Jns,"=","","");} else {echo "SEMUA";}?></td>
			  </tr>
			</table>			</td>
		</tr>
		<tr>
		...
		<tr>
          ...
          <tr height="23">
            ...
            <td width="374" style="border:1px solid #000000; font-weight:bold; text-align:center">URAIAN</td>
            <td width="100" style="border:1px solid #000000; font-weight:bold; text-align:center"> PENGADAAN </td> 
            <td width="100" style="border:1px solid #000000; font-weight:bold; text-align:center">ASET </td>
            <td width="90" style="border:1px solid #000000; font-weight:bold; text-align:center">SELISIH</td>
          </tr>
          <tr> 
          ...
          <?
				...
				$tCol4 = 0;
				$tCol5 = 0;
				$nSQ = "SELECT Kd_Program, Nm_Program, IfNull(sum(Nilai),0) as Nilai 
				FROM ta_pengadaan 
				...
				{
					$iGG=1;
					$nSQA = "SELECT Kd_Kegiatan, Nm_Kegiatan, IfNull(sum(Nilai),0) as Nilai 
					FROM ta_pengadaan 
				...
				{
					$iGA=1;
					$nSQB = "SELECT Kd_Rek13, Nm_Rek13, IfNull(sum(Nilai),0) as Nilai 
					FROM ta_pengadaan 
