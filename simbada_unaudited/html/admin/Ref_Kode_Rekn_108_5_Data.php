...
$iG=1;
$nSQ = "SELECT IDT, Kd_Aset, Nm_Aset FROM ref_rek_aset108_6 WHERE Kd_Aset LIKE '".$KdR4."%' $CrT ORDER BY Kd_Aset";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	$eIdT = $mRo[0];
	$eKdR = $mRo[1];
	$rCek = fGlobal("IDT","ref_rek_aset108_7","Kd_Aset",$eKdR."%","LIKE","","");
	?>
	<tr height="25"> 
	  ...
	  <a href="<?="Ref_Kode_Rekn_108_6.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 108&rKdR=".$eKdR."&IdL=".$_GET['IdL']?>" class="ico prev">&nbsp;View</a>&nbsp;&nbsp;&nbsp;
