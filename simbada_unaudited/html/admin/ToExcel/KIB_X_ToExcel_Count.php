...
<table border='0' width='526' cellspacing='1' style='font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse'>
  ...
  <tr> 
    ...
    <td><a href='#' onclick="P_OpenDoc('800','400','<? echo $ReC?>','<? echo $HeA?>','<? echo $gDoc?>'); return false"><? echo "Export Data (*.xls) KIB-".strtoupper($x)." &nbsp;&nbsp;&nbsp;( Record &nbsp;&nbsp; => &nbsp;&nbsp; ".fConvertToRupiahBulat($gA)." &nbsp; s/d &nbsp; ".fConvertToRupiahBulat($gB)." )"?></a></td>
  </tr>
  <?
		}
		?>
...
<script language="javascript">
	...
	function P_OpenDoc(w,h,ReC,HeA,gDoc)
	{
		...
		URL= gDoc+".php?LmT=YA&HeA="+HeA+"&ReC="+ReC+"<? echo "&gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gThA=".$gThA."&gThB=".$gThB."&gMLK=".$gMLK."&gBid=".$gBid."&gKel=".$gKel."&gJns=".$gJns."&gOBJ=".$gOBJ."&gRin=".$gRin."&IdL=".$_GET['IdL']?>";
