...
?>
<body>
<table border="0" width="2100" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.2.9</td>
  </tr>
</table>
<table border="0" width="2100" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">ASET LAIN-LAIN</td>
  </tr>
  <tr>
...
<table border="0" width="2100" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr style="text-align:center; font-weight:bold">
    ...
    <td rowspan="2" style="border:1px solid #000">Merek / Tipe</td>
    <td rowspan="2" style="border:1px solid #000">Spesifikasi Lainnya </td>
    <td rowspan="2" style="border:1px solid #000">Lokasi</td>
    <td rowspan="2" style="border:1px solid #000">Titik<br>
    Koordinat</td>
    <td colspan="3" style="border:1px solid #000">Kendaraan Dinas </td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Nomor Rangka</td>
    <td style="border:1px solid #000">Nomor BPKB </td>
  </tr>
  <tr style="text-align:center">
    ...
    <td width="100" style="border:1px solid #000; border-bottom:3px double #000">19</td>
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.5.4.%' 
	...
	while ($mRa = mysql_fetch_array($nRa)) 
	{
		...
		$x11="";$x12="";$x13="";$x14=0;$x15=0; $x16="";$x17="";$x18="";$x19="";
		$x0 = "";
		$x1 = $mRa[1];
		$x2 = strtoupper($mRa[2]);
		$x14= $mRa[3];
	...
	function Lev7($KdS,$x1,$ThN,$HostnameSB,$ConSB)
	{
		...
		P1.Nm_Aset as A5,
		concat(P1.Merk,' / ',P1.Type) as A6,
		'-' as A7,
		P1.Alamat as A8,
		P1.Nomor_Polisi as A9,
		P1.Nomor_Rangka as A10,
		P1.Nomor_BPKB as A11,
		'1' as A12,
		'-' as A13,
		P1.Harga as A14,
		IfNull(sum(P2.Debet),0) as A15,
		P1.Asal_Usul as A16,
		P1.Tgl_Perolehan as A17,
		P1.Penggunaan as A18,
		P1.Keterangan as A19 
		FROM ta_kib_108 P1 
		LEFT JOIN ta_kib_post_108 P2 ON P2.Referensi=P1.Referensi AND P2.Ref_Group=P1.Ref_Group AND P2.Kd_UPB=P1.Kd_UPB 
	...
	<?php function detaData($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20,$xB) {?>
		...
		<td style="border:1px solid #000; text-align:center"><?=$x17?></td>
  ...
  <tr height="19" style="font-weight:bold">
    <td colspan="12" style="border:1px solid #000; text-align:right">T O T A L<?=str_repeat('&nbsp;',20)?></td>
    <td style="border:1px solid #000; text-align:center"><?=fConvertToRupiahBulat($_COOKIE['t12'])?></td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000; text-align:right; padding-right:2px"><?=fConvertToRupiahBulat($t15)?></td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
...
<table border="0" width="2100" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
