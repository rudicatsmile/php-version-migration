...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:700px">
  ...
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onclick="P_Dokumen('800','400','RKBMD_Pengadaan_SKPD','<?=$_GET['IdL']?>'); return false;">&nbsp;&nbsp;&nbsp;RKBMD ( PENGADAAN BMD ) *</a></td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onclick="P_Dokumen('800','400','RKBMD_Pemeliharaan_SKPD','<?=$_GET['IdL']?>'); return false;">&nbsp;&nbsp;&nbsp;RKBMD ( PEMELIHARAAN BMD ) *</a></td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
