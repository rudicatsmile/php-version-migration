...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:700px">
  ...
  <tr height="30">
	...
	<input name="dUNT" id="dUNT" type="text" readonly value="<?=$dUNT?>" <? if (!$IdTx) {?> onclick="showUNITx('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13) {showUNIT('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('unit'); return false;}" <? } else {echo "readonly";}?> style="padding-left:5px; width:320px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="30">
	...
	<input name="dSUB" id="dSUB" type="text" value="<?=$dSUB?>" <? if (!$IdTx) {?> onclick="showSUB('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showSUB('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('sub'); return false;}" <? } else {echo "readonly";}?> style="padding-left:5px; width:320px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="30">
	...
	<input name="dUPB" id="dUPB" type="text" value="<?=$dUPB?>" <? if (!$IdTx) {?> onclick="showUPB('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showUPB('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('upb'); return false;}" <? } else {echo "readonly";}?> style="padding-left:5px; width:291px; border: 1px solid #C0C0C0"/>
	<input type="button" name="B13" value="..." <? if (!$IdT) {?> onclick="findUPB('','<?=$_GET['IdL']?>')" <? } ?> style="width: 27px; height:21px; background:#FF9900" />
