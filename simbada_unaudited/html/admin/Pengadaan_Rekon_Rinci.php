	...
	<tr>
	  <td style="font-size: 11pt; font-weight: bold; text-align:center">REKONSILISASI PENGADAAN ASET (RINCI)</td>
		...
		<tr>
          ...
          <? } ?>
          <? function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$iR,$xB) {?>
          <tr style="font-family:arial; font-size:8pt"> 
            ...
            <td width="95" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x1?></td>
            <td width="87" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x2?></td>
            <td width="178" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x3?></td>
            <td width="71" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x4?></td>
            <td width="285" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x5?></td>
            <td width="84" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:right; padding-right:3px"><?=$xB.fConvertToRupiah($x6)?></td>
            </tr>
          <? } ?>
          <? function ViewBlank() {?>
          <tr> 
