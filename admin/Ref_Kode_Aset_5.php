...
<form name="myfrm" method="post" action="<?="Ref_Kode_Aset_5_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG']."&KdAst1=".$KdAst1."&KdAst2=".$KdAst2."&KdAst3=".$KdAst3."&KdAst4=".$KdAst4 ?>">
  ...
  <table border="0" align="center" cellspacing="1" style="font-size: 10pt; font-family: Calibri; border-collapse: collapse; text-transform: uppercase; font-weight: bold; width:99%">
    ...
    <tr> 
      <td><a href="<?="Ref_Kode_Aset_4.php?KdAst1=".$KdAst1."&KdAst2=".$KdAst2."&KdAst3=".$KdAst3."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>">&lt;&lt; - OBJEK</a></td>
      <td>&nbsp;</td>
      <td><a href="<?="Ref_Kode_Aset_4.php?KdAst1=".$KdAst1."&KdAst2=".$KdAst2."&KdAst3=".$KdAst3."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>"><?=$KdAst4." : ".fGlobal("Nm_Aset","Ref_Rek_Aset4","Kd_Aset",$KdAst4,"=","","")?></a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
	...
	$nSQL= "SELECT * FROM ref_rek_aset5 WHERE Kd_Aset LIKE '".$KdAst4.".___' ORDER BY Kd_Aset LIMIT $Offset, $DataPerPage";
	...
	do
	  ...
	  <?php
		$nSQL= "SELECT COUNT(*) AS JmlRc FROM ref_rek_aset5 WHERE Kd_Aset LIKE '".$KdAst4.".___'";
...
<script language="javascript">
			...
			if (win!=null)
				{
					...
					<?php
						$URL_Top = "Form_Kode_Aset5_Top.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'];
						$URL_Mid = "Form_Kode_Aset5_Mid.php?KdAst4=".$KdAst4."&IdL=".$_GET['IdL'];
						$URL_Bot = "Form_Kode_Aset5_Bot.php";
					?>       			
	...
	function EditData(w,h,Lev,IDT)
	{
		...
		{
			win.window.document.open()       			
			URL_Top = "Form_Kode_Aset5_Top.php?"+"<?="FrmG=".$_GET['FrmG']?>";
			URL_Mid = "Form_Kode_Aset5_Mid.php?rIDT="+IDT+"<?="&IdL=".$_GET['IdL']?>";
			URL_Bot = "Form_Kode_Aset5_Bot.php";
			txtHTML="<html><head><title>Simbada Kab. Hulu Sungai Tengah</title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFormKIB_Top' noresize src='"+URL_Top+"' scrolling='no'><frame name='WinFormKIB_Mid' src='"+URL_Mid+"' scrolling='auto'><frame name='WinFormKIB_Bot' src= '"+URL_Bot+"' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
			win.focus()
			win.window.document.clear()
	...
	function P_Document(w,h,pos,gKD)
	{
		...
		LeftPosition=(screen.width)?(screen.width-w)/2:100; 
		TopPosition=(screen.height)?(screen.height-h)/2:100;
		URL = "Ref_Kode_Aset_Doc.php?CrT=RIN&gKD="+gKD+"<?="&IdL=".$_GET['IdL']?>";
