...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>NAMA BARANG</td>
      <td><input name="fNama" type="text" class="text" value="<? echo $gNma?>" style="width: 450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>UKURAN / CC</td>
      <td><input name="fUkuranCC" type="text" class="text" id="fUkuranCC" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gUcc?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBHN?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR PABRIK</td>
      <td><input name="fPabrik" type="text" class="text" id="fPabrik" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gPBR?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR RANGKA</td>
      <td><input name="fRangka" type="text" class="text" id="fRangka" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gRKA?>"  /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR MESIN</td>
      <td><input name="fMesin" type="text" class="text" id="fMesin" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gMSN?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      ...
      <input name="fPolisi" type="text" class="text" value="<? echo $gPLS?>" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" />
      </span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NOMOR BPKB</td>
      <td><input name="fBPKB" type="text" class="text" id="fBPKB" style="width: 300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBPK?>" /></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="fSatuan" type="text" id="fSatuan" value="<? echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:50px; text-align:center; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /> 
      (unit/buah/ect...)</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
