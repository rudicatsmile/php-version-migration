...
require "Form_Asset_E_Mid_Temp_Posting.php";
...
if ($Smp=="Save")
{
	...
	if ($gPRO=="70" || $gPRO=="100")
	{
		PostingDataKIB($gIdT,$rIDT,$gPRO,$gNiL,$gNoM,$gBid,DatabaseSB,$ConSB);
	}
}
else if ($Smp=="Reset")
{
...
$URL="Form_Asset_E_Mid_Temp.php?".$urI."gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$IdL;
header("Location: ".$URL);
?>
