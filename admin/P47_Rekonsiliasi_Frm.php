...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:800px">
  ...
  <tr height="23">
	...
	<option value="V1" <?php if ($model=='V1'){echo "selected";}?>>Format V.1 ( <?=rekonsPh1('V1')." -> ".rekonsPh2('V1')?> )</option>
	<option value="V2" <?php if ($model=='V2'){echo "selected";}?>>Format V.2 ( <?=rekonsPh1('V2')." -> ".rekonsPh2('V2')?> )</option>
	<option value="V3" <?php if ($model=='V3'){echo "selected";}?>>Format V.3 ( <?=rekonsPh1('V3')." -> ".rekonsPh2('V3')?> )</option>
	<option value="V4" <?php if ($model=='V4'){echo "selected";}?>>Format V.4 ( <?=rekonsPh1('V4')." -> ".rekonsPh2('V4')?> )</option>
	</select>	</td>
  </tr>
  <tr height="23">
