			...
			<table border="1" width="100%" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
				...
				?>
					<tr height="20">
						...
						<td align="center" valign="top"><?php if ($x4a>0){echo $xB.$x4a;}?></td>
						<td align="center" valign="top" style="color:#0000FF"><?php if ($x4>0){echo $xB.$x4;}?></td>
						<td align="center" valign="top"><?php if ($x4a>0){echo $xB.($x4-$x4a);}?></td>
						<td align="center" valign="top"><?php if ($x4>0){echo $xB.$x5;}?></td>
						<td align="center" valign="top"><?php if ($x6a>0){echo $xB.$x6a;}?></td>
						<td align="center" valign="top" style="color:#0000FF"><?php if ($x6>0){echo $xB.$x6;}?></td>
						<td align="center" valign="top"><?php if ($x6a>0){echo $xB.($x6-$x6a);}?></td>
						<td align="center" valign="top"><?php if ($x6>0){echo $xB.$x7;}?></td>
						<td align="center" valign="top"><?=$xB.$x8?></td>
						<td valign="top"><?=$xB.$x9?></td>
						<td align="center" valign="top"><?php if ($x10a>0){echo $xB.$x10a;}?></td>
						<td align="center" valign="top" style="color:#0000FF"><?php if ($x10>0){echo $xB.$x10;}?></td>
						<td align="center" valign="top"><?php if ($x10a>0){echo $xB.($x10-$x10a);}?></td>
