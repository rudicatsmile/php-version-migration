...
if ($FnD)
{
	$CrT ="AND (P1.Kd_UPB LIKE '%$FnD%' OR P1.Nm_UPB LIKE '%$FnD%' OR P2.Nm_Sub LIKE '%$FnD%' OR P3.Nm_Unit LIKE '%$FnD%')";
}
?>
<table align="center" cellpadding="0" class="table-listpop" cellspacing="0" width="780" height="100%" border="0">
	...
	JOIN ref_unit P3 ON P3.Kd_Unit=left(P1.Kd_UPB,11) 
	WHERE P1.Kd_UPB LIKE '24.04.08.01%' 
	$CrT ORDER BY Nm_UPB";
	#echo $nSQ;
	$nRs = mysql_query($nSQ);
	while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	{
		...
		<tr height="28">
			...
			<td class="ac" style="border-bottom:1px dotted #ccc" <?=$BG?>><a href="<?="SP3D_Pelatihan_Frm.php?FrmG=DANA BOS -> FORM PENDAFTARAN MENGIKUTI PELATIHAN&gUPB=".$gUPB."&IdL=".$IdL?>" class="ico edit">Use</a></td>
		</tr>
		<?php
		$iG++;
	}
