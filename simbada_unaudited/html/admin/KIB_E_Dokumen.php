...
<div align="center">
	<table border="0" width="1320" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
		<? if ($gHeA!="NO") {?>
			...
			<tr>
				<td style="font-size: 13pt; font-weight: bold" align="center"> ASET TETAP LAINNYA <? if ($gExt=="Y") {echo "(EXTRA KOMTABLE)";}?></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
		...
		?>
          ...
          <tr> 
            ...
            <td width="13%" style="border: 1px solid #000000" valign="top"><? echo $x1?></td>
            <td width="4%" style="border: 1px solid #000000" valign="top" align="center"><? echo $x2?></td>
            <td width="4%" style="border: 1px solid #000000" valign="top" align="center"><? echo $x3?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top"><? echo $x4?></td>
            <td width="5%" style="border: 1px solid #000000" valign="top"><? echo $x5?></td>
            <td width="5%" style="border: 1px solid #000000" valign="top"><? echo $x6?></td>
            <td width="4%" style="border: 1px solid #000000" valign="top"><? echo $x7?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top"><? echo $x8?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top"><? echo $x9?></td>
            <td width="5%" style="border: 1px solid #000000" valign="top"><? if ($x10!=0) {echo $x10;}?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top"><? echo $x11?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top" align="center"><? echo $x12?>
            </td>
            <td width="6%" style="border: 1px solid #000000" valign="top"><? echo $x13?></td>
            <td width="6%" style="border: 1px solid #000000" valign="top" align="right"><? echo fConvertToRupiah($x14)?></td>
          ...
          <tr> 
            ...
            <td width="6%" style="border:1px solid #000000; font-weight: bold" align="right"><? echo fConvertToRupiah($gHrg)?></td>
            <td style="border: 1px solid #000000">&nbsp;</td>
          </tr>
		  <? 
