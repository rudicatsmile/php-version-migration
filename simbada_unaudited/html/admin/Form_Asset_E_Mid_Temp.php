...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      ...
      <td>
	  <? if ($zBid=="1.3.5.01") {?>
	    <input name="fJudul" type="text" class="text" id="fJudul" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gJDL?>" /> 
	  <? } else if ($zBid=="1.3.5.02") {?>
	    <input name="fAsalD" type="text" class="text" id="fAsalD" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gASL?>" /> 
	  <? } else if ($zBid=="1.3.5.03" || $zBid=="1.3.5.04" || $zBid=="1.3.5.05"  || $zBid=="1.3.5.06"  || $zBid=="1.3.5.07") {?>
	    <input name="fJenis" type="text" class="text" id="fJenis" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gJNS?>" /> 
      <? } ?>	  </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td> 
        <? if ($zBid=="1.3.5.01") {?>
        <input name="fSpesi" type="text" class="text" id="fSpesi" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gSPC?>" /> 
        <? } else if ($zBid=="1.3.5.02") {?>
        <input name="fCipta" type="text" class="text" id="fCipta" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gCPT?>" />
	  <? } else if ($zBid=="1.3.5.03" || $zBid=="1.3.5.04" || $zBid=="1.3.5.05"  || $zBid=="1.3.5.06"  || $zBid=="1.3.5.07") {?>
	    <input name="fUkura" type="text" class="text" id="fUkura" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gUKU)?>" />
      <? } ?>	  </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBHN?>" /></td>
      <td>&nbsp;</td>
    </tr>
	<? } ?>
	<? if ($zBid=="1.3.5.01") {?>
    ...
    <tr>
      ...
      <td><input name="fSatuan" type="text" id="fSatuan" value="<? echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:65px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /> 
        BUAH </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
