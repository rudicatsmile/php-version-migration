...
MerupakanAtribusi_induk as A40,
DataSensusFix as A41,
KeberadaanBarang_tidakada_jmlh as A42,
KeberadaanBarang_tidakada as A43 
...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:910px">
	<tr height="30">
	  <td width="120" style="border-bottom:1px solid #ccc"><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="818">&nbsp;</td>
          <td width="132">Format : III.A.5</td>
        </tr>
      </table></td>
  </tr>
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="23" style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td width="101"><label>
            <input type="radio" name="radioAda" value="ada" <?=$CkAda1?> onchange="saveDATA('KeberadaanBarang','ada','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Ada</label></td>
          <td width="185"><label>
            <input type="radio" name="radioAda" value="tidakada"<?=$CkAda2?> onchange="saveDATA('KeberadaanBarang','tidakada','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')">
            Tidak Ada, Sebutkan </label></td>
          <td width="80">Jumlahnya</td>
          <td width="23">:</td>
          <td width="341"><input type="text" name="JmlBRGT" id="JmlBRGT" value="<?=$JmlBRGJmL?>" <?=$JmlBRGJmLR?> onkeypress="if (event.keyCode==13){saveDATA('KeberadaanBarang_tidakada_jmlh',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:40px; text-align:center" /></td>
        </tr>
        <tr height="23" style="font-weight:bold">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td>a.</td>
          <td><label>
            <input type="radio" name="radiotidkAda" value="hilang" <?=$CktidkAda1?> <?=$CktidkAda1D?> onchange="saveDATA('KeberadaanBarang_tidakada','hilang','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Hilang</label></td>
        </tr>
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          ...
          <td>b.</td>
          <td><label>
            <input type="radio" name="radiotidkAda" value="tidakditemukan" <?=$CktidkAda2?> <?=$CktidkAda2D?> onchange="saveDATA('KeberadaanBarang_tidakada','tidakditemukan','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Ditemukan</label></td>
        </tr>
      </table></td>
  </tr>
	<tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="25" style="font-weight:bold">
          ...
          <td colspan="2">
		  <label><input type="radio" name="radioAtr" value="diketahui" <?=$CkAtr1?> onchange="saveDATA('MerupakanAtribusi','ya','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Ya</label>		  </td>
          <td colspan="2"><label><input type="radio" name="radioAtr" value="tidak" <?=$CkAtr2?> onchange="saveDATA('MerupakanAtribusi','tidak','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Bukan merupakan biaya atribusi</label></td>
        </tr>
        <tr height="25" style="font-weight:bold">
          <td colspan="4">
		  <label><input type="radio" name="radioAtrInd" value="diketahui" <?=$CkIndk1?> <?=$CkIndk1D?> onchange="saveDATA('MerupakanAtribusi_induk','diketahui','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Diketahui data awal/induknya, sebutkan data barang induknya :</label></td>
        </tr>
        <tr height="24" style="font-weight:bold">
          <td width="23">&nbsp;</td>
        ...
        <tr height="25" style="font-weight:bold">
          ...
          <td>&nbsp;</td>
          <td colspan="4">
		  <label><input type="radio" name="radioAtrInd" value="tidakdiketahui" <?=$CkIndk2?> <?=$CkIndk2D?> onchange="saveDATA('MerupakanAtribusi_induk','tidakdiketahui','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak diketahui nilai induknya </label></td>
        </tr>
      </table></td>
  </tr>
	<tr height="26">
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr height="25">
          ...
          <td width="16">:</td>
          <td width="417"><input type="text" name="nmPemakai" id="nmPemakai" value="<?=$NmPemakai?>" <?=$NmPemakaiR?> onkeypress="if (event.keyCode==13){saveDATA('PD_NmPemakai',this,'Y','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:250px" /></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td width="16">:</td>
          <td width="417"><input type="text" name="StPemakai" id="StPemakai" value="<?=$StPemakai?>" <?=$StPemakaiR?> onkeypress="if (event.keyCode==13){saveDATA('PD_StatusPemakai',this,'Y','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:250px" /></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td width="16">:</td>
          <td width="417">
		  <label><input type="radio" name="radioBasPD" value="ada" <?=$CkBasPD1?> <?=$CkBasPDR1?> onchange="saveDATA('PD_BastPemakaian','ada','N','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Ada</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  <label><input type="radio" name="radioBasPD" value="tidakada" <?=$CkBasPD2?> <?=$CkBasPDR2?> onchange="saveDATA('PD_BastPemakaian','tidakada','N','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak Ada</label>
		  </td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e. Surat Izin Penghuni (SIP)</td>
          <td width="16">:</td>
          <td width="417">
		  <label><input type="radio" name="radioSipPD" value="ada" <?=$CkSipPD1?> <?=$CkSipPDR1?> onchange="saveDATA('PD_SuratIzin','ada','N','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Ada</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  <label><input type="radio" name="radioSipPD" value="tidakada" <?=$CkSipPD2?> <?=$CkSipPDR2?> onchange="saveDATA('PD_SuratIzin','tidakada','N','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak Ada</label>
		  </td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="26" style="font-weight:bold">N.</td>
          <td width="137" style="font-weight:bold">Gedung dan Bangunan diatas tanah milik</td>
          <td width="21">:</td>
  ...
  <tr>
	...
	?>
			  ...
			  <tr height="18">
               ...
               <?
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
					...
					?>
              <tr height="18">
                <td valign="top" width="17" <?=$gBG?> style="border-bottom:1px dotted #CCCCCC; text-align:center; padding-top:5px; padding-bottom:5px"><?=$iG?>
                  .</td>
                ...
                <td valign="top" width="87" <?=$gBG?> style="border-bottom:1px dotted #CCCCCC; padding-right:15px; padding-top:5px; padding-bottom:5px; text-align:right"><?=$gSz?>
                  KB</td>
                <td valign="top" width="93" <?=$gBG?> style="border-bottom:1px dotted #CCCCCC; text-align:center; padding-top:5px; padding-bottom:5px"><a href="#" onclick="viewIMG('Img','<?=$rIdT?>','600','400','<?=$IdL?>'); return false;" class="ico prev">&nbsp;</a>&nbsp;&nbsp; <a href="#" onclick="remoIMG('Img','<?=$AsT?>','<?=$ReO?>','<?=$rIdT?>','<?=$IdT?>','<?=$IdL?>'); return false;" class="ico dele">&nbsp;</a></td>
              </tr>
              <?
					$iG++;
				}
        ...
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td><a href="#" class="ico docu" onclick="formCetakDok('Report_Form_LKI_ATL','<?=$IdT?>','900','400','<?=$IdL?>'); return false;">&nbsp;&nbsp;DOKUMEN CETAK</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
