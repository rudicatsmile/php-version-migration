<?
	...
	{
		$iGD  = 1;
		$nSQD = "SELECT left(P1.Kd_Aset,11) as Kd_Aset, P2.Nm_Aset 
		FROM ref_rek_aset5_temp P1 
		JOIN ref_rek_aset4 P2 ON P2.Kd_Aset=left(P1.Kd_Aset,11) 
		WHERE P1.Kd_Aset LIKE '".$KdOBJ.".%' AND P1.Kd_Unit = '".substr($mUpb,0,11)."' GROUP BY left(P1.Kd_Aset,11)";
