...
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
  <tr height="35">
    ...
    <?php if ($Jns=='PH') {?>
		...
		<!--td width="60" style="font-weight:bold"><label style="cursor:pointer"><input name="fKIB" type="radio" value="c" onclick="showASET('find','<?=$Jns?>','<?=$IdT?>','<?=$IdL?>')" /> C</label></td-->
	<?php } else {?>
