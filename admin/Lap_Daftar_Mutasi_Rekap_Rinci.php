	  ...
	  <td><table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse" id="table8">
        ...
        <tr>
          ...
          <td width="237" align="right" style="font-weight: bold">Kode Kepemilikan:
            <?php if ($gMLK=="All" || $gMLK=="") {echo "XX";} else {echo $gMLK;}?></td>
        </tr>
      </table></td>
	</tr>
	<tr>
	  <td>
		<table border="1" width="900" cellspacing="1" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1" bordercolor="#000000">
			<tr>
				...
				<?php if ((int)$gDoc == 3) {echo ", Objek";}?>
				<?php if ((int)$gDoc == 4) {echo ", Objek, Rincian Objek";}
				?>
				</td>
			...
			<tr>
				<td width="24" height="22" valign="top" align="center"><?php echo $xB.$x1?></td>
				<td width="30" valign="top" align="center"><?php echo $xB.$x2?></td>
				<td width="35" valign="top" align="left"><?php echo $xB.$x3?></td>
				<td width="285" valign="top" ><?php echo $xB.$x4?></td>
				<td width="52" valign="top" align="center"><?php if ($x5!=0) {echo $xB.fConvertToRupiahBulat($x5);} else {echo "-";}?></td>
				<td width="56" valign="top" align="right"><?php if ($x6!=0) {echo $xB.fConvertToRupiah($x6);} else {echo "-";}?></td>
				<td width="57" valign="top" align="center"><?php if ($x7!=0) {echo $xB.fConvertToRupiahBulat($x7);} else {echo "-";}?></td>
				<td width="114" valign="top" align="right"><?php if ($x8!=0) {echo $xB.fConvertToRupiah($x8);} else {echo "-";}?></td>
				<td width="114" valign="top" align="center"><?php if ($x9!=0) {echo $xB.fConvertToRupiahBulat($x9);} else {echo "-";}?></td>
				<td width="114" valign="top" align="right"><?php if ($x10!=0) {echo $xB.fConvertToRupiah($x10);} else {echo "-";}?></td>
				<td width="56" valign="top" align="center"><?php if ($x11!=0) {echo $xB.fConvertToRupiahBulat($x11);} else {echo "-";}?></td>
				<td width="57" valign="top" align="right"><?php if ($x12!=0) {echo $xB.fConvertToRupiah($x12);} else {echo "-";}?></td>
