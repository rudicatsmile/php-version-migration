...
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
  <tr height="30">
	...
	<select class="boxs" name="fAsT" id="fAsT" style="background:#999900; color:#FFFFFF; width:100px" tabindex="0" onchange="showASET('find','<?=$PgE?>','<?=$Jns?>','<?=$IdT?>','<?=$IdL?>'); return false;">
      <?php if ($gJNS!='PHS'){?>
	  <option value="1.3.1" <?php if ($gAsT=='1.3.1'){echo "selected";}?>>TNH</option>
      <option value="1.3.2" <?php if ($gAsT=='1.3.2'){echo "selected";}?>>ALT</option>
      <option value="1.3.3" <?php if ($gAsT=='1.3.3'){echo "selected";}?>>BNG</option>
      <option value="1.3.4" <?php if ($gAsT=='1.3.4'){echo "selected";}?>>JLN</option>
      <option value="1.3.5" <?php if ($gAsT=='1.3.5'){echo "selected";}?>>ATL</option>
      <option value="1.3.6" <?php if ($gAsT=='1.3.6'){echo "selected";}?>>KDP</option>
      <option value="1.5.3" <?php if ($gAsT=='1.5.3'){echo "selected";}?>>ATB</option>
      <option value="1.5.4" <?php if ($gAsT=='1.5.4'){echo "selected";}?>>KDL</option>
      <?php }else{?>
      <option value="1.5.4" <?php if ($gAsT=='1.5.4'){echo "selected";}?>>KDL</option>
      <?php } ?>
    </select>	</td>
