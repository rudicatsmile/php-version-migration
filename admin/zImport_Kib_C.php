...
$nSQ = "TRUNCATE TABLE ta_kib_c";
$nRs = mysql_query($nSQ) or die(mysql_error());

CallConnection(DatabaseSA,$ConSA);
$iG=1;
$nSQ = "SELECT * FROM ta_kib_c ORDER BY Kd_Prov, Kd_Kab_Kota, Kd_Bidang, Kd_Unit, Kd_Sub, Kd_UPB, Kd_Aset1, Kd_Aset2, Kd_Aset3, Kd_Aset4, Kd_Aset5, No_Register";
$nRs = mysql_query($nSQ) or die(mysql_error());
while ($mRo = mysql_fetch_assoc($nRs))
{
	...
	$gFLD .= ",Bertingkat";
	$gVAL .= ",'".$mRo['Bertingkat_Tidak']."'";
	
	$gFLD .= ",Beton";
	$gVAL .= ",'".$mRo['Beton_tidak']."'";
	
	$gFLD .= ",Luas_Lantai";
	$gVAL .= ",'".$mRo['Luas_Lantai']."'";
	
	$gFLD .= ",Lokasi";
	$gVAL .= ",'".mysql_real_escape_string($mRo['Lokasi'])."'";
	
	$gFLD .= ",Dokumen_Tanggal";
	$gVAL .= ",'".mysql_real_escape_string($mRo['Dokumen_Tanggal'])."'";
	
	$gFLD .= ",Dokumen_Nomor";
	$gVAL .= ",'".mysql_real_escape_string($mRo['Dokumen_Nomor'])."'";
	
	$gFLD .= ",Status_Tanah";
	$gVAL .= ",'".mysql_real_escape_string($mRo['Status_Tanah'])."'";
