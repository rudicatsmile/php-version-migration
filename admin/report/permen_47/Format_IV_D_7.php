...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    <td style="border:1px solid #000" rowspan="2">No.</td>
    <td colspan="2" style="border:1px solid #000">Berita Acara Seeah Terima</td>
    <td colspan="2" style="border:1px solid #000">Penggolongan dan Kodefikasi Barang</td>
    <td style="border:1px solid #000" rowspan="2" width="65">NIBAR/NUSP</td>
    <td colspan="7" style="border:1px solid #000">Pengeluaran Barang</td>
    <td colspan="7" style="border:1px solid #000">Penerimaan Barang </td>
    <td rowspan="2" style="border:1px solid #000">Keterangan</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
    <td style="border:1px solid #000; border-bottom:1px solid #000">Tanggal</td>
    <td style="border:1px solid #000; border-bottom:1px solid #000">Nomor</td>
    ...
    <td style="border:1px solid #000">Pihak yang menyerahkan</td>
    <td style="border:1px solid #000">Jumlah Barang</td>
    <td style="border:1px solid #000">Satuan Barang</td>
    <td style="border:1px solid #000">Harga Satuan (Rp)</td>
    <td style="border:1px solid #000">Total Nilai Barang (Rp)</td>
    <td style="border:1px solid #000">NIlai Akumulasi Penyusutan atau Amortasi (Rp)</td>
    <td style="border:1px solid #000">Nilai Buku (Rp)</td>
    <td style="border:1px solid #000">Pihak yang menerima</td>
    <td style="border:1px solid #000">Jumlah Barang</td>
    <td style="border:1px solid #000">Satuan Barang</td>
    <td style="border:1px solid #000">Harga Satuan (Rp)</td>
    <td style="border:1px solid #000">Total Nilai Barang (Rp)</td>
  ...
  <tr style="text-align:center">
    <td width="29" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="56" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="56" style="border:1px solid #000; border-bottom:3px double #000">1</td>
    <td style="border:1px solid #000; border-bottom:3px double #000" width="35">2</td>
    <td style="border:1px solid #000; border-bottom:3px double #000" width="65">&nbsp;</td>
    <td width="78" style="border:1px solid #000; border-bottom:3px double #000">4</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">5</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">6</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">7</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">9</td>
    <td width="84" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="79" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="75" style="border:1px solid #000; border-bottom:3px double #000">10</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">11</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">12</td>
    <td width="72" style="border:1px solid #000; border-bottom:3px double #000">13</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">14</td>
    <td width="84" style="border:1px solid #000; border-bottom:3px double #000">
	15</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="85" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
  </tr>
	<?php
	...
	<td style="border:1px solid #000; padding-left:3px" width="62">&nbsp;</td>
	...
	<td style="border:1px solid #000; text-align:right; padding-right:3px"><?=fConvertToRupiahBulat($x11)?></td>
	<td style="border:1px solid #000; text-align:right; padding-right:3px"><?=fConvertToRupiahBulat($x12)?></td>
  ...
  <tr height="22">
    ...
    <td style="border:1px solid #000" width="65">&nbsp;</td>
  ...
  <tr height="25" style="font-weight:bold">
    ...
    <td style="border:1px solid #000; border-top:3px double #000; text-align:right; padding-right:3px"><?=fConvertToRupiahBulat($t11)?></td>
    <td style="border:1px solid #000; border-top:3px double #000; text-align:right; padding-right:3px"><?=fConvertToRupiahBulat($t12)?></td>
