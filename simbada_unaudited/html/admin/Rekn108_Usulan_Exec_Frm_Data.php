...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="22"> 
	  ...
	  <td valign="top" width="70" <?=$gBG?> style="border-bottom:1px #999999 dotted; padding-left:3px; padding-right:3px; border-left:1px #ccc solid; text-align:center; font-weight:<?=$WgT?>"><? if (substr($mRo6,0,4)!='0000') {echo fConvertDateShort($mRo6);}?></td>
