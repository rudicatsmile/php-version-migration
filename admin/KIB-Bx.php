	  ...
	  <table align="center" border="0" class="table-list" cellspacing="0" cellpadding="0" style="width:99%">
		...
		do
			...
			<tr height="40" style="cursor: pointer <?=$Blnk?>" <?=fBackCLR($iG)?>> 
              ...
              <td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px"><?=$BARKODE.$NmB.$TtK?><?php if ($mRo['Kd_Ruang']==''){echo "<font style='color:#ff0000'><i><br>Belum Masuk KIR</i></font>";}?></td>
