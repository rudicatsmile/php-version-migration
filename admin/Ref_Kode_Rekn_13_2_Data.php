...
$iG=1;
$tJmL= 0;
$nSQ = "SELECT IDT, Kd_Rek, Nm_Rek FROM ref_rek_2 WHERE Kd_Rek LIKE '".$KdR1."%' $CrT ORDER BY Kd_Rek";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	$eIdT = $mRo[0];
	$eKdR = $mRo[1];
	$rCek = fGlobal("IDT","ref_rek_3","Kd_Rek",$eKdR."%","LIKE","","");
	?>
	<tr height="25"> 
	  ...
	  <a href="<?="Ref_Kode_Rekn_13_3.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 13/2006&rKdR=".$eKdR."&IdL=".$_GET['IdL']?>" class="ico prev">&nbsp;View</a>&nbsp;&nbsp;&nbsp;
