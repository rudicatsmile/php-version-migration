...
$NmR3 = fGlobal("Nm_Rek","ref_rek_90_3","Kd_Rek",$KdR3,"=","","");

$KdR4 = substr($rKdR,0,9);
$NmR4 = fGlobal("Nm_Rek","ref_rek_90_4","Kd_Rek",$KdR4,"=","","");

$KdR5 = $rKdR;
$NmR5 = fGlobal("Nm_Rek","ref_rek_90_5","Kd_Rek",$KdR5,"=","","");
?>
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1200px">
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR1" id="fKdR1" type="text" value="<?=$KdR1?>" readonly="readonly" style="padding-left:5px; width:68px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR2" id="fKdR2" type="text" value="<?=$KdR2?>" readonly="readonly" style="padding-left:5px; width:68px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR3" id="fKdR3" type="text" value="<?=$KdR3?>" readonly="readonly" style="padding-left:5px; width:68px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_90_3.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$KdR2."&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">&nbsp;</td>
    <td class="ac">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR4" id="fKdR4" type="text" value="<?=$KdR4?>" readonly="readonly" style="padding-left:5px; width:68px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_90_4.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$KdR3."&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">&nbsp;</td>
    <td class="ac">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR5" id="fKdR5" type="text" value="<?=$KdR5?>" readonly="readonly" style="padding-left:5px; width:68px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_90_5.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$KdR4."&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">FIND</td>
    <td class="ac">:</td>
...
<table border="0" cellspacing="0" class="table-link" cellpadding="0" align="center" style="width:1200px; height:20px; background: #C9DCD8; font-weight:bold">
  <tr>
    ...
    <td width="425" align="left" style="padding-left:6px">SUB RINCIAN OBJEK (<i>Sumber P90 Kab. Hulu Sungai Tengah</i>)
	<div id="dataMstCri" class="editrekn0Cri">
		<div id="dataDiv1Cri" class="editrekn1Cri"></div>
		<div id="dataDiv2Cri" class="editrekn2Cri"></div>
	</div>	</td>
    <td width="525" align="left" style="padding-left:6px">MAPPING PERMENDAGRI 13/2006 (<i>Sumber : Mapping Kab. Hulu Sungai Tengah</i>)</td>
    <td class="ac">ACTION</td>
  </tr>
</table>
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1200px; height:280px">
  <tr>
    <td valign="top">
	<div id="ViewDELL" style="height:0px; width:0px; overflow:auto"></div>
	<div id="ViewDATA" style="height:280px; width:100%; overflow:auto; border:0px"></div>
	</td>
  </tr>
</table>
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1200px; height:30px">
  <tr>
    <td>&nbsp;&nbsp;&nbsp;
	<a href="#" onClick="editDATA('6','addnew','','','<?=$IdL?>'); return false" class="ico add">&nbsp;Add Item</a>&nbsp;&nbsp;&nbsp;
...
<script languange="javascript">
	...
	function RefreshDATA(IdL)
	{
		...
		{
			$.ajax({
				url:"Ref_Kode_Rekn_90_6_Data.php",
	...
	function prinDATA(w,h,IdL)
	{
		...
		URL = 'Ref_Kode_Rekn_90_Doc.php?Lev=5&eKD='+eKD+'&IdL='+IdL;
