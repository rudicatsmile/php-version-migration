...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_GE_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" align="center" width="1165">
    ...
    <tr> 
	  ...
	  ?>
			...
			<? } else {?>
			<input type="button" name="B392" value="FIND" <? if ($KeY=='Y') {echo "disabled";}?> onclick="OpenAccNumb('600','500','center')" style="width: 50px; height: 22px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
			<? } ?>			</td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
    ...
    <tr> 
      ...
      <td colspan="2">
		<table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="52%"> 
			<input type="button" disabled name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
    ...
    <tr> 
      ...
      <td>
	  <? if ($zBid=="05.17") {?>
	    <input name="fJudul" type="text" class="text" id="fJudul" style="widht:70; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gJDL?>" size="60" maxlength="50" /> 
	  <? } else if ($zBid=="05.18") {?>
	    <input name="fAsalD" type="text" class="text" id="fAsalD" style="widht:60; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gASL?>" size="60" maxlength="50" /> 
	  <? } else if ($zBid=="05.19") {?>
	    <input name="fJenis" type="text" class="text" id="fJenis" style="widht:50; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gJNS?>" size="60" maxlength="50" /> 
      <? } ?>	  </td>
      <td>&nbsp;</td>
      <td colspan="2">
	  ...
	  <tr>
		<?
		$iG=1;
		$SQL="SELECT IDT FROM ta_kib_e_pdf WHERE Referensi='$gREF' ORDER BY IDT";
		$nRs = mysql_query($SQL);
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('e','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('e','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>	  </td>
    </tr>
    <tr> 
      ...
      <td> 
        <? if ($zBid=="05.17") {?>
        <input name="fSpesi" type="text" class="text" id="fSpesi" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gSPC?>" size="20" maxlength="15" /> 
        <? } else if ($zBid=="05.18") {?>
        <input name="fCipta" type="text" class="text" id="fCipta" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gCPT?>" size="60" maxlength="15" />
	  <? } else if ($zBid=="05.19") {?>
	    <input name="fUkura" type="text" class="text" id="fUkura" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gUKU)?>" size="20" maxlength="15" />
      <? } ?>	  </td>
      <td>&nbsp;</td>
	...
	<? if ($zBid=="05.17" || $zBid=="05.18") {?>
    <tr> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gBHN?>" size="20" maxlength="15" /></td>
      <td>&nbsp;</td>
    </tr>
	<? } ?>
	<? if ($zBid=="05.17") {?>
    ...
    <tr> 
      <td>KETERANGAN</td>
      <td><textarea name="fKeterangan" cols="57" rows="3" id="textarea" style="border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
