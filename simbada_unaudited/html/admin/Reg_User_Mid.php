...
<table border="0" width="677" cellspacing="3" cellpadding="0" style="font-family:Calibri; font-size:9pt">
	<tr>
		...
		<td width="13">:</td>
		<td colspan="3"><input readonly name="fUid" type="text" value="<? echo $gUid?>" size="40"/></td>
		<td width="34">&nbsp;</td>
	</tr>
	<tr>
		<td width="83">Nama Lengkap </td>
		<td width="13">:</td>
		<td colspan="3"><input readonly name="fNmA" type="text" value="<? echo $gNmA?>" size="40"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td width="83">Unit Kerja </td>
		<td width="13">:</td>
		<td colspan="3"><input readonly name="fUnt" type="text" value="<? echo $gUnt?>" size="60"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td width="83">Sub Unit </td>
		<td width="13">:</td>
		<td colspan="3"><input readonly name="fSub" type="text" value="<? echo $gSub?>" size="60"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	  <td>UPB</td>
	  <td>:</td>
	  <td colspan="3"><input readonly name="fUpb" type="text" value="<? echo $gUpb?>" size="60"/></td>
	  <td>&nbsp;</td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
	...
	<tr>
	  <td>Aktivasi User </td>
	  <td>:</td>
	  <td colspan="3"><label><input type="checkbox" name="fAct" value="ON" <? echo $gAc?> />&nbsp;&nbsp;AKTIF</label></td>
	  <td>&nbsp;</td>
    </tr>
	...
	<tr>
	  <td>Akses Data </td>
	  <td>&nbsp;</td>
	  <td colspan="3"><label><input type="checkbox" name="fRed" value="ON" <? echo $gRe?> />&nbsp;&nbsp;READONLY</label></td>
	  <td>&nbsp;</td>
    </tr>
	<? if ($Lev<=2){?>
	<tr>
	  ...
	  <td>&nbsp;</td>
	  <td width="184"><label><input type="checkbox" name="fCet" value="ON" <? echo $gCet?> />&nbsp;&nbsp;AKTIF BAR KODE</label></td>
	  <td width="252"><label><input type="checkbox" name="fSen" value="ON" <? echo $gSen?> />&nbsp;&nbsp;USER SEKOLAH</label></td>
	  <td width="90"> </td>
	  <td>&nbsp;</td>
    </tr>
	<? } ?>
	  ...
	  <td colspan="3">
		<table border="0" width="345" cellspacing="0">
			...
			<tr height="22">
			  ...
			  <td width="105"><label><input name="RB_AR" type="radio" <? echo $Chk_11?> value="11" />&nbsp;&nbsp;Admin</label></td>
			  <td width="85" style="border-right: 1px solid #808000"><label><input name="RB_AR" type="radio" <? echo $Chk_10?> value="10" disabled />&nbsp;&nbsp;Reguler</label></td>
			</tr>
			<? } ?>
		  	<? if ($Lev <= 2 && $Lev!="") { ?>
			<tr height="22">
			  <td style="border-left: 1px solid #808000">&nbsp;UNIT/ SKPD </td>
			  <td><label><input name="RB_AR" type="radio" <? echo $Chk_21?> value="21" />&nbsp;&nbsp;Admin</label></td>
			  <td style="border-right: 1px solid #808000"><label><input name="RB_AR" type="radio" <? echo $Chk_20?> value="20" />&nbsp;&nbsp;Reguler</label></td>
		  	</tr>
			<? } ?>
		  	<? if ($Lev <= 3 && $Lev!="") { ?>
		  	<tr height="22">
			  <td style="border-left: 1px solid #808000">&nbsp;SUB UNIT </td>
			  <td><label><input name="RB_AR" type="radio" <? echo $Chk_31?> value="31" />&nbsp;&nbsp;Admin</label></td>
			  <td style="border-right: 1px solid #808000"><label><input name="RB_AR" type="radio" <? echo $Chk_30?> value="30" />&nbsp;&nbsp;Reguler</label></td>
		  	</tr>
			<? } ?>
		  	<? if ($Lev <= 4 && $Lev!="") { ?>
		  	<tr height="22">
			  <td style="border-left: 1px solid #808000; border-bottom: 1px solid #808000">&nbsp;UPB </td>
			  <td style="border-bottom: 1px solid #808000"><? if ($Adm=='1'){?><label><input name="RB_AR" type="radio" <? echo $Chk_41?> value="41" />&nbsp;&nbsp;Admin</label><? } ?></td>
			  <td style="border-bottom: 1px solid #808000; border-right: 1px solid #808000"><label><input name="RB_AR" type="radio" <? echo $Chk_40?> value="40" />&nbsp;&nbsp;Reguler</label></td>
		  	</tr>
			<? } ?>
			<? if ($Lev=="") { ?>
		  	<tr height="22">
	...
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td colspan="3" style="color:#FF0000"><? if (isset($_REQUEST['MsG'])) {echo $_REQUEST['MsG'];}?></td>
	  <td>&nbsp;</td>
    </tr>
	<? if ($Lev!="") {?>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td colspan="3"><input <? echo $diB?> type="button" name="B39" value="SIMPAN" style="width:80px" onclick="P_Save('<?=$ReO?>')"/>&nbsp;&nbsp;
	  <input <? echo $diB?> type="hidden" name="B392" value="RESET" style="width:80px" onclick="P_Reset('<?=$ReO?>')"/></td>
	  <td>&nbsp;</td>
    </tr>
	<? } ?>
	<tr>
