...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:800px">
  ...
  <tr height="24">
    <td valign="top">&nbsp;</td>
    <td valign="top"><a href="#" class="ico docu" onclick="OpenReport('Report_LHI_III_C_1','800','400','<?=$IdL?>')">&nbsp;&nbsp;&nbsp;DOKUMEN</a></td>
  </tr>
  <tr height="24">
    <td valign="top">&nbsp;</td>
    <td valign="top">&nbsp;</td>
...
<script languange="javascript">
	...
	function OpenReport(doc,w,h,IdL)
	{
		...
		URL = 'report/'+doc+'.php?ExT='+ExT+'&fHR='+fHR+'&fBL='+fBL+'&fTH='+fTH+'&fUnt='+fUnt+'&IdL='+IdL;
