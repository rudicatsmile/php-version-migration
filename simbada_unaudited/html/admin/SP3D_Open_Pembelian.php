...
<script languange="javascript">
	...
	function P_Dokumen(w,h,IdL)
	{
		...
		URL='SP3D_Open_Pembelian_Dok.php?eHR='+eHR+'&eBL='+eBL+'&eTH='+eTH+'&fTH='+fTH+'&UpB='+UpB+'&SmS='+SmS+'&IdL='+IdL;
	...
	function findUPB(CrT,IdL)
	{
		if (CrT=='find'){
			...
			$(document).ready(function()
			{
				$("#findupbDiv2Cri").load('SP3D_Open_Pembelian_Find_All_Upb_Mid.php?FnD='+FnD+'&IdL='+IdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#findupbDiv1Cri").load('SP3D_Open_Pembelian_Find_All_Upb_Top.php?IdL='+IdL);
			});
			
			$(document).ready(function()
			{
				$("#findupbDiv2Cri").load('SP3D_Open_Pembelian_Find_All_Upb_Mid.php?IdL='+IdL);
			});
