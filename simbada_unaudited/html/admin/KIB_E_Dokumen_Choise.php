...
<div align="center">
	<table border="0" width="2000" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
      ...
      <td style="font-size: 13pt; font-weight: bold" align="center"> ASET TETAP 
        LAINNYA <? if($gExt=='Y') {echo "(EXTRAKOMPTABEL)";}?></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
			  <tr> 
				...
				<td width="20">:</td>
				<td width="475"><? echo $gNmUNT ?></td>
				<td width="98">BIDANG ASET </td>
				<td width="20">:</td>
				<td width="1290"><? echo $nAs1?></td>
			  </tr>
			  <tr> 
		...
		?>
          <? function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18) {?>
          <tr height="30"> 
            ...
            <td style="border: 1px solid #000; padding-left:2px"><? if ($x10!=0) {echo $x10;}?></td>
            <td style="border: 1px solid #000; padding-left:2px"><?=$x11?></td>
            <td style="border: 1px solid #000; padding-left:2px" align="center"><? if ($x12!=0) {echo $x12;}?></td>
