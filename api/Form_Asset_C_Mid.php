...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      <td>LETAK/ALAMAT</td>
      <td>
		<input name="fAlamat" type="text" class="text" id="fAlamat" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gLKS?>" size="60" maxlength="50" />
