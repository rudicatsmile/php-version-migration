...
<table border="0" align="center" width="1250" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
	...
	<tr>
		...
		?>
		<?php function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15) {?>
		<tr>
			<td width="2%" valign="top" align="center"><?php echo $x1?>.</td>
			<td width="5%" valign="top"><?php echo $x2?></td>
			<td width="4%" valign="top" align="center"><?php echo $x3?></td>
			<td width="16%" valign="top"><?php echo $x4?></td>
			<td width="6%" valign="top"><?php echo $x5?></td>
			<td width="8%" valign="top" align="center"><?php echo $x6?></td>
			<td width="6%" valign="top"><?php echo $x7?></td>
			<td width="9%" valign="top" align="center"><?php echo $x8?></td>
			<td width="6%" valign="top" align="center"><?php echo $x9?></td>
			<td width="6%" valign="top" align="center"><?php if ($x10!=0) {echo $x10;}?></td>
			<td width="4%" valign="top" align="center"><?php if ($x11!="-") {echo $x11;}?></td>
			<td width="5%" valign="top" align="center"><?php echo $x12?></td>
			<td width="3%" valign="top" align="center"><?php echo $x13?></td>
			<td width="8%" valign="top" align="right"><?php echo fConvertToRupiah($x14)?></td>
			<td width="12%" valign="top"><?php echo $x15?></td>
		</tr>
		  <?php } ?>
		...
		<tr>
			...
			<td style="font-weight: bold; border-top: 3px double #000000; " align="right" width="8%"><?php echo fConvertToRupiah($qAKH_A + $qAKH_B + $qAKH_C + $qAKH_D + $qAKH_E + $qAKH_F + $qAKH_G)?></td>
