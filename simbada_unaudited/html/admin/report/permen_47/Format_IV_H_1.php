...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">NIBAR</td>
    <td style="border:1px solid #000" rowspan="2">Kode Barang</td>
    <td style="border:1px solid #000" rowspan="2">Nama Barang</td>
    <td style="border:1px solid #000" rowspan="2">Spesifikasi Nama Barang</td>
    <td style="border:1px solid #000" rowspan="2">Tanggal Perolehan</td>
    <td style="border:1px solid #000" rowspan="2">Masa Manfaat</td>
    <td style="border:1px solid #000" colspan="6">Penyusutan atau Amortisasi 
	Tahun Sebelumnya</td>
    <td style="border:1px solid #000" colspan="8">Penyusutan atau Amortisasi 
	Tahun Berjalan</td>
    <td style="border:1px solid #000" rowspan="2">Total Nilai Perolehan Terakhir 
	(Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Akumulasi Penyusutan / 
	AMortisasi (Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Nilai Buku (Rp)</td>
    <td rowspan="2" style="border:1px solid #000">Sisa Masa Manfaat</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Nilai Perolehan Sebelunya (Rp)</td>
    <td style="border:1px solid #000">Penyusutan atau Amortisasi Per ...(Rp)</td>
    <td style="border:1px solid #000">Masa Manfaat Yang Telah Dilalui</td>
    <td style="border:1px solid #000">Nilai Akumulasi Penyusutan atau Amortisasi</td>
    <td style="border:1px solid #000">Nilai Buku Sebeumnya (Rp)</td>
    <td style="border:1px solid #000">Sisa Masa Manfaat Sebelumnya</td>
    <td style="border:1px solid #000">Nilai Perolehan (Rp)</td>
    <td style="border:1px solid #000">Nilai Kapitalisasi (Rp)</td>
    <td style="border:1px solid #000">Nilai Buku Setelah Kapitalisasi (Rp)</td>
    <td style="border:1px solid #000">Penambahan Masa Manfaat</td>
    <td style="border:1px solid #000">Total Masa Manfaat</td>
    <td style="border:1px solid #000">Penyusutan atau Amortisasi Per ...(Rp)</td>
    <td style="border:1px solid #000">Masa Manfaat Yang Telah Dilalui</td>
    <td style="border:1px solid #000">Beban Penyusutan / Amortisasi (Rp)</td>
  </tr>
  <tr style="text-align:center">
    ...
    <td width="74" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="69" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="69" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="69" style="border:1px solid #000; border-bottom:3px double #000">
    ...
    <td width="77" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="78" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
