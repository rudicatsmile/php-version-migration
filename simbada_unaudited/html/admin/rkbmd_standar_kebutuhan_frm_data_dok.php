...
<table border="0" width="1000" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
	...
	<tr>
		<td align="center">&nbsp;</td>
		<td>&nbsp;</td>
		<td align="center" style="text-decoration:underline; font-weight:bold"><? if ($Crit=='kuasa'){echo str_repeat(".",35);} else {echo $mRo[7];}?></td>
	</tr>
	<tr>
		<td align="center">&nbsp;</td>
		<td>&nbsp;</td>
		<td align="center"><? if ($Crit=='kuasa'){echo "NIP. ..............................";} else {echo $mRo[8];}?></td>
	</tr>
</table>