	...
	<form name="myfrm" method="post" action="<?php echo "KIB-B_.php?FrmG=" . $_GET['FrmG'] . "&IdL=" . $_GET['IdL'] ?>">
		...
		<table border="0" align="center" style="width:99%">
			...
			<tr>
					...
					<table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
						<tr>
							<td width="46%"> <input class="text" type="text" name="fFind" id="fFind"
									placeholder='Search' value="<?php echo $gFin ?>"
				...
				<td width="134" valign="bottom"><label><input type="checkbox" <?php if ($gMuT != "") {
																					echo "checked";
																				} ?>
			...
			<tr>
				...
				<td colspan="6">
					<select class="boxs" name="fKdBar" style="width: 120px" tabindex="0" onchange="this.form.submit()">
						<option <?php if ($gKdBar == "All") {
									echo "selected";
								} ?> value="All">ALL</option>
						<option <?php if ($gKdBar == "N") {
									echo "selected";
								} ?> value="N">Belum QR</option>
						<option <?php if ($gKdBar == "Y") {
									echo "selected";
			...
			?>
					<tr height="40" style="cursor: pointer <?= $Blnk ?>" <?= fBackCLR($iG) ?>>
						...
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px"
							align="right"><?php echo fConvertToRupiah($mRo['Harga']) ?></td>
						<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px <?= $ClR ?>"
							align="right"><?php echo fConvertToRupiah($gNIL) ?></td>
					...
					<tr>
						<td colspan="11">
							<table id="detail<?php echo $iG ?>" cellpadding="3" border="0" width="900"
								...
								<tr>
									...
									<td width="10">:</td>
									<td width="200">
										<?php echo fGlobal("Nm_Aset", "Ref_Rek_Aset2", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 5), "=", "", "") ?>-------
									</td>
									<td width="10">&nbsp;</td>
									<td width="40">Merk</td>
									<td width="9">:</td>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<?php echo fGlobal("Nm_Aset", "Ref_Rek_Aset3", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 8), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Type</td>
									<td>:</td>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<?php echo fGlobal("Nm_Aset", "Ref_Rek_Aset4", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 11), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Ukuran/CC</td>
									<td>:</td>
									<td>
										<?php echo $mRo['Ukuran_CC'] ?>
									</td>
									<td>&nbsp;</td>
									<td>Nomor Polisi</td>
									<td>:</td>
									<td valign="top">
										<?php echo $mRo['Nomor_Polisi'] ?>
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									...
									<td>:</td>
									<td>
										<?php echo fGlobal("Nm_Aset", "Ref_Rek_Aset5", "Kd_Aset", substr($mRo['Kd_Aset'], 0, 15), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Kepemilikan</td>
									<td>:</td>
									<td><?php echo fGlobal("Nm_Pemilik", "Ref_Pemilik", "Kd_Pemilik", substr($mRo['Kd_Pemilik'], 0, 11), "=", "", "") ?>
									</td>
									<td>&nbsp;</td>
									<td>Referensi</td>
									<td>:</td>
									<td valign="top">
										<?php echo $mRo['Referensi'] ?>
									</td>
								</tr>
							</table>
						</td>
