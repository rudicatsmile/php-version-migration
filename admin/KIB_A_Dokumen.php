...
<div align="center">
	...
	<tr>
      ...
      <td style="font-size: 13pt; font-weight: bold" align="center">TANAH <?php if ($gExt=="Y") {echo "(EXTRA KOMTABLE)";}?></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
          ...
          <tr> 
            ...
            <td width="82"><?php if ($CriT=="BPK") {echo "KELOMPOK";}?></td>
            <td width="23"><?php if ($CriT=="BPK") {echo ":";}?></td>
            <td width="557"><?php if ($CriT=="BPK") {echo $gNmKEL;}?></td>
          </tr>
		  <?php if ($gUnt!="All") { ?>
          <tr> 
          ...
          <tr> 
            <td width="104"><?php if ($CriT!="BPK") {echo "KODE LOKASI";} else {echo "TAHUN";}?></td>
            <td width="19"><?=":"?></td>
		...
		<tr>
          ...
          <?php
				...
				?>
          <?php function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$LI,$LT,$LB,$LG,$xB) {?>
          <tr> 
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php echo $xB.$x0?><?php if ($x0!=""){echo ".";}?></td>
            ...
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php if ($x5!="0") {echo $LI.$xB.fConvertToRupiahBulat($x5);}?></td>
            ...
            <td align="right" style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000"><?php if ($x15!="") {echo $xB.fConvertToRupiah($x15);}?></td>
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000"><?php echo $x14?></td>
          </tr>
          <?php } ?>
