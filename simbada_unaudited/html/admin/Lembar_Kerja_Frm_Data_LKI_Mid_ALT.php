...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:910px">
	<tr height="30">
	  <td width="120" style="border-bottom:1px solid #ccc"><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="818">&nbsp;</td>
          <td width="132">Format : III.A.2</td>
        </tr>
      </table></td>
  </tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="23" style="font-weight:bold">
          ...
          <td width="185">
		  <label><input type="radio" name="radioAda" value="tidakada"<?=$CkAda2?> onchange="saveDATA('KeberadaanBarang','tidakada','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')"  />
        ...
        <tr height="23" style="font-weight:bold">
          ...
          <td>&nbsp;</td>
          <td>a.</td>
          <td><label><input type="radio" name="radiotidkAda" value="hilang" <?=$CktidkAda1?> <?=$CktidkAda1D?> onchange="saveDATA('KeberadaanBarang_tidakada','hilang','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Hilang</label></td>
        </tr>
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td>&nbsp;</td>
          <td>b.</td>
          <td><label><input type="radio" name="radiotidkAda" value="tidakditemukan" <?=$CktidkAda2?> <?=$CktidkAda2D?> onchange="saveDATA('KeberadaanBarang_tidakada','tidakditemukan','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak Ditemukan</label></td>
        </tr>
      </table></td>
  </tr>
	<tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="24" style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td><input type="text" name="MrkBRG" id="MrkBRG" value="<?=$mRo[29]." / ".$mRo[30]?>" style="width:300px" /></td>
        </tr>
      </table>	  
	  </td>
  </tr>
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="24" style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="PolBRG" id="PolBRG" value="<?=$mRo[36]?>" style="width:300px" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioPol" value="sesuai" <?=$CkPol1?> onchange="saveDATA('NoPolisi','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioPol" value="tidaksesuai" <?=$CkPol2?> onchange="saveDATA('NoPolisi','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiPOL" id="tsesuaiPOL" value="<?=$CkPolM?>" <?=$CkPolR?> onkeypress="if (event.keyCode==13){saveDATA('NoPolisiMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>	  
	  </td>
  </tr>
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr height="24" style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="RanBRG" id="RanBRG" value="<?=$mRo[34]?>" style="width:300px" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioRan" value="sesuai" <?=$CkRan1?> onchange="saveDATA('NoRangka','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioRan" value="tidaksesuai" <?=$CkRan2?> onchange="saveDATA('NoRangka','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiPOL" id="tsesuaiPOL" value="<?=$CkRanM?>" <?=$CkRanR?> onkeypress="if (event.keyCode==13){saveDATA('NoRangkaMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>	  
	  </td>
  </tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="24" style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="BpkBRG" id="BpkBRG" value="<?=$mRo[38]?>" style="width:300px" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioBpk" value="sesuai" <?=$CkBpk1?> onchange="saveDATA('NoBPKB','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioBpk" value="tidaksesuai" <?=$CkBpk2?> onchange="saveDATA('NoBPKB','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiPOL" id="tsesuaiPOL" value="<?=$CkBpkM?>" <?=$CkBpkR?> onkeypress="if (event.keyCode==13){saveDATA('NoBPKBMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>	  
	  </td>
  </tr>
	...
	?>
        ...
        <tr style="font-weight:bold">
          ...
          <td width="403" rowspan="3" valign="top">
			...
			<tr height="24">
			  <td colspan="2">Pendandatangan:</td>
			  <td>&nbsp;</td>
			</tr>
			<tr height="24">
			  <td>=&gt;</td>
        ...
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td><a href="#" class="ico docu" onclick="formCetakDok('Report_Form_LKI_ALT','<?=$IdT?>','900','400','<?=$IdL?>'); return false;">&nbsp;&nbsp;DOKUMEN CETAK</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
