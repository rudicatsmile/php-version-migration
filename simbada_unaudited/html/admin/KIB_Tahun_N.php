...
<tr height="20" style="vertical-align:top; font-weight:<?=$bold?>">
  ...
  <td style="border-bottom:1px solid #000; border-right:1px solid #000; padding-left:3px; text-align:right"><? if($x7==0){echo "-";}else{echo fConvertToRupiah($x7);}?></td>
  <td style="border-bottom:1px solid #000; border-right:1px solid #000; padding-left:3px; text-align:right"><? if($x8==0){echo "-";}else{echo fConvertToRupiah($x8);}?></td>
  <td style="border-bottom:1px solid #000; border-right:1px solid #000; padding-left:3px; text-align:right"><? if($x9==0){echo "-";}else{echo fConvertToRupiah($x9);}?></td>
...
<tr height="23" style="font-weight:bold">
  ...
  <td style="border:1px solid #000; border-top:3px double #000; padding-left:3px; text-align:right"><? if($tSLD==0){echo "-";}else{echo fConvertToRupiah($tSLD);}?></td>
  <td style="border:1px solid #000; border-top:3px double #000; padding-left:3px; text-align:right"><? if($tINV==0){echo "-";}else{echo fConvertToRupiah($tINV);}?></td>
  <td style="border:1px solid #000; border-top:3px double #000; padding-left:3px; text-align:right"><? if($tNIL==0){echo "-";}else{echo fConvertToRupiah($tNIL);}?></td>
