...
<tr height="18" valign="top">
  ...
  <td style="border:1px solid #000; text-align:center"><? if ($x14!='0' || $x14!='0.00') {echo $x14;}?></td>
  <td style="border:1px solid #000; text-align:center"><? if ($x15!='0' || $x15!='0.00') {echo $x15;}?></td>
  <td style="border:1px solid #000; text-align:center"><? if ($x16!='0' || $x16!='0.00') {echo $x16;}?></td>
