...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:800px; color:#fff; background:#79a86a">
  ...
  <tr height="23">
    ...
    <input name="dSUB" id="dSUB" type="text" value="<?=$dSUB?>" <?php if ($Lev <= 2) {?> onclick="showSUB('','<?=$_GET['IdL']?>')" <?php } else {echo "readonly";}?> style="padding-left:3px; width:450px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
	...
	<input name="dUPB" id="dUPB" type="text" value="<?=$dUPB?>" <?php if ($Lev <= 2) {?> onClick="showUPB('','<?=$_GET['IdL']?>')" <?php } else {echo "readonly";}?> style="padding-left:3px; width:420px; border: 1px solid #C0C0C0"/>
	<div id="upbMstCri" class="Unit0Cri">
		<div id="upbDiv1Cri" class="Unit1Cri"></div>
		<div id="upbDiv2Cri" class="Unit2Cri"></div>
	</div>	</td>
    <td><input type="button" name="BtnFN" id="BtnFN" value="..." <?php if ($Lev <= 1) {?> onclick="cariUPB('','<?=$IdL?>')" <?php } else {echo "disabled";}?> style="width:29px; height:22px" /></td>
    <td align="right">&nbsp;</td>
    </tr>
  <tr height="8">
    <td></td>
