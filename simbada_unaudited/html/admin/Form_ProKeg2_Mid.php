...
{
	$gCod1 = substr($IdRef1,0,1);
	$gCod2 = substr($IdRef1,2,2);
	$gCod3 = substr($IdRef1,5,2);
	$gCod4 = "";
	$ReadO = "";
}
?>
...
<form name="myfrm" method="post" action="<?php echo "Form_ProKeg2_Mid_.php?rIDO=".$rIDO."&IdRef1=".$IdRef1."&IdL=".$_REQUEST['IdL'] ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
	  ...
	  <input name="fKode4" type="text" class="text" id="fKode4" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod4?>" size="2" maxlength="2" <? echo $ReadO?> />
	  </td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="111">NAMA PROGRAM</td>
      <td width="25">:</td>
