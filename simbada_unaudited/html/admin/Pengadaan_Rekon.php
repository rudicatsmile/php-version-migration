...
<div align="center">
	...
	<tr>
	  <td style="font-size: 11pt; font-weight: bold; text-align:center">REKONSILISASI PENGADAAN ASET (REKAP)</td>
	</tr>
	<tr>
		<tr>
			<td>
		...
		<tr>
          ...
          <tr height="23">
            <td width="122" style="border:1px solid #000000; font-weight:bold; text-align:center">KODE</td>
            <td width="392" style="border:1px solid #000000; font-weight:bold; text-align:center">URAIAN</td>
            <td width="166" style="border:1px solid #000000; font-weight:bold; text-align:center"> PENGADAAN </td> 
            <td colspan="4" style="border:1px solid #000000; font-weight:bold; text-align:center">A S E T</td>
            </tr>
          <tr> 
            ...
            <td colspan="4" align="center" style="border:1px solid #000000; font-weight: bold">4</td>
            </tr>
          <?
				###################
				...
				function vwPENG($gUnt,$KdK,$KdR,$gThA,$DatabaseSB,$ConSB)
				{
					...
					WHERE P1.Kd_Unit='".$gUnt."' AND P1.Kd_Kegiatan = '".$KdK."' AND P1.Kd_Rek13 = '".$KdR."' AND P1.Periode='".$gThA."' GROUP BY P2.Kd_Aset";
					...
					while ($mRoC = mysql_fetch_array($nRsC, MYSQL_BOTH))
					{
							...
							$Col[4] = $mRoC[3];
							$Col[5] = $mRoC[4];
							ViewRincian($Col[1],$Col[2],$Col[3],$Col[4],$Col[5],$iGC,$xB);
							$iGC++;
					}
				}
				...
				if ($iG==1){ViewBlank();}
				?>
          <? function ViewRekap($x1,$x2,$x3,$x4,$x5,$xB) {?>
		  <?
		  $eCL="";
		  if ($x5<0){
		  	$eCL="; color:#FF0000";
		  ...
		  ?>
          <tr> 
            <td valign="top" style="border-top: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:left; padding-left:5px"><? if (strlen($x1)!=11){echo $xB;}?><?=$x1?></td>
            <td valign="top" style="border-top: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:left; padding-left:5px"><? if (strlen($x1)!=11){echo $xB;}?><?=$x2?></td>
            ...
            <td colspan="4" valign="top" style="border-top: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:right; padding-right:3px <?=$eCL?>"><?=$xB.fConvertToRupiah($x4)?></td>
            </tr>
          <? } ?>
          <? function ViewRincian($x1,$x2,$x3,$x4,$x5,$iR,$xB) {?>
          <tr style="font-family:arial; font-size:8pt"> 
            <td valign="top" style="border-top: <? if ($iR==1) {echo "1";} else {echo "0";}?>px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:left; padding-left:5px">&nbsp;</td>
            <td valign="top" style="border-top: <? if ($iR==1) {echo "1";} else {echo "0";}?>px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:left; padding-left:5px">&nbsp;</td>
            <td valign="top" style="border-top: <? if ($iR==1) {echo "1";} else {echo "0";}?>px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:right; padding-right:3px"></td>
            <td width="93" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x1?></td>
            <td width="323" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x2?></td>
            <td width="105" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:center"><?=$xB.$x3?> unit</td>
            <td width="99" valign="top" style="border-top: 1px <? if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:right; padding-right:3px"><?=$xB.fConvertToRupiah($x4)?></td>
            </tr>
          <? } ?>
          <? function ViewBlank() {?>
          <tr> 
          ...
          <tr height="23">
            ...
            <td colspan="4" align="center" style="border:1px solid #000000; font-weight: bold; text-align:right; padding-right:3px"><?=fConvertToRupiah($tCol4)?></td>
            </tr>
        </table>		  </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse" id="table6">
				...
				<tr>
					...
					<td align="center" width="294"><?=$NmIbKt.", ".$gHr." ".fNmBulan($gBl)." ".$gTh?></td>
				...
				<tr>
					...
					<td align="center">&nbsp;</td>
					<td align="center" style="font-weight: bold" width="294"><?=$FotC[1]?></td>
				...
				<tr>
					...
					<td width="230" align="center" style="font-weight: bold">&nbsp;</td>
					<td align="center">&nbsp;</td>
					<td align="center" style="font-weight: bold; text-decoration:underline" width="294"><?=$FotC[2]?></td>
					<td align="center" style="font-weight: bold" width="50">&nbsp;</td>
				</tr>
				<tr>
					<td width="50" align="center">&nbsp;</td>
					<td width="230" align="center">&nbsp;</td>
					<td align="center">&nbsp;</td>
					<td align="center" width="294">NIP. <?=$FotC[3]?></td>
					<td align="center" width="50">&nbsp;</td>
				</tr>
			</table>
			<? } ?>			</td>
