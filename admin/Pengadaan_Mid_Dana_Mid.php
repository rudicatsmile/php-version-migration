  ...
  <input type="hidden" name="CriteR" style="width:100px">
	  <table border="0" style="background:#FFFFFF; height:100%; width:680px; border-collapse:collapse; border: 1px solid #999999; font-family:calibri; font-size:11px; font-weight:bold; color: #999999">
        ...
        <tr height="22">
          ...
          <td style="border-bottom:1px dotted"><input name="tNIL" readonly type="text" id="tNIL" value="<?php echo fConvertToRupiah($gTTL)?>" onKeyUp="addSeparator(this)" style="width:130px; text-align: right; background-color: #E1F986; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; font-size:9pt; font-weight:bold; color:#000" />          </td>
        ...
        <tr height="22">
          ...
          <td width="273" style="border-top:0px dotted"><?php if ($mSPP=="N") {?>
          ...
          <td width="159" style="border-top:0px dotted"><input name="fNIL<?=$mIDT?>" type="text" id="fNIL<?=$mIDT?>" <?=$gReD?> value="<?php echo fConvertToRupiah($mNIL)?>" onKeyUp="addSeparator(this)" style="width:130px; text-align: right; background-color: #E1F986; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; font-size:9pt" /></td>
        ...
        <tr height="22">
          ...
          <td style="border-top:1px dotted"><input name="tNIL" readonly type="text" id="tNIL" value="<?php echo fConvertToRupiah($mTTL)?>" onKeyUp="addSeparator(this)" style="width:130px; text-align: right; background-color: #E1F986; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; font-size:9pt; font-weight:bold; color:#<?=$CLR?>" />          </td>
