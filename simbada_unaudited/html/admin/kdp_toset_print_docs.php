...
while ($mRo = mysql_fetch_array($rs, MYSQL_BOTH))
{
	...
	?>
	<tr height="20">
	 <td style="border:1px solid #000; text-align:center"><? if ($TmP=="Y"){echo $iG.".";}?></td>
	 <td style="border:1px solid #000; text-align:center"><? if ($TmP=="Y"){echo fConvertDateShort($mRo[0]);}?></td>
	 <td style="border:1px solid #000; text-align:center"><? if ($TmP=="Y"){echo $mRo[1];}?></td>
	 <td style="border:1px solid #000; text-align:center"><? if ($TmP=="Y"){echo $mRo[2];}?></td>
	 <td style="border:1px solid #000; text-align:center"><? if ($TmP=="Y"){echo $mRo[3];}?></td>
	 <td style="border:1px solid #000; text-align:right; padding-right:3px"><? if ($TmP=="Y"){echo fConvertToRupiah($mRo9).$Tnd;}?></td>
