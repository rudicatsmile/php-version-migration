...
<table border="0" align="center" width="1400" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
  <tr>
	...
	<tr>
      <td align="center" style="font-size: 12pt; font-weight: bold">TAHUN ANGGARAN <? echo $Thn_B?></td>
  </tr>
	<tr>
      <td align="center" style="font-size: 11pt">Per Tanggal 31 Desember <? echo $Thn_B?> </td>
  </tr>
	<tr>
	  <td width="1285">&nbsp;</td>
  </tr>
	<tr>
		...
		<tr>
			...
			<td width="26">:</td>
			<td><?=$NmDaer?></td>
			<td width="237" align="right" style="font-weight: bold">Kode Lokasi : <? echo fStrukKdLokasi($rMLK,$KdProp,$KdKabK,$gUnt,$gSub,$rThn)?></td>
		</tr>
		</table>		</td>
	</tr>
	<tr>
		...
		<tr>
			...
			Jumlah Awal<br>(<? echo $Thn_A?>)</td>
			<td colspan="4" align="center" style="font-weight: bold">Mutasi / Perubahan </td>
		    <td colspan="2" rowspan="2" align="center" style="font-weight: bold">Jumlah Akhir<br>(<? echo $Thn_B?>)</td>
		...
		?>
		<? function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20,$x21) {?>
		<tr>
			<td width="2%" style="font-size:8pt" valign="top" align="center"><? echo $x1?>.</td>
			<td width="3%" style="font-size:8pt" valign="top"><? echo $x2?></td>
			<td width="4%" style="font-size:8pt" valign="top" align="center"><? echo $x3?></td>
			<td width="10%" style="font-size:8pt" valign="top"><? echo $x4?></td>
			<td width="5%" style="font-size:8pt" valign="top"><? echo $x5?></td>
			<td width="5%" style="font-size:8pt" valign="top" align="center"><? echo $x6?></td>
			<td width="4%" style="font-size:8pt" valign="top"><? echo $x7?></td>
			<td width="5%" style="font-size:8pt" valign="top" align="center"><? echo $x8?></td>
			<td width="4%" style="font-size:8pt" valign="top" align="center"><? echo $x9?></td>
			<td width="4%" style="font-size:8pt" valign="top" align="center"><? if ($x10!=0) {echo $x10;}?></td>
			<td width="3%" style="font-size:8pt" valign="top" align="center"><? if ($x11!="-") {echo $x11;}?></td>
			<td width="4%" style="font-size:8pt" valign="top" align="center"><? echo $x12?></td>
			<td width="3%" style="font-size:8pt" valign="top" align="center"><? echo $x13?></td>
			<td width="6%" style="font-size:8pt" valign="top" align="right"><? if ($x14!=0) {echo fConvertToRupiah($x14);}?></td>
			<td width="3%" style="font-size:8pt" valign="top" align="center"><? if ($x15!=0) {echo $x15;}?></td>
		    <td width="6%" style="font-size:8pt" valign="top" align="right"><? if ($x16!=0) {echo fConvertToRupiah($x16);}?></td>
		    <td width="4%" style="font-size:8pt" valign="top" align="center"><? if ($x17!=0) {echo $x17;}?></td>
		    <td width="7%" style="font-size:8pt" valign="top" align="right"><? if ($x18!=0) {echo fConvertToRupiah($x18);}?></td>
		    <td width="4%" style="font-size:8pt" valign="top" align="center"><? if ($x19!=0) {echo $x19;}?></td>
		    <td width="7%" style="font-size:8pt" valign="top" align="right"><? if ($x20!=0) {echo fConvertToRupiah($x20);}?></td>
		    <td width="7%" style="font-size:8pt" valign="top"><? echo $x21?></td>
		</tr>
		  <? } ?>
          <? function ViewBlank() {?>
		<tr>
		...
		<tr>
			...
			<td style="font-weight: bold; border-top: 3px double #000000; " align="right" width="6%"><? echo fConvertToRupiah($qAWL)?></td>
			<td width="3%" style="font-weight: bold; border-top: 3px double #000000; " align="right">&nbsp;</td>
		    <td width="6%" style="font-weight: bold; border-top: 3px double #000000; " align="right"><? if ($qKRG!=0) {echo fConvertToRupiah($qKRG);}?></td>
		    <td width="4%" style="font-weight: bold; border-top: 3px double #000000; " align="right">&nbsp;</td>
		    <td width="7%" style="font-weight: bold; border-top: 3px double #000000; " align="right"><? if ($qTBH!=0) {echo fConvertToRupiah($qTBH);}?></td>
		    <td width="4%" style="font-weight: bold; border-top: 3px double #000000; " align="right">&nbsp;</td>
		    <td width="7%" style="font-weight: bold; border-top: 3px double #000000; " align="right"><? echo fConvertToRupiah($qAKH)?></td>
