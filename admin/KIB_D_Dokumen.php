		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
              <tr>
                ...
                <td width="91"><?php if ($CriT=="BPK") {echo "KELOMPOK";}?></td>
                <td width="30"><?php if ($CriT=="BPK") {echo ":";}?></td>
                <td width="687"><?php if ($CriT=="BPK") {echo $gNmKEL;}?></td>
              </tr>
              <?php if ($gUnt!="All") { ?>
              <tr>
              ...
              <tr>
                <td width="114"><?php if ($CriT!="BPK") {echo "KODE LOKASI";} else {echo "TAHUN";}?></td>
                <td width="21"><?=":"?></td>
...
<table border="0" width="1500" style="border:0 solid #000000; font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table2" bordercolor="#000000">
  ...
  <?php
		...
		{
			$SW="SELECT P2.*, P1.Tanggal as Tanggal, P1.Debet as Debet 
		...
		?>
  <?php function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$LI,$LT,$LB,$LG,$TG,$xB) {?>
  <tr valign="top"> 
    <td width="3%"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php echo $x0?><?php if ($x0!=""){echo ".";}?></td>
    ...
    <td width="4%"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php if ($x5!=0){echo $LI.$xB.fConvertToRupiah($x5);}?></td>
    <td width="3%"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php if ($x6!=0){echo $LI.$xB.fConvertToRupiah($x6);}?></td>
    <td width="3%"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><?php if ($x7!=0){echo $LI.$xB.fConvertToRupiah($x7);}?></td>
    ...
    <td width="6%"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="right"><?php if ($x17!=0) {echo $LI.$xB.fConvertToRupiah($x17);}?></td>
    <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px solid #000; border-bottom: <?=$LB?>px <?=$LG?> #000"><?php echo $x16?></td>
  </tr>
  <?php } ?>
