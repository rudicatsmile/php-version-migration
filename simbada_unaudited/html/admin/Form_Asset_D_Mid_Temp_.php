...
require "Form_Asset_D_Mid_Temp_Posting.php";
...
if ($Smp=="Save")
{
	...
	if ($rIDT)
	{
		$rSTN = fGlobalNEW("Jumlah_Ruas","ta_kib_108_temp","IDT",$rIDT,"=","",DatabaseSB,$ConSB,"");
		...
		Harga_Satuan='$gHRG' WHERE IDT='".$rIDT."'";
	...
	else
	{
		...
		$rIDT = fGlobalNEW("Max(IDT)","ta_kib_108_temp","No_Pengadaan",$gNoM,"=","",DatabaseSB,$ConSB,"");
	}
...
$URL="Form_Asset_D_Mid_Temp.php?".$urI."gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$IdL;
header("Location: ".$URL);
?>
