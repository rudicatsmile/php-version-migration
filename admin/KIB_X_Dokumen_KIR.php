		...
		<tr>
		  <td>
			...
			<tr style="text-align:center; font-weight: bold">
			  ...
			  <td width="200" style="border:1px solid #000; border-bottom:3px double #000">MERK / MODEL / JUDUL</td>
			  <td width="100" style="border:1px solid #000; border-bottom:3px double #000">NO. SERI<br>PABRIK / SPESIFIKASI</td>
			...
			<?php
			$iG=1;
			$nSQ = "SELECT count(*) as gItm, Nm_Aset,Merk,Nomor_Pabrik,Ukuran_CC,Bahan,Tgl_Perolehan,Harga,Kondisi, Kd_Aset_108 
