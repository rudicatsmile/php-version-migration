...
<form name="myfrm" method="post" action="<?php echo "Open_KKM_Mid_.php?IdL=".$_GET['IdL']?>">
  ...
  <table border="0" align="center" style="width:850px">
    ...
    <tr> 
      ...
      <td width="367">
	  <a href="#" class="ico prev" onclick="P_Rekap('1','850','450','2','_mutasi','<?=$_GET['IdL']?>'); return false">&nbsp;&nbsp;Dokumen Rekap ( Ke Aset Lainnya - BIDANG)</a><br>
	  <a href="#" class="ico prev" onclick="P_Rekap('2','850','450','2','_mutasi','<?=$_GET['IdL']?>'); return false">&nbsp;&nbsp;Dokumen Rekap ( Ke Aset Lainnya - KELOMPOK)</a><br> 
	  <a href="#" class="ico prev" onclick="P_Rekap('3','850','450','2','_mutasi','<?=$_GET['IdL']?>'); return false">&nbsp;&nbsp;Dokumen Rekap ( Ke Aset Lainnya - JENIS)</a><br>
	  <a href="#" class="ico prev" onclick="P_Rekap('4','850','450','2','_mutasi','<?=$_GET['IdL']?>'); return false">&nbsp;&nbsp;Dokumen Rekap ( Ke Aset Lainnya - OBJEK)</a>	  </td>
    </tr>
    <tr>
...
<script language="javascript">
	...
	function P_Rekap(crt,w,h,nm,mts,IdL)
	{
		...
		nmF="Tabel_Masa_Manfaat_Rekap_Bulan_All_Kab";
