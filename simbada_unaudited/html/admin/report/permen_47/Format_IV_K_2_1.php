...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">Jumlah Total</td>
    <td style="border:1px solid #000" rowspan="2">Total Akumulasi Penyusutan 
    ...
    <td style="border:1px solid #000" rowspan="2">Lokasi</td>
    <td style="border:1px solid #000" rowspan="2">Penerima Penyerahan</td>
    <td colspan="2" style="border:1px solid #000">Surat Keputusan Penghapusan</td>
  ...
  <tr style="text-align:center">
    ...
    <td width="60" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
  ...
  <tr height="25" style="font-weight:bold">
    <td colspan="3" style="border:1px solid #000; border-top:3px double #000; text-align:center">T O T A L</td>
