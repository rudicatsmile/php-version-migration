...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>LUAS LANTAI</td>
      <td><input name="fLuasLantai" type="text" class="text" id="fLuasLantai" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:80px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gLti)?>" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>LETAK / ALAMAT</td>
      <td><input name="fAlamat" type="text" class="text" id="fAlamat" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gLKS?>" /></td>
      <td>&nbsp;</td>
    </tr>
