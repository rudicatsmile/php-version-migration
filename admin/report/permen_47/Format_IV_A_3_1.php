...
if($formatType=='Format.IV.A.4.1' || $formatType=='Format.IV.A.4.2'){
    ...
    $contractSubHeader = "Nama Dokumen";
}elseif($formatType=='Format.IV.A.7.1' || $formatType=='Format.IV.A.7.2'){
    $contractHeader = "Dokumen Lainnya";
    $contractSubHeader = "Nama Dokumen";
}else{
...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">Kondisi barang</td>
    <td style="border:1px solid #000" colspan="3"><?=$contractHeader?></td>
    <td style="border:1px solid #000" rowspan="2">Pihak yang menyerahkan</td>
    <td style="border:1px solid #000" rowspan="2">Tanggal, Bulan, Tahun 
	Perolehan</td>
    <td colspan="2" style="border:1px solid #000">BAST / 
	Dokumen Pendukung Lainnya</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000"><?=$contractSubHeader?></td>
