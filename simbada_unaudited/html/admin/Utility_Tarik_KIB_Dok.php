...
<tr>
  <td>JENIS</td>
  <td>:</td>
  <td><? if ($Ext=='Y') {echo "EXTRACOM";} else {echo "NON EXTRACOM";} ?></td>
</tr>
<tr>
  <td>SD TAHUN</td>
  <td>:</td>
...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="23">
	  ...
	  <td style="text-align:center; border:1px #000 solid"><? if ($mRo[4]!='0000-00-00') echo fConvertDateShort($mRo[4]);?></td>
