...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="3">Bentuk&nbsp; Pemanfaatan</td>
    <td style="border:1px solid #000" rowspan="2" colspan="2">Mitra Pemanfaatan</td>
    <td style="border:1px solid #000" rowspan="3">Lokasi</td>
    <td colspan="2" style="border:1px solid #000">BAST Pengembalian</td>
    <td style="border:1px solid #000" colspan="3">Dasar Pendukung Lainnya</td>
    <td rowspan="2" style="border:1px solid #000" colspan="2">Penerima 
	Pengembalian</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000" rowspan="2">Nomor</td>
    <td style="border:1px solid #000" rowspan="2">Tanggal</td>
