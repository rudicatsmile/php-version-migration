...
<form name="myfrm" method="POST" action="<?="Utility_Import_SQL_D.php?FrmG=".$FrmG."&IdL=".$IdL?>">
...
<script languange="javascript">
	...
	function RefreshDATA(crt,IdL)
	{
		...
		if (crt=='import')
		{
			fil = "Utility_Import_SQL_D_Import";
			vie = "ViewDELL";
			AN=confirm('Import?');
			if (!AN){return false;}
		}
		...
		{
			fil = "Utility_Import_SQL_D_Batal";
			vie = "ViewDELL";
			AN=confirm('Batalkan?');
			if (!AN){return false;}
		}
