...
<table border="0" width="865" cellspacing="2" style="font-family: Calibri; font-size:9pt; border-collapse: collapse">
	...
	<tr>
      ...
      <td width="260"><input name="fTGL" type="text" class="text" id="fTGL" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gTGL?>" size="30" maxlength="100" /></td>
	  <td width="140">STATUS USULAN </td>
	  <td width="314"><input name="fTGL2" type="text" class="text" id="fTGL2" readonly="readonly" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gSTA?>" size="30" maxlength="100" /></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>NOMOR USULAN </td>
	  <td><input name="fNMR" type="text" class="text" id="fNMR" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gNMR?>" size="30" maxlength="100" /></td>
      <td> NOMOR SK </td>
      <td><input name="fNoSK2" type="text" class="text" id="fNoSK2" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gNoSK?>" size="30" maxlength="100" /></td>
	</tr>
	
	<tr>
	  <td>&nbsp;</td>
	  <td>NILAI  </td>
	  <td><input name="fNIL" type="text" class="text" id="fNIL" readonly style="text-align: right; font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gNIL)?>" size="30" maxlength="100" /></td>
      <td>TANGGAL SK </td>
      <td><input name="fTGL22" type="text" class="text" id="fTGL22" readonly="readonly" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gTgSK?>" size="30" maxlength="100" /></td>
	</tr>
	<tr>
	  <td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		do
			...
			<tr style="cursor: pointer" onmouseover="this.style.cursor='pointer'">
			  ...
			  <td valign="top"><?php echo $mRo['Ref_Aset']?></td>
			  <td valign="top"><?php echo $mRo['Kd_Aset']?></td>
			  <td valign="top"><?php echo $mRo['Nm_Aset']?></td>
			  <td valign="top" class="ar"><?php echo fConvertToRupiah($rNIL)?></td>
			  <td valign="top" align="center"><?php echo $rEXE?></td>
			</tr>
			<?php
			}
