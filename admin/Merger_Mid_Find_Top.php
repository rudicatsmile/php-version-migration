...
<form name="myfrm" method="post" action="<?php echo "Merger_Mid_Find_Mid.php?rIDT=".$_GET['rIDT']."&CrT=".$_GET['CrT']."&IdL=".$_GET['IdL'] ?>" target="WinFindAcc_Mid">
  <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse; color:#FFFFFF; font-family:Calibri; font-size:9pt">
	  <tr> 
		<td width="16">&nbsp; </td>
		<td width="52">CARI</td>
		<td width="266"> <input class="text" type="text" name="fFind" size="32" value="<?php echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
