...
function ExecuteRC($frUPB,$RfA,$RfU,$TbK,$tID,$UID)
{
	...
	$NewReGAset = mNewRegAset_108($gRin,$NewUPB);
	
	$CekR = fGlobal("IDT","ta_kib_108_mutasi","Ref_Usulan:Referensi",$RfU.":".$RfA,"=:=","","");
	if ($CekR=='') 
	{
		InsertKib_Mutasi_108($frUPB,$RfA,$RfU,$TglMts,$NewUPB,$UID);
		InsertPos_Mutasi_108($frUPB,$RfA,$RfU,$TglMts,$NewUPB,$UID);
		DeleteKibPos_108($frUPB,$RfA);
...
{
	$DtE = fGlobal("Ref_Usulan:Ref_Usulan_His:Ref_History:Referensi:Kd_UPB:Kd_UPB_To:No_Register:Tgl_Mutasi_Masuk","ta_kib_108_mutasi","Referensi:Ref_Usulan:Kd_UPB",$RfA.":".$RfU.":".$frUPB."%","=:=:LIKE","IDT limit 0,1","");
	if ($DtE!="")
	{
		$DeB = explode(":",$DtE);
	...
	RoollBackKib_Mutasi_108($frUPB,$RfU,$ReF,$UID);
	RoollBackPos_Mutasi_108($frUPB,$RfU,$ReF,$UID);
	DeleteKibPos_108_Mutasi($frUPB,$RfU,$ReF);
	UpdateUsulanVerRci($tID,'Belum',$UID);	
}

function DeleteKibPos_108_Mutasi($frUPB,$RfU,$ReF)
{
...
function InsertPos_Mutasi_108($frUPB,$RfA,$RfU,$TglMts,$NewUPB,$UID)
{
...
function InsertKib_Mutasi_108($frUPB,$RfA,$RfU,$TglMts,$NewUPB,$UID)
{
...
function DeleteKibPos_108($frUPB,$RfA)
{
	$SQU = "DELETE FROM ta_kib_108 WHERE Referensi='".$RfA."' AND Kd_UPB LIKE '".$frUPB."%'";
	$RsU = mysql_query($SQU);
	
	$SQU = "DELETE FROM ta_kib_post_108 WHERE Referensi='".$RfA."' AND Kd_UPB LIKE '".$frUPB."%'";
	$RsU = mysql_query($SQU);
}
...
function RoollBackKib_Mutasi_108($frUPB,$RfU,$ReF,$UID)
{
	$SQG = "SELECT * FROM ta_kib_108_mutasi WHERE Ref_Usulan='".$RfU."' AND Referensi='".$ReF."' AND Kd_UPB LIKE '".$frUPB."%' ORDER BY Tgl_Perolehan";
	$RsG = mysql_query($SQG);
...
function RoollBackPos_Mutasi_108($frUPB,$RfU,$ReF,$UID)
{
	$SQG = "SELECT * FROM ta_kib_post_108_mutasi WHERE Ref_Usulan='".$RfU."' AND Referensi='".$ReF."' AND Kd_UPB LIKE '".$frUPB."%' ORDER BY Tanggal";
	$RsG = mysql_query($SQG);
	while ($mRG = mysql_fetch_array($RsG, MYSQL_BOTH))
	{
