...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="80" valign="top"> 
	  ...
	  <td width="70" <?=$gBG?>  style="border-bottom:1px #999 dotted; border-right:1px #ccc solid; text-align:center"><? if ($mRo[3]!='0000-00-00') {echo fConvertDateShort($mRo[3]);}?></td>
	  <td width="70" <?=$gBG?> style="border-bottom:1px #999 dotted; border-right:1px #ccc solid; text-align:center"><? if ($mRo[4]!='') {echo $mRo[4];}else{echo "<font style='color:#ff0000'>....????";}?></td>
