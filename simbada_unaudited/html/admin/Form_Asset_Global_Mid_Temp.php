...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>NO. REGISTER</td>
      <td colspan="3"><input name="fReG" type="text" class="text" readonly value="<? echo $gReG?>" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; background:#CCCCCC" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>KODE ASET </td>
      <td colspan="3"><input name="fKdA" type="text" class="text" readonly value="<? echo $gKdA?>" style="width:150px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; background:#CCCCCC" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>NAMA ASET </td>
      <td colspan="3"><input name="fNmA" type="text" class="text" readonly value="<? echo $gNmA?>" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; background:#CCCCCC" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3"><input name="fNiL" type="text" class="text" readonly value="<? echo fConvertToRupiah($gNIL)?>" style="text-align:right; width:130px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; background: #CCCCCC" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
