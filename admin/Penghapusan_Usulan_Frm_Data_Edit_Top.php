...
else if ($CrT=='Edit') 
{
	...
	if ($gJN=='MS') {$JdL.=" MUTASI ANTAR SKPD";}
	if ($gJN=='HB') {$JdL.=" HIBAH";}
	if ($gJN=='PH') {$JdL.=" PENGHAPUSAN";}
}
?>
<table border="0" width="100%" height="23" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td style="text-align:right; padding-right:6px"><a href="#" onclick="closeIMG('Cri'); return false" class="igo clos"><u>C</u>LOSE</a></td>
  </tr>
</table>