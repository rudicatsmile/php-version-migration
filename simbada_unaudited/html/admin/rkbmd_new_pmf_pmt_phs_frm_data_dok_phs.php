...
?>
<div align="center">
<table border="0" width="1200" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
	<tr>
		<td style="font-size: 11pt; font-weight: bold" align="center">RENCANA KEBUTUHAN BARANG MILIK DAERAH </td>
	</tr>
	<tr>
		<td style="font-size: 11pt; font-weight: bold" align="center"> ( RENCANA PENGHAPUSAN ) </td>
	</tr>
	<tr>
		<td style="font-size: 10pt; font-weight: bold" align="center"> <? if ($mRo[7]=="kuasa"){echo "KUASA ";}?>PENGGUNA BARANG</td>
	</tr>
	<tr>
	  <td style="font-size: 10pt; font-weight: bold" align="center">TAHUN ANGGARAN <?=$mRo[4]?></td>
  </tr>
</table>
<table border="0" width="1200" cellspacing="1" style="font-size: 10pt; font-family: Calibri; border-collapse: collapse" id="table1">
	<tr>
		<td <? if ($mRo[7]=="kuasa"){echo "width='120'";} else {echo "width='70'";}?>width="120">UNIT KERJA</td>
		<td width="18">:</td>
		<td><?=$mRo[5]?></td>
	</tr>
	<? if ($mRo[7]=="kuasa"){?>
...
<table border="0" width="1200" cellspacing="0" style="font-size:9pt; font-family: Calibri; border-collapse: collapse">
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td width="230" style="border:1px #000000 solid">Spesifikasi Nama Barang</td>
    <td width="100" style="border:1px #000000 solid">NIBAR</td>
    <td width="50" style="border:1px #000000 solid">Jumlah<br>Barang</td>
    <td width="110" style="border:1px #000000 solid">Nilai<br>Perolehan<br>(Rp)</td>
    <td width="150" style="border:1px #000000 solid">Alasan Rencana<br>Penghapusan</td>
  ...
  <tr style="text-align:center; font-weight:bold">
	...
	p1.alasan_rencana_penghapusan as A8,
	'-' as A9 
	...
	while ($mR = mysql_fetch_array($rs, MYSQL_BOTH))
	{
		...
		<td style="border:1px #000000 solid; text-align:right; padding-right:3px"><?=fConvertToRupiah($mR[7])?></td>
		<td style="border:1px #000000 solid; text-align:center"><?=$mR[8]?></td>
		<td style="border:1px #000000 solid"><?=$mR[9]?></td>
		</tr>
		<?
		$iG++;
		$mR7=$mR7+$mR[7];
  ...
  <tr height="22" style="font-weight:bold">
    <td colspan="5" style="border:1px #000000 solid; text-align:center">T O T A L</td>
    <td style="border:1px #000000 solid; text-align:center"><?=$iG-1?></td>
    <td style="border:1px #000000 solid; text-align:right; padding-right:3px"><?=fConvertToRupiah($mR7)?></td>
    <td style="border:1px #000000 solid">&nbsp;</td>
    <td style="border:1px #000000 solid">&nbsp;</td>
  </tr>
</table>
<table border="0" width="1330" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
	...
	<tr height="30">
		<td align="center">&nbsp;</td>
		<td>&nbsp;</td>
		<td align="center"><? if ($Crit=='kuasa'){echo "KUASA PENGGUNA BARANG";} else {echo "PENGGUNA BARANG";}?></td>
	</tr>
	<tr>
		<td height="60">&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td align="center">&nbsp;</td>
		<td>&nbsp;</td>
		<td align="center" style="text-decoration:underline; font-weight:bold"><? if ($Crit=='kuasa'){echo str_repeat(".",35);} else {echo $mRo[8];}?></td>
	</tr>
	<tr>
		<td align="center">&nbsp;</td>
		<td>&nbsp;</td>
		<td align="center"><? if ($Crit=='kuasa'){echo "NIP. ..............................";} else {echo $mRo[9];}?></td>
	</tr>
</table>