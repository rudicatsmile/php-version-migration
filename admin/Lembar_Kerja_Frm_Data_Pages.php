...
else
{
	...
	#echo $PerPage."<br>";
	$nSQ = "SELECT Referensi, Ref_Group, count(*) as JmlR FROM ta_kib_108_sensus_2023 
	WHERE Kd_UPB LIKE '".$UnT."%' $FiD AND Extracom LIKE '".$ExT."' $SyT GROUP BY Referensi" ;
	$nRs = mysql_query($nSQ);
	#if ($UID =="creator") {echo $nSQ;}
