...
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format IV.L.4.4</td>
  </tr>
</table>
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:11pt">
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">LAPORAN BMD</td>
  </tr>
...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td rowspan="2" style="border:1px solid #000">Jumlah BMD<br></td>
  ...
  <tr style="text-align:center">
    ...
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">3</td>
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">4</td>
  </tr>
	<?php
	...
	{ 
		...
		$fs = "";
		$x3 = fGlobal("ifnull(count(*),0)","ta_kib_108","Kd_UPB:Kd_Aset_108:Tgl_Perolehan:Extracom:KdpToAset",$KdS."%:".$x1.".%:".$TGz.":N:N","LIKE:LIKE:<=:LIKE:=","",$fs);
		$x4 = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:Extracom:KdpToAset",$KdS."%:".$x1.".%:".$TGz.":N:N","LIKE:LIKE:<=:LIKE:=","",$fs);
