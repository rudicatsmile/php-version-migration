...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td>JUMLAH SATUAN</td>
      <td><input name="fSatuan" type="text" id="fSatuan" value="<?php echo $gSTN?>" <?php if ($KeY=="Y") {echo "readonly";}?> onblur="NumValidate(this)" onkeyup="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" /></td>
    </tr>
    <tr> 
      <td>RINCIAN</td>
    ...
    <tr> 
      <td>UKURAN / CC</td>
      <td><input name="fUkuranCC" type="text" class="text" id="fUkuranCC" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gUcc?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gBHN?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR PABRIK</td>
      <td><input name="fPabrik" type="text" class="text" id="fPabrik" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gPBR?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR RANGKA</td>
      <td><input name="fRangka" type="text" class="text" id="fRangka" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gRKA?>" size="60" maxlength="50" />
      <span class="style1">*</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR MESIN</td>
      <td><input name="fMesin" type="text" class="text" id="fMesin" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gMSN?>" size="60" maxlength="50" />
      <span class="style1">*</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR POLISI</td>
      <td><input name="fPolisi" type="text" class="text" value="<?php echo $gPLS?>" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" size="60" maxlength="50" />
      <span class="style1">*</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>NOMOR BPKB</td>
      <td><input name="fBPKB" type="text" class="text" id="fBPKB" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gBPK?>" size="60" maxlength="50" />
      <span class="style1">*</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td valign="top">KETERANGAN</td>
      <td><textarea name="fKeterangan" cols="58" rows="2" id="fKeterangan" style="border: 1px solid #C0C0C0"><?php echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
