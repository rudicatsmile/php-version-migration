      ...
      <td style="font-size: 13pt; font-weight: bold" align="center">KONSTRUKSI DALAM PENGERJAAN </td>
		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
			  <tr> 
				...
				<td width="18">:</td>
				<td width="424"><?php echo $gNmUNT ?></td>
				<td width="94">BIDANG ASET </td>
				<td width="18">:</td>
				<td width="1247"><?php echo $nAs1?></td>
			  </tr>
			  <tr> 
		...
		<tr>
          ...
          <?php
				...
				?>
          <?php function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17) {?>
          <tr height="30"> 
            ...
            <td style="border: 1px solid #000"><?php if ($x7!="" && $x7!="0000-00-00" && $x7!="00-00-0000") {echo fConvertDateShort($x7);}?></td>
            <td style="border: 1px solid #000; padding-left:2px"><?=$x8?></td>
            <td style="border: 1px solid #000"><?php if ($x9!="" && $x9!="0000-00-00" && $x9!="00-00-0000") {echo fConvertDateShort($x9);}?></td>
