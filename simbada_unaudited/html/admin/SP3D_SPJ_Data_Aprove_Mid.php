...
<table align="center" cellpadding="0" cellspacing="0" width="800" border="0" style="font-size:10pt; font-family:calibri">
	...
	<tr height="27">
	  ...
	  <td style="text-align:center">:</td>
	  <td>
	  <label <?=$sTa?>><input name="radioApp" type="radio" value="none" <? if ($Aprov=='none'){echo "checked";}?> />None</label>&nbsp;
	  <label <?=$sTb?>><input name="radioApp" type="radio" value="aproved" <? if ($Aprov=='aproved'){echo "checked";}?> />
	  <? if ($Aprov=='aproved') {echo "Aproved"; } else {echo "Aprove";}?>
	  </label>&nbsp;
	  <label <?=$sTc?>><input name="radioApp" type="radio" value="ditolak" <? if ($Aprov=='ditolak'){echo "checked";}?> />Tolak</label>&nbsp;	  </td>
	</tr>
	<tr height="50">
	  <td>&nbsp;</td>
