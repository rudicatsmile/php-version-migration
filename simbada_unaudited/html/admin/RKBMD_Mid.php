	...
	do
		{
			...
			?>
				...
				function P_Acc<? echo $IDO?>(w,h,xR)
				{
					...
					if (win!=null)
					{
						...
						?>       			
						txtHTML="<html><head><title>Simbada Kab. Hulu Sungai Tengah</title><meta name='GENERATOR' content='Microsoft FrontPage 5.0'><meta name='ProgId' content='FrontPage.Editor.Document'></head><frameset framespacing='0' border='0' rows='30,*,25' frameborder='0'><frame name='FormRKBTop' target='FormRKBMid' noresize scrolling='no' src='<? echo $URL_Top?>'><frame name='FormRKBMid' src='<? echo $URL_Mid?>' scrolling='auto'><frame name='FormRKBBot' src='<? echo $URL_Bot?>' scrolling='no'><noframes><body><p>This page uses frames, but your browser doesn't support them.</p></body></noframes></frameset></html>"            
						win.focus()
			...
			<tr>
				<td><input type="text" name="fNomo" size="2" value="<? echo $iG?>." style="text-align:center; font-family: calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #C0C0C0" /></td>
				<td width="60"><input type="text" name="fKode" size="13" value="<? echo $rCod?>" readonly onclick="P_Acc<? echo $IDO?>('600','500'); return false" style="width:90px; font-family: calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
				...
				<td><input type="text" name="fNama<? echo $IDO?>" value="<?=$rNma?>" readonly style="width:240px; font-family: calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
