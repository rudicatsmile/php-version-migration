...
<tr>
  ...
  <option value=""></option>
  <? for ($i=1; $i<=20; $i++){?>
  <option value="<?=$i?>" <? if ($i==$tme) {echo "selected";}?>><?=$i?></option>
  <? } ?>
  </select>
  <select name="fWkt" id="fWkt" style="width:80px; text-align:center">
  <option value=""></option>
  <option value="Hari"  <? if ($wkt=='Hari') {echo "selected";}?>>Hari</option>
  <option value="Bulan" <? if ($wkt=='Bulan'){echo "selected";}?>>Bulan</option>
  <option value="Tahun" <? if ($wkt=='Tahun'){echo "selected";}?>>Tahun</option>
  </select>
  </td>
  </tr>
<tr>
