...
$worksheet->write(0, 0, $nSQL, $Merg1);
...
$tNIL= 0;
$iG  = 6;
$nSQL= "SELECT * FROM ta_kib_a WHERE Kd_UPB='".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Tgl_Perolehan, Kd_Aset, No_Register";
...
header("Content-Type: application/x-msexcel; name=\"KiB-A.xls\"");
header("Content-Disposition: inline; filename=\"KiB-A.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>