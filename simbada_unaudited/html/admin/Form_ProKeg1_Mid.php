...
<form name="myfrm" method="post" action="<?php echo "Form_ProKeg1_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDO=".$rIDO ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      ...
      <td width="25">:</td>
      <td>
	  <input name="fKode1" type="text" class="text" id="fKode1" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod1?>" size="1" maxlength="1" <? echo $ReadO?>/>.
	  <input name="fKode2" type="text" class="text" id="fKode2" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod2?>" size="2" maxlength="2" <? echo $ReadO?>/>.
      <input name="fKode3" type="text" class="text" id="fKode3" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod3?>" size="2" maxlength="2" readonly/></td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
