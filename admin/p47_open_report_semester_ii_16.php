...
$gUNT = "25.08.XX.XX";//substr($SkP,0,11);
$dUNT = "All SKPD";//fGlobal("Nm_Unit","ref_unit","Kd_Unit",$gUNT,"=","","");
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:900px; color:#fff; background:#79a86a">
  ...
  <tr height="23">
    ...
    <input name="dUNT" id="dUNT" type="text" value="<?=$dUNT?>" readonly 
      <?php if ($Lev <= 1) {?> onClick="showUNIT_xxx('','<?=$_GET['IdL']?>')" 
  ...
  <tr height="24">
    ...
    <td>&nbsp;</td>
    <td>
	<label><input name="radiOnOff" id="radiOnOff" type="radio" value="N" checked />Intra Komtabel</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label><input name="radiOnOff" id="radiOnOff" type="radio" value="Y" />Ekstra Komtabel</label>
	<label><input name="radiOnOff" id="radiOnOff" type="radio" value="%" />Gabung</label>
	</tr>
  <tr height="24">
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:900px">
  ...
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('_._._','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.X - (Semua)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.1','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.1 - (Tanah)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.2','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.2 - (Peralatan & Mesin)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.3','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.3 - (Gedung & Bangunan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.4','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.4 - (Jalan, Irigasi & Bangunan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.5','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.5 - (Aset Tetap Lainnya)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.6','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.6 - (Konstruksi Dalam Pengerjaan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.2','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.7 - (Kemiteraan Dengan Pihak Ketiga)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.3','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.8 - (Aset Tidak Berwujud)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.4','Format_II_O_4_x','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.9 - (Aset Lain-Lain)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.1.12','Format_II_O_4_10','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.10 - (Persediaan Rusak Berat / Usang) *</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.5.02','Format_II_O_4_11','<?=$IdL?>'); return false;">&nbsp;Daftar BMD II.O.4.11 - (Barang Bersejarah) *</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
