...
<body>
	...
	<tr>
	  ...
	  <td width="1190" style="font-size: 10pt; font-weight: normal"><?php if ($_GET['uNT']=='All'){echo "SEMUA";} else {echo strtoupper(fGlobalNEW("Nm_Unit","ref_unit","Kd_Unit",$_GET['uNT'],"=","",DatabaseSB,$ConSB,""));}?></td>
	</tr>
	<tr>
	  <td colspan="3">&nbsp;</td>
	</tr>
    ...
    <table border="0" align="center" width="1270" cellspacing="0" style="font-size: 9pt; font-family: Calibri; border-collapse: collapse">
	  ...
	  ?>
	  <?php function RowData($Col01,$Col02,$Col03,$Col04,$Col05,$Col06,$Col07,$Col08,$Col09,$Col10,$Col11,$xG,$xB) {?>
	  <tr height="28">
		...
		<td style="border:1px solid #000000; text-align:right; padding-right:3px <?php if ($xG!="") {echo "; color:#".$xG;}?>"><?=$xB.fConvertToRupiah($Col11)?></td>
	  </tr>
	  <?php
	  }
	  ?>
