...
<input type="button" name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
    ...
    <tr> 
      <td>KONTRUKSI</td>
      <td><input name="fKonstruksi" type="text" class="text" id="fKonstruksi" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gKns?>" size="60" maxlength="50" />      </td>
      <td>&nbsp;</td>
      <td colspan="2">
    ...
    <tr> 
      <td>LOKASI</td>
      <td>
		<input name="fLokasi" type="text" class="text" id="fAlamat3" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gLKS?>" size="60" maxlength="50" />
    ...
    <tr> 
      ...
      <td><textarea name="fKeterangan" id="textarea" style="height:60px; width:440px; border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
