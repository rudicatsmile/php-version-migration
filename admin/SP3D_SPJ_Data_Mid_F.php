...
<table border="0" width="1000" height="23" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="25">
    ...
    <td><select class="boxs" name="fTin" id="fTin" style="width:170px" tabindex="0">
      <option value=""></option>
      <option <?php if ($fTin=="Bertingkat") {echo "selected";}?> value="Bertingkat">Bertingkat</option>
      <option <?php if ($fTin=="Tidak") {echo "selected";}?> value="Tidak">Tidak Bertingkat</option>
    </select>
      <select class="boxs" name="fBet" id="fBet" style="width:134px" tabindex="0">
        <option value=""></option>
        <option <?php if ($fBet=="Beton") {echo "selected";}?> value="Beton">Beton</option>
        <option <?php if ($fBet=="Tidak") {echo "selected";}?> value="Tidak">Bukan Beton</option>
      </select></td>
  ...
  <tr height="25">
    ...
    <input type="button" name="B393" <?=$DisA?> value="RESET" onclick="ResetMidASET('f','<?=$rIdT?>','<?=$IdL?>')" style="width: 80px; height: 21px" /></td>
  </tr>
  <tr height="25">
    <td class="ar">&nbsp;</td>
    <td class="ac">&nbsp;</td>
