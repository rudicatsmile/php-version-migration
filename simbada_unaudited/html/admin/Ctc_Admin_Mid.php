...
<table border="0" width="561" cellspacing="1" align="center" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1">
	...
	<tr>
	  <td height="5"><input name="fPrm" type="text" value="<? echo $fNma?>" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" size="50" maxlength="100" /></td>
	</tr>
	<tr>
	  <td height="5" style="color:#FF0000"><? echo $MsG?>&nbsp;</td>
	</tr>
	<tr>
