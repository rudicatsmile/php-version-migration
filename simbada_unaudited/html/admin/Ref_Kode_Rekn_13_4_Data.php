...
$iG=1;
$nSQ = "SELECT IDT, Kd_Rek, Nm_Rek FROM ref_rek_4 WHERE Kd_Rek LIKE '".$KdR3."%' $CrT ORDER BY Kd_Rek";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	$eKdR = $mRo[1];
	$rCek = "";
	$rCek = fGlobal("IDT","ref_rek_5","Kd_Rek",$eKdR."%","LIKE","","");
	?>
	<tr height="25"> 
	  ...
	  <a href="<?="Ref_Kode_Rekn_13_5.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 13/2006&rKdR=".$eKdR."&IdL=".$_GET['IdL']?>" class="ico prev">&nbsp;View</a>&nbsp;&nbsp;&nbsp;
