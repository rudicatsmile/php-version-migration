...
<tr height="100%">
  ...
  <td width="90" valign="top" style="border-bottom:1px dotted #ccc; text-align:right; font-weight:bold; color:#0000FF"><?php if ($iG!=1){?>Tandai Semua<?php } ?></td>
  <td width="90" valign="top" style="border-bottom:1px dotted #ccc; border-right:1px dotted #ccc">&nbsp;</td>
  <td width="20" valign="top" style="border-bottom:1px dotted #ccc"><?php if ($iG!=1){?><input type="checkbox" name="rDana" value="" onclick="CheckAllb()" /><?php } ?></td>
</tr>
</table>
