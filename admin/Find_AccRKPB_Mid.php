	...
	if ($tRo > 0)
	{
		do
		{
			...
			<tr title="Klik disini untu melihat Kelompok, Jenis, Objek....!!"> 
		      <td width="102" height="18" valign="top"><a href="<?php echo $URL?>" target="_top"><?php echo $mRo['Kd_Rek']?></a></td>
		      <td width="1016" valign="top" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;);"><a href="<?php echo $URL?>" target="_top"><?php echo $mRo['Nm_Rek']?>&nbsp;</a></td>
			</tr>
			<tr style="cursor: pointer; " onmouseover="this.style.cursor=&#39;pointer&#39;"> 
			  ...
			  <table id="detail<?php echo $iG?>" cellspacing="0" cellpadding="3" border="0" width="100%" style="font-style: italic; color: #808080; display: none;">
				  <tr> 
					...
					<td width="20">:</td>
					<td>
					  <?php echo fGlobal("Nm_Rek","Ref_Rek_2","Kd_Rek",$gK2,"=","","")?>
					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					...
					<td>:</td>
					<td>
					  <?php echo fGlobal("Nm_Rek","Ref_Rek_3","Kd_Rek",$gK3,"=","","")?>
					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					...
					<td>:</td>
					<td>
					  <?php echo fGlobal("Nm_Rek","Ref_Rek_4","Kd_Rek",$gK4,"=","","")?>
					</td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
