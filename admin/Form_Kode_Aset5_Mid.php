...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset5_Mid_.php?FrmG=".($_REQUEST['FrmG'] ?? '')."&IdL=".($_REQUEST['IdL'] ?? '')."&rIDT=".$rIDT ?>">
