...
?>
<body>
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.3.1</td>
  </tr>
</table>
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">T A N A H</td>
  </tr>
  <tr>
...
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td rowspan="2" style="border:1px solid #000">Nomor<br>Register </td>
    <td rowspan="2" style="border:1px solid #000">Spesifikasi Nama <br>Barang</td>
    <td rowspan="2" style="border:1px solid #000">Spesifikasi Lainnya </td>
    <td rowspan="2" style="border:1px solid #000">Jumlah</td>
    <td rowspan="2" style="border:1px solid #000">Satuan</td>
    <td rowspan="2" style="border:1px solid #000">Lokasi</td>
    <td rowspan="2" style="border:1px solid #000">Titik Koordinat </td>
    <td colspan="4" style="border:1px solid #000">Buku Kepemilikan </td>
    <td rowspan="2" style="border:1px solid #000">Harga Satuan<br>Perolehan<br>(Rp) </td>
    <td rowspan="2" style="border:1px solid #000">Nilai Perolehan<br>(Rp) </td>
    <td rowspan="2" style="border:1px solid #000">Cara Perolehan </td>
    <td rowspan="2" style="border:1px solid #000">Tanggal<br>Perolehan</td>
    <td rowspan="2" style="border:1px solid #000">Status<br>Penggunaan </td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Nama Kepemilikan<br>Dalam Dokumen </td>
  </tr>
  <tr style="text-align:center">
    ...
    <td width="50" style="border:1px solid #000; border-bottom:3px double #000">7</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">8</td>
    <td width="180" style="border:1px solid #000; border-bottom:3px double #000">9</td>
    ...
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">13</td>
    <td width="100" style="border:1px solid #000; border-bottom:3px double #000">14</td>
    <td width="100" style="border:1px solid #000; border-bottom:3px double #000">15</td>
    <td width="100" style="border:1px solid #000; border-bottom:3px double #000">16</td>
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">17</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">18</td>
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">19</td>
    <td style="border:1px solid #000; border-bottom:3px double #000">20</td>
  </tr>
	<?php
	$iGa = 1;
	$t7  = 0;
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.3.1.%' 
	...
	function Lev7($KdS,$x1,$ThN,$HostnameSB,$ConSB)
	{
		...
		*/
		...
		'Sertifikat' as A11,
		P1.Sertifikat_Nomor as A12,
		P1.Sertifikat_Tanggal as A13,
		'-' as A14,
		P1.Harga as A15,
		IfNull(sum(P2.Debet),0) as A16,
		P1.Asal_Usul as A17,
		P1.Tgl_Perolehan as A18,
		P1.Penggunaan as A19,
		P1.Keterangan as A20 
		FROM ta_kib_108 P1 
		LEFT JOIN ta_kib_post_108 P2 ON P2.Referensi=P1.Referensi AND P2.Ref_Group=P1.Ref_Group AND P2.Kd_UPB=P1.Kd_UPB 
	...
	?>
	<?php function detaData($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20,$xB) {?>
		...
		<td style="border:1px solid #000; text-align:right; padding-right:2px"><?=fConvertToRupiahBulat($x15)?></td>
		<td style="border:1px solid #000; text-align:right; padding-right:2px"><?=fConvertToRupiahBulat($x16)?></td>
		<td style="border:1px solid #000; padding-left:2px"><?=$x17?></td>
		<td style="border:1px solid #000; text-align:center"><?=$x18?></td>
		<td style="border:1px solid #000; padding-left:2px"><?=$x19?></td>
		<td style="border:1px solid #000; padding-left:2px"><?=$x20?></td>
		</tr>
	<?php } ?>
	<?php function detaBlank() {?>
		<tr height="19">
  ...
  <tr height="19" style="font-weight:bold">
    <td colspan="6" style="border:1px solid #000; text-align:right">T O T A L<?=str_repeat('&nbsp;',20)?></td>
    <td style="border:1px solid #000; text-align:center"><?=fConvertToRupiahBulat($_COOKIE['t7'])?></td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    ...
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000; text-align:right; padding-right:2px"><?=fConvertToRupiahBulat($t16)?></td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
    <td style="border:1px solid #000">&nbsp;</td>
