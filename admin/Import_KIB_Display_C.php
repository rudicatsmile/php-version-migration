...
<tr style="font-weight:bold"> 
  ...
  <?php
	...
	for ($i = 3; $i <= $data->sheets[0]['numRows']; $i++) {
		if ($data->sheets[0]['cells'][$i][5]!="")
		{
		  ...
		  <tr> 
			<td class="ac"><?=$tG ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][5].$WrN ?></td>
			<td class="ac"><?php echo $WrM.$data->sheets[0]['cells'][$i][6] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][7] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][8] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][9] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][10] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][11] ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][12] ?></td>
			<td><?php echo $gTglD ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][14] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][16] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][17] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][18] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][19] ?></td>
			<td class="ar"><?php echo fConvertToRupiahBulat($data->sheets[0]['cells'][$i][20]) ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][21] ?></td>
		  </tr>
	  <?php } ?>
  <?php 
  $tG++;
  ...
  <tr style="font-weight:bold"> 
    ...
    <td class="ar"><?php echo fConvertToRupiahBulat($tJML) ?></td>
    <td>&nbsp;</td>
  </tr>
</table>
