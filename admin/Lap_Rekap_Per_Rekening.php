...
<table border="0" align="center" width="900" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
	...
	<tr>
		<td width="1285" align="center" style="font-size: 12pt"><span style="font-size: 11pt">Per Tanggal 1 Jan <?php echo $rThn?> s.d 31 Des <?php echo $qThn?></span></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
  </tr>
	<tr>
		...
		<tr>
			<td width="74">SKPD</td>
			<td width="25">:</td>
			<td width="551"><?php if ($xUnt=="") {echo "<i>Semua Unit Kerja</i>";} else {echo strtoupper(fGlobal("Nm_Unit","Ref_Unit","Kd_Unit",$xUnt,"=","",""));}?></td>
			<td width="237" align="right">&nbsp;</td>
		</tr>
		<tr>
			<td width="74">SUB UNIT </td>
			<td width="25">:</td>
			<td><?php if ($xSub=="") {echo "<i>Semua Sub Unit Kerja</i>";} else {echo strtoupper(fGlobal("Nm_Sub","Ref_Sub_Unit","Kd_Sub",$xSub,"=","",""));}?></td>
			<td width="237">&nbsp;</td>
		</tr>
		<tr>
			<td width="74">UPB</td>
			<td width="25">:</td>
			<td><?php if ($xUpb=="") {echo "<i>Semua UPB</i>";} else {echo strtoupper(fGlobal("Nm_Upb","Ref_Upb","Kd_Upb",$xUpb,"=","",""));}?></td>
			<td width="237">&nbsp;</td>
		</tr>
		<tr>
	...
	<tr>
		...
		?>
		<?php function ViewData($x01,$x02,$x03,$x04,$x05,$x06,$x07,$x08,$x09,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$xB) {?>
		<tr>
			<td width="50" valign="top"><?php echo $xB.$x01?></td>
			<td width="133" valign="top"><?php echo $xB.$x02?>&nbsp;</td>
			<td valign="top" align="center"><?php echo $xB.fConvertToRupiahBulat($x03)?></td>
			<td valign="top" align="right"><?php echo $xB.fConvertToRupiah($x04)?></td>
			<td valign="top" align="center"><?php if ($x05 >0 ) {echo $xB.fConvertToRupiahBulat($x05);}?></td>
			<td valign="top" align="center"><?php if ($x06 >0 ) {echo $xB.fConvertToRupiahBulat($x06);}?></td>
			<td valign="top" align="center"><?php if ($x07 >0 ) {echo $xB.fConvertToRupiahBulat($x07);}?></td>
			<td valign="top" align="center"><?php if ($x08 >0 ) {echo $xB.fConvertToRupiahBulat($x08);}?></td>
			<td align="center" valign="top"><?php if ($x09 >0 ) {echo $xB.fConvertToRupiahBulat($x09);}?></td>
			<td valign="top" align="center"><?php if ($x10 >0 ) {echo $xB.fConvertToRupiahBulat($x10);}?></td>
			<td valign="top" align="center"><?php if ($x11 >0 ) {echo $xB.fConvertToRupiahBulat($x11);}?></td>
			<td valign="top" align="center"><?php if ($x12 >0 ) {echo $xB.fConvertToRupiahBulat($x12);}?></td>
			<td valign="top" align="center"><?php if ($x13 >0 ) {echo $xB.fConvertToRupiahBulat($x13);}?></td>
			<td valign="top" align="center"><?php if ($x14 >0 ) {echo $xB.fConvertToRupiahBulat($x14);}?></td>
			<td valign="top" align="center"><?php if ($x15 >0 ) {echo $xB.fConvertToRupiahBulat($x15);}?></td>
			<td valign="top" align="center"><?php if ($x16 >0 ) {echo $xB.fConvertToRupiahBulat($x16);}?></td>
			<td align="center" valign="top"><?php if ($x17 >0 ) {echo $xB.fConvertToRupiahBulat($x17);}?></td>
		</tr>
		<?php } ?>
		<?php function EmptyRow() {?>
		<tr>
		...
		<tr>
			...
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php echo fConvertToRupiahBulat($tJmlRc)?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="right"><?php echo fConvertToRupiah($tJmlHr)?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJmlBB!=0) {echo fConvertToRupiahBulat($tJmlBB);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJmlRR!=0) {echo fConvertToRupiahBulat($tJmlRR);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJmlRB!=0) {echo fConvertToRupiahBulat($tJmlRB);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJmlLL!=0) {echo fConvertToRupiahBulat($tJmlLL);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml09!=0) {echo fConvertToRupiahBulat($tJml09);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml10!=0) {echo fConvertToRupiahBulat($tJml10);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml11!=0) {echo fConvertToRupiahBulat($tJml11);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml12!=0) {echo fConvertToRupiahBulat($tJml12);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml13!=0) {echo fConvertToRupiahBulat($tJml13);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml14!=0) {echo fConvertToRupiahBulat($tJml14);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml15!=0) {echo fConvertToRupiahBulat($tJml15);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml16!=0) {echo fConvertToRupiahBulat($tJml16);}?></td>
			<td style="border-top: 3px double #000000; font-weight:bold" align="center"><?php if ($tJml17!=0) {echo fConvertToRupiahBulat($tJml17);}?></td>
		</tr>
	</table>	</td>
	</tr>
	<tr>
