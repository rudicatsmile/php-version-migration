...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:910px">
	<tr height="30">
	  <td width="120" style="border-bottom:1px solid #ccc"><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="818">&nbsp;</td>
          <td width="132">Format : III.A.3</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr style="font-weight:bold">
          <td width="30">J.</td>
          <td width="140">Alamat/Lokasi</td>
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="fForm" id="fForm" readonly value="<?=$mRo[47]?>" style="width:300px; background:#fff" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
  ...
  <tr>
	...
	?>
        ...
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td><a href="#" class="ico docu" onclick="formCetakDok('Report_Form_LKI_BNG','<?=$IdT?>','900','400','<?=$IdL?>'); return false;">&nbsp;&nbsp;DOKUMEN CETAK</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
...
*/
  ...
  function OpenAccMAP(ReO, w, h, pos) {
    ...
    if (win != null) {
      ...
      URL_Top = "UploadIMG_Top.php?FrmG=Lokasi Peta -> KIB C (ASET GEDUNG DAN BANGUNAN)";
      URL_Mid = "UploadMAP_Mid.php?" + "<?= "rCRT=c&rIDT=" . $IdT . "&IdL=" . $IdL . "&src=lki&SnsIDT=" . $SnsIDT ?>";
