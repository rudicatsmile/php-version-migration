		...
		<tr>
		  ...
		  <? function ViewRinci($x1,$x2,$x3,$x4,$x5,$iR,$xB) {?>
			<tr>
			  ...
			  <td valign="top" style="border-left:0px solid #000000; border-top: <? if ($iR==1){echo "0";} else {echo "1";}?>px dotted #000000; border-bottom:0px solid #000000; border-right:1px solid #000000; padding-left:3px"><?=$x2?></td>
			  <td valign="top" style="border-left:0px solid #000000; border-top: <? if ($iR==1){echo "0";} else {echo "1";}?>px dotted #000000; border-bottom:0px solid #000000; border-right:1px solid #000000; text-align:center"><?=$x3?> unit</td>
