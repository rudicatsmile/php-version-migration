  ...
  <table width="1165" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	if ($tRo > 0)
	{
		do
		{
			...
			?>
			<tr height="18"> 
			  <td width="100" valign="top"><a href="<? echo $URL?>" target="_top"><?=$mRo['Kd_Aset']?></a></td>
			  <td valign="top"><a href="<? echo $URL?>" target="_top"><?=$mRo['Nm_Aset']?>&nbsp;</a></td>
			  <td width="10" valign="top">&nbsp;</td>
			  <td width="400" valign="top"><a href="<? echo $URL?>" target="_top">
