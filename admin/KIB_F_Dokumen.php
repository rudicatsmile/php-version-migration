	...
	<table border="0" width="1320" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
      ...
      <td style="font-size: 13pt; font-weight: bold" align="center">KONSTRUKSI DALAM PENGERJAAN </td>
		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
              ...
              <tr>
                ...
                <td width="18">:</td>
                <td colspan="4"><?php if ($gKDP=='All'){echo "SEMUA";} else if ($gKDP=='Y'){echo "SUDAH";} else {echo "BELUM";}?></td>
              </tr>
            </table>
			<!--table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
          <tr> 
		...
		<tr>
          ...
          <tr> 
            <td style="border: 1px solid #000000" valign="top" align="center"><?php echo $x0?>.</td>
            <td style="border: 1px solid #000000" valign="top"><?php echo $x1?></td>
            <td style="border: 1px solid #000000" valign="top" align="center"><?php echo $x2?></td>
            <td align="center" valign="top" style="border: 1px solid #000000"><?php echo $x3?></td>
            <td align="center" valign="top" style="border: 1px solid #000000"><?php echo $x4?></td>
            <td style="border: 1px solid #000000" valign="top" align="center"><?php if ($x5!='0' || $x5>0) {echo fConvertToRupiah($x5);}?></td>
            ...
            <td style="border: 1px solid #000000; text-align:center" valign="top"><?php if ($x7!="" && $x7!="0000-00-00" && $x7!="00-00-0000") {echo fConvertDateShort($x7);}?></td>
            <td style="border: 1px solid #000000" valign="top"><?php echo $x8?></td>
            <td valign="top" style="border: 1px solid #000000"><?php if ($x9!="" && $x9!="0000-00-00" && $x9!="00-00-0000") {echo fConvertDateShort($x9);}?></td>
            <td valign="top" style="border: 1px solid #000000"><?php echo $x10?></td>
            <td valign="top" style="border: 1px solid #000000"><?php echo $x11?></td>
            <td valign="top" style="border: 1px solid #000000"><?php echo $x12?></td>
            <td style="border: 1px solid #000000" valign="top" align="right"><?php echo fConvertToRupiah($x13)?></td>
            <td style="border: 1px solid #000000" valign="top"><?php echo $x15?></td>
            <td style="border: 1px solid #000000" valign="top"><?php echo $x14?></td>
          </tr>
          <?php } ?>
          ...
          <tr> 
            ...
            <td style="border:1px solid #000000; font-weight: bold" align="center">&nbsp;</td>
            <td style="border:1px solid #000000; font-weight: bold" align="center">&nbsp;</td>
            <td style="border:1px solid #000000; font-weight: bold" align="right"><?php echo fConvertToRupiah($gHrg)?></td>
            <td style="border: 1px solid #000000">&nbsp;</td>
            <td style="border: 1px solid #000000">&nbsp;</td>
          </tr>
        </table>		  
