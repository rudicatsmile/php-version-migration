...
<form name="myfrm" method="post" action="<?php echo "Form_Asset_F_KdpToKib_Find_Mid.php?IDT=".$_GET['IDT']."&IdL=".$_GET['IdL'] ?>" target="WinFormFND_Mid">
    ...
    <tr> 
	  ...
	  <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse; color:#FFFFFF">
          <tr> 
            <td width="10">&nbsp;</td>
            <td width="50">CARI</td>
            <td width="215"><input class="text" type="text" name="fFind" value="<? echo $gFin?>" style=" width:200px; font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
