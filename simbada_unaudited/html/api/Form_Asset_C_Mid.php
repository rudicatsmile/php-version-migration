...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td>JUMLAH SATUAN</td>
      <td><input name="fSatuan" type="text" id="fSatuan" value="<?=$gSTN?>" <? if ($KeY=="Y") {echo "readonly";}?> onblur="NumValidate(this)" onkeyup="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" /></td>
    </tr>
    <tr> 
      <td>RINCIAN</td>
    ...
    <tr> 
	  ...
	  <tr>
		<?
		$iG=1;
		$SQL="SELECT IDT FROM ta_kib_c_pdf WHERE Referensi='$gREF' ORDER BY IDT";
		$nRs = mysql_query($SQL);
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('c','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('c','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>	  </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td>LUAS LANTAI</td>
      <td><input name="fLuasLantai" type="text" class="text" id="fLuasLantai" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="text-align:right; padding-right:5px; width:90px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gLti)?>" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LETAK/ALAMAT</td>
      <td>
		<input name="fAlamat" type="text" class="text" id="fAlamat" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gLKS?>" size="60" maxlength="50" />
    ...
    <tr> 
      <td>LUAS TANAH</td>
      <td>
	  <input name="fLuasTanah" type="text" class="text" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="text-align:right; padding-right:5px; width:90px; border: 1px solid #C0C0C0; padding-left: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gLTnh)?>" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
...
<script language="javascript">
	...
	{	
		...
		if (win!=null)
		{
			...
			URL_Bot = "UploadIMG_Bot.php";
			txtHTML="<html><head><title>SimB@DA</title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFindAcc_Top' noresize src='"+URL_Top+"' scrolling='no'><frame name='WinFindAcc_Mid' src='"+URL_Mid+"' scrolling='auto'><frame name='WinFindAcc_Bot' src= '"+URL_Bot+"' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
			win.focus()
			win.window.document.clear()
			win.window.document.write(txtHTML)
			win.window.document.close() 
