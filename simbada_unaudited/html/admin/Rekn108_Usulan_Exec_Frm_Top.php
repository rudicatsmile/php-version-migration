...
<table border="0" width="100%" height="25" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="409" height="35" style="padding-left:3px; font-weight:bold; font-size:16px; text-shadow: #fff 1px 1px 0px ">EKSEKUSI USULAN MUTASI REKENING</font></td>
    <td width="120" style="font-weight:bold">Find (Kode Rekening)</td>
    <td width="200" style="font-family:arial; font-size:8pt">
    ...
    <td style="text-align:right; padding-right:6px"><a href="#" onClick="closeEXEC('','<?=$IdL?>'); return false" class="ico clos"><u>C</u>LOSE</a></td>
  </tr>
</table>
</body>
