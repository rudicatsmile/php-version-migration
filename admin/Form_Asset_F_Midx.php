...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      <td width="127">UNIT KERJA</td>
      <td width="419"> <select name="fUnt" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <?php
		if ($Lev > 1 )
      ...
      <td width="371"> <select class="boxs" name="fMilik" style="width: 250px" tabindex="0">
          <option value=""></option>
          <?php
    ...
    <tr> 
      <td width="127">SUB UNIT</td>
      <td width="419"> <select class="boxs" name="fSub" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <?php
	  ...
	  <option value="-"></option>
	  <option <?php if ($gKDS=="P") {echo "selected";}?> value="P">Permanen</option>
	  <option <?php if ($gKDS=="SP") {echo "selected";}?> value="SP">Semi Permanen</option>
	  <option <?php if ($gKDS=="D") {echo "selected";}?> value="D">Darurat</option>
      </select></td>
    </tr>
    <tr> 
      <td width="127">UPB</td>
      <td width="419"> <select class="boxs" name="fUpb" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <?php
    ...
    <tr> 
      <td>OBJEK</td>
      <td><select class="boxs" name="fBid" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <option value=""></option>
          <?php
    ...
    <tr> 
      <td>RINCIAN OBJEK </td>
      <td><select class="boxs" name="fKel" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <?php
      ...
      <td>JUMLAH SATUAN</td>
      <td>
	  <input name="fSatuan" type="text" id="fSatuan" value="<?=$gSTN?>" <?php if ($KeY=="Y") {echo "readonly";}?> onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" />
	  </td>
    </tr>
    <tr> 
      <td>SUB ROBJ </td>
      <td><select class="boxs" name="fOBJ" tabindex="0" style="width: 100%" onchange="this.form.submit()">
          <?php
      ...
      <td>
	  <input name="fHarga" type="text" id="fHarga" value="<?=fConvertToRupiah($gHRG)?>" <?php if ($KeY=="Y") {echo "readonly";}?> onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:130px; text-align: right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" />
	  </td>
    </tr>
    <tr> 
      <td>SUB-SUB ROBJ</td>
      <td><table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="89%"> 
			<select class="boxs" name="fRin" tabindex="0" style="width: 445px">
                <?php
	  ...
	  ?>
            ...
            <td width="11%" valign="top" align="right"><input type="button" name="B392" value="FIND" <?php if ($KeY=='Y') {echo "disabled";}?> onclick="OpenAccNumb('600','500','center')" style="width: 50px; height: 22px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
      <td>NILAI PEROLEHAN (Rp)</td>
      <td>
	  <input name="fTotal" type="text" id="fTotal" <?=$gReaD?> value="<?=fConvertToRupiah($gTTL)?>" <?php if ($KeY=="Y") {echo "readonly";}?> style="width:130px; text-align: right; background-color: #E1F986; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px"/>
	  </td>
    </tr>
    <tr> 
      <td>REGISTER</td>
...
<input type="button" name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
    ...
    <tr> 
      ...
      <td>
		  <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
		  <tr> 
			<td width="90" valign="top" style="font-weight: bold; color: #008000">BERTINGKAT </td>
			...
			<td width="52" valign="middle" style="font-weight: bold; color: #008000">BETON</td>
	  ...
	  <tr>
		<?php
		$iG=1;
		$SQL="SELECT IDT FROM ta_kib_f_pdf WHERE Referensi='$gREF' ORDER BY IDT";
		$nRs = mysql_query($SQL);
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('f','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?php
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('f','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>
	  </td>
    </tr>
    <tr> 
      <td>PANJANG</td>
      <td><input name="fPanjang" type="text" class="text" id="fPanjang2" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gPjg)?>" size="20" maxlength="15" />
      M</td>
      <td>&nbsp;</td>
      <td colspan="2" rowspan="9"> <table border="0" width="430" style="border-collapse: collapse; color: #CC0000; border: 1px solid #8FA908; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
          ...
          <tr>
			...
			[&nbsp;<a href="#" class="ico doc" onclick="P_OpenDoc('800','400','KIB_F_Dokumen'); return false">DOKUMEN KIB</a>&nbsp;]
			</td>
          </tr>
          <tr> 
            <td width="14">&nbsp;</td>
    ...
    <tr> 
      <td>LEBAR</td>
      <td><input name="fLebar" type="text" class="text" id="fLebar" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gLbr)?>" size="20" maxlength="15" />
      M</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LUAS LANTAI </td>
      <td><input name="fLuas" type="text" class="text" id="fLuas" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gLua)?>" size="20" maxlength="15" />
        M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td>LOKASI</td>
      <td><input name="fLokasi" type="text" class="text" id="fAlamat3" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gLKS?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>KODE TANAH</td>
    ...
    <tr> 
      ...
      <td><textarea name="fKeterangan" cols="57" rows="2" id="textarea" style="border: 1px solid #C0C0C0"><?php echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
