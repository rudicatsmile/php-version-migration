<?php
	function ViewBidang($KdBDG,$mUpb,$mThn,$nThn,$mG,$LoadMutasi,$LoadExtrac,$rPil)  #**#
	{
		$iGG  = 1;
		#$nSQB = "SELECT left(P1.Kd_Aset,5) as Kd_Aset, P2.Nm_Aset 
		#FROM ref_rek_aset5_temp P1 
		#JOIN ref_rek_aset2 P2 ON P2.Kd_Aset=left(P1.Kd_Aset,5) 
		#WHERE P1.Kd_Aset LIKE '".$KdBDG.".%' AND P1.Kd_Unit = '".substr($mUpb,0,11)."' GROUP BY left(P1.Kd_Aset,5)";
		
		$nSQB = "SELECT left(P1.Kd_Aset,8) as Kd_Aset, P2.Nm_Aset 
		FROM ref_rek_aset108_7_temp P1 
		JOIN ref_rek_aset108_4 P2 ON P2.Kd_Aset=left(P1.Kd_Aset,8) 
		WHERE P1.Kd_Aset LIKE '".$KdBDG.".%' AND P1.Kd_Unit = '".substr($mUpb,0,11)."' GROUP BY left(P1.Kd_Aset,8)";
		...
		while ($mRoB = mysql_fetch_array($nRsB, MYSQL_BOTH))
		{
			...
			if ($tView!=0) {
				...
				if ($rPil==2 || $rPil==3 || $rPil==4) {ViewJenis($KdAsT,$mUpb,$mThn,$nThn,$mG,$LoadMutasi,$LoadExtrac,$rPil);}
				$iGG++;
			}
		}
	}
