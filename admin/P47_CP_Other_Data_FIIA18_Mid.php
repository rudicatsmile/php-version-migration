...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family:calibri; font-size:10pt">
  ...
  <tr height="24">
    ...
    <td>:</td>
    <td colspan="2"><input type="text" name="fTgBA" id="fTgBA" value="<?=$TgBA?>" style="width:90px; text-align:center" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td>&nbsp;</td>
    <td>a.</td>
    <td>Perjanjian Tukar Menukar</td>
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="padding-left:13px"><li>Tentang</td>
    <td>:</td>
  ...
  <tr height="24">
    ...
    <td><a href="#" onClick="formCetakDok('Format_II_A_18','<?=$IdT?>','800','400','<?=$IdL?>'); return false" class="ico docu">&nbsp;&nbsp;Format II.A.18</a></td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
