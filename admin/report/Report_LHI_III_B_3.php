...
?>
<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:2100px; font-family:calibri; text-align:center; font-weight:bold; font-size:11pt">
<tr>
  	<td style="text-align:right">Format : III.B.3&nbsp;</td>
</tr>
<tr>
  	<td>LAPORAN HASIL INVENTARISASI (LHI)</td>
</tr>
<tr>
  	<td>REKAPITULASI BMD BELUM DIKAPITALISASI DAN  DIKETAHUI DATA AWAL/DATA INDUKNYA</td>
</tr>
<tr>
  	<td><?=$NmA?></td>
</tr>
...
?>
<table align="center" cellpadding="0" cellspacing="0" border="0" width="2100" style="border-collapse:collapse; font-family:calibri; font-size:9pt">
<tr style="text-align:center; font-weight:bold">
	...
	<td colspan="6" style="border:1px solid #000">DATA INDUK </td>
...
<tr style="text-align:center; font-weight:bold">
  ...
  <td style="border:1px solid #000">Kode Lokasi </td>
...
<tr style="text-align:center">
  ...
  <td width="120" style="border:1px solid #000">4</td>
  <td width="200" style="border:1px solid #000">5</td>
  <td width="200" style="border:1px solid #000">6</td>
  <td width="200" style="border:1px solid #000">7</td>
  ...
  <td width="90" style="border:1px solid #000">11</td>
  <td width="90" style="border:1px solid #000">12</td>
...
P4.Nibar as A15,
P4.KodeBarang as A16,
P4.KodeLokasi as A17,
P4.KodeRegister as A18,
P4.NamaBarang as A19,
P4.NamaSpesifikasiBarang as A20 
...
AND P1.MerupakanAtribusi='ya' 
AND P1.MerupakanAtribusi_induk='diketahui' 
...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="2100" style="font-family:calibri; font-size:10pt">
  <tr>
    <td width="436">&nbsp;</td>
    <td width="433">&nbsp;</td>
    <td width="481">&nbsp;</td>
