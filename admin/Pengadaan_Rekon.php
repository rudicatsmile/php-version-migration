...
<div align="center">
	...
	<tr>
		...
		<tr>
          ...
          <?php } ?>
          <?php function ViewRincian($x1,$x2,$x3,$x4,$x5,$iR,$xB) {?>
          <tr style="font-family:arial; font-size:8pt"> 
            ...
            <td width="93" valign="top" style="border-top: 1px <?php if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x1?></td>
            <td width="323" valign="top" style="border-top: 1px <?php if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-left:3px"><?=$xB.$x2?></td>
            <td width="105" valign="top" style="border-top: 1px <?php if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:center"><?=$xB.$x3?> unit</td>
            <td width="99" valign="top" style="border-top: 1px <?php if ($iR==1) {echo "solid";} else {echo "dotted";}?> #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align:right; padding-right:3px"><?=$xB.fConvertToRupiah($x4)?></td>
            </tr>
          <?php } ?>
