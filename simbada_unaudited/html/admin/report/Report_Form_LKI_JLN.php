...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:800px; border:1px solid #000; font-family:calibri;">
	<tr height="20">
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td>&nbsp;</td>
          <td width="100">Format : III.A.4</td>
        </tr>
      </table>
	  </td>
	</tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128"><?=TChek($CkKrs1,'Sesuai','80')?></td>
          <td width="100"><?=TChek($CkKrs2,'Tidak Sesuai','100')?></td>
          <td width="135">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><?=$CkKrsM?></td>
        </tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128"><?=TChek($CkStr1,'Sesuai','80')?></td>
          <td width="100"><?=TChek($CkStr2,'Tidak Sesuai','100')?></td>
          <td width="135">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><?=$CkStrM?></td>
        </tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128"><?=TChek($CkRua1,'Sesuai','80')?></td>
          <td width="100"><?=TChek($CkRua2,'Tidak Sesuai','100')?></td>
          <td width="135">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><?=$CkRuaM?></td>
        </tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128"><?=TChek($CkIri1,'Sesuai','80')?></td>
          <td width="100"><?=TChek($CkIri2,'Tidak Sesuai','100')?></td>
          <td width="135">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><?=$CkIriM?></td>
        </tr>
  ...
  <tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td width="196"><?=TChek($CkAda2,'Tidak Ada','80')?></td>
          <td width="147">&nbsp;</td>
          <td width="20">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="25">
          <td width="30" rowspan="8" valign="top">M.</td>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="30">P.</td>
          <td width="138">Penggunaan Barang</td>
          <td width="23">:</td>
        ...
        <tr height="25">
          ...
          <td width="16">:</td>
          <td width="417" colspan="2"><?=$NmPemakai?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td width="16">:</td>
          <td width="417" colspan="2"><?=$StPemakai?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td><?=TChek($CkBasPD2,'Tidak Ada','100')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          ...
          <td>:</td>
          <td><?=TChek($CkSipPD1,'Ada','70')?></td>
          <td><?=TChek($CkSipPD2,'Tidak Ada','100')?></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="26">R.</td>
          <td width="137">Gedung dan Bangunan diatas tanah milik</td>
          <td width="21">:</td>
          <td width="254"><?=TChek($CkMil1,'Pemerintah Daerah','200')?></td>
          <td width="340">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?=TChek($CkMil2,'Pemerintah Daerah Lainnya, sebutkan :','250')?></td>
          <td><?=$CkMil2Memo?></td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?=TChek($CkMil3,'Pemerintah Pusat','200')?></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?=TChek($CkMil4,'Pihak Lain, sebutkan :','200')?></td>
          <td><?=$CkMil4Memo?></td>
          <td>&nbsp;</td>
        </tr>
	  </table>
