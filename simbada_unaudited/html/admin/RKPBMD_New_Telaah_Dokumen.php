...
<div align="center">
	<table border="0" width="1500" cellspacing="1" style="font-size: 9pt; font-family: Calibri; border-collapse: collapse" id="table1">
		<tr>
			<td style="font-size: 11pt; font-weight: bold" align="center">HASIL PENELAAHAN RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<table border="1" width="100%" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
				<tr>
				    ...
				    <td colspan="2" align="center" style="font-weight: bold">RENCANA KEBUTUHAN PEMELIHARAAN BMD YANG DISETUJUI</td>
				...
				<tr>
					...
					<td width="38" align="center" style="font-weight: bold; border-bottom: 3px double #000000">14</td>
				    <td width="40" align="center" style="font-weight: bold; border-bottom: 3px double #000000">15</td>
				    <td width="150" align="center" style="font-weight: bold; border-bottom: 3px double #000000">16</td>
				</tr>
				<?
				...
				$nKT = fGlobalNEW("IfNull(sum(Jumlah_Yg_Disetujui),0)","ta_rkpbmd_new_rekening","Referensi:Kd_Unit:Tahun",$Ref.":".$UnT.":".$Thn,"=:=:=","",$DatabaseSB,$ConSB,"");
				...
				?>
					<tr height="20">
						...
						<td align="center" valign="top"><?=$xB.$x16?></td>
				...
				<tr height="25">
					...
					<td align="center" style="font-weight: bold; border-top: 3px double #000000">&nbsp;</td>
					<td style="font-weight: bold; border-top: 3px double #000000; text-align:center"><?=fConvertToRupiahBulat($nKT)?></td>
				    <td style="font-weight: bold; border-top: 3px double #000000; text-align:center">&nbsp;</td>
