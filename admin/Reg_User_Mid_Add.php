  ...
  <input type="hidden" name="fSimpan">
    <table width="650" border="0" cellspacing="3" cellpadding="0" style="font-family:Calibri; font-size:9pt">
      ...
      <tr valign="top">
        ...
        <td width="456" align="left"><input name="fUid" id="fUid" type="text" style="width:150px" value="<?php if (isset($gUid)) {echo $gUid;}?>" /> 
          ** </td>
      </tr>
      <tr valign="top">
        <td width="136" align="left" title="<?php echo base64_encode("oecoep76").":".$gPasA?>">PASSWORD</td>
        <td width="456" align="left"><input name="fPasA" id="fPasA" type="Password" class="text" style="width:150px" value="<?php if (isset($gPasA)) {echo $gPasA;}?>" /> 
          ** </td>
      </tr>
      <tr valign="top">
        <td width="136" align="left" title="<?php echo base64_encode("oecoep76").":".$gPasA?>">RETYPE PASSWORD </td>
        <td width="456" align="left"><input name="fPasB" id="fPasB" type="Password" style="width:150px" class="text" value="<?php if (isset($gPasB)) {echo $gPasB;}?>" /> 
          ** </td>
      </tr>
      <tr valign="top">
        <td align="left">NAMA LENGKAP </td>
        <td align="left"><input name="fNmaA" id="fNmaA" type="text" class="text" value="<?php if (isset($gNmaA)) {echo $gNmaA;}?>" size="40"/></td>
      </tr>
      <tr valign="top">
        <td align="left">NAMA PANGGILAN </td>
        <td align="left"><input name="fNmaB" id="fNmaB" type="text" class="text" value="<?php if (isset($gNmaB)) {echo $gNmaB;}?>" size="40"/></td>
      </tr>
      <tr valign="top">
        <td align="left">UNIT KERJA </td>
        <td align="left">
		<select name="fUnt" tabindex="0" style="width: 400px" <?php if ($eIdT=="") { echo "onchange='this.form.submit()'";}?>>
        <?php
		if ($eIdT!="")
		{
      ...
      <tr valign="top">
        ...
        <td align="left"><select name="fSub" tabindex="0" style="width: 400px" <?php if ($eIdT=="") { echo "onchange='this.form.submit()'";}?>>
          <?php
		if ($eIdT!="")
		{
      ...
      <tr valign="top">
        ...
        <td align="left">
		<select name="fUpb" tabindex="0" style="width: 400px" <?php if ($eIdT=="") { echo "onchange='this.form.submit()'";}?>>
        <?php
		if ($eIdT!="")
		{
      ...
      <tr valign="top">
        ...
        <td align="left"><textarea name="fText" cols="40" rows="3"><?php if (isset($gText)) {echo $gText;}?></textarea></td>
      </tr>
      <tr valign="top">
        <td align="left">&nbsp;</td>
        <td align="left" style="color:#FF0000"><?php if (isset($_GET['gMsG'])) {echo $_GET['gMsG'];}?>&nbsp;</td>
      </tr>
      <tr valign="top">
        <td align="left">&nbsp;</td>
