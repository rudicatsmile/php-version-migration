			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
				...
				if ($mRw > 0)
				{
					do
					{
						...
						?>
						<tr>
							<td><?php echo fConvertDateShort($mRo['Tanggal'])?></td>
							<td><?php echo $gMem?></td>
							<td align="right"><?php if ($nDB!=0) {echo fConvertToRupiah($nDB);}?></td>
							<td align="right"><?php if ($nKR!=0) {echo fConvertToRupiah($nKR);}?></td>
						    <td align="right">&nbsp;</td>
						    <td><?php echo $mRo['Keterangan']?></td>
					    </tr>
						<?php
					}
