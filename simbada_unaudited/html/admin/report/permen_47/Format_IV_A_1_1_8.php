...
if ($RdB=='V2')
{
	...
	$fP1Pkt  = fGlobal("Jab_Pimpinan","ref_unit","Kd_Unit",$KdS,"=","","");
	$fP1Jab  = fGlobal("Pkt_Pimpinan","ref_unit","Kd_Unit",$KdS,"=","","");
}
if ($RdB=='V3')
{
	$KdSx = "24.04.13.04";
...
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format IV.A.1.1.8</td>
  </tr>
</table>
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:11pt">
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">xREKAPITULASI PENGADAAN PERSEDIAAN PER PENGGUNA BARANG 
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri"><?=$NmDaer?></td>
  </tr>
  <tr>
...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" colspan="3">Jumlah (Rp)</td>
    <td rowspan="2" style="border:1px solid #000">Total (Rp)</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Barang Pakai Habis</td>
    <td style="border:1px solid #000">Barang Tak Pakai Habis</td>
    <td style="border:1px solid #000">Barang Bekas Dipakai</td>
  </tr>
