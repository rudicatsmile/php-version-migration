			...
			<table border="1" width="100%" style="font-family: arial; font-size: 8pt; border-collapse: collapse" bordercolor="#000000">
				...
				?>
					<tr valign="top" height="22">
						...
						<td style="text-align:center"><? if ($x13>0) {echo $xB.fConvertToRupiahBulat($x13); }else {echo "-";}?></td>
						<td style="text-align:right; padding-right:3px"><? if ($x14>0) {echo $xB.fConvertToRupiah($x14); }else {echo "-";}?></td>
						<td style="text-align:center"><? if ($x15>0) {echo $xB.fConvertToRupiahBulat($x15); }else {echo "-";}?></td>
						<td style="text-align:right; padding-right:3px"><? if ($x16>0) {echo $xB.fConvertToRupiah($x16); }else {echo "-";}?></td>
						<td style="text-align:center"><? if ($x17>0) {echo $xB.fConvertToRupiahBulat($x17); }else {echo "-";}?></td>
						<td style="text-align:right; padding-right:3px"><? if ($x18>0) {echo $xB.fConvertToRupiah($x18); }else {echo "-";}?></td>
						<td style="text-align:center"><? if ($x19>0) {echo $xB.$x19; }else {echo "-";}?></td>
						<td style="text-align:right; padding-right:3px"><? if ($x20>0) {echo $xB.$x20; }else {echo "-";}?></td>
						<td><?=$xB.$x21?></td>
					</tr>
					<?
				}
				...
				<tr height="23">
					...
					<td style="font-weight: bold; border-top: 3px double #000000; text-align:right; padding-right:3px"><? if ($t17>0) {echo fConvertToRupiahBulat($t17);}else{echo "-";}?></td>
					<td style="font-weight: bold; border-top: 3px double #000000; text-align:right; padding-right:3px"><? if ($t18>0) {echo fConvertToRupiah($t18);}else{echo "-";}?></td>
					<td style="font-weight: bold; border-top: 3px double #000000; text-align:right; padding-right:3px"><? if ($t19>0) {echo fConvertToRupiahBulat($t19);}else{echo "-";}?></td>
					<td style="font-weight: bold; border-top: 3px double #000000; text-align:right; padding-right:3px"><? if ($t20>0) {echo fConvertToRupiah($t20);}else{echo "-";}?></td>
