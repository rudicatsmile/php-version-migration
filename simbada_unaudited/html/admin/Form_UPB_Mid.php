...
<form name="myfrm" method="post" action="<?php echo "Form_UPB_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="1100" cellpadding="0" style="border-collapse: collapse">
    ...
    <tr> 
      ...
      <td width="37">:</td>
      <td> <select class="boxs" name="fBdg" tabindex="0" style="width: 470px" <? echo $Sbmt ?>>
          <?
		if ($Lev > 1)
    ...
    <tr> 
      ...
      <td width="37">:</td>
      <td>
	  <select class="boxs" name="fUnt" tabindex="0" style="width: 470px" <? echo $Sbmt ?>>
	  <option value=""></option>
          <?
		if ($Lev > 1)
    ...
    <tr> 
      ...
      <td width="37">:</td>
      <td><select class="boxs" name="fSub" tabindex="0" style="width: 470px" <? echo $Sbmt ?>>
          <?
    ...
    <tr> 
      ...
      <td width="37">:</td>
      <td> <input name="fNmUpb" type="text" class="text" id="fNmUpb" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gNMU?>" size="55" maxlength="100" /> 
      </td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
    ...
    <tr> 
      ...
      <td><input type="button" name="B39" value="SIMPAN" onclick="P_Save('<?=$ReO?>')" style="width: 60px; height: 21px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
        ...
        <input type="button" name="B3922" value="REFRESH" <? if ($rIDT==""){echo "disabled";}?> onclick="P_Refresh()" style="width: 60px; height: 21px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /> 
		...
		do
            ...
            <tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
              <td> 
                <? echo $iG?>
                .</td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo $mRo['Tahun']?>              </td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo $mRo['Nm_Pimpinan']?>              </td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo $mRo['Nip_Pimpinan']?>              </td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <?
              ...
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><?=$mRo['Hp_Pimpinan']?></td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><?=$mRo['Pin_Pimpinan']?></td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><?=$mRo['Ema_Pimpinan']?></td>
              <td align="center">
            ...
            <tr> 
              <td colspan="9">
			  <table cellpadding="3" id="detail<? echo $iG?>" border="0" width="100%" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
                  <tr> 
                    <td width="26">&nbsp;</td>
