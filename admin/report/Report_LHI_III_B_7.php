...
?>
<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:1850px; font-family:calibri; text-align:center; font-weight:bold; font-size:11pt">
<tr>
  	<td style="text-align:right">Format : III.B.7&nbsp;</td>
</tr>
<tr>
  	<td>LAPORAN HASIL INVENTARISASI (LHI)</td>
</tr>
<tr>
  	<td>REKAPITULASI BMD TERJADI PERUBAHAN KONDISI FISIK BARANG</td>
</tr>
<tr>
  	<td><?=$NmA?></td>
</tr>
...
?>
<table align="center" cellpadding="0" cellspacing="0" border="0" width="1850" style="border-collapse:collapse; font-family:calibri; font-size:9pt">
<tr height="35" style="text-align:center; font-weight:bold">
	...
	<td colspan="3" style="border:1px solid #000">Kondisi Fisik<br>Sebelum Inventarisasi</td>
	<td colspan="3" style="border:1px solid #000">Kondisi Fisik<br>Setelah Inventarisasi</td>
	<td rowspan="2" style="border:1px solid #000">Keterangan</td>
    <td rowspan="2" style="border:1px solid #000">Petugas Sensus</td>
</tr>
<tr style="text-align:center; font-weight:bold">
  <td style="border:1px solid #000">Baik (B)</td>
  <td style="border:1px solid #000">Rusak Ringan (RR)</td>
  <td style="border:1px solid #000">Rusak Berat (RB)</td>
  <td style="border:1px solid #000">Baik (B)</td>
  <td style="border:1px solid #000">Rusak Ringan (RR)</td>
  <td style="border:1px solid #000">Rusak Berat (RB)</td>
</tr>
<tr style="text-align:center">
  ...
  <td width="95" style="border:1px solid #000">2</td>
  ...
  <td width="70" style="border:1px solid #000">12</td>
  <td width="70" style="border:1px solid #000">13</td>
  <td width="70" style="border:1px solid #000">14</td>
  <td width="70" style="border:1px solid #000">15</td>
  <td width="70" style="border:1px solid #000">16</td>
...
P1.KondisiBarangAsal as A15,
P1.KondisiBarang as A16 
...
{
	$img = "<img src='../css/images/newokey.gif' />";
	$KonA = $mRo[15];
	$Co11 = ""; $Co12 = ""; $Co13 = "";
	if ($KonA=='B')	 {$Co11 = $img;}
	if ($KonA=='RR') {$Co12 = $img;}
	...
	<tr height="22">
	  ...
	  <td style="border:1px solid #000; text-align:center"><?=$Co11?></td>
	  <td style="border:1px solid #000; text-align:center"><?=$Co12?></td>
	  <td style="border:1px solid #000; text-align:center"><?=$Co13?></td>
...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="1850" style="font-family:calibri; font-size:10pt">
  <tr>
    <td width="481">&nbsp;</td>
    <td>&nbsp;</td>
    <td width="481">&nbsp;</td>
