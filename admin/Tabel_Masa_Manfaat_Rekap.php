...
<tr>
  ...
  <div class="pagging"> 
	...
	if ($CntItem>0)
	{
		...
		{
			?>
			<a href="<?="Tabel_Masa_Manfaat_Rekap.php?iPG=".$iR."&rTH=".$rTH."&rAS=".$rAS."&uNT=".$uNT."&gUnt=".$uNT."&gHriC=".$frHri."&gBlnC=".$frBln."&gThnC=".$frThn."&IdL=".$IdL?>"><?="<b>".substr('00'.$i,-3,3)."</b>"?></a><?php if ($i==100) {echo "<br>";}?><?=str_repeat('&nbsp;',0)?>
			<?php 
			$i++;
		}
	}
