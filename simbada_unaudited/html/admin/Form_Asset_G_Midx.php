...
if ($rIDT!="")
{
	...
	if ($tRo > 0)
	{
		...
		$gNIa = fGlobal("IfNull(sum(Debet),0)","ta_kib_post_108","Referensi:Kd_UPB",$gREF.":".$gUnt."%","=:LIKE","","");
		$gNIb = fGlobal("IfNull(sum(Kredit),0)","ta_kib_post_108","Referensi:Kd_UPB",$gREF.":".$gUnt."%","=:LIKE","","");
  ...
  <table border="0" align="center" width="1165">
    ...
    <tr> 
	  ...
	  ?>
            ...
            <td width="11%" valign="top" align="right"><input type="button" name="B392" value="FIND" <? if ($KeY=='Y') {echo "disabled";}?> onclick="OpenAccNumb('600','500','center')" style="width: 50px; height: 22px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
...
<input type="button" name="B393" value="RESET" disabled onclick="P_Reset('<?=$ReO?>')" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" />
<? if ($KeY=='Y') { echo "<div style='float:right'><img src='css/images/keys.png' /></div>";}?></td>
            <td width="6%"> 
  ...
  <?
	  ...
	  <tr>
		...
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('g','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('g','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>	  </td>
    </tr>
    <tr> 
      ...
      <td colspan="2" rowspan="9"> <table border="0" width="430" style="border-collapse: collapse; color: #CC0000; border: 1px solid #8FA908; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
          <tr> 
            ...
            <td width="121" bgcolor="#8FA908">RESULT</td>
          ...
          <tr> 
            ...
            <td>&nbsp;</td>
            <td width="141">&nbsp;</td>
            <td width="109" rowspan="7" align="center" valign="middle">
			<table border="0" width="97" bgcolor="#FFFFFF" cellpadding="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
			  ...
			  <tr>
				...
				<? if ($gIMG!="") {?>
					<a href="#"><img src="<?="SourceIMG.php?rCRT=g&rIDT=".$rIDT?>" height="75" width="80" onclick="PreviewIMG('400','300','center')"></a>
				<? } else {?>
          ...
          <tr> 
            <td width="15">&nbsp;</td>
            <td width="121">REFERENSI GROUP</td>
            <td width="20">:</td>
            <td> 
              <? echo $gGRP?>            </td>
          </tr>
          ...
          <tr> 
            <td width="15">&nbsp;</td>
            <td width="121">RECORDED</td>
            <td width="20">:</td>
            <td>-</td>
          </tr>
          <tr> 
            <td width="15">&nbsp;</td>
            <td width="121">PENCATAT</td>
            <td width="20">:</td>
            <td>-</td>
          </tr>
          <tr>
    ...
    <tr> 
      <td>KETERANGAN</td>
      <td><textarea name="fKeterangan" cols="57" rows="4" id="textarea" style="border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
...
<script language="javascript">
			...
			if (win!=null)
    			{
					...
					<?
						$URL_Top = "Find_Acc_Top.php?CrAcc=Form_Asset_G_Mid&IdL=".$_GET['IdL']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb;
						$URL_Mid = "Find_Acc_Mid.php?CrAcc=Form_Asset_G_Mid&IdL=".$_GET['IdL']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb;
			...
			if (win!=null)
    			{
					...
					$URL_Mid = "Form_Invent_Asset_Ubh.php?rKib=Kib_G&IdL=".$_GET['IdL']."&rIDT=".$rIDT;
	...
	function PreviewIMG(w,h,pos)
	{
		...
		<?
			{
			$URL="PreviewIMG.php?rCRT=g&rIDT=".$rIDT."&IdL=".$_GET['IdL'];
			}
		?>
	...
	{	var win=null;
		...
		if (win!=null)
		{
			...
			URL_Mid = "UploadIMG_Mid.php?"+"<?="rCRT=g&rIDT=".$rIDT."&IdL=".$_GET['IdL']?>";
