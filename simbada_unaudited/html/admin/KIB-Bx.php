  ...
  <table border="0" align="center" style="width:99%">
    ...
    <tr> 
      ...
      <td valign="middle"> <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            <td width="46%"> <input class="text" type="text" name="fFind" placeholder='Search' value="<? echo $gFin?>" style="width: 200px; font-family: Calibri; font-size: 10pt; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
	  ...
	  <table align="center" border="0" class="table-list" cellspacing="0" cellpadding="0" style="width:99%">
		...
		do
			...
			if ($mRo['kode_bar']!=""){
				...
				$BARKODE="<font style='background:#FF0000; color:#FFFFFF'>
							Scan QR SIMANDOR tanggal : ".$tanggal_scan." oleh : ".$user_scan." [".$mRo['kode_bar']."]
						</font><br>";
			}
			if ($tMuTZ!=""){
				$gCeU = $mRo['Ref_Mutasi'];
			...
			<tr height="40" style="cursor: pointer <?=$Blnk?>" <?=fBackCLR($iG)?>> 
              ...
              <td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px"><?=$BARKODE.$NmB.$TtK?><? if ($mRo['Kd_Ruang']==''){echo "<font style='color:#ff0000'><i><br>Belum Masuk KIR</i></font>";}?></td>
