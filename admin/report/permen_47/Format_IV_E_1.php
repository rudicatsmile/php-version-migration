...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    <td style="border:1px solid #000" rowspan="3">No.</td>
    <td style="border:1px solid #000" rowspan="3">NIBAR</td>
    ...
    <td style="border:1px solid #000" rowspan="3">Nilai Perolehan Barang (Rp)</td>
    <td style="border:1px solid #000" rowspan="3">Mitra Pemanfaatan</td>
    <td style="border:1px solid #000" rowspan="3">Jumlah</td>
    <td style="border:1px solid #000" rowspan="3">Satuan</td>
    <td style="border:1px solid #000" rowspan="3">Lokasi</td>
    <td colspan="3" style="border:1px solid #000">Jangka Waktu</td>
    <td style="border:1px solid #000" rowspan="3">Peruntukan</td>
    <td style="border:1px solid #000" colspan="4">Dasar Penggunaan</td>
    <td rowspan="2" style="border:1px solid #000" colspan="3">Dokumen Pendukung 
	Lainnya</td>
    <td rowspan="3" style="border:1px solid #000">Keterangan</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
    <td style="border:1px solid #000; border-bottom:1px solid #000" rowspan="2">Kode<br>Barang</td>
    <td style="border:1px solid #000; border-bottom:1px solid #000" width="35" rowspan="2">Nama Barang</td>
    <td style="border:1px solid #000" rowspan="2">Waktu Pemanfaatan</td>
    <td style="border:1px solid #000" rowspan="2">Mulai</td>
    <td style="border:1px solid #000" rowspan="2">Berakhir</td>
    <td style="border:1px solid #000" colspan="2">Surat Keputusan</td>
    <td style="border:1px solid #000" colspan="2">Surat Perjanjian</td>
  </tr>
  <tr style="text-align:center; font-weight:bold">
  ...
  <tr style="text-align:center">
    <td width="26" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
    <td width="71" style="border:1px solid #000; border-bottom:3px double #000">
	&nbsp;</td>
  ...
  <tr height="25" style="font-weight:bold">
    <td colspan="4" style="border:1px solid #000; border-top:3px double #000; text-align:center">T O T A L</td>
