...
if ($rIDT!="")
{
	$nSQ = "SELECT * FROM ref_rek_aset108_6 WHERE IDT='".$rIDT."'";
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset108_5_Mid_.php?IdL=".$IdL."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="114">OBJEK</td>
      <td width="20">:</td>
      <td>
	  <select name="fJNS" class="boxs" id="fJNS" style="width: 480px" tabindex="0" <?php echo $Sbmt?>>
          <?php
    ...
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="114">RINCIN</td>
      <td width="20">:</td>
      <td>
	  <select class="boxs" name="fOBJ" tabindex="0" style="width: 480px" <?php echo $Sbmt?>>
          <?php
    ...
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="114">KODE SUBR</td>
      <td width="20">:</td>
      <td><input name="fKode" type="text" class="text" id="fKode" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<?php echo $gCod?>" size="12" maxlength="15" /></td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="114">NAMA SUBR </td>
      <td width="20">:</td>
