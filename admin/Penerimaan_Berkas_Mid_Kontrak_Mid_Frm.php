...
<form name="myfrm" method="post" action="<?="Penerimaan_Berkas_Mid_Kontrak_Mid_Frm_.php?gID=".$gID."&gKG=".$gKG."&gRK=".$gRK."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" style="width:770px">
	...
	<tr height="25">
	  ...
	  <td valign="top">:</td>
	  <td valign="top"><input name="fNoM" type="text" value="<?=$gNoM?>" <?php if ($gDeL) {echo "readonly";}?> style="width:204px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
	  <td valign="top"></td>
    </tr>
	<tr height="27">
	  <td valign="top">&nbsp;</td>
	...
	<tr height="22">
	  ...
	  <td valign="top">&nbsp;</td>
	  <td valign="top">&nbsp;</td>
	  <td valign="top"><?php if (isset($_GET['MsG'])) {echo $_GET['MsG'];}?></td>
	  <td valign="top"></td>
    </tr>
	<tr height="22">
	  <td valign="top">&nbsp;</td>
