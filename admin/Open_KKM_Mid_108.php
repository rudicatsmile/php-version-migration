  ...
  <table border="0" align="center" style="width:700px">
    ...
    <tr>
	  ...
	  <select class="boxs" name="fSst" id="fSst" style="width: 120px" tabindex="0">
        <option value="BLN" <?php if ($gSst=="BLN") {echo "selected";}?>>PERBULAN</option>
        <!--option value="THN" <?php if ($gSst=="THN") {echo "selected";}?>>PERTAHUN</option-->
      </select></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
