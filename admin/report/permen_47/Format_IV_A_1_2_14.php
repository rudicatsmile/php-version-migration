...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td colspan="5" style="border:1px solid #000">Penambahan (Rp) </td>
    <td colspan="6" style="border:1px solid #000">Pengurangan
    (Rp) </td>
    <td rowspan="2" style="border:1px solid #000">Selisih +/-</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Dari Rek.Belanja operasi</td>
    <td style="border:1px solid #000">Dari Rek.Belanja Tidak Terduga</td>
    <td style="border:1px solid #000">Dari Rek.Belanja Modal Jenis lainnya</td>
    <td style="border:1px solid #000">Dari Barang Karena Alasan Lainnya</td>
    <td style="border:1px solid #000">Jumlah</td>
    <td style="border:1px solid #000">Ke Jenis Aset Tetap Selain ..</td>
    <td style="border:1px solid #000">Ke Aset Tetap EkstraKomtabel</td>
    <td style="border:1px solid #000">Ke Aset Lancar Berupa Persediaan</td>
    <td style="border:1px solid #000">Ke Aset lainnya</td>
    <td style="border:1px solid #000">Karena Alasan Lainnya</td>
    <td style="border:1px solid #000">Jumlah</td>
  </tr>
  <tr style="text-align:center">
    ...
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">
	16</td>
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
  </tr>
	<?php
