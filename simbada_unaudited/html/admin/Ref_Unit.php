  ...
  <input type="hidden" name="CritIDT" size="10">
    ...
    <table align="center" class="table-list" border="0" cellspacing="0" cellpadding="0" style="width:99%">
      ...
      <tr height="22" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
        ...
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><?=$mRo['Kd_Unit']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><?=$mRo['Nm_Unit']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><?=$mLNK?></td>
      ...
      <tr> 
        <td colspan="5"> <table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <?
			if ($zRo > 0)
			{
			do
