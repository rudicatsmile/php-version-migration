...
?>
<body>
<form name="myfrm" method="POST" action="<? echo "Information_Mid.php?IdL=".$IdL ?>">
		...
		do
            ...
            <tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
              ...
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo $mRo['Header']?>              </td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo substr($mRo['Informasi'],0,60)."...."?>              </td>
              <td onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" align="center"><? echo $mRo['Tampil']?></td>
              <td align="right"><a href="#" class="ico del" onclick="P_DeleteR('<? echo $mRo['IDT']?>')">DELETE</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="ico edit" onclick="EditData<? echo $mRo['IDT']?>('650','450','center')">EDIT</a></td>
            </tr>
            <tr> 
              <td colspan="5">
			  <table cellpadding="3" id="detail<? echo $iG?>" border="0" width="100%" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
                  <tr> 
                    <td width="100">&nbsp;</td>
                    <td align="center"><? echo $mRo['Informasi']?></td>
                  </tr>
