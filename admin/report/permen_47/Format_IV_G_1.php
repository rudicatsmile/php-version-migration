...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">Pengguna Barang Sementara</td>
    <td style="border:1px solid #000" rowspan="2">Jumlah Barang</td>
    <td style="border:1px solid #000" rowspan="2">Satuan Barang</td>
    <td style="border:1px solid #000" colspan="3">Sebelum Koreksi</td>
    <td style="border:1px solid #000" colspan="3">Setelah Koreksi</td>
    <td style="border:1px solid #000" colspan="3">Selisih</td>
    <td style="border:1px solid #000" rowspan="2">Penyebab Koreksi</td>
    <td colspan="3" style="border:1px solid #000">Dokumen Sumber</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Nilai Akumulasi Penyusutan atau Amortisasi 
	(Rp)</td>
    <td style="border:1px solid #000">Nilai Buku (Rp)<p>&nbsp;</td>
    <td style="border:1px solid #000">Nilai Perolehan (Rp)</td>
    <td style="border:1px solid #000">Nilai Akumulasi Penyusutan atau Amortisasi 
	(Rp)</td>
