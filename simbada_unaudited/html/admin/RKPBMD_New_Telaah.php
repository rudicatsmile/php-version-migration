...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%">
  ...
  <tr height="25">
    ...
    <td colspan="2" style="padding-right:5px">
	  ...
	  <input type="hidden" name="B3" value="EXPORT KE PERUBAHANx" onclick="exportFORM('<?=$_GET['IdL']?>')" style="width: 140px; height: 21px; color:#FF0000" />
	  </div>	  </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
...
<script languange="javascript">
	...
	function RefreshDATA(IdL)
	{
		...
		if (ShoW==1){
			...
			{
				$("#ViewDATA").load('RKPBMD_New_Telaah_Data.php?gUnT='+gUnT+'&gFnD='+gFnD+'&gTHN='+gTHN+'&gUBH='+gUBH+'&IdL='+IdL);
			});
		}
		else{
			$(document).ready(function()
			{
				$.ajax({
					url:"RKPBMD_New_Telaah_Data.php",
	...
	{
		window.open('RKPBMD_New_Telaah_Frm.php?FrmG=FORM TELAAH USULAN PEMELIHARAAN BMD&IdT='+IdT+'&IdL='+IdL,'_self');
	}
