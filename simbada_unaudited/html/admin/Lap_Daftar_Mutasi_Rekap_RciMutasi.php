...
$nSQL= "SELECT Kd_Aset FROM ta_kib_post_mutasi WHERE Kd_UPB LIKE '$gUnt%' GROUP BY Kd_Aset";
$nRs = mysql_query($nSQL);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	$tID = fGlobal("IDT","ref_rek_aset5_temp","Kd_Aset:Kd_Unit",$mRo[0].":".$gUnt,"=:=","","");
...
<table border="0" align="center" width="4300" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
	...
	<tr>
		...
		<tr>
			<td width="75">SKPD</td>
			<td width="23">:</td>
			<td width="3188"><? if ($xUnt=="") {echo "<i>SEMUA</i>";} else {echo strtoupper(fGlobal("Nm_Unit","Ref_Unit","Kd_Unit",$xUnt,"=","",""));}?></td>
	...
	<tr>
	  <td><table border="1" width="4300" cellspacing="1" style="font-family: arial; font-size: 8pt; border-collapse: collapse" bordercolor="#000000">
        ...
        <?
			...
			while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
			{
				...
				if (fNmHuruf($iG)=="f"){
					#TAHUN BERSANGKUTAN
					# - 
					$Col[47] = ItemKurangKibF($iG,$sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG),"Kd_Aset:Tgl_Perolehan:Tgl_Perolehan:Kd_Upb:KdpToAset".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL.":Y","LIKE:>=:<=:LIKE:=".$oPr,"","");
					$Col[48] = HargKurangKibF($sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb:KdpToAset".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL.":Y","LIKE:>=:<=:LIKE:=".$oPr,"","");
					# +
					$Col[49] = ItemTambahKibF($iG,$sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG),"Kd_Aset:Tgl_Perolehan:Tgl_Perolehan:Kd_Upb".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL,"LIKE:>=:<=:LIKE".$oPr,"","");
					$Col[50] = HargTambahKibF($sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL,"LIKE:>=:<=:LIKE".$oPr,"","");
				}
				else{
					if ($LoadMutasi=="Y"){
						#RUSAK BERAT
						$mMS="RB";
						# -
						$Col[7]  = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[8]  = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[9]  = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[10] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
					
						#MUTASI SKPD
						$mMS="MS";
						# -
						$Col[11] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[12] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[13] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[14] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
					
						#MUJTASI KIB
						$mMS="MK";
						# - 
						$Col[15] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[16] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +	
						$Col[17] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[18] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#LELANG
						$mMS="LE";
						# - 
						$Col[19] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[20] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[21] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[22] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#HIBAH
						$mMS="HB";
						# - 
						$Col[23] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[24] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[25] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[26] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#RENOVASI
						$mMS="AR";
						# - 
						$Col[27] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[28] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[29] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[30] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#DOBEL CATAT / KOREKSI
						$mMS="KR";
						# - 
						$Col[31] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[32] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[33] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[34] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#DALAM PENELUSURAN
						$mMS="PL";
						# - 
						$Col[35] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[36] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[37] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[38] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#HILANG
						$mMS="HL";
						# - 
						$Col[39] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[40] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[41] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[42] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						
						#PENGHAPUSAN
						$mMS="PH";
						# - 
						$Col[43] = ItemKurang($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset:Tgl_Mutasi:Kd_Upb:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%".":".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[44] = HargKurang($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						# +
						$Col[45] = ItemTambah($iG,$KdAsT,$Thn_B,$gUpb,$mMS,"");  #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG)."_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						$Col[46] = HargTambah($KdAsT,$Thn_B,$gUpb,$mMS,"");      #fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsT."%:".$Thn_B."-%-%:".$gUpb.":".$mMS,"LIKE:LIKE:LIKE:=","","");
						...
						$Col[48] = 0;
						# +
						$Col[49] = ItemTambahThnN($iG,$sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,""); #fGlobal("IfNull(count(*),0)", "ta_kib_".fNmHuruf($iG),"Kd_Aset:Tgl_Perolehan:Tgl_Perolehan:Kd_Upb".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL,"LIKE:>=:<=:LIKE".$oPr,"","");
						$Col[50] = HargTambahThnN($sYt,$KdAsT,$Thn_B,$gUpb,$nIL,$oPr,"");     #fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb".$sYt,$KdAsT."%:".$Thn_B."-01-01".":".$Thn_B."-12-31:".$gUpb.$nIL,"LIKE:>=:<=:LIKE".$oPr,"","");
					}
				}
				################
			...
			{
				$nSQE = "SELECT P1.Kd_Aset, P2.Nm_Aset FROM ref_rek_aset5_temp P1 
				JOIN ref_rek_aset5 P2 ON P2.Kd_Aset=P1.Kd_Aset 
			...
			?>
        <? function ViewRincian($x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20,$x21,$x22,$x23,$x24,$x25,$x26,$x27,$x28,$x29,$x30,$x31,$x32,$x33,$x34,$x35,$x36,$x37,$x38,$x39,$x40,$x41,$x42,$x43,$x44,$x45,$x46,$x47,$x48,$x49,$x50,$x51,$x52,$x53,$x54,$x55,$x56,$x57,$xR,$xB) {?>
        <tr <?=$xR?>>
        ...
        <tr height="30">
          ...
          <td align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($fAWL!=0) {echo fConvertToRupiahBulat($fAWL);}?></td>
          <td align="right" style="font-weight:bold; border-top: 3px double #000000"><? if ($tAWL!=0) {echo fConvertToRupiah($tAWL);}?></td>
...
{
	if ($mMSR=="MK"){
		return fGlobal("IfNull(count(*),0)", "ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi:Crit",$KdAsTR."%:".$ThnR."-%-%:".$gUpbR.":".$mMSR.":SLD","LIKE:LIKE:LIKE:=:=","",$LoD);
	}
	else{
...
{
	return fGlobal("IfNull(sum(Debet),0)", "ta_kib_post_mutasi","Kd_Aset:Tgl_Mutasi:Kd_UPB:Jns_Mutasi",$KdAsTR."%:".$ThnR."-%-%:".$gUpbR.":".$mMSR,"LIKE:LIKE:LIKE:=","",$LoD);
}

function HargTambah($KdAsTR,$ThnR,$gUpbR,$mMSR,$LoD)
{
	return fGlobal("IfNull(sum(Debet),0)","ta_kib_post_mutasi","Kd_Aset_To:Tgl_Mutasi:Kd_UPB_To:Jns_Mutasi",$KdAsTR."%:".$ThnR."-%-%:".$gUpbR.":".$mMSR,"LIKE:LIKE:LIKE:=","",$LoD);
}
...
{
	return fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb:KdpToAset".$sYtR,$KdAsTR."%:".$ThnR."-01-01".":".$ThnR."-12-31:".$gUpbR.$nILR.":Y","LIKE:>=:<=:LIKE:=".$oPrR,"",$LoD);
}
...
{
	return fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb".$sYtR,$KdAsTR."%:".$ThnR."-01-01".":".$ThnR."-12-31:".$gUpbR.$nILR,"LIKE:>=:<=:LIKE".$oPrR,"",$LoD);
}
...
{
	return fGlobal("IfNull(sum(Debet),0)", "ta_kib_post","Kd_Aset:Tanggal:Tanggal:Kd_Upb".$sYRt,$KdAsTR."%:".$ThnR."-01-01".":".$ThnR."-12-31:".$gUpbR.$nILR,"LIKE:>=:<=:LIKE".$oPrR,"",$LoD);
}
?>
