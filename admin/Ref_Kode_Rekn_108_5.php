...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px">
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR1" id="fKdR1" type="text" value="<?=$KdR1?>" readonly="readonly" style="padding-left:5px; width:65px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR2" id="fKdR2" type="text" value="<?=$KdR2?>" readonly="readonly" style="padding-left:5px; width:65px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR3" id="fKdR3" type="text" value="<?=$KdR3?>" readonly="readonly" style="padding-left:5px; width:65px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR4" id="fKdR4" type="text" value="<?=$KdR4?>" readonly="readonly" style="padding-left:5px; width:65px; border: 1px solid #C0C0C0"/>
...
<table border="0" cellspacing="0" class="table-link" cellpadding="0" align="center" style="width:1000px; height:20px; background: #C9DCD8; font-weight:bold">
  <tr>
    ...
    <td width="670" align="left" style="padding-left:6px">SUB RINCIAN OBJEK
...
<script languange="javascript">
	...
	function RefreshDATA(IdL)
	{
		...
		{
			$.ajax({
				url:"Ref_Kode_Rekn_108_5_Data.php",
	...
	function prinDATA(w,h,IdL)
	{
		...
		URL = 'Ref_Kode_Rekn_108_Doc.php?Lev=5&eKD='+eKD+'&IdL='+IdL;
