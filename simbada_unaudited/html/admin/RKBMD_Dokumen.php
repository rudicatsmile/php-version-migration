			...
			<table border="1" width="100%" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
				...
				if ($tRo > 0)
				{
					...
					do
						...
						?>
						<tr height="22">
							<td width="33" valign="top" align="center" height="20"><? echo $iG?>.</td>
							<td width="269" valign="top" height="20"><? echo $mRo['Nm_Aset']?></td>
							<td width="128" valign="top" height="20"><? echo $mRo['Merk_Type']?></td>
							<td width="106" valign="top" height="20"><? echo $mRo['Ukuran']?></td>
							<td width="46" height="20" align="center" valign="top"><? if ($mRo['Qty']> 0) {echo $mRo['Qty'];}?></td>
							<td width="87" height="20" align="center" valign="top"><? echo $nStn?></td>
							<td width="87" valign="top" align="right" height="20"><? if ($mRo['Harga']> 0) {echo fConvertToRupiah($mRo['Harga']);}?></td>
							<td valign="top" align="right" height="20"><? if ($mRo['Jumlah']> 0) {echo fConvertToRupiah($mRo['Jumlah']);}?></td>
							<td valign="top" align="center" height="20" width="99"><? echo $mRo['Kd_Aset']?></td>
							<td valign="top" height="20" width="188"><? echo $mRo['Deskripsi']?>&nbsp;</td>
						</tr>
						<?
				...
				<tr>
					...
					TOTAL</td>
					<td align="right" style="font-weight: bold; border-top: 3px double #000000"><? echo fConvertToRupiah($gTotal)?></td>
