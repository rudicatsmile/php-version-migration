...
?>
<table border="0" align="center" width="1340" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
<tr>
...
<tr>
  ...
  <td>:</td>
  <td><? if ($TgP!='0000-00-00') {echo fConvertDateShort($TgP);} else {echo '-';}?></td>
</tr>
<tr>
  <td>RINCIAN</td>
  <td>:</td>
  ...
  <td>:</td>
  <td><? if ($TgM!='0000-00-00') {echo fConvertDateShort($TgM);} else {echo '-';}?></td>
</tr>
...
<!--###-->
<table border="0" align="center" width="1340" cellspacing="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
<tr>
  <td width="25" style="text-align:center; font-weight:bold; border:1px #000000 solid">No</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Tahun<br>Pelaporan</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Tahun<br>Awal</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Keadaan<br>Barang</td>
  <td width="90" style="text-align:center; font-weight:bold; border:1px #000000 solid">Harga</td>
  <td width="100" style="text-align:center; font-weight:bold; border:1px #000000 solid">Nilai<br>Perolehan</td>
  <td width="60" style="text-align:center; font-weight:bold; border:1px #000000 solid">Kode<br>Umur</td>
  <td width="30" style="text-align:center; font-weight:bold; border:1px #000000 solid">Rank</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Tahun<br>Akhir</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Prosentase<br>Awal </td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Prosentase</td>
  ...
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Umur<br>Telah<br>Dilalui</td>
  <td width="50" style="text-align:center; font-weight:bold; border:1px #000000 solid">Sisa<br>Umur</td>
  <td width="100" style="text-align:center; font-weight:bold; border:1px #000000 solid">Nilai<br>Buku Awal</td>
  <td width="100" style="text-align:center; font-weight:bold; border:1px #000000 solid">Nilai<br>Penyusutan</td>
  <td width="100" style="text-align:center; font-weight:bold; border:1px #000000 solid">Nilai<br>Akumulasi<br>Penyusutan </td>
  <td style="text-align:center; font-weight:bold; border:1px #000000 solid">Nilai<br>Buku Akhir</td>
</tr>
...
$nSQ ="SELECT Referensi,IndexData,Kd_UPB,Kd_Aset_108,No_Register,PerLap,Tahun,Tanggal,Nilai_Perolehan,Ms_Manfaat_Old,Ms_Manfaat_Old,Nilai_Tambah,Prosentase,
Ms_Manfaat_Add,Ms_Manfaat_Add,Ms_Manfaat_New,Ms_Manfaat_New,Penyusutan,Ms_Manfaat_Telah_Dilalui,Ms_Manfaat_Telah_Dilalui,
Beban_Tahun_Berjalan,Koreksi_Akumulasi,Nilai_Buku,Uraian,Nilai_Akhir, Ms_Manfaat_Sisa 
FROM ta_kib_post_penyusutan_108 WHERE Referensi = '$Ref' AND PerLap <='$rTH' ORDER BY PerLap, IndexData";
...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="25">
	  ...
	  <td style="text-align:right; border:1px #000000 solid; padding-right:2px"><? if ($mRo[10]>0) {echo fConvertToRupiahBulat($mRo[10]);} else {echo "-";}?></td>
	  <td style="text-align:right; border:1px #000000 solid; padding-right:2px"><? if ($mRo[11]>0) {echo fConvertToRupiahBulat($mRo[11]);} else {echo "-";}?></td>
	  <td style="text-align:center; border:1px #000000 solid"><?=$mRo[12]?></td>
	  <td style="text-align:center; border:1px #000000 solid"><? if ($mRo[13]>0) {echo $mRo[13];} else {echo "-";}?></td>
	  <td style="text-align:center; border:1px #000000 solid"><? if ($mRo[14]>0) {echo $mRo[14];} else {echo "-";}?></td>
	  <td style="text-align:center; border:1px #000000 solid"><? if ($mRo[15]>0) {echo $mRo[15];} else {echo "-";}?></td>
	  <td style="text-align:center; border:1px #000000 solid"><? if ($mRo[16]>0) {echo $mRo[16];} else {echo "-";}?></td>
...
<tr height="30">
  ...
  <td style="font-weight:bold; text-align:center; border:1px #000000 solid; border-top:3px #000000 double"><? if ($tRo15>0) {echo $tRo15;} else {echo "-";}?></td>
  <td style="font-weight:bold; text-align:center; border:1px #000000 solid; border-top:3px #000000 double"><? if ($tRo16>0) {echo $tRo16;} else {echo "-";}?></td>
