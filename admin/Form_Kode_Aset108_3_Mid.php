...
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset108_3_Mid_.php?IdL=".$IdL."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      ...
      <td>KODE OBJEK </td>
      <td>:</td>
      <td><input name="fKode" type="text" class="text" id="fKode" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986; width:60px" value="<?php echo $gCod?>" /></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>NAMA OBJEK </td>
