...
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset4_Mid_.php?FrmG=".($_REQUEST['FrmG'] ?? '')."&IdL=".($_REQUEST['IdL'] ?? '')."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      ...
      <td width="16">:</td>
      <td><select name="fKel" class="boxs" id="fKel" style="width: 450px" tabindex="0" <?php echo $Sbmt?>>
          <?php
    ...
    <tr> 
      ...
      <td width="16">:</td>
      <td><select name="fJNS" class="boxs" id="fJNS" style="width: 450px" tabindex="0" <?php echo $Sbmt?>>
          <?php
