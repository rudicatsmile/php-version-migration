...
<form name="myfrm" method="post" action="<?php echo "Inventarisasi_KIB-E_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="900px">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td align="right"><input type="button" name="B37" value="EXPORT DATA" onclick="P_ToExcel('800','400','center','ToExcel/KIB_E_ToExcel')" style="width: 90px; height: 24px; border: 1px solid #C0C0C0; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
    </tr>
    <tr> 
      <td width="92">UPB</td>
      <td width="519"> 
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
        ...
        <th width="395" align="left">Uraian</th>
              
        <th width="72" align="left">Tgl.Perolehan</th>
              
        <th width="96" align="right">Nilai Perolehan </th>
              
        <th width="103" align="right">Nilai Akhir </th>
        <th width="116" class="ac">Actions</th>
            </tr>
            <?
		...
		$nSQL= "SELECT * FROM ta_kib_e where Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Kd_Aset, No_Register LIMIT $Offset, $DataPerPage";
      ...
      <tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
		...
		<table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <tr> 
              ...
              <td width="113"> 
                <? echo $mRo['Judul']?>              </td>
              <td width="3">&nbsp;</td>
              <td width="105">Pencipta</td>
              <td width="10">:</td>
              <td width="290">
                <? echo $mRo['Pencipta']?>              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Jenis</td>
              ...
              <td>:</td>
              <td> 
                <? echo $mRo['Spesifikasi']?>              </td>
              <td>&nbsp;</td>
              <td>Asal Derah</td>
              <td>:</td>
              <td>
                <? echo $mRo['Daerah_Asal']?>              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Objek</td>
		...
		?>
          ...
          <!-- Pagging -->
          <?
			$nSQL= "SELECT COUNT(*) AS JmlRc FROM ta_kib_e WHERE Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy;
...
<script language="javascript">
			...
			if (win!=null)
    			{
      				win.window.document.open()       			
					<?
						$URL_Top = "Find_Acc_Top.php?CrAcc=Inventarisasi_KIB-E&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
						$URL_Mid = "Find_Acc_Mid.php?CrAcc=Inventarisasi_KIB-E&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
	...
	{	var win=null;
		...
		if (win!=null)
		{
			...
			URL_Mid = "Form_Invent_Asset_Opt.php?rKib=Kib_E&rIDT="+IDT+"<?="&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
