...
<input type="hidden" name="Simpan">
  <table border="0" width="800" cellpadding="0" style="border-collapse: collapse">
    ...
    <tr height="26">
      ...
      <td width="119" class="ar"><? if ($rMRG=="Y"){echo "TGL. ".$NmD;}?></td>
      <td width="23">&nbsp;</td>
      <td width="274">
	  <? if ($rMRG=="Y") {?>
    ...
    <tr height="26">
      ...
      <td class="ar"><? if ($rMRG=="Y"){echo "NO. ".$NmD;}?></td>
      <td>&nbsp;</td>
      <td>
	  <? if ($rMRG=="Y") {?>
    ...
    <tr height="26">
      ...
      <td>&nbsp;</td>
      <td colspan="4"><input name="fUraian" type="text" class="text" style="width:450px; height:19px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gURA?>" /></td>
    </tr>
    <tr height="26">
      <td>&nbsp;</td>
    ...
    <tr height="25">
      ...
      <td>&nbsp;</td>
      <td colspan="4"><input name="fNilai" type="text" class="text" id="fNilai" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="text-align: right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 5px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gNIL)?>" size="19" maxlength="19" /></td>
    </tr>
    <tr height="25">
      <td>&nbsp;</td>
      ...
      <option <? if ($gCR=="SLD") {echo "selected";}?> value="SLD">SALDO AWAL</option>
      <option <? if ($gCR=="INV") {echo "selected";}?> value="INV">ATRIBUSI</option>
      </select></td>
    </tr>
    <tr height="25">
      <td>&nbsp;</td>
      ...
      <td>&nbsp;</td>
      <td colspan="4"><textarea name="fKeterangan" style="width:450px; height:70px; border: 1px solid #C0C0C0"><? echo $gKET ?></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="4" style="color:#FF0000"><? echo $_REQUEST['MsG']?>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
			...
			if (win!=null)
    			{
					...
					?>       			
       			txtHTML="<html><head><title>Simbada Kab. Hulu Sungai Tengah</title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFindBBB_Top' noresize src='<? echo $URL_Top?>' scrolling='no'><frame name='WinFindBBB_Mid' src='<? echo $URL_Mid?>' scrolling='auto'><frame name='WinFindBBB_Bot' src= '<? echo $URL_Bot?>' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
       			win.focus()
