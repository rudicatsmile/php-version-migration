...
<form name="myfrm" method="post" action="<?="Ref_Kode_Aset_3_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG']."&KdAst1=".$KdAst1."&KdAst2=".$KdAst2 ?>">
  ...
  <table align="center" border="0" cellspacing="0" cellpadding="0" class="table-list" style="width:99%">
      ...
      <?php
		...
		$nSQL= "SELECT * FROM ref_rek_aset3 WHERE Kd_Aset LIKE '".$KdAst2.".__' ORDER BY Kd_Aset LIMIT $Offset, $DataPerPage";
		...
		do
			...
			{
				$mSQL= "SELECT * FROM ref_rek_aset4 WHERE Kd_Aset LIKE '".$mRo['Kd_Aset'].".__' ORDER BY Kd_Aset";
      ...
      <tr height="22" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
		...
		[&nbsp;<a href="<?="Ref_Kode_Aset_4.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&KdAst1=".$_GET['KdAst1']."&KdAst2=".$_GET['KdAst2']."&KdAst3=".$mRo['Kd_Aset']?>" class="ico prev">VIEW</a>&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <?php
		$nSQL= "SELECT COUNT(*) AS JmlRc FROM ref_rek_aset3 WHERE Kd_Aset LIKE '".$KdAst2.".__'";
...
<script language="javascript">
			...
			if (win!=null)
				{
					...
					<?php
						$URL_Top = "Form_Kode_Aset3_Top.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'];
						$URL_Mid = "Form_Kode_Aset3_Mid.php?KdAst2=".$KdAst2."&IdL=".$_GET['IdL'];
						$URL_Bot = "Form_Kode_Aset3_Bot.php";
					?>       			
	...
	function EditData(w,h,Lev,IDT)
	{
		...
		{
			win.window.document.open()       			
			URL_Top = "Form_Kode_Aset3_Top.php?"+"<?="FrmG=".$_GET['FrmG']?>";
			URL_Mid = "Form_Kode_Aset3_Mid.php?rIDT="+IDT+"<?="&IdL=".$_GET['IdL']?>";
			URL_Bot = "Form_Kode_Aset3_Bot.php";
			txtHTML="<html><head><title>Simbada Kab. Hulu Sungai Tengah</title></head><frameset framespacing='0' border='0' rows='45,*,30' frameborder='0'><frame name='WinFormKIB_Top' noresize src='"+URL_Top+"' scrolling='no'><frame name='WinFormKIB_Mid' src='"+URL_Mid+"' scrolling='auto'><frame name='WinFormKIB_Bot' src= '"+URL_Bot+"' scrolling='no'><noframes><body><p>=>.............??!</p></body></noframes></frameset></html>"            
			win.focus()
			win.window.document.clear()
	...
	function P_Document(w,h,pos,gKD)
	{
		...
		LeftPosition=(screen.width)?(screen.width-w)/2:100; 
		TopPosition=(screen.height)?(screen.height-h)/2:100;
		URL = "Ref_Kode_Aset_Doc.php?CrT=JNS&gKD="+gKD+"<?="&IdL=".$_GET['IdL']?>";
