...
?> 
<body>
<table border="0" width="1200" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format II.I.10</td>
  </tr>
</table>
<table border="0" width="1200" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td colspan="3" style="text-align:center; font-size:10pt; font-weight:bold; font-family:verdana">BUKU PENYALURAN BARANG</td>
  </tr>
...
<table border="0" width="1200" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    <td rowspan="2" style="border:1px solid #000">No</td>
    <td colspan="2" style="border:1px solid #000">BAST</td>
    ...
    <td rowspan="2" style="border:1px solid #000">Nilai<br>
    Total<br>
    (Rp)</td>
    <td rowspan="2" style="border:1px solid #000">Penerima</td>
  ...
  <tr style="text-align:center">
    ...
    <td width="115" style="border:1px solid #000; border-bottom:3px double #000">3</td>
    <td width="115" style="border:1px solid #000; border-bottom:3px double #000">4</td>
    <td width="200" style="border:1px solid #000; border-bottom:3px double #000">5</td>
    <td width="60" style="border:1px solid #000; border-bottom:3px double #000">6</td>
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">7</td>
    <td width="60" style="border:1px solid #000; border-bottom:3px double #000">8</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">9</td>
    ...
    <td style="border:1px solid #000; border-bottom:3px double #000">12</td>
  </tr>
	<?
	$iG=1;
	$nSQ = "SELECT 
	...
	LEFT JOIN tb_bidang_sub P5 ON P5.Kode=P1.KdBidangTo 
	WHERE P1.KdBidang='".$BiD."' AND (P1.Tanggal BETWEEN '$TgA' AND '$TgB') ORDER BY P1.Nomor";
	#echo $nSQ;
	$nRs = mysql_query($nSQ);
  ...
  <tr height="24">
    ...
    <td style="border:1px solid #000; padding-left:3px"><?=$mRo[9]?></td>
  ...
  <tr height="24" style="font-weight:bold">
    <td colspan="7" style="border:1px solid #000; text-align:center">T o t a l</td>
