...
<tr>
  <td style="font-size: 11pt; font-weight: bold; text-align:center">REKAPITULASI PENERIMAAN BERKAS</td>
</tr>
<tr>
...
<tr>
  ...
  <tr height="23">
	<td width="120" style="border:1px solid #000000; font-weight:bold; text-align:center">KODE</td>
	<td style="border:1px solid #000000; font-weight:bold; text-align:center">URAIAN</td>
	<td width="110" style="border:1px solid #000000; font-weight:bold; text-align:center">NILAI DPA</td> 
	<td width="110" style="border:1px solid #000000; font-weight:bold; text-align:center">NILAI BERKAS</td>
	<td width="110" style="border:1px solid #000000; font-weight:bold; text-align:center">LEBIH/(KURANG)</td>
  </tr>
  <tr> 
  ...
  <?
		...
		$tCol4 = 0;
		$tCol5 = 0;
		$nSQ = "SELECT idProgram, nmProgram FROM ta_apbd_program_skpd WHERE kdUnit LIKE '".$gUnt."' AND Periode='".$gThA."' GROUP BY idProgram";
		#echo $nSQ;
		$nRs = mysql_query($nSQ);
		...
		function vwKEGI($gUnt,$KdP,$gThA,$DatabaseSB,$ConSB)
		{
			...
			while ($mRoA = mysql_fetch_array($nRsA, MYSQL_BOTH))
			{
				...
				if ($Col[3]>0 || $Col[4]>0){
					...
					ViewRincian($Col[1],$Col[2],$Col[3],$Col[4],$Col[5],$xB);
					#vwBELA($KdK,$gThA,$DatabaseSB,$ConSB);
		...
		if ($iG==1){ViewBlank();}
		?>
  <? function ViewRincian($x1,$x2,$x3,$x4,$x5,$xB) {?>
  <?
  $eCL="";
  if ($x5<0){
	$eCL="; color:#FF0000";
  ...
  <tr> 
	...
	<td valign="top" style="border: 1px solid #000000; text-align:left; padding-left:5px"><?=$xB.$x2?></td>
	<td valign="top" style="border: 1px solid #000000; text-align:right; padding-right:5px"><?=$xB.fConvertToRupiah($x3)?></td>
	<td valign="top" style="border: 1px solid #000000; text-align:right; padding-right:5px"><?=$xB.fConvertToRupiah($x4)?></td>
	<td valign="top" style="border: 1px solid #000000; text-align:right; padding-right:5px <?=$eCL?>"><?=$xB.fConvertToRupiah($x5)?></td>
  </tr>
  <? } ?>
  <? function ViewBlank() {?>
  <tr> 
  ...
  <tr height="23">
	...
	<td align="center" style="border:1px solid #000000; font-weight: bold; text-align:right; padding-right:5px"><?=fConvertToRupiah($tCol3)?></td>
	...
	<td align="center" style="border:1px solid #000000; font-weight: bold; text-align:right; padding-right:5px"><?=fConvertToRupiah($tCol5)?></td>
  </tr>
</table>		  </td>
</tr>
<tr>
