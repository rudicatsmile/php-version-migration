...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="35"> 
	  <td width="100" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:0px #ccc solid; text-align:center"><?php if ($RefB!=$RefA) {echo $mRo[1]."<br>".$mRo[0];}?></td>
	  <td width="230" style="border-bottom:1px #999999 dotted; text-align:left; border-left:1px #ccc solid; padding-left:3px" title="Nilai Kapitalisi : <?=fConvertToRupiah($mRoAS)?>" <?=$gBG?>><?php if ($RekB!=$RekA) {echo "<font style='font-weight:bold'>".$mRo[4]."</font><br>".$mRo[3]." ( <font style='cursor:pointer ".$eCL."'>Rp. ".fConvertToRupiah($rNiL)." </font>)";}?></td>
	  <td width="230" style="border-bottom:1px #999999 dotted; text-align:left; border-left:1px #ccc solid; padding-left:3px" <?=$gBG?>><?php if ($AstB!=$AstA) {echo $mRo[6]."<br>".$mRo[5];}?></td>
	  ...
	  <td width="90" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; text-align:right; padding-right:3px <?=$eCL?>"><?php if ($mRo[11]!=''){echo fConvertToRupiah($mRo[9]);}?></td>
	  <td width="100" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; text-align:right; padding-right:3px <?=$eCL?>"><?php if ($mRo[11]!=''){echo fConvertToRupiah($mRo[10]);}?></td>
