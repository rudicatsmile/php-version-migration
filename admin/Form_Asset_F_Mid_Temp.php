...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_F_Mid_Temp_.php?gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$_GET['IdL'] ?>">
...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>KONTRUKSI</td>
      <td><input name="fKonstruksi" type="text" class="text" id="fKonstruksi" style="width:250px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gKns?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>PANJANG</td>
      <td><input name="fPanjang" type="text" class="text" id="fPanjang2" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:100px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gPjg)?>" />
      M</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>LEBAR</td>
      <td><input name="fLebar" type="text" class="text" id="fLebar" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:100px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gLbr)?>" />
      M</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>LUAS</td>
      <td><input name="fLuas" type="text" class="text" id="fLuas" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style="width:100px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gLua)?>" />
      M<sup>2</sup> </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>LOKASI</td>
      <td><input name="fLokasi" type="text" class="text" id="fAlamat3" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gLKS?>" /></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="fSatuan" type="text" id="fSatuan" value="<?php echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:100px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
