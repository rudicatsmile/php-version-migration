  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr height="24" style="font-weight:bold">
		  ...
		  <td width="25">:</td>
		  <td colspan="2"><input type="text" name="TitikKoordinat" id="TitikKoordinat" value="<?=$Koordinat?>" onkeypress="if (event.keyCode==13){saveDATA('TitikKoordinat',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:292px" /></td>
		</tr>
        <tr height="24" style="font-weight:bold">
          <td>T.</td>
          <td>Lainnya</td>
               ...
               <?
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
				  ...
				  <tr height="18">
					...
					<td valign="top" width="70" <?=$gBG?> style="border-bottom:1px dotted #CCCCCC; text-align:center; padding-top:5px; padding-bottom:5px"><img src="<?="Lembar_Kerja_Frm_Img_Load.php?CrT=Img&rIdT=".$rIdT?>" height="40" width="40" style="border:1px #999999 solid" /> </td>
