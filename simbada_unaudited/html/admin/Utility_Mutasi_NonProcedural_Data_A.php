...
if ($gSkP)
{
	...
	<tr height="40px">
	  ...
	  <td valign="top" style="border-bottom:1px dotted #ccc <?=$gBc.$rC?>"><input type="checkbox" name="sDana" value="<?=$gId?>" <? if ($CeKD!=""){echo "disabled";}?> /></td>
	</tr>
	<?
		$iG++;
	}
...
<tr height="100%">
  ...
  <td width="80" valign="top" style="border-bottom:1px dotted #ccc; text-align:right; font-weight:bold; color:#FF0000"><? if ($iG!=1){?>Tandai Semua<? } ?></td>
  <td width="80" valign="top" style="border-bottom:1px dotted #ccc; text-align:right; font-weight:bold; color:#FF0000">&nbsp;</td>
  <td width="20" valign="top" style="border-bottom:1px dotted #ccc"><? if ($iG!=1){?><input type="checkbox" name="sDana" value="" onclick="CheckAlla()" /><? } ?></td>
</tr>
</table>
