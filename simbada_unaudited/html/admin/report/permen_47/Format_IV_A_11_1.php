...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" colspan="10">Cara Perolehan / Penerimaan 
	(Rp)</td>
    <td rowspan="2" style="border:1px solid #000">Jumlah Total (Rp)</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Pengadaan APBD</td>
    <td style="border:1px solid #000">Hibah / Sumbangan atau yang 
	sejenis</td>
    <td style="border:1px solid #000">Pelaksanaan dari Perjanjian /Kontrak<p>&nbsp;</td>
    <td style="border:1px solid #000">Ketentuan Peraturan Perundangundangan<p>&nbsp;</td>
    <td style="border:1px solid #000">Putusan Pengadilan Yang Berkekuatan Hukum Tetap<p>&nbsp;</td>
    <td style="border:1px solid #000">Divestasi<p>&nbsp;</td>
    <td style="border:1px solid #000">Hasil Inventarisasi<p>&nbsp;</td>
    <td style="border:1px solid #000">Hasil Tukar Menukar<p>&nbsp;</td>
    <td style="border:1px solid #000">Pembatalan Penghapusan<p>&nbsp;</td>
    <td style="border:1px solid #000">Perolehan Lainnya<p>&nbsp;</td>
  </tr>
  <tr style="text-align:center">
    ...
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">
	(5)</td>
    <td width="119" style="border:1px solid #000; border-bottom:3px double #000">
	(6)</td>
    <td width="142" style="border:1px solid #000; border-bottom:3px double #000">
	(7)</td>
