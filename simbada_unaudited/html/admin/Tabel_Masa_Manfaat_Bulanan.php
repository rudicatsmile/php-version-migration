...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="25">
	  ...
	  <td style="text-align:right; border:1px #000000 solid; text-align:center"><? if ($mRo[10]>0) {echo fConvertToRupiahBulat($mRo[10]);} else {echo "-";}?></td>
	  <td style="text-align:right; border:1px #000000 solid; text-align:center"><? if ($mRo[11]>0) {echo fConvertToRupiahBulat($mRo[11]);} else {echo "-";}?></td>
