...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%; height:30px; background: #EAE6E6">
  <tr>
    <td width="5">&nbsp;</td>
    <td><input type="button" name="B11" id="B11" value="REFRESH" onclick="RefreshDATA('<?=$IdL?>','0')" style="width: 80px; height: 21px" /><?=str_repeat("&nbsp;",5)?>
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="button" name="B15" id="B15" <?php if ($IdT=="") {echo "disabled";}?> value="CETAK" onclick="P_Dokumen('800','400','<?=$Frm?>','<?=$Crit?>','<?=$IdT?>','<?=$_GET['IdL']?>')" style="width: 120px; height: 21px; color:#0000FF" />	  </td>
    <td width="5">&nbsp;</td>
  </tr>
</table>
<?php if ($IdT) {?>
...
<script languange="javascript">
	...
	function showUNIT(CrT,gIdL)
	{
		if (CrT=='find')
		{
			...
			{
				$("#unitDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_unit_mid.php?gFnD='+gFnD+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#unitDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_unit_top.php?IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#unitDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_unit_mid.php?IdL='+gIdL);
			});
	...
	function showSUB(CrT,gIdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#subDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_sub_mid.php?gFnD='+gFnD+'&gUNT='+fUNT+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#subDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_sub_top.php?IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#subDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_sub_mid.php?gUNT='+fUNT+'&IdL='+gIdL);
			});
	...
	function showUPB(CrT,gIdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#upbDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_upb_mid.php?gFnD='+gFnD+'&gSUB='+fSUB+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#upbDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_upb_top.php?IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#upbDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_upb_mid.php?gSUB='+fSUB+'&IdL='+gIdL);
			});
	...
	function proslNIL(crt,PgE,IdT,gAsT,gLhI,gExT,IdL,AmBiL)
	{
		if (AmBiL=="ALL")
		{
			...
			{
				$("#loadingImg").show();
				$("#ViewDATA").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_mid_checklist.php?rUpb='+rUpb+'&gExT='+gExT+'&gLhI='+gLhI+'&PgE='+PgE+'&IdT='+IdT+'&gAsT='+gAsT+'&gUNT='+gUNT+'&AmBiL='+AmBiL+'&gFnD='+gFnD+'&gTHN='+gTHN+'&gLST='+gLST+'&IdL='+IdL);
			});
		}
		else
		{
			...
			{
				$("#loadingImg").show();
				//$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_mid_checklist.php?AmBiL='+AmBiL+'&PgE='+PgE+'&IdT='+IdT+'&gCrID='+gCrID+'&IdL='+IdL);
				$("#ViewDATA").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_mid_checklist.php?AmBiL='+AmBiL+'&PgE='+PgE+'&IdT='+IdT+'&gCrID='+gCrID+'&IdL='+IdL);
			});
		}
	...
	function showCLICK(crt,mesg,refs,kde,nma,IdL)
	{
		...
		if (crt=='aset') 
		{
			$(document).ready(function()
			{
				$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_add.php?IdT='+kde+'&rDTA='+nma+'&IdL='+IdL);
			});
		}
		document.getElementById(crt+'MstCri').style.display = "none";
	}
	...
	function showASET(CrT,PgE,Jns,IdT,IdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#asetDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_mid.php?rUpb='+rUpb+'&gLhI='+gLhI+'&PgE='+PgE+'&gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gAsT='+gAsT+'&gFnD='+gFnD+'&IdT='+IdT+'&gUPB='+gUPB+'&Jns='+Jns+'&IdL='+IdL);
				$("#asetDiv3Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_page.php?rUpb='+rUpb+'&gLhI='+gLhI+'&PgE='+PgE+'&gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gAsT='+gAsT+'&gFnD='+gFnD+'&IdT='+IdT+'&gUPB='+gUPB+'&Jns='+Jns+'&IdL='+IdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#asetDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_top.php?PgE='+PgE+'&IdT='+IdT+'&Jns='+Jns+'&gAsT='+gAsT+'&IdL='+IdL);
				$("#asetDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_mid.php?gLhI='+gLhI+'&PgE='+PgE+'&gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gAsT='+gAsT+'&IdT='+IdT+'&gUPB='+gUPB+'&Jns='+Jns+'&IdL='+IdL);
				$("#asetDiv3Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_find_aset_page.php?gLhI='+gLhI+'&PgE='+PgE+'&gEXT='+gEXT+'&gLST='+gLST+'&gTHN='+gTHN+'&gAsT='+gAsT+'&IdT='+IdT+'&gUPB='+gUPB+'&Jns='+Jns+'&IdL='+IdL);
			});
	...
	function RefreshDATA(IdL,PgE)
	{
		...
		$(document).ready(function()
		{
			...
			$("#ViewDATAaX").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_pages.php?PgE='+PgE+'&gREF='+gREF+'&IdL='+IdL);
		});
	}
	...
	function P_Remove(PgE,rIdT,DeL,IdL)
	{
		if (DeL=="DelVer") {
			...
			if (AN)
			{
				$(document).ready(function()
				{
					$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_del.php?PgE='+PgE+'&DelVer=Ya&rIdT='+rIdT+'&IdL='+IdL);
				});
			}
		}
		else{
			...
			if (AN)
			{
				$(document).ready(function()
				{
					$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_del.php?PgE='+PgE+'&rIdT='+rIdT+'&IdL='+IdL);
				});
			}
		}
	}
	...
	function choiseTANGGAL(IdL)
	{
		...
		$(document).ready(function()
		{
			$("#choiseDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_choise_top.php');
		});
		
		$(document).ready(function()
		{
			$("#choiseDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_choise_mid.php?IdL='+IdL);
		});
	...
	function showDATANew(Frm,Crit,IdL)
	{
		...
		fE="";
		gUNT = $("#fUNT").val();
		window.open('rkbmd_new_pmf_pmt_phs_telaah.php?FrmG=RENCANA '+fR+' BMD (TELAAH) '+fE+'&Frm='+Frm+'&Crit='+Crit+'&gUNT='+gUNT+'&IdL='+IdL,'_self');
	}
	...
	function showDATA(CrT,IdT,gIdL)
	{
		...
		if (CrT=='find')
		{
			...
			$(document).ready(function()
			{
				$("#tranDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_mid.php?gFnD='+gFnD+'&gUPB='+gUPB+'&IdL='+gIdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#tranDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_top.php?IdL='+gIdL);
			});
			
			$(document).ready(function()
			{
				$("#tranDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_mid.php?gUPB='+gUPB+'&IdL='+gIdL);
			});
	...
	function showREF(CrT,gIdT,gIdL)
	{
		...
		$(document).ready(function()
		{
			$("#imgDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_edit_mid.php?gIdT='+gIdT+'&gRF='+gRF+'&CrT='+CrT+'&IdL='+gIdL);
		});
	}
	...
	function showEDIT(CrT,IdT,IdL)
	{
		...
		if (CrT=='refr')
		{
			$(document).ready(function()
			{
				$("#edtDiv2Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_edit_mid.php?IdT='+IdT+'&gRF='+gRF+'&CrT='+CrT+'&IdL='+IdL);
			});
		}
		else
		{
			...
			$(document).ready(function()
			{
				$("#edtDiv1Cri").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_edit_top.php?CrT='+CrT+'&IdL='+IdL);
			});
	...
	function SaveEDIT(gRF,JeN,IdT,IdL)
	{
		...
		$(document).ready(function()
		{
			filepost = "rkbmd_new_pmf_pmt_phs_telaah_frm_data_edit_save_json.php";
			$.post(filepost,
	...
	function choiseFIND_xxxx(Frm,CrT,gid,kde,nma,IdL)
	{
		$(document).ready(function()
		{
			$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_data_edit_mid_find_add.php?gFrm='+Frm+'&gID='+gid+'&gKD='+kde+'&IdL='+IdL);
		});
	...
	{
		if (Frm=="PMF"){dk="rkbmd_new_pmf_pmt_phs_telaah_frm_data_dok_pmf";}
		if (Frm=="PMT"){dk="rkbmd_new_pmf_pmt_phs_telaah_frm_data_dok_pmt";}
		if (Frm=="PHS"){dk="rkbmd_new_pmf_pmt_phs_telaah_frm_data_dok_phs";}
		var win=null;
		var txtHTML = "";
		var iErrors=0;
	...
	function saveRECO(stLOCK,crt,fld,rIdT,IdL)
	{
		...
		$(document).ready(function()
		{
			$("#ViewDELL").load('rkbmd_new_pmf_pmt_phs_telaah_frm_save.php?stLOCK='+stLOCK+'&crt='+crt+'&fld='+fld+'&rIdT='+rIdT+'&IdL='+IdL);
		});
	}
