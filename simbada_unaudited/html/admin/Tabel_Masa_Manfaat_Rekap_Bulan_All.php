...
<table border="0" align="center" cellspacing="0" style="width:1050px; font-size: 8pt; font-family: Calibri; border-collapse: collapse">
  <tr>
	...
	<tr>
	  <td colspan="3" align="center" style="font-size: 11pt; font-weight: bold">SEMUA ASET<?=$txt?> <? if ($ExtR=="Y"){echo "( EXTRACOM )";} else {echo "( NON EXTRACOM )";} ?></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td width="17" style="font-size: 10pt; font-weight: normal">:</td>
	  <td width="944" style="font-size: 10pt; font-weight: normal"><? if ($_GET['uSU']=="All"){echo "Semua";}else{ echo strtoupper(fGlobalNEW("Nm_Sub","ref_sub_unit","Kd_Sub",$_GET['uSU'],"=","",DatabaseSB,$ConSB,""));}?></td>
	</tr>
	<tr>
	  <td width="79" style="font-size: 10pt; font-weight: normal">UPB</td>
	  <td width="17" style="font-size: 10pt; font-weight: normal">:</td>
	  <td width="944" style="font-size: 10pt; font-weight: normal"><? if ($_GET['uUP']=="All"){echo "Semua";}else{echo strtoupper(fGlobalNEW("Nm_UPB","ref_upb","Kd_UPB",$_GET['uUP'],"=","",DatabaseSB,$ConSB,""));}?></td>
	</tr>
	<tr>
	  <td colspan="3">&nbsp;</td>
	</tr>
	...
	<table border="0" align="center" width="1050" cellspacing="0" style="font-size: 9pt; font-family: Calibri; border-collapse: collapse">
	  ...
	  <tr height="20">
		...
		if ($mts!=""){
			...
			#$nSQ = "SELECT Kd_Aset, Nm_Aset FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '1.3.4%' ORDER BY Kd_Aset";
		}
		else{
			$nSQ = "SELECT Kd_Aset, Nm_Aset FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '1.3.1%' OR Kd_Aset LIKE '1.3.2%' OR Kd_Aset LIKE '1.3.3%' OR Kd_Aset LIKE '1.3.4%' OR Kd_Aset LIKE '1.3.5%' OR Kd_Aset LIKE '1.3.6%' OR Kd_Aset LIKE '1.5.3%' OR Kd_Aset LIKE '1.5.4%' ORDER BY Kd_Aset";
			#$nSQ = "SELECT Kd_Aset, Nm_Aset FROM ref_rek_aset108_3 WHERE Kd_Aset LIKE '1.3.4%' ORDER BY Kd_Aset";
		...
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			$KdAsT = $Col01;
			if ($TbL=='1.3.1' || $TbL=='1.3.5' || $TbL=='1.3.6') 
			{
				if ($mts){
					...
					if ($TbL=='1.3.5') {
						if (substr($uNT,0,11)=='24.04.05.02'){
							...
							$Col03 = fGlobalNEW("IfNull(sum(Harga),0)","ta_kib_108","Kd_UPB:Kd_Aset_108:Tgl_Perolehan:extracom:KdpToAset",$uNT."%:".$Col01.".%:".$rTH."-12-31:".$ExtR.":N","LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
						}
					}
					else{
						$Col03 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post_108","Kd_UPB:Kd_Aset_108:Tanggal:extracom:KdpToAset",$uNT."%:".$Col01.".%:".$rTH."-12-31:".$ExtR.":N","LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
			...
			else
			{
				if ($TbL=='1.5.4'){
					...
					$Col04 = fGlobalNEW("IfNull(sum(Nilai_Tambah),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset_108:PerLap:SdhMutasi:extracom",$uNT."%:".$Col01.".%:".$rTH.":".$nMT.":".$ExtR,"LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
					$Col03 = $Col03-$Col04;
				}
				else{
				...
				$Col05 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset_108:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$uNT."%:".$Col01.".%:".((int)$rTH-1).":Y:IV:".$nMT.":".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
				$Col06 = fGlobalNEW("IfNull(sum(Beban_Tahun_Berjalan),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset_108:PerLap:SdhMutasi:extracom",$uNT."%:".$Col01.".%:".$rTH.":".$nMT.":".$ExtR,"LIKE:LIKE:=:=:=","",DatabaseSB,$ConSB,"");
				$Col07 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset_108:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$uNT."%:".$Col01.".%:".$rTH.":Y:IV:".$nMT.":".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
				if ($TbL=='1.5.4'){
					$Col08 = ($Col03+$Col04)-$Col07;
				}
				else{
					$Col08 = fGlobalNEW("IfNull(sum(Nilai_Buku),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset_108:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$uNT."%:".$Col01.".%:".$rTH.":Y:IV:".$nMT.":".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
				}
			}
			$tCol03 = $tCol03 + $Col03;
			$tCol04 = $tCol04 + $Col04;
		...
		function SubData2($KdR,$TbL,$rTH,$uNT,$crt,$mts,$nMT,$ExtR,$DatabaseSB,$ConSB,$CeNT,$PaD,$xB)
		{
			...
			while ($mRoA = mysql_fetch_array($nRsA, MYSQL_BOTH))
			{
				...
				if ($TbL=='1.3.1' || $TbL=='1.3.5' || $TbL=='1.3.6')
				{
					if ($TbL=='1.3.5') {
						if (substr($uNT,0,11)=='24.04.05.02'){
							$Col03 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post_108".$mts,"Kd_UPB:Kd_Aset_108:Tanggal:KdpToAset:extracom",$uNT."%:".$Col01.".%:".$rTH."-12-31:N:".$ExtR."","LIKE:LIKE:<=:=:=","",$DatabaseSB,$ConSB,"");
						}
						else{
							$Col03 = fGlobalNEW("IfNull(sum(Harga),0)","ta_kib_108".$mts,"Kd_UPB:Kd_Aset_108:Tgl_Perolehan:KdpToAset:extracom",$uNT."%:".$Col01.".%:".$rTH."-12-31:N:".$ExtR."","LIKE:LIKE:<=:=:=","",$DatabaseSB,$ConSB,"");
						}
					}
					else{
						$Col03 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post_108".$mts,"Kd_UPB:Kd_Aset_108:Tanggal:KdpToAset:extracom",$uNT."%:".$Col01.".%:".$rTH."-12-31:N:".$ExtR."","LIKE:LIKE:<=:=:=","",$DatabaseSB,$ConSB,"");
		...
		{
			$nSQD = "SELECT Kd_Aset, Nm_Aset FROM ref_rek_aset108_7 WHERE Kd_Aset LIKE '$KdR%' ORDER BY Kd_Aset";
