...
<form name="myfrm" method="POST" action="<?="Utility_Import_SQL_E.php?FrmG=".$FrmG."&IdL=".$IdL?>">
...
<script languange="javascript">
	...
	function RefreshDATA(crt,IdL)
	{
		...
		if (crt=='import')
		{
			fil = "Utility_Import_SQL_E_Import";
			vie = "ViewDELL";
			AN=confirm('Import?');
			if (!AN){return false;}
		}
		...
		{
			fil = "Utility_Import_SQL_E_Batal";
			vie = "ViewDELL";
			AN=confirm('Batalkan?');
			if (!AN){return false;}
		}
		...
		$(document).ready(function()
		{
			$.ajax({
				url:fil+".php",
				data: {gUnT:gUnT,gSuB:gSuB,gUpB:gUpB,gReC:gReC,gPaG:gPaG,gHpS:gHpS,gDtA:gDtA,IdL:IdL},
				type:"get",
				beforeSend:function()
				{
					$("#loadingImg").show();
