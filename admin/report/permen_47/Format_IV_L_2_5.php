...
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:right">Format IV.L.2.5</td>
  </tr>
</table>
<table border="0" width="800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:11pt">
  ...
  <tr>
    <td style="text-align:center; font-weight:bold; font-family:calibri">LAPORAN ASET TETAP MUTASI TAMBAH DAN MUTASI KURANG ASET TETAP</td>
  </tr>
  <tr>
...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  ...
  <tr style="text-align:center">
	...
	{ 
		...
		#mutasi masuk
		$x4 = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108_mutasi","Kd_UPB_To:Kd_Aset_108_To:Tanggal:Tgl_Mutasi:Extracom",$KdS."%:".$x1.".%:".$TG.":".$TG.":N","LIKE:LIKE:<:>=:LIKE","",$fs);
		#mutasi keluar
		$x5 = fGlobal("ifnull(sum(Debet),0)","ta_kib_post_108_mutasi","Kd_UPB:Kd_Aset_108:Tanggal:Tgl_Mutasi:Extracom",$KdS."%:".$x1.".%:".$TG.":".$TG.":N","LIKE:LIKE:<:>=:LIKE","",$fs);
		$x3 = $x3+$x5-$x4;
