...
<table border="0" width="1330" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
	...
	<tr>
		<td style="font-size: 11pt; font-weight: bold" align="center"> ( RENCANA PEMINDAHTANGANAN ) </td>
	</tr>
	<tr>
...
<table border="0" width="1330" cellspacing="0" style="font-size:9pt; font-family: Calibri; border-collapse: collapse">
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td width="110" style="border:1px #000000 solid">Bentuk<br>Pemindahtanganan</td>
    <td width="110" style="border:1px #000000 solid">Alasan Rencana<br>Pemindahtanganan</td>
  ...
  <tr style="text-align:center; font-weight:bold">
	...
	p1.bentuk_pemindahtanganan as A8,
	p1.alasan_rencana_pemindahtanganan as A9,
	'-' as A10 
