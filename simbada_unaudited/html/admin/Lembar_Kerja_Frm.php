...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%; color:#fff; background:#79a86a">
  ...
  <tr height="23">
	...
	<input name="dUNT" id="dUNT" type="text" value="<?=$dUNT?>" readonly <? if ($Lev <= 1) {?> onClick="showUNIT('','<?=$_GET['IdL']?>')" <? } else {echo "readonly";}?> style="padding-left:3px; width:350px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
    ...
    <input name="dSUB" id="dSUB" type="text" value="<?=$dSUB?>" <? if ($Lev <= 2) {?> onclick="showSUB('','<?=$_GET['IdL']?>')" <? } else {echo "readonly";}?> style="padding-left:3px; width:350px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="23">
	...
	<input name="dUPB" id="dUPB" type="text" value="<?=$dUPB?>" <? if ($Lev <= 2) {?> onClick="showUPB('','<?=$_GET['IdL']?>')" <? } else {echo "readonly";}?> style="padding-left:3px; width:320px; border: 1px solid #C0C0C0"/>
	<div id="upbMstCri" class="Unit0Cri">
		<div id="upbDiv1Cri" class="Unit1Cri"></div>
		<div id="upbDiv2Cri" class="Unit2Cri"></div>
	</div>	</td>
    <td><input type="button" name="BtnFN" id="BtnFN" value="..." <? if ($Lev <= 1) {?> onclick="cariUPB('','<?=$IdL?>')" <? } else {echo "disabled";}?> style="width:26px; height:22px" /></td>
...
<table border="0" cellspacing="0" class="table-link" cellpadding="0" align="center" style="width:99%; height:20px; background: #CEFBE3; font-weight:bold">
  ...
  <tr style="text-align:center">
    ...
    <td width="43" style="border-right:1px solid #ccc">Foto</td>
    <td>Action</td>
  </tr>
  <? } ?>
</table>
...
<script languange="javascript">
	...
	function remoIMG(CrT,AsT,ReO,rIdT,IdT,IdL)
	{
		...
		{
			$.ajax({
				url:"Lembar_Kerja_Frm_Img_Remove.php",
	...
	function viewIMG(CrT,rIdT,w,h,IdL)
	{
		var win=null;
		var txtHTML = "";
		var iErrors=0;
		...
		URL='Lembar_Kerja_Frm_Img_View.php?CrT='+CrT+'&rIdT='+rIdT+'&IdL='+IdL;
