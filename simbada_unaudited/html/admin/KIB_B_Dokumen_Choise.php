...
<div align="center">
	<table border="0" width="2050" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
		...
		<tr>
			...
			PERALATAN DAN MESIN <? if($gExt=='Y') {echo "(EXTRAKOMPTABEL)";}?></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<table border="0" width="2050" cellpadding="0" cellspacing="0" style="border:0 solid #000000; font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table2" bordercolor="#000000">
				...
				?>
				<? function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20) {?>
				<tr height="30">
					...
					<td style="border: 1px solid #000000; padding-left:2px"><? echo $x2?></td>
		...
		<tr height="27">
            ...
            <td style="border:1px solid #000000; font-weight: bold; padding-right:2px" align="right"><? echo fConvertToRupiah($gTot)?></td>
            <td style="border: 1px solid #000000">&nbsp;</td>
		    <td style="border: 1px solid #000000">&nbsp;</td>
		</tr>
		<? } ?>
