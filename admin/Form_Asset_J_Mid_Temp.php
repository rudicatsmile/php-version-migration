...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_J_Mid_Temp_.php?gIdT=".$gIdT."&rIDT=".$rIDT."&rNOM=".$rNOM."&IdL=".$_GET['IdL'] ?>">
...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>UNIT KERJA</td>
      <td><input name="f01" type="text" readonly value="<?=$gUnt." : ".strtoupper($mUnt)?>" style="width:450px; border: 1px solid #C0C0C0; padding-left: 6px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
