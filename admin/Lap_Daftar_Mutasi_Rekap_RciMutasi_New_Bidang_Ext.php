<?php
	function ViewBidang($KdBDG,$mUpb,$mThn,$nThn,$mG,$LoadMutasi,$UID,$LoadExtrac,$rPil)  #**#
	{
		$iGG  = 1;
		...
		while ($mRoB = mysql_fetch_array($nRsB, MYSQL_BOTH))
		{
			...
			if ($tView!=0) {
				...
				if ($rPil==2 || $rPil==3 || $rPil==4) {ViewJenis($KdAsT,$mUpb,$mThn,$nThn,$mG,$LoadMutasi,$UID,$LoadExtrac,$rPil);}
				$iGG++;
			}
		}
	}
