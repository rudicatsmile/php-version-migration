...
$div   = 0;
if ($mts!=""){
	#$CntItem = fGlobalNEW("IfNull(count(*),0)","ta_kib_".$TbL.$mts,"Kd_UPB:Tgl_Perolehan:extracom:Kd_Aset_To",$uNT."%:".$rTH."-12-31:N:07%","LIKE:<=:=:LIKE","",DatabaseSB,$ConSB,"");
	$CntItem = fGlobalNEW("IfNull(count(*),0)","ta_kib_108","Kd_UPB:Tgl_Perolehan:extracom:Kd_Aset_To",$uNT."%:".$rTH."-12-31:".$ExtR.":07%","LIKE:<=:=:LIKE","",DatabaseSB,$ConSB,"");
}
else{
	if ($TbL=="g"){
		#$nSQL = "SELECT IDT FROM ta_kib_g WHERE extracom='N' AND Kd_UPB LIKE '".$uNT."%' AND Tgl_Perolehan <='".$rTH."-12-31' AND Kd_Pemilik LIKE '__' AND Status='' GROUP BY Referensi, LEFT(Kd_UPB,11), Ref_History";
		$nSQL = "SELECT IDT FROM ta_kib_108 WHERE extracom='".$ExtR."' AND Kd_UPB LIKE '".$uNT."%' AND Tgl_Perolehan <='".$rTH."-12-31' AND Kd_Pemilik LIKE '__' AND Status='' GROUP BY Referensi, LEFT(Kd_UPB,11), Ref_History";
		...
		#$CntItem = fGlobalNEW("IfNull(count(*),0)","ta_kib_".$TbL.$mts,"Kd_UPB:Tgl_Perolehan:extracom",$uNT."%:".$rTH."-12-31:N","LIKE:<=:=","",DatabaseSB,$ConSB,"");
		$CntItem = fGlobalNEW("IfNull(count(*),0)","ta_kib_108".$mts,"Kd_UPB:Tgl_Perolehan:extracom",$uNT."%:".$rTH."-12-31:".$ExtR,"LIKE:<=:=","",DatabaseSB,$ConSB,"");
	}
}
if ($CntItem>=$rPG){
...
<table border="0" align="center" cellspacing="0" style="width:1400px; font-size: 8pt; font-family: Calibri; border-collapse: collapse">
  <tr>
	...
	<tr>
	  <td colspan="3" align="center" style="font-size: 13pt; font-weight: bold">REKAPITULASI DATA PENYUSUTAN <? if ($ExtR=="Y"){echo "( EXTRACOM )";} else {echo "( NON EXTRACOM )";} ?></td>
	</tr>
	<tr>
	...
	<table border="0" align="center" width="1400" cellspacing="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
	  <tr height="20">
		<td width="31" style="text-align:center; font-weight:bold; border:1px solid #000000">NO</td>
		<td width="43" style="text-align:center; font-weight:bold; border:1px solid #000000">KODE BARANG</td>
		<td width="43" style="text-align:center; font-weight:bold; border:1px solid #000000">REFERENSI</td>
		<td width="46" style="text-align:center; font-weight:bold; border:1px solid #000000">REGISTER</td>
		<td width="232" style="text-align:center; font-weight:bold; border:1px solid #000000">JENIS / OBJEK / NAMA BARANG</td>
		<td width="46" style="text-align:center; font-weight:bold; border:1px solid #000000">UMUR EKONOMIS (Tahun) </td>
		<td width="148" style="text-align:center; font-weight:bold; border:1px solid #000000">KETERANGAN</td>
		<td width="118" style="text-align:center; font-weight:bold; border:1px solid #000000">
		<?
		...
		?>		</td>
		<td width="101" style="text-align:center; font-weight:bold; border:1px solid #000000">
		<?
		...
		?>		</td>
		<td width="61" style="text-align:center; font-weight:bold; border:1px solid #000000">TAHUN PEROLEHAN</td>
		<td width="81" style="text-align:center; font-weight:bold; border:1px solid #000000">NILAI <br>PEROLEHAN</td>
		<td width="81" style="text-align:center; font-weight:bold; border:1px solid #000000">ATRIBUSI/<br>PENAMBAHAN</td>
		<td width="81" style="text-align:center; font-weight:bold; border:1px solid #000000">AKUMULASI PENYUSUTAN S.D <br>TAHUN <?=((int)$rTH-1)?></td>
		<td width="81" style="text-align:center; font-weight:bold; border:1px solid #000000">BEBAN PENYUSUTAN <br>TAHUN <?=$rTH?></td>
		<td width="81" style="text-align:center; font-weight:bold; border:1px solid #000000">AKUMULASI PENYUSUTAN S.D <br>TAHUN <?=$rTH?></td>
		<td width="40" style="text-align:center; font-weight:bold; border:1px solid #000000">NILAI BUKU</td>
	    <td width="54" style="text-align:center; font-weight:bold; border:1px solid #000000">SISA UMUR (Bulan) </td>
	  </tr>
	  <tr height="20">
	  ...
	  if ($mts!=""){
		#$nSQ = "SELECT * FROM ta_kib_".$TbL.$mts." WHERE extracom='N' AND Kd_UPB LIKE '".$uNT."%' AND Tgl_Perolehan <= '".$rTH."-12-31' AND Kd_Aset_To LIKE '07%' ORDER BY Tgl_Perolehan, Kd_Aset, No_Register LIMIT $iPG,$rPG";
		...
		#if ($TbL=="g"){
		if ($rAS=="1.5.4"){
			#$nSQ = "SELECT * FROM ta_kib_g WHERE extracom='N' AND Kd_UPB LIKE '".$uNT."%' AND Tgl_Perolehan <='".$rTH."-12-31' AND Kd_Pemilik LIKE '__' AND Status='' 
			...
			ORDER BY Tgl_Perolehan, Kd_Aset, No_Register LIMIT $iPG,$rPG";
		  	...
		  	#$nSQ = "SELECT * FROM ta_kib_".$TbL.$mts." WHERE extracom='N' AND Kd_UPB LIKE '".$uNT."%' AND Tgl_Perolehan <= '".$rTH."-12-31' ORDER BY Tgl_Perolehan, Kd_Aset, No_Register LIMIT $iPG,$rPG";
	  ...
	  while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	  {
		...
		#if ($TbL=="g"){
		if ($rAS=="1.5.4"){
			$Col09 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post","Kd_UPB:Referensi:Ref_History:Tanggal:Crit:extracom",$rUPB."%:".$rEF.":".$RefH.":".$rTH."-12-31:%:".$ExtR,"LIKE:=:=:<=:LIKE:=","",DatabaseSB,$ConSB,"");
			$Col10 = fGlobalNEW("IfNull(sum(Nilai_Tambah),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:Ref_History:PerLap:SdhMutasi",$rUPB."%:".$rEF.":".$RefH.":".$rTH.":".$ExtR,"LIKE:=:=:<=:=","",DatabaseSB,$ConSB,"");
			$Col09 = $Col09 - $Col10;
			
			$Col11 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:Ref_History:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$RefH.":".((int)$rTH-1).":Y:IV:N:".$ExtR,"LIKE:=:=:=:=:=:=:=","",DatabaseSB,$ConSB,"");
			$Col12 = fGlobalNEW("IfNull(sum(Beban_Tahun_Berjalan),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:Ref_History:PerLap:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$RefH.":".$rTH.":N:".$ExtR,"LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
			$ColDT = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0):IfNull(sum(Nilai_Buku),0):Ms_Manfaat_Sisa_Dlm_Bln","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:Ref_History:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$RefH.":".$rTH.":Y:IV:N:".$ExtR,"LIKE:=:=:=:=:=:=:=","",DatabaseSB,$ConSB,"");
		}
		else{
			$Col09 = $mRo['Harga'];
			$Col10 = fGlobalNEW("IfNull(sum(Nilai_Tambah),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:PerLap:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$rTH.":N:".$ExtR,"LIKE:=:<=:=:=","",DatabaseSB,$ConSB,"");
			$Col11 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rEF.":".((int)$rTH-1).":Y:IV:N:".$ExtR,"LIKE:=:=:=:=:=:=","",DatabaseSB,$ConSB,"");
			$Col12 = fGlobalNEW("IfNull(sum(Beban_Tahun_Berjalan),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:PerLap:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$rTH.":N:".$ExtR,"LIKE:=:=:=:=","",DatabaseSB,$ConSB,"");
			$ColDT = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0):IfNull(sum(Nilai_Buku),0):Ms_Manfaat_Sisa_Dlm_Bln","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Referensi:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rEF.":".$rTH.":Y:IV:N:".$ExtR,"LIKE:=:=:=:=:=:=","",DatabaseSB,$ConSB,"");
		}		
		$ColDT = explode(":",$ColDT);
		$Col13 = $ColDT[0];
		
		if ($Col13>($Col09 + $Col10)){$Col13 = $Col09 + $Col10;}
		if ($Col11>($Col09 + $Col10)){$Col11 = $Col09 + $Col10;}
	  ...
	  <tr height="23">
		...
		<td valign="top" style="border:1px solid #000000; padding-left:0px; text-align:center"><? if ($Umur!=0) {echo $Umur;} else {echo "-";}?></td>
		...
		<td valign="top" style="border:1px solid #000000"><? if ($Col07!=0){echo $Col07;}else{echo "-";}?></td>
	  ...
	  <? if ($CntItem==($iG-1)) {
		if ($TbL=="g"){
			$tCol09 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post","Kd_UPB:Kd_Aset:Tanggal:Crit:extracom",$rUPB."%:07%:".$rTH."-12-31:%:".$ExtR,"LIKE:LIKE:<=:LIKE:=","",DatabaseSB,$ConSB,"");
			$tCol10 = fGlobalNEW("IfNull(sum(Nilai_Tambah),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:SdhMutasi:extracom",$rUPB."%:07%:".$rTH.":N:".$ExtR,"LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
			$tCol09 = $tCol09 - $tCol10;
			
			$tCol11 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:07%:".((int)$rTH-1).":Y:IV:N:".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
			$tCol12 = fGlobalNEW("IfNull(sum(Beban_Tahun_Berjalan),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:SdhMutasi:extracom",$rUPB."%:07%:".$rTH.":N:".$ExtR,"LIKE:LIKE:=:=:=","",DatabaseSB,$ConSB,"");
			$tColDT = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0):IfNull(sum(Nilai_Buku),0):Ms_Manfaat_Sisa_Dlm_Bln","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:07%:".$rTH.":Y:IV:N:".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
		}
		else{
			if ($TbL=="a"){$rKD="01";}
			if ($TbL=="b"){$rKD="02";}
			...
			if ($TbL=="e"){$rKD="05";}
			if ($TbL=="f"){$rKD="06";}
			$tCol09 = fGlobalNEW("IfNull(sum(Harga),0)","ta_kib_".$TbL.$mts,"Kd_UPB:Tgl_Perolehan:extracom",$uNT."%:".$rTH."-12-31:".$ExtR,"LIKE:<=:=","",DatabaseSB,$ConSB,"");
			$tCol10 = fGlobalNEW("IfNull(sum(Nilai_Tambah),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:SdhMutasi:extracom",$rUPB."%:".$rKD."%:".$rTH.":N:"$ExtR,"LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
			$tCol11 = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rKD.":".((int)$rTH-1).":Y:IV:N:".$ExtR,"LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
			$tCol12 = fGlobalNEW("IfNull(sum(Beban_Tahun_Berjalan),0)","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:SdhMutasi:extracom",$rUPB."%:".$rKD."%:".$rTH.":N:".$ExtR,"LIKE:LIKE:=:=:=","",DatabaseSB,$ConSB,"");
			$tColDT = fGlobalNEW("IfNull(sum(Koreksi_Akumulasi),0):IfNull(sum(Nilai_Buku),0):Ms_Manfaat_Sisa_Dlm_Bln","ta_kib_post_penyusutan_bulanan_108","Kd_UPB:Kd_Aset:PerLap:Nilai_Akhir:Triwulan:SdhMutasi:extracom",$rUPB."%:".$rKD."%:".$rTH.":Y:IV:N:".$ExtR,"LIKE:LIKE:=:=:=:=:=","",DatabaseSB,$ConSB,"");
		}		
		$tColDT = explode(":",$tColDT);
		$tCol13 = $tColDT[0];
		if ($TbL=='g'){
			$tCol14 = ($tCol09+$tCol10)-$tCol13;
		}
		else{
			$tCol14 = $tColDT[1];
		}
...
<tr>
  ...
  <div class="pagging"> 
	...
	if ($CntItem>0)
	{
		...
		{
			?>
			<a href="<?="Tabel_Masa_Manfaat_Rekap_Bulan.php?iPG=".$iR."&mts=".$mts."&rTH=".$_GET['rTH']."&rAS=".$_GET['rAS']."&uNT=".$_GET['uNT']."&uUP=".$_GET['uUP']."&uSU=".$_GET['uSU']."&gHriC=".$_GET['gHriC']."&gBlnC=".$_GET['gBlnC']."&gThnC=".$_GET['gThnC']."&IdL=".$_GET['IdL']?>"><?="<b>".substr('00'.$i,-2,2)."</b>"?></a><? if ($i==100) {echo "<br>";}?><?=str_repeat('&nbsp;',0)?>
			<? 
			$i++;
		}
	}
