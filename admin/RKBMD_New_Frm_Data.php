...
function RowList($stLOCK,$CrT,$iG,$mRo1,$mRo2,$mRo3,$rIdT,$IdL,$pad,$DatabaseSB,$ConSB,$xB,$Link,$eCeK)
{
	...
	?>
	<tr height="40"> 
	  <td width="25" style="border-bottom:1px #999 dotted; text-align:center" <?=$gBG?>><?php if ($iG){echo $iG.".";}?></td>
	  ...
	  <td width="450" style="border-bottom:1px #000 dotted; padding-left:<?=$pad?>px; border-left:1px #ccc solid" <?=$gBG?>><?php if ($CrT=='rekn') {echo $xB."<font style='color:#0000ff'>".$mRo3."</font>".$gJnSR;} else {echo $xB.$mRo3;}?></td>
	  ...
	  <?php
	   ...
	   if ($CrT=='rekn'){
			...
			<tr height="22">
			  ...
			  <td width="15">:</td>
			  <td><input name="fKebU" id="fKebU" type="text" <?=$eReDB?> value="<?=$gKebU?>" onkeypress="if (event.keyCode==13) {saveRECO('<?=$stLOCK?>','maksimum_jumlah',this,'<?=$rIdT?>','<?=$_GET['IdL']?>'); return false;}" onkeyup="NumValidate(this)" style="height:15px; border-radius:0px; text-align:center; width:40px; border: 1px solid #C0C0C0 <?php if ($gOLD==''){?>; background:#CCFF99<?php } ?>"/>
		      <input name="fKebT" id="fKebT" type="text" <?=$eReD?> value="<?=$gKebT?>" onkeypress="if (event.keyCode==13) {saveRECO('<?=$stLOCK?>','maksimum_satuan',this,'<?=$rIdT?>','<?=$_GET['IdL']?>'); return false;}" style="height:15px; border-radius:0px; text-align:left; width:70px; border: 1px solid #C0C0C0<?php if ($gOLD==''){?>; background:#99FF66<?php } ?>"/></td>
			  </tr>
			<tr height="22">
			  ...
			  <td>
				...
				<option value="" <?php if ($gPenU==''){ echo "selected";}?>></option>
				<option value="Belanja Modal" <?php if ($gPenU=='Belanja Modal'){ echo "selected";}?>>Belanja Modal</option>
				<option value="Hibah" <?php if ($gPenU=='Hibah'){ echo "selected";}?>>Hibah</option>
				<option value="Tukar Guling" <?php if ($gPenU=='Tukar Guling'){ echo "selected";}?>>Tukar Guling</option>
				<option value="Lainnya" <?php if ($gPenU=='Lainnya'){ echo "selected";}?>>Lainnya</option>
				</select>
				
			  </td>
			  <td>Optimalisasi (<i>auto</i>)</td>
			  <td>:</td>
			  <td><input name="fOptI" id="fOptI" type="text" <?=$eReDB?> value="<?=$gOptI?>" onkeypress="if (event.keyCode==13) {saveRECO('<?=$stLOCK?>','optimalisasi_jumlah',this,'<?=$rIdT?>','<?=$_GET['IdL']?>'); return false;}" onkeyup="NumValidate(this)" style="height:15px; border-radius:0px; text-align:center; width:40px; border: 1px solid #C0C0C0 <?php if ($gOLD==''){?>; background:#CCFF99<?php } ?>"/>
		      <input name="fOptT" id="fOptT" type="text" <?=$eReD?> value="<?=$gOptT?>" onkeypress="if (event.keyCode==13) {saveRECO('<?=$stLOCK?>','optimalisasi_satuan',this,'<?=$rIdT?>','<?=$_GET['IdL']?>'); return false;}" style="height:15px; border-radius:0px; text-align:left; width:70px; border: 1px solid #C0C0C0<?php if ($gOLD==''){?>; background:#99FF66<?php } ?>"/></td>
			  </tr>
			<tr height="22">
			  <td>&nbsp;</td>
			  <td>&nbsp;</td>
