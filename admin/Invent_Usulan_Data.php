...
WHERE P1.Kd_UPB LIKE '$gUnT%' AND (P1.Tanggal BETWEEN '$gTA' AND '$gTB') AND P1.Tanggal NOT LIKE '%2019%' AND P1.Jenis LIKE '$gJNS' AND P1.Jenis NOT LIKE 'PH' $CrT ORDER BY P1.Tanggal DESC,P1.IDT DESC LIMIT 0,500";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="22"> 
	  ...
	  <td width="70" <?=$gBG?> style="border-bottom:1px #999999 dotted; padding-left:3px; padding-right:3px; border-left:1px #ccc solid; text-align:center; font-weight:<?=$WgT?>"><?php if (substr($mRo6,0,4)!='0000') {echo fConvertDateShort($mRo6);}?></td>
