...
$URL="KIB-I.php?FrmG=".$_GET['FrmG']."&eMuT=".$eMuT."&gMuT=".$fMuT."&gExt=".$gExt."&gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gRua=".$gRua."&gThn=".$gThn."&gThnA=".$gThnA."&gBid=".$gBid."&gKel=".$gKel."&gOBJ=".$gOBJ."&gRin=".$gRin."&gFin=".$gFin."&IdL=".$_GET['IdL'];
header("Location: ".$URL);
?>
