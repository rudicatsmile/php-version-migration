...
if ($SnsIDT=='')
{
	...
	DiatasTanahMilik='PD',
	DiatasTanahMilik_PDL_Memo='',
	DiatasTanahMilik_PL_Memo='',
	
	JenisPerkerasanJalan='sesuai',
	JenisPerkerasanJalanMemo='',
	JenisBahanStrukturJalan='sesuai',
	JenisBahanStrukturJalanMemo='',
	NomorRuasJalan='sesuai',
	NomorRuasJalanMemo='',
	NomorIrigasiJalan='sesuai',
	NomorIrigasiJalanMemo=''";
	$rs = mysql_query($SQ);
}
else
{
...
DiatasTanahMilik as A37,
DiatasTanahMilik_PDL_Memo as A38,
DiatasTanahMilik_PL_Memo as A39,

JenisPerkerasanJalan as A40,
JenisPerkerasanJalanMemo as A41,
JenisBahanStrukturJalan as A42,
JenisBahanStrukturJalanMemo as A43,
NomorRuasJalan as A44,
NomorRuasJalanMemo as A45,
NomorIrigasiJalan as A46,
NomorIrigasiJalanMemo as A47,
MerupakanAtribusi_induk as A48,
DataSensusFix as A49 
...
$CkMil2MemorR = "disabled";
$CkMil4MemorR = "disabled";
...
$CkKrsM = ""; $CkKrsR = "";
if ($mR[40]=='sesuai') {
	$CkKrs1 = "checked"; $CkKrsR = 'disabled';
}
else {
	$CkKrs2 = "checked"; $CkKrsM = $mR[41];
}

$CkStr1 = ""; $CkStr2 = ""; 
$CkStrM = ""; $CkStrR = "";
if ($mR[42]=='sesuai') {
	$CkStr1 = "checked"; $CkStrR = 'disabled';
}
else {
	$CkStr2 = "checked"; $CkStrM = $mR[43];
}

$CkRua1 = ""; $CkRua2 = ""; 
$CkRuaM = ""; $CkRuaR = "";
if ($mR[44]=='sesuai') {
	$CkRua1 = "checked"; $CkRuaR = 'disabled';
}
else {
	$CkRua2 = "checked"; $CkRuaM = $mR[45];
}

$CkIri1 = ""; $CkIri2 = ""; 
$CkIriM = ""; $CkIriR = "";
if ($mR[46]=='sesuai') {
	$CkIri1 = "checked"; $CkIriR = 'disabled';
}
else {
	$CkIri2 = "checked"; $CkIriM = $mR[47];
}
...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:910px">
	<tr height="30">
	  <td width="120" style="border-bottom:1px solid #ccc"><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="818">&nbsp;</td>
          <td width="132">Format : III.A.4</td>
        </tr>
      </table></td>
  </tr>
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioNma" value="sesuai" <?=$CkNmb1?> onchange="saveDATA('NmBarang','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145">
		  <label><input type="radio" name="radioNma" value="tidaksesuai" <?=$CkNmb2?> onchange="saveDATA('NmBarang','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioSpe" value="sesuai" <?=$CkSpc1?> onchange="saveDATA('SpecNamaBarang','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr style="font-weight:bold">
          <td width="30">E.</td>
          <td width="130">Jenis perkerasan Jalan</td>
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="fForm" id="fForm" readonly value="-" style="width:300px; background:#fff" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioKrs" value="sesuai" <?=$CkKrs1?> onchange="saveDATA('JenisPerkerasanJalan','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioKrs" value="tidaksesuai" <?=$CkKrs2?> onchange="saveDATA('JenisPerkerasanJalan','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiKRS" id="tsesuaiKRS" value="<?=$CkKrsM?>" <?=$CkKrsR?> onkeypress="if (event.keyCode==13){saveDATA('JenisPerkerasanJalanMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>
	  </td>
  </tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr style="font-weight:bold">
          <td width="30">F.</td>
          <td width="130">Jenis Bahan Struktur Jembatan</td>
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="fForm" id="fForm" readonly value="-" style="width:300px; background:#fff" /></td>
        </tr>
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioStr" value="sesuai" <?=$CkStr1?> onchange="saveDATA('JenisBahanStrukturJalan','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioStr" value="tidaksesuai" <?=$CkStr2?> onchange="saveDATA('JenisBahanStrukturJalan','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiSTR" id="tsesuaiSTR" value="<?=$CkStrM?>" <?=$CkStrR?> onkeypress="if (event.keyCode==13){saveDATA('JenisBahanStrukturJalanMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr style="font-weight:bold">
          <td width="30">G.</td>
          <td width="130">Nomor Ruas Jalan</td>
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="fForm" id="fForm" readonly value="-" style="width:300px; background:#fff" /></td>
        </tr>
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioRua" value="sesuai" <?=$CkRua1?> onchange="saveDATA('NomorRuasJalan','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioRua" value="tidaksesuai" <?=$CkRua2?> onchange="saveDATA('NomorRuasJalan','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiRUA" id="tsesuaiRUA" value="<?=$CkRuaM?>" <?=$CkRuaR?> onkeypress="if (event.keyCode==13){saveDATA('NomorRuasJalanMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>
  ...
  <tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr style="font-weight:bold">
          <td width="30">H.</td>
          <td width="130">Nomor Jaringan Irigasi</td>
          <td width="20">:</td>
          <td colspan="5"><input type="text" name="fForm" id="fForm" readonly value="-" style="width:300px; background:#fff" /></td>
        </tr>
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioIri" value="sesuai" <?=$CkIri1?> onchange="saveDATA('NomorIrigasiJalan','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145"><label>
            <input type="radio" name="radioIri" value="tidaksesuai" <?=$CkIri2?> onchange="saveDATA('NomorIrigasiJalan','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />
            Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
          <td><input type="text" name="tsesuaiIRI" id="tsesuaiIRI" value="<?=$CkIriM?>" <?=$CkIriR?> onkeypress="if (event.keyCode==13){saveDATA('NomorIrigasiJalanMemo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:280px" /></td>
        </tr>
      </table>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr style="font-weight:bold">
          ...
          <td width="20">:</td>
          <td width="77">
		  <label><input type="radio" name="radioAda" value="ada" <?=$CkAda1?> onchange="saveDATA('KeberadaanBarang','ada','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Ada</label></td>
          <td width="196">
		  <label><input type="radio" name="radioAda" value="tidakada"<?=$CkAda2?> onchange="saveDATA('KeberadaanBarang','tidakada','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')"  />Tidak Ada</label></td>
          <td width="147">&nbsp;</td>
          <td width="20">&nbsp;</td>
          <td width="290">&nbsp;</td>
        </tr>
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="25" style="font-weight:bold">
          <td width="27" rowspan="8" valign="top">M.</td>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioAlm" value="sesuai" <?=$CkAlm1?> onchange="saveDATA('Alamat','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145">
		  <label><input type="radio" name="radioAlm" value="tidaksesuai" <?=$CkAlm2?> onchange="saveDATA('Alamat','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Tidak Sesuai</label></td>
          <td width="147">Sebutkan yang seharusnya</td>
          <td width="20">:</td>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioKon" value="B" <?=$CkKon1?> onchange="saveDATA('KondisiBarang','B','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Baik (B)</label></td>
          <td width="145">
		  <label><input type="radio" name="radioKon" value="RR" <?=$CkKon2?> onchange="saveDATA('KondisiBarang','RR','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Rusak Ringan (RR)</label></td>
          <td width="147">
		  <label><input type="radio" name="radioKon" value="RB" <?=$CkKon3?> onchange="saveDATA('KondisiBarang','RB','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Rusak Berat (RB)</label></td>
          <td width="20"></td>
          <td>&nbsp;</td>
        </tr>
      </table>	  </td>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="30" style="font-weight:bold">P.</td>
          <td width="138" style="font-weight:bold">Penggunaan Barang</td>
          <td width="23">:</td>
          <td colspan="4" style="font-weight:bold">
		  <label><input type="radio" name="radioGun" value="PD" <?=$CkGun1?> onchange="saveDATA('PenggunaanBarang','PD','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Daerah</label></td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr height="25">
		  ...
		  <label><input type="radio" name="radioGun" value="PP" <?=$CkGun2?> onchange="saveDATA('PenggunaanBarang','PP','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Pusat</label>		  </td>
        ...
        <tr height="25">
          ...
          <td>:</td>
          <td>
		  <input type="text" name="PP_Nama" id="PP_Nama" value="<?=$PP_Ada_Nama?>" <?=$PP_Ada_NamaR?> onkeypress="if (event.keyCode==13){saveDATA('PP_dasarpenggunaan_ada_nama',this,'Y','TbL2','<?=$IdT?>','<?=$SnsIDG?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:250px" />		  </td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td style="font-weight:bold">
		  <label><input type="radio" name="radioGun" value="PDL" <?=$CkGun3?> onchange="saveDATA('PenggunaanBarang','PDL','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Daerah Lainya</label>		  </td>
          <td style="font-weight:bold; color:#0000FF">Dasar Penggunaan:</td>
          <td></td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td style="font-weight:bold">
		  <label><input type="radio" name="radioGun" value="PL" <?=$CkGun4?> onchange="saveDATA('PenggunaanBarang','PL','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pihak Lain</label>		  </td>
		  <td style="font-weight:bold; color:#0000FF">Dasar Penggunaan : </td>
          <td></td>
          <td>&nbsp;</td>
        </tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="27" style="font-weight:bold">Q.</td>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="26" style="font-weight:bold">R.</td>
          <td width="137" style="font-weight:bold">Jalan diatas tanah milik</td>
          <td width="21">:</td>
          <td width="254"><label><input type="radio" name="radioMilik" value="PD" <?=$CkMil1?> onchange="saveDATA('DiatasTanahMilik','PD','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Daerah</label></td>
          <td width="340">&nbsp;</td>
          <td width="132">&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><label><input type="radio" name="radioMilik" value="PDL" <?=$CkMil2?> onchange="saveDATA('DiatasTanahMilik','PDL','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Daerah Lainnya, sebutkan</label></td>
          <td><input type="text" name="CkMil2Memo" id="CkMil2Memo" value="<?=$CkMil2Memo?>" <?=$CkMil2MemorR?> onkeypress="if (event.keyCode==13){saveDATA('DiatasTanahMilik_PDL_Memo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:292px" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><label><input type="radio" name="radioMilik" value="PP" <?=$CkMil3?> onchange="saveDATA('DiatasTanahMilik','PP','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pemerintah Pusat</label></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr height="25">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><label><input type="radio" name="radioMilik" value="PL" <?=$CkMil4?> onchange="saveDATA('DiatasTanahMilik','PL','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Pihak Lain, sebutkan</label></td>
          <td><input type="text" name="CkMil4Memo" id="CkMil4Memo" value="<?=$CkMil4Memo?>" <?=$CkMil4MemorR?> onkeypress="if (event.keyCode==13){saveDATA('DiatasTanahMilik_PL_Memo',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:292px" /></td>
          <td>&nbsp;</td>
        </tr>
	  </table>	  </td>
  </tr>
  ...
  <tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr height="24" style="font-weight:bold">
		  ...
		  <td width="25">:</td>
		  <td colspan="2"><input type="text" name="TitikKoordinat" id="TitikKoordinat" value="<?=$Koordinat?>" onkeypress="if (event.keyCode==13){saveDATA('TitikKoordinat',this,'Y','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>');}" style="width:292px" />
    <a href="#" class="btn-lokasi-peta" onclick="OpenAccMAP('<?= $ReO ?>','750','450','center'); return false;"><svg class="icon-map" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <tr style="font-weight:bold">
          ...
          <td colspan="2">
			...
			<input type="button" value="Upload" onclick="P_Upload('Img','<?=$AsT?>','<?=$SnsIDT?>','<?=$ReO?>','<?=$IdT?>','<?=$IdL?>')">		  </td>
        </tr>
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	...
	?>
        ...
        <tr style="font-weight:bold">
          <td rowspan="3">&nbsp;</td>
          <td colspan="3" valign="top"><div id="loadImgLokasi" class="loadImgLokasi" style="border:1px solid; width:454px; height:150px" >
            <table align="center" cellpadding="0" class="table-listpop" cellspacing="0" width="100%" height="150" border="0">
			  ...
			  <tr height="18">
				...
				<td valign="top" style="border-bottom:1px dotted #CCCCCC; padding-top:5px; padding-bottom:5px"><?=$mRo[67]?></td>
				...
				<a href="#" onclick="alert('Simador data -> Access denied...!!!'); return false;" class="ico delt">&nbsp;</a>				</td>
			   </tr>
			   <?php } ?>
               <?php
				$iG=1;
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
				  ...
				  <tr height="18">
					...
					<a href="#" onclick="remoIMG('Img','<?=$AsT?>','_Tabel','<?=$ReO?>','<?=$rIdT?>','<?=$IdT?>','<?=$IdL?>'); return false;" class="ico dele">&nbsp;</a></td>
				  </tr>
				  <?php
					$iG++;
				}
               ...
               <?php
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
				  ...
				  <tr height="18">
					...
					<a href="#" onclick="remoIMG('Img','<?=$AsT?>','','<?=$ReO?>','<?=$rIdT?>','<?=$IdT?>','<?=$IdL?>'); return false;" class="ico dele">&nbsp;</a></td>
				  </tr>
				  <?php
					$iG++;
				}
          ...
          <td width="403" rowspan="3" valign="top">
			...
			<tr height="24">
			  ...
			  <label><input type="radio" name="radioFIX" value="Y" <?=$CkFix3?> onchange="saveDATA('DataSensusFix','Y','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Selesai</label>			  </td>
			</tr>
			</table>			</td>
        </tr>
        <tr height="50" style="font-weight:bold">
		  ...
		  <input type="button" value="Upload" onclick="P_Upload('Pdf','<?=$AsT?>','<?=$SnsIDT?>','<?=$ReO?>','<?=$IdT?>','<?=$IdL?>')">		  </td>
        </tr>
        <tr style="font-weight:bold">
              ...
              <?php
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
				  ...
				  <tr height="18">
					...
					<a href="#" onclick="remoIMG('Pdf','<?=$AsT?>','_Tabel','<?=$ReO?>','<?=$rIdT?>','<?=$IdT?>','<?=$IdL?>'); return false;" class="ico dele">&nbsp;</a></td>
				  </tr>
				  <?php
					$iG++;
				}
              ...
              <?php
				...
				while ($mRx = mysql_fetch_array($nRx, MYSQL_BOTH))
				{
				  ...
				  <tr height="18">
					...
					<a href="#" onclick="remoIMG('Pdf','<?=$AsT?>','','<?=$ReO?>','<?=$rIdT?>','<?=$IdT?>','<?=$IdL?>'); return false;" class="ico dele">&nbsp;</a></td>
				  </tr>
				  <?php
					$iG++;
				}
        ...
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td><a href="#" class="ico docu" onclick="formCetakDok('Report_Form_LKI_JLN','<?=$IdT?>','900','400','<?=$IdL?>'); return false;">&nbsp;&nbsp;DOKUMEN CETAK</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
...
*/
  ...
  function OpenAccMAP(ReO, w, h, pos) {
    ...
    if (win != null) {
      ...
      URL_Top = "UploadIMG_Top.php?FrmG=Lokasi Peta -> KIB D (ASET JALAN & JEMBATAN)";
      URL_Mid = "UploadMAP_Mid.php?" + "<?= "rCRT=d&rIDT=" . $IdT . "&IdL=" . $IdL . "&src=lki&SnsIDT=" . $SnsIDT ?>";
