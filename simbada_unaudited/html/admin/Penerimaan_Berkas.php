...
<form name="myfrm" method="post" action="<?php echo "Penerimaan_Berkas_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="1858">
    ...
    <tr>
      ...
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><input class="text" type="text" name="fFind" id="fFind" value="<? echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986; width:200px" /></td>
