...
if ($tRo > 0) {
	...
	$tmpGLng  = $mRo['lng'];
        ...
        //-2.562076396904316, 115.38082635806937
	$gLat  = "-2.562076";
	$gLng  = "115.380826";
	$gLatLng  = "LatLng(-2.562076, 115.380826)";
	$Nm_Aset = '';
	$tmpGLat  = '';
	$tmpGLng  = '';
}
...
<body>
	<table align="center" style="width:800px">
		<div center>
			<form method="post" name="myfrm" action="<?= "UploadMAP_Mid_.php?rIDT=" . $rIDT . "&rCRT=" . $rCRT . "&IdL=" . $_GET['IdL'] . (isset($_GET['src']) ? "&src=" . $_GET['src'] . "&SnsIDT=" . $_GET['SnsIDT'] : "") ?>" enctype="multipart/form-data">
	...
	<script>
		...
		const map = new mapboxgl.Map({
			container: 'mapid',
			attribution: 'Pemerintah Kabupaten Balangan',
