...
<tr>
  	<td style="text-align:right">Format : III.B.2&nbsp;</td>
</tr>
<tr>
  	<td>LAPORAN HASIL INVENTARISASI (LHI)</td>
</tr>
<tr>
  	<td>REKAPITULASI BMD TIDAK ADA KARENA TIDAK DIKETEMUKAN</td>
</tr>
<tr>
  	<td><?=$NmA?></td>
</tr>
...
<tr style="text-align:center; font-weight:bold">
	...
	<td width="70" style="border:1px solid #000">Tahun Perolehan </td>
...
AND P1.KeberadaanBarang='tidakada' 
AND P1.KeberadaanBarang_tidakada='tidakditemukan' 
...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="22">
	  ...
	  <td style="border:1px solid #000; text-align:center"><?=fConvertDateFull($mRo[15])?></td>
