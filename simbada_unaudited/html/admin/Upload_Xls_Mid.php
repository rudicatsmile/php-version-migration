...
if (isset($_POST['Simpan']))
{
	if ($_POST['Simpan']=="Close")
	{
		...
		this.window.open ('<? echo $URLK ?>','WinOpenXLS_Mid<?=$gKib?>')
		this.window.focus()
...
<body>
<form name="uploadfile" action="<? echo "Upload_Xls_Mid.php?gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gThn=".$gThn."&gKib=".$gKib."&IdL=".$_GET['IdL'] ?>" method="post" enctype="multipart/form-data">
