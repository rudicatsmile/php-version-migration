    ...
    <tr> 
      ...
      <td valign="middle"> <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            ...
            <td width="8%">CARI</td>
            <td width="35%"> <input class="text" type="text" name="fFind" value="<? echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
            <td width="2%">&nbsp;</td>
	  ...
	  if ($gUpb=="All") {$zUpb = $zSub.".%";}
		...
		do
		  ...
		  <tr height="23" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
			<td style="border-bottom: #999999 dotted 1px; text-align:center; border-right:#999999 dotted 1px; padding-left:2px" ><? echo $iG?>.</td>
			...
			<td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px"  onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
			  <?
				...
				{echo $mRo['Keterangan'];}
				?>        </td>
        <td style="text-align:center; border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px"  onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> <?=fConvertDateShort($mRo['Tgl_Perolehan'])?></td>
        ...
        <td style="border-bottom:#999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px"  align="right" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <? echo $ClR?>> <?=fConvertToRupiah($gNIL)?>        </td>
        <td style="border-bottom: #999999 dotted 1px"  align="center">
		<a href="#" class="ico <?=$del?>" onclick="P_DeleteR('<?=$CeK?>','<?=$ThN?>','<?=$KiB?>','<?=$mRo['IDT']?>','<?=$RegGrp?>','<?=$ReO?>'); return false">&nbsp;Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="ico edit" onclick="EditData('950','520','center','<? echo $mRo['IDT']?>'); return false">Edit</a></td>
      </tr>
	  <!--
      <tr> 
        <td colspan="9">
		<table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <tr> 
              ...
              <td width="9">:</td>
              <td width="200">
                <? echo fConvertDateShort($mRo['Sertifikat_Tanggal'])?>              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Jenis</td>
              ...
              <td>:</td>
              <td>
                <? echo $mRo['Hak_Tanah']?>              </td>
              <td>&nbsp;</td>
              <td>Sertifikat Nomor</td>
              <td>:</td>
              <td><? echo $mRo['Sertifikat_Nomor']?></td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Objek</td>
