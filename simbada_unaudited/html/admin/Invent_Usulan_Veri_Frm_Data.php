...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="26"> 
	  ...
	  <td width="170" <?=$gBG?> style="border-bottom:1px #999999 dotted; border-left:1px #ccc solid; text-align:center; font-weight:<?=$WgT?>"><?=$mRo5?><? if (substr($mRo6,0,4)!='0000') {echo "<br>".fConvertDateShort($mRo6);}?></td>
