...
?>
<body>
<table border="0" width="2600" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.2.7</td>
  </tr>
</table>
<table border="0" width="2600" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">KEMITRAAN PIHAK KETIGA</td>
  </tr>
  <tr>
...
<table border="0" width="2600" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td rowspan="2" style="border:1px solid #000">Bentuk<br>
    Pemanfaatan</td>
    <td rowspan="2" style="border:1px solid #000">Mitra<br>
      Pemanfaatan/<br>
      Pihak<br>
    Pemanfaat</td>
    <td colspan="3" style="border:1px solid #000">Jangka waktu</td>
    <td colspan="2" style="border:1px solid #000">Surat Perjanjian</td>
    <td rowspan="2" style="border:1px solid #000">Peruntukan</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    <td style="border:1px solid #000">Jangka<br>
      Waktu<br>
    Pemanfaatan</td>
  ...
  <tr style="text-align:center">
    ...
    <td width="180" style="border:1px solid #000; border-bottom:3px double #000">7</td>
    ...
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">13</td>
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">14</td>
    ...
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">18</td>
    ...
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">21</td>
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">22</td>
    <td style="border:1px solid #000; border-bottom:3px double #000">23</td>
  </tr>
	<?php
	$iGa = 1;
	$t8  = 0;
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.5.2.%' 
	...
	<?php function detaData($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$x20,$xB) {?>
		...
		<td style="border:1px solid #000; text-align:center"><?=$x21?></td>
  ...
  <tr height="19" style="font-weight:bold">
    <td colspan="7" style="border:1px solid #000; text-align:right">T O T A L<?=str_repeat('&nbsp;',20)?></td>
...
<table border="0" width="2600" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
