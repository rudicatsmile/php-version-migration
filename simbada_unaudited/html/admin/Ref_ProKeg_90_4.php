...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px">
  ...
  <tr height="25">
    ...
    <td class="ac">&nbsp;</td>
    <td class="al">
	<input name="fURU" id="fURU" type="text" value="<?=$gURU?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
	...
	style="padding-left:5px; width:445px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="25">
    ...
    <td class="ac">&nbsp;</td>
    <td class="al">
	<input name="fBDG" id="fBDG" type="text" value="<?=$gBDG?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="25">
    ...
    <td class="ac">&nbsp;</td>
    <td class="al">
	<input name="fPRG" id="fPRG" type="text" value="<?=$gPRG?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
...
<table border="0" cellspacing="0" class="table-link" cellpadding="0" align="center" style="width:1000px; height:20px; background: #C9DCD8; font-weight:bold">
  <tr>
    ...
    <td width="670" align="left" style="padding-left:6px">K E G I A T A N
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px; height:30px">
  <tr>
    <td>&nbsp;&nbsp;&nbsp;
	<a href="#" onClick="editDATA('<?=$ReO?>','4','addnew','','','<?=$IdL?>'); return false" class="ico add">&nbsp;Add Item</a>&nbsp;&nbsp;&nbsp;
...
<script languange="javascript">
	...
	function RefreshDATA(IdL)
	{
		...
		gIdM = ReplaceText($("#fPRG").val());
		$(document).ready(function()
		{
			$.ajax({
				url:"Ref_ProKeg_90_4_Data.php",
	...
	function editDATA(ReO,Lev,CrT,IdT,rCek,IdL)
	{
		...
		{
			fKdM = $("#fPRG").val();
			if (fKdM==''){alert('Error program..!!'); return false;}
