...
<body>
  ...
  <table width="1165" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	{
		...
		?>
		<tr height="18"> 
		  <td width="70" valign="top" style="padding-left:5px"><a href="<?php echo $URL?>" target="_top"><?=fConvertDateShort($mRo[0])?></a></td>
		  <td width="120" valign="top"><a href="<?php echo $URL?>" target="_top"><?=$mRo[1]?>&nbsp;</a></td>
		  <td width="120" valign="top"><a href="<?php echo $URL?>" target="_top"><?=$mRo[2]?></a></td>
		  <td width="150" valign="top"><a href="<?php echo $URL?>" target="_top"><?=$mRo[3]?></a></td>
		  <td valign="top"><a href="<?php echo $URL?>" target="_top"><?=$mRo[4]?></a></td>
		  <td width="100" valign="top" style="text-align:right; padding-right:10px"><a href="<?php echo $URL?>" target="_top"><?=fConvertToRupiah($gSPP)?></a></td>
		</tr>
		<?php
		$iG++;
	}
