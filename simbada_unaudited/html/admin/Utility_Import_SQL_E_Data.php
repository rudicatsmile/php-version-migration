...
while($mRo = sqlsrv_fetch_array($rst))
{
	...
	$DtA = fGlobal("IDT:Kd_Ruang:Harga","ta_kib_108","IdTabelMaster:Referensi",$mRo[0].":ATL%","=:LIKE","","");
	$DtA = explode(":",$DtA);
	$IdT = $DtA[0];
	$KdR = $DtA[1];
	$HrG = $DtA[2];
	...
	<tr height="20">
	  ...
	  <td style="border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding-left:2px"><?="<b>".$mRo[30]."</b><br>".$mRo[26]?></td>
	  <td style="border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding-left:2px"><?=$mRo[18].", ".$mRo[19]?></td>
