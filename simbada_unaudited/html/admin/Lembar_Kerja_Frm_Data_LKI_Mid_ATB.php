...
KeberadaanBarang_tidakada_jmlh as A33,
KeberadaanBarang_tidakada as A34 
...
<table align="center" cellpadding="0" class="table-form" cellspacing="0" border="0" style="width:910px">
	<tr height="30">
	  <td width="120" style="border-bottom:1px solid #ccc"><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="818">&nbsp;</td>
          <td width="132">Format : III.A.6</td>
        </tr>
      </table></td>
  </tr>
	...
	<tr style="text-align:center; font-weight:bold; font-size:11pt">
		<td>AKTIVA TIDAK BERWUJUD (ATB)</td>
	</tr>
	<tr style="text-align:center; font-weight:bold; font-size:11pt">
		<td><?=$TiDaer." ".$NmDaer?></td>
	</tr>
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td width="128">
		  <label><input type="radio" name="radioReg" value="sesuai" <?=$CkReg1?> onchange="saveDATA('KdRegister','sesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')" />Sesuai</label></td>
          <td width="145">
		  <label><input type="radio" name="radioReg" value="tidaksesuai" <?=$CkReg2?> onchange="saveDATA('KdRegister','tidaksesuai','N','TbL1','<?=$IdT?>','<?=$SnsIDT?>','<?=$AsT?>','<?=$ReO?>','<?=$IdL?>')"/>Tidak Sesuai</label>		  </td>
  ...
  <tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr height="24" style="font-weight:bold">
          <td width="30">L.</td>
          <td width="140">Merek/Tipe/Spesifikasi Lainnya</td>
          <td width="25">:</td>
          <td colspan="2"><input type="text" name="MerkType" id="MerkType" value="<?=$MerkType?>" style="width:292px" /></td>
        </tr>
	  </table>
	  </td>
  </tr>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="30" style="font-weight:bold">M.</td>
	...
	<tr>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td width="27" style="font-weight:bold">N.</td>
	...
	?>
        ...
        <tr style="font-weight:bold">
          <td>&nbsp;</td>
          <td><a href="#" class="ico docu" onclick="formCetakDok('Report_Form_LKI_ATB','<?=$IdT?>','900','400','<?=$IdL?>'); return false;">&nbsp;&nbsp;DOKUMEN CETAK</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
