			...
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
				...
				if ($mRw > 0)
				{
					do
					{
						...
						?>
						<tr>
							<td><? echo fConvertDateShort($mRo['Tanggal'])?></td>
							<td><? echo $gMem?></td>
							<td align="right"><? if ($nDB!=0) {echo fConvertToRupiah($nDB);}?></td>
							<td align="right"><? if ($nKR!=0) {echo fConvertToRupiah($nKR);}?></td>
						    <td align="right">&nbsp;</td>
						    <td><? echo $mRo['Keterangan']?></td>
					    </tr>
						<?
					}
