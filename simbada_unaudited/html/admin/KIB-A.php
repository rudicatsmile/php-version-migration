      ...
      <?
		...
		do
			...
			<tr height="40" style="cursor: pointer <?=$Blnk?>" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
				...
				<td style="text-align:center; border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px"><? if ($mRo['Tgl_Mutasi']!="0000-00-00"){echo fConvertDateShort($mRo['Tgl_Mutasi']);}?></td>
				...
				<td align="right" style="border-bottom:#999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px <?=$ClR?>" <? echo $ClR?>> <?=fConvertToRupiah($gNIL)?>        </td>
