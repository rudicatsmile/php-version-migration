...
<table border="0" align="center" width="600" cellpadding="0" cellspacing="0" style="font-size:10pt; font-family: calibri; border-collapse: collapse">
	...
	<tr>
	  <td align="center" style="font-size: 12pt; font-weight: bold; border-top: #000000 solid 2px">&nbsp;</td>
	  <td style="font-size: 10pt; border-top: #000000 solid 2px" align="center">&nbsp;</td>
  </tr>
</table>
<table border="0" align="center" width="600" cellpadding="0" cellspacing="0" style="font-size:12pt; font-family: calibri; border-collapse: collapse">
	...
	<tr>
	  ...
	  <td valign="top">:</td>
	  <td valign="top" colspan="2"><?=$PeR?></td>
	  <td>&nbsp;</td>
  </tr>
	<tr>
	  <td>&nbsp;</td>
	...
	<tr>
	  ...
	  Sehubungan dengan adanya rencana Penghentian Status Penggunaan Barang Milik Daerah di Lingkungan <b><?=ucwords(strtolower($SkA))?></b>. Kabupaten Hulu Sungai Tengah, dengan ini kami sampaikan Daftar Usulan Penghentian Status Penggunaan Barang Milik Daerah dimaksud sebagaimana terlampir. Barang Milik Daerah tersebut kami usulkan penghentikan status penggunaannya disebabkan karena <?=$SbB?>.</td>
  </tr>
  <tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
