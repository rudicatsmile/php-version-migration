...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%">
  ...
  <tr height="25">
	...
	<option value="V1" <?php if ($model=='V1'){echo "selected";}?>>Format V.1 </option>
	<option value="V2" <?php if ($model=='V2'){echo "selected";}?>>Format V.2 </option>
	<option value="V3" <?php if ($model=='V3'){echo "selected";}?>>Format V.3 </option>
	<option value="V4" <?php if ($model=='V4'){echo "selected";}?>>Format V.4 </option>
    </select></td>
    <td>FIND</td>
