...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:700px">
  ...
  <tr height="25">
	...
	<input name="dUNT" id="dUNT" type="text" value="<?=$dUNT?>" <? if ($Lev <= 1) {?> onClick="showUNIT('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13) {showUNIT('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('unit'); return false;}" <? } ?> style="padding-left:5px; width:450px; border: 1px solid #C0C0C0; text-transform:uppercase"/>
  ...
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onclick="P_Dokumen('800','400','RKBMD_Usulan_Pengadaan_PENGELOLA','<?=$_GET['IdL']?>'); return false;">&nbsp;&nbsp;&nbsp;RKBMD USULAN ( PENGADAAN BMD ) *</a></td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onclick="P_Dokumen('800','400','RKBMD_Usulan_Pengadaan_PENGELOLA_Telaah','<?=$_GET['IdL']?>'); return false;">&nbsp;&nbsp;&nbsp;TELAAH RKBMD USULAN ( PENGADAAN BMD ) *</a></td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
