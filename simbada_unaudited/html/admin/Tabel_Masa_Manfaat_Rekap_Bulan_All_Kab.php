		...
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			if ($TbL=='1.3.1' || $TbL=='1.3.5' || $TbL=='1.3.6') 
			{
				if ($TbL=='1.3.5'){
					...
					$Col03 = fGlobalNEW("IfNull(sum(Debet),0)","ta_kib_post_108".$mts,"Kd_UPB:Kd_Aset_108:Tanggal:extracom:KdpToAset",$uNT."%:".$Col01.".%:".$rTH."-12-31:".$ExtR.":N","LIKE:LIKE:<=:=:=","",DatabaseSB,$ConSB,"");
				}
				$Col04 = 0;
				$Col05 = 0;
				$Col06 = 0;
