...
if($formatType=='Format.IV.J.1.3' || $formatType=='Format.IV.J.1.4'){
    $tableUsertHeader = "Pemakai";
    $tableUserSubHeader1 = "Nama Pemakai";
    $tableUserSubHeader2 = "Alamat ";
}else{
    $tableUsertHeader = "Penghuni";
    $tableUserSubHeader1 = "Nama Penghuni";
    $tableUserSubHeader2 = "Alamat Penghuni";
}
?> 
<body>
...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">Lokasi / Alamat</td>
    <td style="border:1px solid #000" colspan="3"><?=$tableUsertHeader?></td>
    <td style="border:1px solid #000" rowspan="2">Penyebab Penyerahan Pengembalian</td>
    <td style="border:1px solid #000" colspan="2">BAST Pengembalian</td>
    <td style="border:1px solid #000" colspan="2">Penerima Pengembalian</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000"><?=$tableUserSubHeader1?></td>
    <td style="border:1px solid #000">Nomor Identitas Penghuni</td>
    <td style="border:1px solid #000"><?=$tableUserSubHeader2?></td>
