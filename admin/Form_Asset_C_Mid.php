...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      <td>NO. DOKUMEN</td>
      <td><input name="fNoDok" type="text" class="text" id="fNoDok" style="width:300px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gNoD?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LUAS LANTAI</td>
      ...
      <td>KOORDINAT</td>
		<td>
			...
			<input name="fPosisi_koordinat" type="text" class="text" id="fPosisi_koordinat" 
				...
				value="<?php echo $posisi_koordinat?>" size="50" maxlength="50" disabled />		</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>KODE TANAH</td>
