...
if ($rIDT!="")
{
	$nSQ = "SELECT * FROM ref_rek_4 WHERE IDT='".$rIDT."'";
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Rekn4_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDT=".$rIDT ?>">
