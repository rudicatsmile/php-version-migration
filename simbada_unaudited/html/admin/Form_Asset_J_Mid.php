...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_J_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
    ...
    <tr> 
	  ...
	  <tr>
		...
		while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
		{
			...
			<td width="10" style="border-right:1px solid #CCCCCC"><a href="#" onClick="P_PDF('<?=$ReO?>','j','600','300','<?=$rIDT?>','<?=$gIDT?>','<?=$_GET['IdL']?>'); return false" class="ico reff"></a></td>
			<?
			$iG++;
		}
		?>
	  <td><a href="#" onClick="P_PDF('<?=$ReO?>','j','600','300','<?=$rIDT?>','','<?=$_GET['IdL']?>'); return false" class="ico pdf">&nbsp;&nbsp;Upl.PDF</a></td>
	  </tr>
	  </table>	  </td>
    </tr>
    <tr> 
...
<script language="javascript">
	...
	function P_MoveAccount(ReO,KeY,w,h,rIDT,IdL)
	{
		...
		if (win!=null)
		{
			...
			URL_Mid = 'Move_Account_Mid.php?rKib=Kib_J&IdL='+IdL+'&rIDT='+rIDT;
