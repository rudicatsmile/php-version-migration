...
#$nSQ = "SELECT Referensi, Kd_UPB, Kd_Aset, No_Register, Nm_Aset, Tgl_Perolehan, Keterangan, Harga, $kond, Asal_Usul FROM ta_kib_".$rTbL." WHERE IDT = '$rIdT'";
$nSQ = "SELECT Referensi, Kd_UPB, Kd_Aset_108, No_Register, Nm_Aset, Tgl_Perolehan, Keterangan, Harga, $kond, Asal_Usul FROM ta_kib_108 WHERE IDT = '$rIdT'";
$nRs = mysql_query($nSQ);
