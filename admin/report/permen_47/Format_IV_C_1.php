...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">NIBAR / NUSP</td>
    ...
    <td style="border:1px solid #000" rowspan="2">Spesifikasi lainnya</td>
    <td style="border:1px solid #000" rowspan="2">Jumlah Barang</td>
    <td style="border:1px solid #000" rowspan="2">Satuan Barang</td>
    <td style="border:1px solid #000" rowspan="2">Harga Satuan (Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Total Nilai Barang (Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Nilai Akumulasi Penyusutan 
	atau Amortisasi (Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Nilai Buku (Rp)</td>
    <td style="border:1px solid #000" rowspan="2">Tanggal, Bulan, Tahun 
	Perolehan</td>
    <td style="border:1px solid #000" rowspan="2">Cara Perolehan</td>
    <td colspan="3" style="border:1px solid #000">Asal Barang</td>
    <td style="border:1px solid #000" colspan="2">Berita Acara Serah Terima</td>
