...
<form name="myfrm" method="post" action="<?="Form_Unit_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="925" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td width="323">
	  <select class="boxs" name="fBid" tabindex="0" style="width: 300px" <? echo $Sbmt?>>
        <?
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td><input name="fKode" type="text" class="text" style="border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; width:80px" value="<? echo $gCod?>" readonly /></td>
      <td align="right">KODE UNIT</td>
      <td>&nbsp;</td>
      <td><input name="fLINK" type="text" class="text" onkeyup="addSeparatorSkpd(this)" maxlength="7" style="border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; width:60px" value="<? echo $gLNK?>" /></td>
    </tr>
    <tr> 
      <td align="right">Nama Unit/SKPD </td>
      <td>&nbsp;</td>
      <td><input name="fNama" type="text" class="text" style="border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; width:300px" value="<? echo $gNma?>" /></td>
