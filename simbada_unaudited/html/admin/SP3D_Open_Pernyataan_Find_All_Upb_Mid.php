...
<table align="center" cellpadding="0" class="table-listpop" cellspacing="0" width="780" height="100%" border="0">
	...
	while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	{
		...
		<tr height="28">
			...
			<td class="ac" style="border-bottom:1px dotted #ccc" <?=$BG?>><a href="<?="SP3D_Open_Pernyataan.php?FrmG=DANA BOS -> SURAT PERNYATAAN&gUPB=".$gUPB."&IdL=".$IdL?>" class="ico edit">Use</a></td>
		</tr>
		<?
		$iG++;
	}
