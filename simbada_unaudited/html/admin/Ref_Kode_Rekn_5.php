...
<form name="myfrm" method="post" action="<?="Ref_Kode_Rekn_5_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG']."&KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&KdRek3=".$KdRek3."&KdRek4=".$KdRek4 ?>">
  ...
  <table border="0" align="center" cellspacing="1" style="font-size: 10pt; font-family: Calibri; border-collapse: collapse; text-transform: uppercase; font-weight: bold; width:900px">
    <tr> 
      ...
      <td width="15">&nbsp;</td>
      <td width="970"><a href="<?="Ref_Kode_Rekn_1.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>"><? echo $KdRek1." : ".fGlobal("Nm_Rek","Ref_Rek_1","Kd_Rek",$KdRek1,"=","","")?></a></td>
      <td width="6"></td>
    </tr>
    <tr> 
      <td><a href="<?="Ref_Kode_Rekn_2.php?KdRek1=".$KdRek1."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>">&lt;&lt; - KELOMPOK</a></td>
      <td>&nbsp;</td>
      <td><a href="<?="Ref_Kode_Rekn_2.php?KdRek1=".$KdRek1."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>"><? echo $KdRek2." : ".fGlobal("Nm_Rek","Ref_Rek_2","Kd_Rek",$KdRek2,"=","","")?></a></td>
    </tr>
    <tr> 
      <td><a href="<?="Ref_Kode_Rekn_3.php?KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>">&lt;&lt; - JENIS</a></td>
      <td>&nbsp;</td>
      <td><a href="<?="Ref_Kode_Rekn_3.php?KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>"><? echo $KdRek3." : ".fGlobal("Nm_Rek","Ref_Rek_3","Kd_Rek",$KdRek3,"=","","")?></a></td>
    </tr>
    <tr> 
      <td><a href="<?="Ref_Kode_Rekn_4.php?KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&KdRek3=".$KdRek3."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>">&lt;&lt; - OBJEK</a></td>
      <td>&nbsp;</td>
      <td><a href="<?="Ref_Kode_Rekn_4.php?KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&KdRek3=".$KdRek3."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>"><? echo $KdRek4." : ".fGlobal("Nm_Rek","Ref_Rek_4","Kd_Rek",$KdRek4,"=","","")?></a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <table align="center" class="table-list" border="0" cellspacing="0" cellpadding="0" style="width:900px">
      ...
      <tr height="22"> 
        ...
        <td <?=fBackCLR($iG)?> style="border-bottom: 1px dotted #CCCCCC"><? echo $mRo['Kd_Rek']?></td>
        <td <?=fBackCLR($iG)?> style="border-bottom: 1px dotted #CCCCCC"><? echo $mRo['Nm_Rek']?></td>
      ...
      <tr height="30">
		...
		[&nbsp;<a href="<? echo $_SERVER['PHP_SELF']."?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG']."&KdRek1=".$KdRek1."&KdRek2=".$KdRek2."&KdRek3=".$KdRek3."&KdRek4=".$KdRek4?>" class="ico reff">&nbsp;REFRESH</a>&nbsp;]</td>
        <td style="border-top:1px solid #CCCCCC">&nbsp;</td>
      </tr>
    </table>
	  <?
