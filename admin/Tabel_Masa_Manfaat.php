...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="23">
	  ...
	  <td style="vertical-align:top; text-align:right; border:1px #000000 solid; padding-right:2px"><?php if ($CL4!=0) {echo fConvertToRupiahBulat($CL4);}else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL5!=0) {echo $CL5;} else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL5h!=0) {echo fConvertToRupiahBulat($CL5h);} else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:right; border:1px #000000 solid; padding-right:2px"><?php if ($CL6!=0) {echo fConvertToRupiahBulat($CL6);} else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL7!=0) {echo fConvertToRupiah($CL7);} else {echo "-";}?></td>
	  <td width="44" style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL8!=0) {echo $CL8;} else {echo "-";}?></td>
	  <td width="67" style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL8h!=0) {echo fConvertToRupiahBulat($CL8h);} else {echo "-";}?></td>
	  <td width="80" style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL9h!=0) {echo fConvertToRupiahBulat($CL9h);} else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:right; border:1px #000000 solid; padding-right:2px"><?=fConvertToRupiah($CL10)?></td>
	  <td width="52" style="vertical-align:top; text-align:center; border:1px #000000 solid"><?php if ($CL11h!=0) {echo fConvertToRupiahBulat($CL11h);} else {echo "-";}?></td>
	  <td style="vertical-align:top; text-align:right; border:1px #000000 solid; padding-right:2px"><?php if ($CL12!=0) {echo fConvertToRupiah($CL12);} else {echo "-";}?></td>
