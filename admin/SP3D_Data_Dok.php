...
<tr>
  ...
  <td>JENIS</td>
  <td align="center">:</td>
  <td><?php if ($gJNS=='AA'){echo "SEMUA";} else {echo fGlobal("Deskripsi","ref_sp3d_jenis","Kode",$gJNS,"=","","");}?></td>
  </tr>
<tr>
  <td>UPB</td>
  <td align="center">:</td>
  ...
  <td>TAHAP</td>
  <td align="center">:</td>
  <td><?php if ($gSES=='AA'){echo "SEMUA";} else {fGlobal("Deskripsi","ref_session","Kode",$gSES,"=","","");}?></td>
  </tr>
<tr>
  <td>&nbsp;</td>
  <td align="center">&nbsp;</td>
