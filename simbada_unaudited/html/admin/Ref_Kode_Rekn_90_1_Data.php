...
$iG=1;
$tJmL= 0;
$nSQ = "SELECT IDT, Kd_Rek, Nm_Rek FROM ref_rek_90_1 $CrT ORDER BY Kd_Rek";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="25"> 
	  ...
	  <a href="<?="Ref_Kode_Rekn_90_2.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$eKdR."&IdL=".$_GET['IdL']?>" class="ico prev">&nbsp;View</a>&nbsp;&nbsp;&nbsp;
