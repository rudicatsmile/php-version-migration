	    ...
	    <tr>
		 ...
		 <? if ($gIdT) {?>
			 <? if ($gCK1=="checked") {?>
				...
				<? if ($gIdT!='' && $gRin!=''){?>
				<a href="<?="Form_Asset_".$gTmp."_Mid_Temp.php?gIdT=".$gIdT."&IdL=".$_GET['IdL']?>" class="ico item">&nbsp;&nbsp;INPUT DETAIL DATA <? if ($iG>1) {echo "BARU";}?></a>
				<? } ?>
			 <? } else {?>
					<? if ($gIdT!='' && $gRin!=''){?>
