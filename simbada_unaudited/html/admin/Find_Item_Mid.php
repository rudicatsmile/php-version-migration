  ...
  <table width="1165" border="0" align="center">
	...
	if ($tRo > 0)
	{
		do
		{
			...
			?>
			<tr>
			  <td width="103" height="18" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Kd_Aset']?></a></td>
			  <td width="58" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['No_Register']?></a></td>
			  <td width="450" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Nm_Aset']?>&nbsp;</a></td>
			  <td width="285" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Alamat']?></a></td>
			  <td width="50" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo substr($mRo['Tgl_Perolehan'],0,4)?></a></td>
			  <td width="146" valign="top" align="right"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><?=fConvertToRupiah($gNIL)?></a></td>
			</tr>
			<?
			$iG++;
		}
	...
	if ($tRo > 0)
	{
		do
		{
			...
			<tr>
			  <td width="103" height="18" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Kd_Aset']?></a></td>
			  <td width="58" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['No_Register']?></a></td>
			  <td width="601" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Nm_Aset']?>&nbsp;</a></td>
			  <td width="285" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Merk']?></a></td>
			  <td width="50" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo substr($mRo['Tgl_Perolehan'],0,4)?></a></td>
			  <td width="50" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Kondisi']?></a></td>
			  <td width="146" valign="top" align="right"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><?=fConvertToRupiah($gNIL)?></a></td>
			</tr>
			<?
			$iG++;
	...
	if ($tRo > 0)
	{
		do
		{
			...
			<tr>
			  <td width="103" height="18" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Kd_Aset']?></a></td>
			  <td width="58" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['No_Register']?></a></td>
			  <td width="350" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Nm_Aset']?>&nbsp;</a></td>
			  <td width="300" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Lokasi']?></a></td>
			  <td width="100" valign="top" align="right"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Luas_Lantai']?></a></td>
			  <td width="70" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo substr($mRo['Tgl_Perolehan'],0,4)?></a></td>
			  <td width="60" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Kondisi']?></a></td>
			  <td width="146" valign="top" align="right"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><?=fConvertToRupiah($gNIL)?></a></td>
			</tr>
			<?
			$iG++;
	...
	if ($tRo > 0)
	{
		do
		{
			...
			<tr>
			  ...
			  <td width="300" valign="top"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Lokasi']?></a></td>
			  <td width="70" valign="top" align="center"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo substr($mRo['Tgl_Perolehan'],0,4)?></a></td>
			  <td width="100" valign="top" align="right"><a href="<? echo $URL?>" <?=$TRG?> <?=$CLK?>><? echo $mRo['Luas']?></a></td>
