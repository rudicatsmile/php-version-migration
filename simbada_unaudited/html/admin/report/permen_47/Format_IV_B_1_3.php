...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td rowspan="2" style="border:1px solid #000">Jumlah Barang</td>
    <td rowspan="2" style="border:1px solid #000">Jumlah (Rp) </td>
    <td rowspan="2" style="border:1px solid #000">Nilai Akumulasi Penyusutan atau Amortisasi (Rp)</td>
    <td rowspan="2" style="border:1px solid #000">Nilai Buku (Rp)</td>
  </tr>
  ...
  <tr style="text-align:center">
    ...
    <td width="110" style="border:1px solid #000; border-bottom:3px double #000">
	3</td>
    <td width="110" style="border:1px solid #000; border-bottom:3px double #000">4</td>
    <td width="110" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
    <td width="110" style="border:1px solid #000; border-bottom:3px double #000">&nbsp;</td>
  </tr>
	<?
