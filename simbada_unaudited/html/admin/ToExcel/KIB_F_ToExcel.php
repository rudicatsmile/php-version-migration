...
$tNIL= 0;
$iG  = 6;
$nSQL= "SELECT * FROM ta_kib_f WHERE Kd_UPB='".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Tgl_Perolehan, Kd_Aset, No_Register";
...
header("Content-Type: application/x-msexcel; name=\"KiB-F.xls\"");
header("Content-Disposition: inline; filename=\"KiB-F.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>