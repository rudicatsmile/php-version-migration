...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1300px">
  ...
  <tr height="25">
	...
	<input name="dSUB" id="dSUB" type="text" value="<?=$dSUB?>" <?php if ($IdT=='' && $Lev<=2){?> onclick="showSUB('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showSUB('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('sub'); return false;}" <?php } else {echo "readonly";}?> style="padding-left:5px; width:320px; border: 1px solid #C0C0C0; background:#e9f5cc"/>
    ...
    <td class="ac">:</td>
    <td><input name="fNO4" type="text" value="<?php if ($gTG){ echo fConvertDateShort($gTG);}?>" readonly style=" width:152px; border: 1px solid #C0C0C0; background:#e9f5cc"/></td>
  ...
  <tr height="25">
	...
	<input name="dUPB" id="dUPB" type="text" value="<?=$dUPB?>" <?php if ($IdT=='' && $Lev<=3){?> onclick="showUPB('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showUPB('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('upb'); return false;}" <?php } else {echo "readonly";}?> style="padding-left:5px; width:320px; border: 1px solid #C0C0C0; background:#e9f5cc"/>
