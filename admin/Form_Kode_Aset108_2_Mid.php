...
if ($rIDT!="")
{
	$nSQ = "SELECT * FROM ref_rek_aset108_3 WHERE IDT='".$rIDT."'";
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset108_2_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDT=".$rIDT ?>">
