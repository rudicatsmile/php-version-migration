...
if ($rIDT!="")
{
	$nSQ = "SELECT * FROM ref_rek_1 WHERE IDT='".$rIDT."'";
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Rekn1_Mid_.php?FrmG=".($_REQUEST['FrmG'] ?? '')."&IdL=".($_REQUEST['IdL'] ?? '')."&rIDT=".$rIDT ?>">
