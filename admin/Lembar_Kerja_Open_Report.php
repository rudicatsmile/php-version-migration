...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px; color:#fff; background:#79a86a">
  ...
  <tr height="23">
	...
	<input name="dUPB" id="dUPB" type="text" value="<?=$dUPB?>" <?php if ($Lev <= 2) {?> onClick="showUPB('','<?=$_GET['IdL']?>')" <?php } else {echo "readonly";}?> style="padding-left:3px; width:450px; border: 1px solid #C0C0C0"/>
