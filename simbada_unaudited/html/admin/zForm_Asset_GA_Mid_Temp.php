...
if ($gIdT!="")
{
	$nSQ = "SELECT Kd_Unit, Nilai, SPP, Pros, No_Berkas, Nomor FROM ta_pengadaan WHERE IDT='$gIdT'";
...
if ($rIDT!="")
{
	$nSQ = "SELECT * FROM ta_kib_g_temp where IDT='".$rIDT."'";
	$nRs = mysql_query($nSQ) or die(mysql_error());
...
else
{
	$gLua  = 0;
	$gSTN  = 1;
	$vUse  = fGlobalNEW("IfNull(sum(Nilai_Pengadaan),0)","ta_kib_g_temp","No_Pengadaan",$gNoM,"=","",$DatabaseSB,$ConSB,"");
	$gTTL  = $gNiL-$vUse;
...
<form name="myfrm" method="post" action="<?php echo "Form_Asset_A_Mid_Temp_.php?gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>SUB UNIT</td>
      <td><select class="boxs" name="fSub" id="fSub" tabindex="0" style="width:450px" onChange="func_select('CrUPB','fSub','fUpb','')">
          <?
    ...
    <tr>
      <td>&nbsp;</td>
      <td>UPB</td>
      <td><select class="boxs" name="fUpb" id="fUpb" tabindex="0" style="width: 450px">
          <?
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>NAMA BARANG</td>
      <td><input name="fNama" type="text" class="text" style="widTh:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $fNma?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>LETAK TANAH </td>
      <td><input name="fAlmt" type="text" class="text" id="fAlmt" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gAlm?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>PENGGUNAAN</td>
      <td><input name="fGuna" type="text" class="text" id="fGuna" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gGna?>" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
      <td valign="top">KETERANGAN</td>
      <td><textarea name="fKetr" rows="3" style="width: 450px; border: 1px solid #C0C0C0"><? echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      ...
      <td><input name="fSatuan" type="text" id="fSatuan" value="<? echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:50px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" />
      BIDANG</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="button" name="B39" value="SIMPAN" onClick="P_Save('<?=$gSPP?>')" style="width: 90px; height: 23px; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
      <td>&nbsp;</td>
    </tr>
