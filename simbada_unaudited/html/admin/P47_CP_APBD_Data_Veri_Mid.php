...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family:calibri; font-size:10pt">
  ...
  <tr height="24">
    ...
    <td style="text-align:center"><input type="text" name="fJm1" id="fJm1" value="<? if ($fJm1!=0) {echo $fJm1;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','1',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm2" id="fJm2" value="<? if ($fJm2!=0) {echo $fJm2;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','2',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm3" id="fJm3" value="<? if ($fJm3!=0) {echo $fJm3;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','3',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm4" id="fJm4" value="<? if ($fJm4!=0) {echo $fJm4;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','4',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm5" id="fJm5" value="<? if ($fJm5!=0) {echo $fJm5;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','5',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm6" id="fJm6" value="<? if ($fJm6!=0) {echo $fJm6;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','6',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm7" id="fJm7" value="<? if ($fJm7!=0) {echo $fJm7;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','7',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm8" id="fJm8" value="<? if ($fJm8!=0) {echo $fJm8;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','8',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm9" id="fJm9" value="<? if ($fJm9!=0) {echo $fJm9;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','9',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm10" id="fJm10" value="<? if ($fJm10!=0) {echo $fJm10;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','10',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm11" id="fJm11" value="<? if ($fJm11!=0) {echo $fJm11;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','11',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm12a" id="fJm12a" value="<? if ($fJm12a!=0) {echo $fJm12a;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','12a',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm12b" id="fJm12b" value="<? if ($fJm12b!=0) {echo $fJm12b;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','12b',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
  ...
  <tr height="24">
	...
	<td style="text-align:right">Jumlah</td>
	<td style="text-align:center">:</td>
    <td style="text-align:center"><input type="text" name="fJm12c" id="fJm12c" value="<? if ($fJm12c!=0) {echo $fJm12c;}?>" onkeypress="if (event.keyCode==13){saveRecordVeri('Jumlah','12c',this,'<?=$NoM?>','<?=$IdT?>','<?=$IdL?>');}" style="width:30px; text-align:center" /></td>
    <td style="text-align:right">Ket.</td>
    <td style="text-align:center">:</td>
