...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px">
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR1" id="fKdR1" type="text" value="<?=$KdR1?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_108_1.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">&nbsp;</td>
    <td class="ac">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR2" id="fKdR2" type="text" value="<?=$KdR2?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_108_2.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$KdR1."&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">&nbsp;</td>
    <td class="ac">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr height="23">
    ...
    <td class="ac">:</td>
    <td>
	<input name="fKdR3" id="fKdR3" type="text" value="<?=$KdR3?>" readonly="readonly" style="padding-left:5px; width:45px; border: 1px solid #C0C0C0"/>
	...
	&nbsp;&nbsp;&nbsp;<a href="<?="Ref_Kode_Rekn_108_3.php?FrmG=REFERENSI -> KODE REKENING PERMENDAGRI 90&rKdR=".$KdR2."&IdL=".$_GET['IdL']?>" class="ico prev"></a>
	</td>
    <td class="ar">FIND</td>
    <td class="ac">:</td>
...
<table border="0" cellspacing="0" class="table-link" cellpadding="0" align="center" style="width:1000px; height:20px; background: #C9DCD8; font-weight:bold">
  <tr>
    ...
    <td width="670" align="left" style="padding-left:6px">NAMA RINCIAN OBJEK
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1000px; height:325px">
  <tr>
    <td valign="top">
...
<script languange="javascript">
	...
	function RefreshDATA(IdL)
	{
		...
		{
			$.ajax({
				url:"Ref_Kode_Rekn_108_4_Data.php",
				data: {KdR3:KdR3,gFnD:gFnD,IdL:IdL},
				type:"get",
				beforeSend:function()
				{
					$("#loadingImg").show();
	...
	function prinDATA(w,h,IdL)
	{
		...
		URL = 'Ref_Kode_Rekn_108_Doc.php?Lev=4&eKD='+eKD+'&IdL='+IdL;
