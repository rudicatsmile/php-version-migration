...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	?>
	<tr height="18"> 
	  <td valign="top" width="95"><a href="<? echo $URL?>" target="_top"><?=$mRo[0]?></a></td>
	  <td valign="top" width="95"><a href="<? echo $URL?>" target="_top"><?=$mRo[1]?></a></td>
	  <td valign="top" width="95" style="text-align:right; padding-right:15px"><a href="<? echo $URL?>" target="_top"><?=fConvertToRupiah($mRo[2])?></a></td>
	  <td valign="top" width="30"><a href="<? echo $URL?>" target="_top"><?=$mRo[3]?>&nbsp;%</a></td>
