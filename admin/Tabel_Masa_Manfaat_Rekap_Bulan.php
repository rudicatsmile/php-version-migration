...
<tr>
  ...
  <div class="pagging"> 
	...
	if ($CntItem>0)
	{
		...
		{
			?>
			<a href="<?="Tabel_Masa_Manfaat_Rekap_Bulan.php?iPG=".$iR."&mts=".$mts."&rTH=".$_GET['rTH']."&rAS=".$_GET['rAS']."&uNT=".$_GET['uNT']."&uUP=".$_GET['uUP']."&uSU=".$_GET['uSU']."&gHriC=".$_GET['gHriC']."&gBlnC=".$_GET['gBlnC']."&gThnC=".$_GET['gThnC']."&IdL=".$_GET['IdL']?>"><?="<b>".substr('00'.$i,-2,2)."</b>"?></a><?php if ($i==100) {echo "<br>";}?><?=str_repeat('&nbsp;',0)?>
			<?php 
			$i++;
		}
	}
