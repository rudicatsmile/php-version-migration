...
<input type="hidden" name="Simpan">
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      <td>NO. DOKUMEN</td>
      <td><input name="fNoDok" type="text" class="text" id="fNoDok" style="width:200px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gNoD?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>LUAS LANTAI</td>
    ...
    <tr> 
      <td>LETAK/ALAMAT</td>
      <td><input name="fAlamat" type="text" class="text" id="fAlamat" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gLKS?>" size="60" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>KODE TANAH</td>
