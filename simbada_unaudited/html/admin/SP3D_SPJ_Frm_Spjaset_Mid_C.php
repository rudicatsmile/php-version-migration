...
<table border="0" width="1000" height="23" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="25">
    ...
    <td><select class="boxs" name="cTin" id="cTin" style="width:170px" tabindex="0">
      <option value=""></option>
      <option <? if ($cTin=="Bertingkat") {echo "selected";}?> value="Bertingkat">Bertingkat</option>
      <option <? if ($cTin=="Tidak") {echo "selected";}?> value="Tidak">Tidak Bertingkat</option>
    </select>
      <select class="boxs" name="cBet" id="cBet" style="width:134px" tabindex="0">
        <option value=""></option>
        <option <? if ($cBet=="Beton") {echo "selected";}?> value="Beton">Beton</option>
        <option <? if ($cBet=="Tidak") {echo "selected";}?> value="Tidak">Bukan Beton</option>
      </select></td>
  ...
  <tr height="25">
    ...
    <input type="button" name="B393" <?=$DisA?> value="RESET" onclick="ResetMidASET('C','<?=$rIdT?>','<?=$IdL?>')" style="width: 80px; height: 21px" />
