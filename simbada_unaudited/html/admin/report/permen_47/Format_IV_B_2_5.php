...
<table border="0" width="1500" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:9pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td style="border:1px solid #000" rowspan="2">Pengguna Barang</td>
    ...
    <td style="border:1px solid #000" rowspan="2">Satuan</td>
    <td style="border:1px solid #000" rowspan="2">Lokasi</td>
    <td colspan="3" style="border:1px solid #000">Jangka Waktu</td>
    <td style="border:1px solid #000" rowspan="2">Peruntukan</td>
    <td style="border:1px solid #000" colspan="2">Dasar Penggunaan</td>
  ...
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Waktu Penggunaan</td>
    <td style="border:1px solid #000">Mulai</td>
    <td style="border:1px solid #000">Berakhir</td>
    <td style="border:1px solid #000">Surat Persetujuan</td>
    <td style="border:1px solid #000">Surat Perjanjian</td>
  </tr>
