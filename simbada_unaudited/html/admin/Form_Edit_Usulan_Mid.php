...
<table border="0" width="631" cellspacing="2" style="font-family: Calibri; font-size:9pt; border-collapse: collapse">
	...
	<tr>
	  ...
	  <td width="451"><input name="fKOD" type="text" class="text" id="fKOD" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gKDB?>" size="20" maxlength="100" /></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>NOMOR REGISTER </td>
	  <td><input name="fREG" type="text" class="text" id="fREG" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gREG?>" size="20" maxlength="100" /></td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
		<td>NAMA BARANG </td>
		<td><input name="fNMA" type="text" class="text" id="fNMA" readonly style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gNMA?>" size="68" maxlength="100" /></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>NILAI</td>
	  <td><input name="fNIL" type="text" class="text" id="fNIL" readonly style="text-align: right; font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo fConvertToRupiah($gAKH)?>" size="20" maxlength="100" /></td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
	...
	<tr>
	  <td>&nbsp;</td>
		<td>KETERANGAN</td>
		<td><textarea name="fKET" cols="68" rows="4" id="fKET" style="font-size:9pt; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px"><? echo $gKET ?></textarea></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
