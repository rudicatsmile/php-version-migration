...
$JmREC = 0;
if ($gThnA){
	$nSQL= "SELECT IDT FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.4.%' AND Kd_UPB LIKE '".$gUpb."' AND (Tgl_Perolehan BETWEEN '".$gThnA."-01-01' AND '".$gThn."-12-31') AND Status='' 
	GROUP BY Referensi, LEFT(Kd_UPB,11), Ref_History";
}
else{
	$nSQL= "SELECT IDT FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.4.%' AND Kd_UPB LIKE '".$gUpb."' AND Tgl_Perolehan LIKE '".$gThn."-__-__' AND Status='' 
	GROUP BY Referensi, LEFT(Kd_UPB,11), Ref_History";
}
...
if ($JmREC <= 5000)
{
	$URL="KIB_G_Dokumen.php?gExt=".$_GET['gExt']."&rHri=".$_GET['rHri']."&rBln=".$_GET['rBln']."&rThn=".$_GET['rThn']."&gUnt=".$_GET['gUnt']."&gSub=".$_GET['gSub']."&gUpb=".$_GET['gUpb']."&gThn=".$_GET['gThn']."&gThnA=".$_GET['gThnA']."&gMLK=".$_GET['gMLK']."&IdL=".$_GET['IdL'];
	header("Location: ".$URL);
}
else
{
...
<script language="javascript">
	...
	function P_OpenDoc(w,h,ReC,TtD,HeA,LoadEND)
	{
		...
		URL= "KIB_G_Dokumen.php?LmT=YA&LoadEND="+LoadEND+"&HeA="+HeA+"&TtD="+TtD+"&ReC="+ReC+"<?="&rHri=".$_GET['rHri']."&rBln=".$_GET['rBln']."&rThn=".$_GET['rThn']."&gUnt=".$_GET['gUnt']."&gSub=".$_GET['gSub']."&gUpb=".$_GET['gUpb']."&gThn=".$_GET['gThn']."&gThnA=".$_GET['gThnA']."&gMLK=".$_GET['gMLK']."&IdL=".$_GET['IdL']?>";
