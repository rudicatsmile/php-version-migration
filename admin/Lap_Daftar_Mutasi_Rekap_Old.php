...
<table border="0" align="center" width="900" cellspacing="1" style="font-family: Calibri; font-size: 8pt; border-collapse: collapse" id="table1">
	...
	<tr>
		...
		<tr>
			<td width="74">SKPD</td>
			<td width="25">:</td>
			<td width="551"><?php if ($xUnt=="") {echo "<i>Semua Unit Kerja</i>";} else {echo fGlobal("Nm_Unit","Ref_Unit","Kd_Unit",$xUnt,"=","","");}?></td>
			<td width="237" align="right">&nbsp;</td>
		</tr>
		<tr>
			<td width="74">Sub Unit</td>
			<td width="25">:</td>
			<td><?php if ($xSub=="") {echo "<i>Semua Sub Unit Kerja</i>";} else {echo fGlobal("Nm_Sub","Ref_Sub_Unit","Kd_Sub",$xSub,"=","","");}?></td>
			<td width="237">&nbsp;</td>
		</tr>
		<tr>
			<td width="74">UPB</td>
			<td width="25">:</td>
			<td><?php if ($xUpb=="") {echo "<i>Semua UPB</i>";} else {echo fGlobal("Nm_Upb","Ref_Upb","Kd_Upb",$xUpb,"=","","");}?></td>
			<td width="237">&nbsp;</td>
		</tr>
		<tr>
	  ...
	  <td>
		<table border="1" width="900" cellspacing="1" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1" bordercolor="#000000">
			...
			<tr>
				...
				<td width="52" align="center"><?php if ($x5!=0) {echo $xB.$x5;} else {echo "-";}?></td>
				<td width="56" align="right"><?php if ($x6!=0) {echo $xB.fConvertToRupiah($x6);} else {echo "-";}?></td>
				<td width="57" align="center"><?php if ($x7!=0) {echo $xB.$x7;} else {echo "-";}?></td>
				<td width="114" align="right"><?php if ($x8!=0) {echo $xB.fConvertToRupiah($x8);} else {echo "-";}?></td>
				<td width="114" align="center"><?php if ($x9!=0) {echo $xB.$x9;} else {echo "-";}?></td>
				<td width="114" align="right"><?php if ($x10!=0) {echo $xB.fConvertToRupiah($x10);} else {echo "-";}?></td>
				<td width="56" align="center"><?php if ($x11!=0) {echo $xB.$x11;} else {echo "-";}?></td>
			...
			<tr>
				...
				<td width="52" align="center" style="font-weight:bold; border-top: 3px double #000000"><?php if ($fAWL!=0) {echo $fAWL;}?></td>
				<td width="56" align="right" style="font-weight:bold; border-top: 3px double #000000"><?php if ($tAWL!=0) {echo fConvertToRupiah($tAWL);}?></td>
				<td width="57" align="center" style="font-weight:bold; border-top: 3px double #000000"><?php if ($fKRG!=0) {echo $fKRG;}?></td>
				<td width="114" align="right" style="font-weight:bold; border-top: 3px double #000000"><?php if ($tKRG!=0) {echo fConvertToRupiah($tKRG);}?></td>
				<td width="114" align="center" style="font-weight:bold; border-top: 3px double #000000"><?php if ($fTMB!=0) {echo $fTMB;}?></td>
				<td width="114" align="right" style="font-weight:bold; border-top: 3px double #000000"><?php if ($tTMB!=0) {echo fConvertToRupiah($tTMB);}?></td>
				<td width="56" align="center" style="font-weight:bold; border-top: 3px double #000000"><?php if ($fAKH!=0) {echo $fAKH;}?></td>
