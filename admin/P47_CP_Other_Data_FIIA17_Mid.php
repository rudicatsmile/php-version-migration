...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family:calibri; font-size:10pt">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><input type="text" name="fTgL" id="fTgL" value="<?=$TgL?>" style="width:90px; text-align:center" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" style="padding-left:13px"><li>Jumlah Barang</td>
    <td>:</td>
  ...
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" style="padding-left:13px"><li>Satuan Barang</td>
    <td>:</td>
  ...
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" style="padding-left:13px"><li>Harga Satuan (Rp)</td>
    <td>:</td>
  ...
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" style="padding-left:13px"><li>Total Nilai (Rp)</td>
    <td>:</td>
  ...
  <tr height="30" style="font-weight:bold">
    ...
    <td colspan="5">Dokumen Sumber Perolehan/Penerimaan<br>
      Berita Acara Hasil Inventarisasi </td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    ...
    <td>:</td>
    <td colspan="2"><input type="text" name="fNoBH" id="fNoBH" value="<?=$NoBH?>" style="width:240px; background:#fff" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    ...
    <td>:</td>
    <td colspan="2"><input type="text" name="fTgBH" id="fTgBH" value="<?=$TgBH?>" style="width:90px; text-align:center" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td colspan="2" style="padding-left:13px"><li>Tanggal, Bulan, Tahun</td>
    <td>:</td>
    <td colspan="2"><input type="text" name="fDokPTg" id="fDokPTg" value="<?=$DokPTg?>" style="width:90px; text-align:center" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td><a href="#" onClick="formCetakDok('Format_II_A_17','<?=$IdT?>','800','400','<?=$IdL?>'); return false" class="ico docu">&nbsp;&nbsp;Format II.A.17</a></td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>:</td>
    <td colspan="2"><input type="text" name="fKt12216810" id="fKt12216810" value="<?=$ReC?>" readonly style="width:240px; background:#e2fae2" /></td>
