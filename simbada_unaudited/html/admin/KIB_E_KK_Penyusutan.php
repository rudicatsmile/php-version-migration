...
<div align="center">
	<table border="0" width="1300" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
		...
		<tr>
			<td style="font-size: 13pt; font-weight: bold" align="center">ASET TETAP LAINNYA</td>
		</tr>
		<tr>
		...
		<tr>
            ...
            <td style="border:1px solid #000000; font-weight: bold" align="center" width="7%">16</td>
				...
				$nSQL= "SELECT * FROM ta_kib_e WHERE Kd_UPB LIKE '".$gUpb."' AND Tgl_Perolehan LIKE '".$gThn."-__-__' AND Kd_Pemilik LIKE '".$gMLK."' AND Status='' ORDER BY Tgl_Perolehan, Kd_Aset, No_Register";
