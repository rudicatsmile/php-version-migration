...
function RowList($stLOCK,$CrT,$iG,$mRo1,$mRo2,$mRo3,$rIdT,$IdL,$pad,$DatabaseSB,$ConSB,$xB,$Link,$eCeK)
{
	...
	<tr height="40"> 
	  ...
	  <td width="394" style="border-bottom:1px #000 dotted; padding-left:<?=$pad?>px; border-left:1px #ccc solid" <?=$gBG?>><?php if ($CrT=='rekn') {echo $xB."<font style='color:#0000ff'>".$mRo3."</font>".$gJnSR;} else {echo $xB.$mRo3;}?></td>
