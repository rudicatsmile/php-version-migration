...
function ExecuteRC($NoRG,$frUPB,$RfA,$RfU,$TbK,$tID,$UID)
{
	...
	if ($CekR=='') 
	{
		...
		UpdateKib_108($NoRG,$frUPB,$RfA,$RfU,$NewReGAset,$TglMts,$NewUPB,$eRuH,$UID);
		UpdatePos_108($NoRG,$frUPB,$RfA,$RfU,$NewReGAset,$TglMts,$NewUPB,$eRuH,$UID);
...
function UnExecuteRC($NoRG,$frUPB,$RfA,$RfU,$TbK,$tID,$UID)
{
	...
	UpdateKibPos_108($NoRG,$frUPB,$RfU,$RuH,$ReF,$RfH,$KdU,$KdT,$ReG,$TgM,$UID);
...
function UpdateKibPos_108($NoRG,$frUPB,$RfU,$RuH,$ReF,$RfH,$KdU,$KdT,$ReG,$TgM,$UID)
{
	#No_Register='".$ReG."',
	...
	Recorded=now(),
	Pencatat='".$UID.":UnExe' 
	WHERE Referensi='".$ReF."' AND Ref_Usulan='".$RfU."' AND Kd_UPB LIKE '".substr($KdT,0,11)."%' AND No_Register='".$NoRG."'";
	$RsU = mysql_query($SQU);
...
function UpdateKib_108($NoRG,$frUPB,$RfA,$RfU,$NewReGAset,$TglMts,$NewUPB,$eRuH,$UID)
{
...
function UpdatePos_108($NoRG,$frUPB,$RfA,$RfU,$NewReGAset,$TglMts,$NewUPB,$eRuH,$UID)
{
	#No_Register='".$NewReGAset."',
	$SQU = "UPDATE ta_kib_post_108 SET 
	Kd_UPB='".$NewUPB."', 
