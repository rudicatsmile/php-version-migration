...
?>
<body>
<table border="0" width="1500" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.2.11</td>
  </tr>
</table>
<table border="0" width="1500" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">ASET BERSEJARAH</td>
  </tr>
  <tr>
...
<table border="0" width="1500" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  <tr style="text-align:center; font-weight:bold">
    ...
    <td style="border:1px solid #000">Spesifikasi<br>
    Lainnya</td>
    <td style="border:1px solid #000">Lokasi</td>
    <td style="border:1px solid #000">Titik<br>
    Koordinat</td>
    ...
    <td style="border:1px solid #000">Tanggal<br>
    Perolehan</td>
  ...
  <tr style="text-align:center">
    ...
    <td width="50" style="border:1px solid #000; border-bottom:3px double #000">9</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">10</td>
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">11</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">12</td>
    <td width="100" style="border:1px solid #000; border-bottom:3px double #000">13</td>
    <td style="border:1px solid #000; border-bottom:3px double #000">14</td>
  </tr>
	<?php
	$iGa = 1;
	$t8  = 0;
