...
$gUNT = "24.04.XX.XX";//substr($SkP,0,11);
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:900px">
  ...
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('_._._','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Semua)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.1','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Tanah)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.2','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Peralatan & Mesin)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.3','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Gedung & Bangunan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.4','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Jalan, Irigasi & Bangunan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.5','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Aset Tetap Lainnya)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.3.6','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Konstruksi Dalam Pengerjaan)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.2','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Kemiteraan Dengan Pihak Ketiga)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.3','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Aset Tidak Berwujud)</a></td>
  </tr>
  <tr height="22">
    <td>&nbsp;</td>
    <td><a href="#" class="ico docu" onClick="showDoc('1.5.4','Format_XX_0','<?=$IdL?>'); return false;">&nbsp;Daftar BMD (Aset Lain-Lain)</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
