...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family:calibri; font-size:10pt">
  ...
  <tr height="24">
    ...
    <td>Dasar Hukum </td>
    <td>:</td>
    <td colspan="2"><input type="text" name="fDsrHuk" id="fDsrHuk" value="<?=$DsrHuk?>" style="width:240px; background:#fff" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
  ...
  <tr height="24">
    ...
    <td><a href="#" onClick="formCetakDok('Format_II_A_14','<?=$IdT?>','800','400','<?=$IdL?>'); return false" class="ico docu">&nbsp;&nbsp;Format II.A.14</a></td>
  </tr>
  <tr height="24">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
