...
<form name="myfrm" method="post" action="<?php echo "Open_NRC_Mid_.php?IdL=".$_GET['IdL']?>">
  ...
  <table border="0" align="center" style="width:600px">
    ...
    <tr>
	  ...
	  <option value="1.5.3" <? if ($gAst=="1.5.3") {echo "selected";}?>>KIB-G ( <?="1.5.3 ".strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.5.3","=","",DatabaseSB,$ConSB,""))?> )</option>
	  <option value="1.5.4" <? if ($gAst=="1.5.4") {echo "selected";}?>>KIB-H ( <?="1.5.4 ".strtoupper(fGlobalNEW("Nm_Aset","ref_rek_aset108_3","Kd_Aset","1.5.4","=","",DatabaseSB,$ConSB,""))?> )</option>
      </select></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
