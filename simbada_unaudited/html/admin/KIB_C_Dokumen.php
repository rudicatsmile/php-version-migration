...
<div align="center">
	<table border="0" width="1600" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
      ...
      <td style="font-size: 13pt; font-weight: bold" align="center"> GEDUNG DAN BANGUNAN <? if ($gExt=="Y") {echo "(EXTRA KOMTABLE)";}?></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td><table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; font-weight: bold; border-collapse: collapse" id="table3">
              <tr>
                ...
                <td width="110"><? if ($CriT=="BPK") {echo "KELOMPOK";}?></td>
                <td width="40"><? if ($CriT=="BPK") {echo ":";}?></td>
                <td width="641"><? if ($CriT=="BPK") {echo $gNmKEL;}?></td>
              </tr>
              <? if ($gUnt!="All") { ?>
              <tr>
              ...
              <tr>
                <td width="103"><? if ($CriT!="BPK") {echo "KODE LOKASI";} else {echo "TAHUN";}?></td>
                <td width="30"><?=":"?></td>
		...
		<tr>
          ...
          <?
				...
				?>
          <? function ViewRincian($x0,$x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$LI,$LT,$LB,$LG,$LL,$TG,$xB) {?>
          <tr height="22">
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LL?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><? echo $x0?><? if ($x0!=""){echo ".";}?></td>
            ...
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="center"><? if ($x7!=0){echo $LI.$xB.fConvertToRupiahBulat($x7);}?></td>
            ...
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000; text-align:center"><? if ($x9!="0000-00-00" && $x9!=""){echo $LI.$xB.fConvertDateShort($x9);}?></td>
            ...
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000; text-align:center"><? if ($x11!=0){echo $LI.$xB.fConvertToRupiahBulat($x11);}?></td>
            ...
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="right"><? echo $LI.$xB.fConvertToRupiah($x15)?></td>
            <td style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: <?=$LT?>px <?=$LG?> #000; border-bottom: <?=$LB?>px <?=$LG?> #000" align="right"><? if ($x17!="") {echo $LI.$xB.fConvertToRupiah($x17);}?></td>
          ...
          <tr height="25"> 
            ...
            <td align="right" style="border:1px solid #000000; font-weight: bold"><? echo fConvertToRupiah($gAhr)?></td>
            <td style="border: 1px solid #000000">&nbsp;</td>
          </tr>
        </table>			
			</td>
