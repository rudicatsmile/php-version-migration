...
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="40"> 
	  ...
	  <a href="#" onClick="showEDIT('<?=$IdT?>','<?=$Frm?>','<?=$Crit?>','<?=$IdL?>'); return false" class="ico edit">edit</a>&nbsp;&nbsp;&nbsp;
	  <a href="#" onClick="showDELE('<?=$IdT?>','<?=$rCek?>','<?=$Frm?>','<?=$Crit?>','<?=$IdL?>'); return false" class="ico dell">delete</a>&nbsp;&nbsp;&nbsp;
	  <a href="#" onclick="P_Dokumen('800','400','<?=$IdT?>','<?=$Frm?>','<?=$Crit?>','<?=$IdL?>'); return false" class="ico prev">&nbsp;print</a>	  </td>
    </tr>
	<?php
	$iG++;
	$tJmL=$tJmL+$mRo[7];
