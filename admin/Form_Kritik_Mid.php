...
<table border="0" width="561" cellspacing="1" align="center" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1">
	<tr>
	  ...
	  <td width="449" height="5"><input name="fJdl" type="text" readonly value="<?php echo $gJdl?>" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width:200px" /></td>
	</tr>
	...
	<tr>
      ...
      <td height="5">&nbsp;</td>
      <td height="5"><input name="fAlm" type="text" readonly value="<?php echo $gAlm?>" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width:200px" /></td>
	</tr>
	...
	<tr>
	  ...
	  <textarea name="S1" readonly style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width: 600px; height:130px"><?php echo $gInf?></textarea></td>
	</tr>
	<tr>
	  <td height="5" colspan="3">&nbsp;</td>
	  </tr>
	<tr>
	  <td height="5" colspan="3"><label><input type="checkbox" name="fTmpl" value="ON" <?php echo $gTmp?>> TAMPILKAN </label></td>
    </tr>
	
	<tr>
	  <td height="5" colspan="3" style="color:#FF0000"><?php echo $MsG?>&nbsp;</td>
	</tr>
	<tr>
