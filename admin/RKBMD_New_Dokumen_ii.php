		...
		<tr>
			...
			<table border="1" width="1800" cellpadding="1" cellspacing="0" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000">
				...
				<tr height="22">
				  ...
				  <td colspan="4" align="center" style="font-weight: bold">J u m l a h</td>
			  ...
			  <tr>
				  <td align="center" style="font-weight: bold">Usulan</td>
			      <td align="center" style="font-weight: bold">Kebutuhan<br>Maximum </td>
			      <td align="center" style="font-weight: bold">Optimalisasi</td>
			      <td align="center" style="font-weight: bold">Kubutuhan<br>Riil </td>
			  ...
			  <tr style="text-align:center">
				...
				<td width="70" style="font-weight: bold; border-bottom: 3px double #000">8</td>
				<td width="35" style="font-weight: bold; border-bottom: 3px double #000">9</td>
				<td width="70" style="font-weight: bold; border-bottom: 3px double #000">10</td>
				<td width="200" style="font-weight: bold; border-bottom: 3px double #000">11</td>
				<td width="80" style="font-weight: bold; border-bottom: 3px double #000">12</td>
				<td width="200" style="font-weight: bold; border-bottom: 3px double #000">13</td>
				<td width="90" style="font-weight: bold; border-bottom: 3px double #000">14</td>
				<td width="200" style="font-weight: bold; border-bottom: 3px double #000">15</td>
			  </tr>
				<?php
				$mRo4 = 0;
				$mRo5 = 0;
				...
				P1.Usulan_Jumlah, 
				P1.Maksimum_Jumlah, 
				P1.Optimalisasi_Jumlah,
				(P1.Maksimum_Jumlah-P1.Optimalisasi_Jumlah) as KebutuhanReal_Jumlah,
				...
				LEFT JOIN ta_rkbmd_new_program P3 ON P3.Referensi=P1.Referensi AND P3.Kd_Program=left(P1.Kd_Kegiatan,7) 
				LEFT JOIN ta_rkbmd_new_kegiatan P4 ON P4.Referensi=P1.Referensi AND P4.Kd_Kegiatan=P1.Kd_Kegiatan 
				LEFT JOIN ta_rkbmd_new_kegiatan_sub P5 ON P5.Referensi=P1.Referensi AND P5.Kd_Sub_Kegiatan=P1.Kd_Sub_Kegiatan 
				...
				?>
					...
					<td style="border-bottom: 1px solid #000; text-align:center"><?=$mRo[6]?></td>
					<td style="border-bottom: 1px solid #000; text-align:center <?=$eCL?>"><?=$mRo[7]?></td>
					<td style="border-bottom: 1px solid #000; text-align:center"><?=$mRo[8]?></td>
					<td style="border-bottom: 1px solid #000"><?=$mRo[9]?></td>
					<td style="border-bottom: 1px solid #000; text-align:center"><?=$mRo[10]?></td>
					<td style="border-bottom: 1px solid #000"><?=$mRo[11]?></td>
					<td style="border-bottom: 1px solid #000; text-align:center"><?=$mRo[12]?></td>
					<td style="border-bottom: 1px solid #000"><?=$mRo[13]?></td>
					</tr>
				<?php
				$iG++;
				$mRo4 = $mRo4+$mRo[4];
			  ...
			  <tr height="22" style="font-weight:bold; text-align:center">
			      ...
			      <td style="border-bottom: 1px solid #000"><?=fConvertToRupiahBulat($mRo6)?></td>
			      <td style="border-bottom: 1px solid #000"><?=fConvertToRupiahBulat($mRo7)?></td>
			      <td style="border-bottom: 1px solid #000">&nbsp;</td>
			      <td style="border-bottom: 1px solid #000">&nbsp;</td>
			      <td style="border-bottom: 1px solid #000">&nbsp;</td>
			      <td style="border-bottom: 1px solid #000">&nbsp;</td>
