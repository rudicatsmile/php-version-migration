...
<table border="0" width="1000" cellpadding="0" style="border-collapse: collapse" id="table1">
	<tr>
		...
		<td width="54">REG.</td>
		<td width="347">NAMA</td>
		<td width="109">HARGA</td>
		<td width="101">NILAI AKHIR</td>
		<td width="110">POSTING</td>
	</tr>
	<?
	$iG=1;
	$nSQL= "SELECT * FROM Ta_Kib_F where Post='N' order by IDT limit 2000";
	...
	if ($tRo > 0)
	{
		do
		{
			...
			if ($eINS == "")
				...
				//UPDATE
				$SQ = "update Ta_Kib_F set Post='Y' where IDT='".$mRo['IDT']."'";
				$rs = mysql_query($SQ) or die(mysql_error());		
			}
			?>
			<tr>
				...
				<td align="right"><? echo fConvertToRupiah($mRo['Nilai_Sisa'])?></td>
