...
?>
<body>
<form name="myfrm" method="POST" action="<? echo "Import_KIB_Mid.php?gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gThn=".$gThn."&gKib=".$gKib."&IdL=".$_GET['IdL']?>">
  ...
  <table border="0" width="1050" cellspacing="0" bgcolor="#FFFFFF" style="font-size:10pt; font-family:calibri; border-collapse: collapse" id="table1">
	...
	if ($tRo > 0)
	{
		do
		{
			...
			?>
			<tr> 
			  <td style="border-top: 1px dotted #000000"><? echo $iG?>.</td>
			  <td style="border-top: 1px dotted #000000"><? echo substr($gNm,17,100).$gCK?></td>
			  <td style="border-top: 1px dotted #000000"><? echo $mRo['Size']?></td>
			  <td style="border-top: 1px dotted #000000"><? echo $mRo['Recorded']?></td>
			  <td style="border-top: 1px dotted #000000"><? echo $mRo['Pencatat']?></td>
			  <td style="border-top: 1px dotted #000000"><? echo $gST?>
			  </td>
			  <td class="ac" style="border-top: 1px dotted #000000"><a href="<? echo $gURL?>" class="ico upl">&nbsp;Import</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="ico del" onClick="P_Delete('<? echo $mRo['IDT']?>')">&nbsp;Delete</a></td>
			</tr>
			<?
			$iG++;
		}
...
<script language="javascript">
	...
	function WinUPLOAD(w,h,pos)
	{
		...
		if (win!=null)
		{
			...
			URL_Top = "Upload_Xls_Top.php?FrmG=UPLOAD FILE (*.XLS)"+"<? echo "&IdL=".$_GET['IdL']?>";
			URL_Mid = "Upload_Xls_Mid.php?"+"<? echo "gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gThn=".$gThn."&gKib=".$gKib."&IdL=".$_GET['IdL']?>";
	...
	function P_Delete(id)
	{
		...
		if (AN)	
		{
			window.open("Import_KIB_Mid.php?gDEL=YA&gIDT="+id+"<? echo "&gUnt=".$gUnt."&gSub=".$gSub."&gUpb=".$gUpb."&gThn=".$gThn."&gKib=".$gKib."&IdL=".$_GET['IdL']?>","_self");
		}
	}
</script>
