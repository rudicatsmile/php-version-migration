...
if ($gThn=="____") {
	$nSQ = "SELECT * FROM ta_upb where Kd_Upb = '".$gUpb."' ORDER BY Tahun DESC LIMIT 0,1";
}
else {
	$nSQ = "SELECT * FROM ta_upb where Kd_Upb = '".$gUpb."' and Tahun='".$gThn."'";
}

$nSQ = "SELECT * FROM ref_unit where Kd_Unit = '".substr($gUpb,0,11)."'";
