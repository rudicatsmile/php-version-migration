  ...
  <input type="hidden" name="CritIDT" size="10">
	...
	<table align="center" class="table-list" border="0" cellspacing="0" cellpadding="0" style="width:99%">
		...
		do
			...
			?>
      		<script language="javascript">
				function EditData<? echo $mRo['IDT']?>(w,h,pos)
				{	var win=null;
					var txtHTML = "";
					var iErrors=0;
      ...
      <tr height="22" style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39"> 
        <td <?=fBackCLR($iG)?> style="border-bottom: 1px dotted #CCCCCC; text-align:center"><? echo $iG?>.</td>
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><? echo $mRo['Kd_Sub']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <?=fBackCLR($iG)?>><? echo $mRo['Nm_Sub']?></td>
        <td style="border-bottom: 1px dotted #CCCCCC" class="ac" <?=fBackCLR($iG)?>><a href="#" class="ico del" onclick="P_DeleteR('<?=$mRo['IDT']?>','<?=$nDel?>','<?=$ReO?>'); return false;">DELETE</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="ico edit" onclick="EditData<? echo $mRo['IDT']?>('800','450','center'); return false;">EDIT</a></td>
      </tr>
      <tr> 
        <td colspan="4"> <table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <?
			if ($zRo > 0)
			{
			do
				...
				?>
      		<script language="javascript">
				function EditDataUPB<? echo $mRo['IDT'].$rRo['IDT']?>(w,h,pos)
				{	var win=null;
					var txtHTML = "";
					var iErrors=0;
					LeftPosition=(screen.width)?(screen.width-w)/2:100; 
            ...
            <tr> 
              <td width="36">&nbsp;</td>
              <td width="81"><a href="#" onclick="EditDataUPB<? echo $mRo['IDT'].$rRo['IDT']?>('800','450','center'); return false"> 
                <? echo $rRo['Kd_UPB']?>
                </a></td>
              <td width="8">:</td>
              <td width="814"><a href="#" onclick="EditDataUPB<? echo $mRo['IDT'].$rRo['IDT']?>('800','450','center'); return false">
                <? echo $rRo['Nm_UPB']?>
                </a></td>
              <td width="137">&nbsp; </td>
            </tr>
      ...
      <tr height="30">
		...
		[&nbsp;<a href="<? echo $_SERVER['PHP_SELF']."?gUnT=".$zUnT."&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']."&Page=".$_GET['Page']."&iG=".$_GET['iG'] ?>" class="ico reff">&nbsp;REFRESH</a>&nbsp;]</td>
        <td style="border-top:1px solid #CCCCCC">&nbsp;</td>
      </tr>
    </table>
	  <?
