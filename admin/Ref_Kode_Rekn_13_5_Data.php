...
<?php
$iG=1;
$nSQ = "SELECT P1.IDT as A0, P1.Kd_Rek as A1, P1.Nm_Rek as A2, P2.Kd_Rek_90 as A3, P3.Nm_Rek as A4 
FROM ref_rek_5 P1 
LEFT JOIN ref_rek_90_6_mapping_13 P2 ON P2.Kd_Rek_13=P1.Kd_Rek 
LEFT JOIN ref_rek_90_6 P3 ON P3.Kd_Rek=P2.Kd_Rek_90 
WHERE P1.Kd_Rek LIKE '".$KdR4."%' $CrT ORDER BY P1.Kd_Rek";
#echo $nSQ;
$nRs = mysql_query($nSQ);
while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
{
	...
	<tr height="25"> 
	  ...
	  <a href="#" onClick="deleteDATA('5','<?=$eIdT?>','<?=$rCek?>','<?=$IdL?>'); return false" class="ico dell">&nbsp;Delete</a>&nbsp;&nbsp;	  </td>
    </tr>
	<?php
	$iG++;
}
