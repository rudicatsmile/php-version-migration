<?php
function ExecutePH_All($NoRG,$frUPB,$RfA,$RfU,$tID,$UID)
{
	...
	if ($CekR=='') 
	{
		...
		DeleteKib_108($NoRG,$frUPB,$RfA,$RfU,$TglMts,$NewUPB,$eRuH,$UID);
		DeletePos_108($NoRG,$frUPB,$RfA,$RfU,$TglMts,$NewUPB,$eRuH,$UID);
		
		UpdateUsulanVerRci($tID,'Sudah',$UID);
	}
}

function UnExecutePH_All($NoRG,$frUPB,$RfA,$RfU,$tID,$UID)
{
...
function InsertKib_Mutasi_108($NoRG,$frUPB,$RfA,$RfU,$TglMts,$NewUPB,$UID)
{
	...
	while ($mRo = mysql_fetch_array($Rs, MYSQL_BOTH))
	{
		...
		Batas_Barat='".mysql_real_escape_string($mRo['Batas_Barat'])."',
		Batas_Selatan='".mysql_real_escape_string($mRo['Batas_Selatan'])."',
		Batas_Timur='".mysql_real_escape_string($mRo['Batas_Timur'])."',
		Batas_Utara='".mysql_real_escape_string($mRo['Batas_Utara'])."',
...
function DeleteKib_108($NoRG,$frUPB,$RfA,$RfU,$TglMts,$NewUPB,$eRuH,$UID)
{
	$SQU = "Delete FROM ta_kib_108 
	WHERE Referensi='".$RfA."' AND Kd_UPB LIKE '".$frUPB."%' AND No_Register='".$NoRG."'";
	mysql_query($SQU);
	#echo $SQU."<br>";
}

function DeletePos_108($NoRG,$frUPB,$RfA,$RfU,$TglMts,$NewUPB,$eRuH,$UID)
{
	$SQU = "DELETE FROM ta_kib_post_108 
	WHERE Referensi='".$RfA."' AND Kd_UPB LIKE '".$frUPB."%' AND No_Register='".$NoRG."'";
	$RsU = mysql_query($SQU);
}
