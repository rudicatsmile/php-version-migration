...
<table align="center" cellpadding="0" cellspacing="0" width="850" border="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt"> 
  ...
  <tr height="26" style="vertical-align:top; font-weight:bold">
	...
	<td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center">&nbsp;</td>
	<td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center">&nbsp;</td>
	<td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center"><? if($Sisa!=0){echo fConvertToRupiahBulat($Sisa);} else {echo '-';}?></td>
    <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center">&nbsp;</td>
    <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($HarG!=0){echo fConvertToRupiah($HarG);} else {echo '-';}?></td>
  </tr>
  <? } ?>
  <? 
	$iG=1; 
	...
	{ 
        ...
        ?> 
          <tr height="26" style="cursor: pointer">
            ...
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center"><? if($PosA!=0){echo fConvertToRupiahBulat($PosA);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($HrgM!=0){echo fConvertToRupiah($HrgM);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($TtlM!=0){echo fConvertToRupiahBulat($TtlM);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center"><? if($PosB!=0){echo fConvertToRupiahBulat($PosB);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($HrgK!=0){echo fConvertToRupiah($HrgK);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($TtlK!=0){echo fConvertToRupiah($TtlK);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:center"><? if($Sisa!=0){echo fConvertToRupiahBulat($Sisa);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($HarG!=0 && $Sisa!=0){echo fConvertToRupiah($HarG/$Sisa);} else {echo '-';}?></td>
            <td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($HarG!=0){echo fConvertToRupiah($HarG);} else {echo '-';}?></td>
          </tr> 
          <? 
        $iG++; 
  ...
  <tr height="30" style="cursor: pointer; font-weight:bold">
	...
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center"><? if($TosA!=0){echo fConvertToRupiahBulat($TosA);} else {echo '-';}?></td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center">-</td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($EtlM!=0){echo fConvertToRupiah($EtlM);} else {echo '-';}?></td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center"><? if($TosB!=0){echo fConvertToRupiahBulat($TosB);} else {echo '-';}?></td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center">-</td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($EtlK!=0){echo fConvertToRupiah($EtlK);} else {echo '-';}?></td>
	<td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center"><? if($Tisa!=0){echo fConvertToRupiahBulat($Tisa);} else {echo '-';}?></td>
    <td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:center">-</td>
    <td style="border-right:1px solid #000; border-top:0px solid #000; border-bottom:1px solid #000; text-align:right; padding-right:3px"><? if($TarG!=0){echo fConvertToRupiah($TarG);} else {echo '-';}?></td>
  </tr>
</table>
