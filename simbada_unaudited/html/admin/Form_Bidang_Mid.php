...
<form name="myfrm" method="post" action="<?php echo "Form_Bidang_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      ...
      <td width="25">:</td>
      <td><input name="fKode" type="text" class="text" id="fKode" style="font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod?>" size="5" maxlength="8" readonly /></td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
