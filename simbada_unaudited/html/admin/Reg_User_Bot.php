...
<form name="myfrm" method="post" action="<?php echo "Reg_User_Bot.php?IdL=".$IdL."&eIdT=".$eIdT?>">
  <input type="hidden" name="Simpan">
	<table border="0" width="100%" cellspacing="1" style="font-size: 10pt; font-family: Calibri; border-collapse: collapse" id="table1">
		<tr>
		  <td width="8">&nbsp;</td>
			<td width="20"><? if ($IdL!="") {?><img src="Images/e_contents_view.gif" width="16" height="16" /><? } ?></td>
			<td width="70"><? if ($IdL!="") {?><a href="<?php echo "Reg_User_Mid.php?IdL=".$IdL."&eIdT=".$eIdT?>" target="WinFormUser_Mid">PREVIEW</a><? } ?></td>
			<td width="20"><? if ($IdL!="") {?><img src="Images/edit.png" width="16" height="16" /><? } ?></td>
			<td width="70"><? if ($IdL!="") {?><a href="<?php echo "Reg_User_Mid_Add.php?IdL=".$IdL."&eIdT=".$eIdT?>" target="WinFormUser_Mid">EDIT USER</a><? } ?></td>
			<td width="20"><? if ($IdL!="") {?><img src="Images/del.gif" width="12" height="12" /><? } ?></td>
			<td><? if ($IdL!="") {?><a href="" onclick="P_Delete('<?=$ReO?>')">HAPUS USER</a><? } ?></td>
