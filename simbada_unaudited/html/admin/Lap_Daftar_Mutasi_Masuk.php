...
<tr>
  <td style="font-size: 13pt; font-weight: bold" align="center">DAFTAR MUTASI MASUK</td>
</tr>
</table>
<table border="0" width="1900" cellspacing="1" align="center" style=" font-size: 10pt; font-family: Calibri; border-collapse: collapse">
<tr>
...
Kd_Aset_To as A9,
Kd_Aset_108 as A10,
Kd_Aset_108_To as A11,
No_Register as A12,
No_Pengadaan as A13,
Nm_Aset as A14,
Tgl_Perolehan as A15,
Tgl_Mutasi as A16,
Tgl_Mutasi_Masuk as A17,
Luas_M2 as A18,
concat(Lokasi,'<br>',Alamat) as A19,
Hak_Tanah as A20,
Sertifikat as A21,
Sertifikat_Tanggal as A22,
Sertifikat_Nomor as A23,
Penggunaan as A24,
Asal_Usul as A25,
Kondisi as A26,
Harga as A27,
...
Nomor_Mesin as A37,
Nomor_Polisi as A38,
Nomor_Polisi_Lama as A39,
Nomor_BPKB as A40,
Pemegang as A41,
Pemegang_Lama as A42,
Nilai_Akhir as A43,
Bertingkat as A44,
Beton as A45,
Luas_Lantai as A46,
Lokasi as A47,
Dokumen_Tanggal as A48,
...
Tahun as A63,
Tgl_Mulai as A64,
Tipe_Bangunan as A65 
FROM ta_kib_108_mutasi 
WHERE Kd_UPB_To LIKE '".$gUnt."%' AND Tgl_Mutasi LIKE '".$gThn."-%-%' 
AND Jns_Mutasi LIKE '".$JnM."' AND Kd_Aset_108_To LIKE '".$Ast."%'
AND Kd_Aset_108_To=Kd_Aset_108 
ORDER BY Referensi";
#echo $SQL."<br>";
$nRs = mysql_query($SQL);
...
?>
<? function ShowDATA($x1,$x2,$x3,$x4,$x5,$x6,$x7,$x8,$x9,$x10,$x11,$x12,$x13,$x14,$x15,$x16,$x17,$x18,$x19,$xB) {?>
<tr height="18" valign="top">
  ...
  <td style="border:1px solid #000; text-align:center"><? if ($x5!='0000-00-00'){echo fConvertDateShort($x5);}?></td>
  <td style="border:1px solid #000; text-align:center"><? if ($x6!='0000-00-00'){echo fConvertDateShort($x6);}?></td>
  <td style="border:1px solid #000; padding-left:3px"><?=$x7?></td>
  <td style="border:1px solid #000; text-align:center"><? if ($x8!='0000-00-00'){echo fConvertDateShort($x8);}?></td>
