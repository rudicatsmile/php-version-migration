...
?>
<body>
<table border="0" width="1800" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.3.8</td>
  </tr>
</table>
<table border="0" width="1800" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">ASET TIDAK BERWUJUD</td>
  </tr>
  <tr>
...
<table border="0" width="1800" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  ...
  <tr style="text-align:center">
    ...
    <td width="180" style="border:1px solid #000; border-bottom:3px double #000">2</td>
    ...
    <td width="180" style="border:1px solid #000; border-bottom:3px double #000">5</td>
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.5.3.%' 
...
<table border="0" width="1800" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
