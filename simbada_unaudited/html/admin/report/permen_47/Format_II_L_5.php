...
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.L.5</td>
  </tr>
</table>
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR PENGGUNAAN/PEMAKAIAN BARANG MILIK DAERAH PERALATAN DAN MESIN</td>
  </tr>
  <tr>
...
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  <tr style="text-align:center; font-weight:bold">
    ...
    <td colspan="2" style="border:1px solid #000">Dokumen Sumber<br>Penggunaan</td>
  ...
  <tr style="text-align:center">
    ...
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">15</td>
    <td width="65" style="border:1px solid #000; border-bottom:3px double #000">16</td>
    <td style="border:1px solid #000; border-bottom:3px double #000">17</td>
  </tr>
  <?
	$iG=1;
	...
	WHERE Kd_UPB LIKE '".$KdS."%' AND Kd_Aset_108 LIKE '1.3.2.%' AND Pemegang<>'' 
