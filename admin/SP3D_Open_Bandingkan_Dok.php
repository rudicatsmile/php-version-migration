...
<table align="center" border="0" width="1000" cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-family: Calibri; font-size:10pt">
  ...
  <tr style="text-align:center">
	...
	while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
	{
		...
		?>
		<tr height="30" style="">
		<td style="border:1px solid #000; text-align:center"><?php if ($B != $A){echo $iG.".";}?></td>
		<td style="border:1px solid #000; padding-left:3px"><?php if ($B != $A){echo $mRo[0];}?></td>
		<td style="border:1px solid #000; padding-left:3px"><?php if ($B != $A){echo $mRo[2];}?></td>
