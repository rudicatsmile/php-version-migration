		...
		<tr>
		  <td>
			...
			<tr style="text-align:center; font-weight: bold">
			  ...
			  <td width="200" style="border:1px solid #000; border-bottom:3px double #000">JUDUL</td>
			  <td width="100" style="border:1px solid #000; border-bottom:3px double #000">SPESIFIKASI</td>
			...
			$nSQ = "SELECT count(*) as gItm, Nm_Aset,Judul,Spesifikasi,Ukuran,Bahan,Tgl_Perolehan,Harga,Kondisi, Kd_Aset_108 
			FROM ta_kib_108 WHERE Kd_UPB LIKE '".$gUpb."' AND Kd_Ruang='".$gRua."' $ReK 
			GROUP BY Kd_Aset_108,Nm_Aset,Judul,Spesifikasi,Ukuran,Bahan,Tgl_Perolehan,Harga,Kondisi";
			$nRs = mysql_query($nSQ);
			while ($mRo = mysql_fetch_array($nRs, MYSQL_BOTH))
			{
