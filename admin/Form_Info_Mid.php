...
<table border="0" width="561" cellspacing="1" align="center" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1">
	...
	<tr>
	  ...
	  <td height="5">&nbsp;</td>
	  <td height="5"><input name="fJdl" type="text" value="<?php echo $gJdl?>" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width:300px"/></td>
    </tr>
	<tr>
	  <td height="5">FOTO</td>
	  <td height="5">&nbsp;</td>
	...
	<tr>
	  ...
	  <textarea name="S1" cols="65" rows="8" style="border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width:600px;"><?php echo $gInf?></textarea>	  </td>
	</tr>
	...
	<tr>
	  ...
	  <td>&nbsp;</td>
	  <td valign="middle"><input readonly name="fPcc" type="text" value="<?php echo $gUid?>" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px; width:200px" maxlength="100" /></td>
    </tr>
	<tr>
	  <td height="5">STATUS</td>
	  <td>&nbsp;</td>
	  <td valign="middle"><label><input type="checkbox" name="fTmpl" value="ON" <?php echo $gTmp?>> TAMPILKAN</label></td>
    </tr>
	<tr>
