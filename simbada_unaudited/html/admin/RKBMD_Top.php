...
<table border="0" width="1313" cellpadding="0" style="border-collapse: collapse">
  <tr>
	...
	<td width="1140" height="30" style="font-family: Agency FB; font-size: 14pt; font-weight: bold; color: #E1F986; font-style:italic">RKBMD (Rencana Kebutuhan Barang Milik Daerah) TAHUN <? echo $gThn?></td>
	</tr>
  <tr>
...
<? if ($_REQUEST['Simpan']=="View") {?>
	<script language="JavaScript">
		window.open("<? echo "RKBMD_Mid.php?JusV=1&IdL=".$_REQUEST['IdL'] ?>","WinOpenRKB_Mid");
	</script>
<? } ?>
<? if ($_REQUEST['Simpan']=="Next") {?>
	<script language="JavaScript">
		window.open("<? echo "RKBMD_Mid.php?JusV=0&zKeg=".$zKeg."&zUpb=".$zUpb."&zThn=".$gThn."&IdL=".$_REQUEST['IdL'] ?>","WinOpenRKB_Mid");
	</script>
<? } ?>