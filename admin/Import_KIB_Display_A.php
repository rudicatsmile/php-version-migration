	...
	for ($i = 3; $i <= $data->sheets[0]['numRows']; $i++) {
		...
		?>
		  <tr> 
			...
			<td><?php echo $data->sheets[0]['cells'][$i][10] ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][11] ?></td>
			<td><?php echo $gTglV ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][13] ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][14] ?></td>
			<td class="ac"><?php echo $data->sheets[0]['cells'][$i][15] ?></td>
			<td class="ar"><?php echo fConvertToRupiahBulat($data->sheets[0]['cells'][$i][16]) ?></td>
			<td><?php echo $data->sheets[0]['cells'][$i][17] ?></td>
		  </tr>
	  <?php } ?>
  <?php 
  $tG++;
