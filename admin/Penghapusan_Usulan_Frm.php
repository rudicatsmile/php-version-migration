...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%; color:#fff; background:#79a86a">
  ...
  <tr height="25">
	...
	<input name="dP47" id="dP47" type="text" value="<?=$dP47?>" <?php if (!$IdT) {?> onClick="showP47('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showP47('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('des'); return false;}" <?php } else {echo "readonly";}?> style="width:260px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="25">
	...
	<input name="dDES" id="dDES" type="text" value="<?=$dDES?>" <?php if (!$IdT) {?> onClick="showDES('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13){ showDES('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('des'); return false;}" <?php } else {echo "readonly";}?> style="width:260px; border: 1px solid #C0C0C0"/>
  ...
  <tr height="25">
	...
	<input name="dUNT" id="dUNT" type="text" value="<?=$dUNT?>" <?php if ($IdT=='' && $Lev <= 1) {?> onClick="showUNIT('','<?=$_GET['IdL']?>')" onkeypress="if (event.keyCode==13) {showUNIT('find','<?=$_GET['IdL']?>'); return false;} else if (event.keyCode==27) {closeCLICK('unit'); return false;}" <?php } else {echo "readonly";}?> style="padding-left:5px; width:486px; border: 1px solid #C0C0C0"/>
