...
?>
<body>
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.2.6</td>
  </tr>
</table>
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">DAFTAR BMD PADA PENGGUNA BARANG</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">KONTRUKSI DALAM PENGERJAAN</td>
  </tr>
  <tr>
...
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  ...
  <tr style="text-align:center">
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.3.6.%' AND P1.KdpToAset='N' 
	...
	function Lev5($KdS,$x1,$ThN,$HostnameSB,$ConSB)
	{
		...
		WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '".$x1.".%' AND P1.KdpToAset='N' 
		AND P1.Tgl_Perolehan<='".$ThN."-12-31' 
...
<table border="0" width="2000" cellspacing="0" cellpadding="0" align="center" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr>
