		  ...
		  <td>
			<table border="0" width="100%" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
				<tr bgcolor="#FF0033" style="color:#FFFFFF">
					...
					<td width="24%">URAIAN</td>
					<td width="12%" align="right">DEBET</td>
					<td width="12%" align="right">KREDIT</td>
				...
				if ($mRw > 0)
				{
					do
					{
						...
						<tr>
							...
							<td valign="top"><? echo $gMem?></td>
							<td valign="top" align="right"><? if ($nDB!=0) {echo fConvertToRupiah($nDB);}?></td>
							<td valign="top" align="right"><? if ($nKR!=0) {echo fConvertToRupiah($nKR);}?></td>
						    <td valign="top" align="right">&nbsp;</td>
						    <td valign="top" style="text-align:justify"><? echo $mRo['Keterangan']?></td>
					    </tr>
						<?
					}
