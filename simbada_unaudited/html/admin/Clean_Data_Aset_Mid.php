...
<form name="myfrm" method="post" action="<?php echo "Clean_Data_Aset_Mid_.php?IdL=".$_GET['IdL']?>">
  ...
  <table width="1165" border="0" align="center">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td>Ta KIB-A</td>
      <td width="60" class="ar" valign="middle"><? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_a","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      ...
      <td width="60" class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":TNH.%","LIKE:LIKE","",""))?>
      </td>
    ...
    <tr> 
      ...
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_b","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      ...
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":ALT.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
    ...
    <tr> 
      ...
      <td>Ta KIB-C</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_c","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle">Posting</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":BNG.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
    ...
    <tr> 
      ...
      <td>Ta KIB-D</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_d","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle">Posting</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":JLN.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
    ...
    <tr> 
      ...
      <td>Ta KIB-E</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_e","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle">Posting</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":ATL.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
    ...
    <tr> 
      ...
      <td>Ta KIB-F</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_f","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle">Posting</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Referensi",$rUpb.":KDP.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
    ...
    <tr> 
      ...
      <td>Ta KIB-G</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_g","Kd_UPB",$rUpb,"LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle">Posting</td>
      <td class="ar" valign="middle"> 
        <? echo fConvertToRupiahBulat(fGlobal("count(*)","ta_kib_post","Kd_UPB:Kd_Aset",$rUpb.":07.%","LIKE:LIKE","",""))?>
      </td>
      <td valign="middle">&nbsp;</td>
      <td valign="middle"><i>record</i></td>
