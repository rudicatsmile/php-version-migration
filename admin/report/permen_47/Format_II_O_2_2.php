...
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:11pt">
  <tr>
    <td width="567"></td>
    <td width="131" style="text-align:right; font-size:10pt">Format II.O.2.2</td>
  </tr>
</table>
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:10pt">
  ...
  <tr>
    <td style="text-align:center; font-size:10pt; font-weight:bold; font-family:calibri">PERALATAN DAN MESIN</td>
  </tr>
  <tr>
...
<table border="0" width="2400" cellspacing="0" cellpadding="0" align="center" style="border-collapse: collapse; font-family:Calibri; font-size:9pt">  
  ...
  <tr style="text-align:center">
    ...
    <td width="150" style="border:1px solid #000; border-bottom:3px double #000">7</td>
    ...
    <td width="50" style="border:1px solid #000; border-bottom:3px double #000">12</td>
    <td width="80" style="border:1px solid #000; border-bottom:3px double #000">13</td>
    ...
    <td width="90" style="border:1px solid #000; border-bottom:3px double #000">16</td>
    <td width="70" style="border:1px solid #000; border-bottom:3px double #000">17</td>
    <td width="120" style="border:1px solid #000; border-bottom:3px double #000">18</td>
	...
	WHERE P1.Kd_UPB LIKE '".$KdS.".%' AND P1.Kd_Aset_108 LIKE '1.3.2.%' 
  ...
  <tr height="19" style="font-weight:bold">
    <td colspan="11" style="border:1px solid #000; text-align:right">T O T A L<?=str_repeat('&nbsp;',20)?></td>
