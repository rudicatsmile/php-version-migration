...
<body>
  ...
  <table width="1165" border="0" align="center">
	...
	if ($tRo > 0)
	{
      ...
      <td width="102" height="18" valign="top"><a href="<? echo $URL?>" target="_top">
        <? echo $mRo['Kd_Aset']?>
        </a></td>
			  
      <td width="1016" valign="top" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;);"><a href="<? echo $URL?>" target="_top">
        <? echo $mRo['Nm_Aset']?>
        &nbsp;</a></td>
			</tr>
			<tr style="cursor: pointer; " onmouseover="this.style.cursor=&#39;pointer&#39;"> 
			  ...
			  <table id="detail<? echo $iG?>" cellspacing="0" cellpadding="3" border="0" width="100%" style="font-style: italic; color: #808080; display: none;">
				  <tr> 
					...
					<td width="20">:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset2","Kd_Aset",$gK2,"=","","")?>
					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					...
					<td>:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset3","Kd_Aset",$gK3,"=","","")?>
					</td>
				  </tr>
				  <tr> 
					<td>&nbsp;</td>
					...
					<td>:</td>
					<td>
					  <? echo fGlobal("Nm_Aset","Ref_Rek_Aset4","Kd_Aset",$gK4,"=","","")?>
					</td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
