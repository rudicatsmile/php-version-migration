...
<form name="myfrm" method="POST" action="<?="Utility_Import_SQL_FFN.php?FrmG=".$FrmG."&IdL=".$IdL?>">
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:99%; background-color:#D2DAC4">
  ...
  <tr height="25">
    ...
    <td>&nbsp;</td>
    <td>
	<select class="boxs" name="fKON" id="fKON" tabindex="0" style="width:140px" onchange="RefreshDATA('view','<?=$IdL?>')">
      <option value="0">0</option>
      <option value="1" selected>1. Baik</option>
...
<script languange="javascript">
	...
	function RefreshDATA(crt,IdL)
	{
		...
		if (crt=='import')
		{
			//fil = "Utility_Import_SQL_FFN_Import";
			//vie = "ViewDELL";
			//AN=confirm('Import?');
			//if (!AN){return false;}
			return false;
		...
		{
			//fil = "Utility_Import_SQL_FFN_Batal";
			//vie = "ViewDELL";
			//AN=confirm('Batalkan?');
			//if (!AN){return false;}
			return false;
		...
		{
			fil = "Utility_Import_SQL_FFN_Data";
			vie = "ViewDATA";
		}
