...
function RowList($stLOCK,$CrT,$iG,$mRo1,$mRo2,$mRo3,$mRo4,$mRo5,$mRo6,$mRo7,$mRo8,$mRo9,$rIdT,$IdL,$pad,$DatabaseSB,$ConSB,$gBG,$xB)
{
	...
	<tr height="25"> 
	  ...
	  <td rowspan="<?=$span?>" style="border-bottom:1px #999999 dotted; padding-left:<?=$pad?>px; border-left:1px #ccc solid" <?=$gBG?>><?php if ($CrT=='rekn') {echo $xB."<b>".$mRo3."</b>".$gJnSR;} else {echo strtoupper($xB.$mRo3);}?></td>
