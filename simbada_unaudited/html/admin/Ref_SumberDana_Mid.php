...
<table border="0" class="table-form" cellspacing="0" cellpadding="0" align="center" style="width:99%; height:30px">
  ...
  <tr height="25">
    ...
    <td>&nbsp;</td>
    <td align="left"><input name="fNmSB" id="fNmSB" type="text" value="<?=$NmSB?>" <? if ($CeK!=''){echo "readonly";}?> style=" width:300px; border: 1px solid #C0C0C0"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr height="25">
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td align="left"><input name="fAlIA" id="fAlIA" type="text" value="<?=$AlIA?>" <? if ($CeK!=''){echo "readonly";}?> style=" width:300px; border: 1px solid #C0C0C0"/></td>
    <td>&nbsp;</td>
  </tr>
