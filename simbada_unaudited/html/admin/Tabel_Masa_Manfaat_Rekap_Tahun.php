...
<table border="0" align="center" cellspacing="0" style="width:1400px; font-size: 8pt; font-family: Calibri; border-collapse: collapse">
  <tr>
	...
	<tr>
	  ...
	  <td width="1292" style="font-size: 10pt; font-weight: normal"><? if ($uNT=='All') {echo "Semua";} else {echo strtoupper(fGlobalNEW("Nm_Unit","ref_unit","Kd_Unit",$_GET['uNT'],"=","",DatabaseSB,$ConSB,""));}?></td>
	</tr>
	<tr>
	...
	<table border="0" align="center" width="1400" cellspacing="0" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse">
	  <tr height="20">
	    ...
	    <td width="54" style="text-align:center; font-weight:bold; border:1px solid #000000">SISA UMUR (Tahun) </td>
	  </tr>
	  <tr height="20">
...
<tr>
  ...
  <div class="pagging"> 
	...
	if ($CntItem>0)
	{
		...
		{
			?>
			<a href="<?="Tabel_Masa_Manfaat_Rekap_Tahun.php?iPG=".$iR."&mts=".$mts."&ExtR=".$ExtR."&rTH=".$_GET['rTH']."&rAS=".$_GET['rAS']."&uNT=".$_GET['uNT']."&uUP=".$_GET['uUP']."&uSU=".$_GET['uSU']."&gHriC=".$_GET['gHriC']."&gBlnC=".$_GET['gBlnC']."&gThnC=".$_GET['gThnC']."&IdL=".$_GET['IdL']?>"><?="<b>".substr('00'.$i,-2,2)."</b>"?></a><? if ($i==100) {echo "<br>";}?><?=str_repeat('&nbsp;',0)?>
			<? 
			$i++;
		}
	}
