...
<table border="1" width="1300" cellspacing="0" cellpadding="0" align="center" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" bordercolor="#000000">
  ...
  <tr height="25"> 
    ...
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[1]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[2]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[3]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[4]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[5]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[6]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[7]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[8]) ?></td>
    <td align="right" style="font-weight:bold; border-top: 3px double #000000; padding-right:2px"><? echo fConvertToRupiah($tCoL[9]) ?></td>
  </tr>
</table>
<table border="0" width="1300" cellspacing="0" cellpadding="0" align="center" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse" id="table1" bordercolor="#000000">
	<tr>
