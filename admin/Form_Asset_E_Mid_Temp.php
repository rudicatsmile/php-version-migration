...
if ($gIdT!="")
{
	$nSQ = "SELECT Kd_Unit, Nilai, Kd_Aset_108, SPP, Pros, No_Berkas, Nomor, Uraian FROM ta_pengadaan WHERE IDT='$gIdT'";
...
?>
<body>
<form name="myfrm" method="post" action="<?php echo "Form_Asset_E_Mid_Temp_.php?gIdT=".$gIdT."&rIDT=".$rIDT."&IdL=".$_GET['IdL'] ?>">
...
<input type="hidden" name="CriteR" style="width:100px">
  <table border="0" align="center" width="900" style="font-family:Calibri; font-size:10pt">
    ...
    <tr>
      ...
      <td>
	  <?php if ($zBid=="1.3.5.01") {?>
	    <input name="fJudul" type="text" class="text" id="fJudul" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gJDL?>" /> 
	  <?php } else if ($zBid=="1.3.5.02") {?>
	    <input name="fAsalD" type="text" class="text" id="fAsalD" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gASL?>" /> 
	  <?php } else if ($zBid=="1.3.5.03" || $zBid=="1.3.5.04" || $zBid=="1.3.5.05"  || $zBid=="1.3.5.06"  || $zBid=="1.3.5.07") {?>
	    <input name="fJenis" type="text" class="text" id="fJenis" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gJNS?>" /> 
      <?php } ?>	  </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td> 
        <?php if ($zBid=="1.3.5.01") {?>
        <input name="fSpesi" type="text" class="text" id="fSpesi" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gSPC?>" /> 
        <?php } else if ($zBid=="1.3.5.02") {?>
        <input name="fCipta" type="text" class="text" id="fCipta" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gCPT?>" />
	  <?php } else if ($zBid=="1.3.5.03" || $zBid=="1.3.5.04" || $zBid=="1.3.5.05"  || $zBid=="1.3.5.06"  || $zBid=="1.3.5.07") {?>
	    <input name="fUkura" type="text" class="text" id="fUkura" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo fConvertToRupiah($gUKU)?>" />
      <?php } ?>	  </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>&nbsp;</td> 
      <td>BAHAN</td>
      <td><input name="fBahan" type="text" class="text" id="fBahan" style="width:450px; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<?php echo $gBHN?>" /></td>
      <td>&nbsp;</td>
    </tr>
	<?php } ?>
	<?php if ($zBid=="1.3.5.01") {?>
    ...
    <tr>
      ...
      <td><input name="fSatuan" type="text" id="fSatuan" value="<?php echo $gSTN?>" onBlur="NumValidate(this)" onKeyUp="addSeparator(this)" style=" width:65px; text-align : right; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" /> 
        BUAH </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
