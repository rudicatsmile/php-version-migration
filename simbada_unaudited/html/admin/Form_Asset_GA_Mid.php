...
<form name="myfrm" method="post" action="<?php echo "Form_Asset_GA_Mid_.php?IdL=".$_GET['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" align="center" width="1165">
    ...
    <tr> 
      <td>LETAK TANAH </td>
      <td><input name="fAlmt" type="text" class="text" id="fAlmt" style="widht:100%; border: 1px solid #C0C0C0; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" value="<? echo $gAlm?>" size="50" maxlength="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>PENGGUNAAN</td>
