...
if($formatType=='Format.IV.H.2' || $formatType=='Format.IV.H.3' || $formatType=='Format.IV.H.4' || $formatType=='Format.IV.H.5' ){
    $sumHeader = "Akumulasi Penyusutan atau Amortisasi <br>(Rp)";
}else{
    $sumHeader = "Jumlah <br>(Rp)";
}
?> 
<body>
...
<table border="0" width="800" align="center" cellspacing="0" cellpadding="0" style="border:0px solid #000; border-collapse: collapse; font-family:Calibri; font-size:10pt">
  <tr height="25" style="font-weight:bold; text-align:center">
    ...
    <td rowspan="2" style="border:1px solid #000"><?=$sumHeader?> </td>
  </tr>
