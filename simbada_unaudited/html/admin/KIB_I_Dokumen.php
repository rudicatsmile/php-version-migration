...
<div align="center">
	<table border="0" width="1100" cellspacing="1" style="font-size: 8pt; font-family: Calibri; border-collapse: collapse" id="table1">
      ...
      <td style="font-size: 13pt; font-weight: bold" align="center">KEMITERAAN DENGAN PIHAK KETIGA</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
          ...
          <?
				...
				if ($CriT=="BPK")
				{
					...
					if ($gThnA){
						$nSQL= "SELECT * FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.2%' AND extracom LIKE '".$gExt."' AND Kd_UPB LIKE '".$gUpb."' AND Kd_Aset_108 LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND (Tgl_Perolehan BETWEEN '".$gThnA."-01-01' AND '".$gThn."-12-31') ".$fFindSy." ORDER BY Tgl_Perolehan, Kd_Aset_108, No_Register";
					}
					else{
						$nSQL= "SELECT * FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.2%' AND extracom LIKE '".$gExt."' AND Kd_UPB LIKE '".$gUpb."' AND Kd_Aset_108 LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Tgl_Perolehan, Kd_Aset_108, No_Register";
					}
				}
				else
				{
					if ($rIDT!="") {
						...
						if ($gThnA){
							$nSQL= "SELECT * FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.2%' AND extracom LIKE '".$gExt."' AND Kd_UPB LIKE '".$gUpb."' AND (Tgl_Perolehan BETWEEN '".$gThnA."-01-01' AND '".$gThn."-12-31') AND Status='' ORDER BY Tgl_Perolehan, Kd_Aset_108, No_Register";
						}
						else{
							$nSQL= "SELECT * FROM ta_kib_108 WHERE Kd_Aset_108 LIKE '1.5.2%' AND extracom LIKE '".$gExt."' AND Kd_UPB LIKE '".$gUpb."' AND Tgl_Perolehan LIKE '".$gThn."-__-__' AND Kd_Pemilik LIKE '".$gMLK."' AND Status='' ORDER BY Tgl_Perolehan, Kd_Aset_108, No_Register";
						}
					}
				}
				#echo $nSQL;
          ...
          <tr> 
            ...
            <td width="17%" style="border: 1px solid #000000" valign="top"><?=$x4?><? if ($Urai!=""){echo "<br>(<i>".$Urai."</i>)";}?><? if ($RefH!=""){echo "<br>(<i>Ref. Mutasi : ".$RefH."</i>)";}?></td>
