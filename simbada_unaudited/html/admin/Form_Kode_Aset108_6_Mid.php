...
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset108_6_Mid_.php?IdL=".$IdL."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      ...
      <td width="21">:</td>
      <td><select name="fJNS" class="boxs" id="fJNS" style="width: 480px" tabindex="0" <? echo $Sbmt?>>
          <?
    ...
    <tr> 
      ...
      <td width="21">:</td>
      <td><select class="boxs" name="fOBJ" tabindex="0" style="width: 480px" <? echo $Sbmt?>>
          <?
    ...
    <tr> 
      ...
      <td width="21">:</td>
      <td><select class="boxs" name="fSUB" tabindex="0" style="width: 480px" <? echo $Sbmt?>>
          <?
    ...
    <tr> 
      ...
      <td width="21">:</td>
      <td><input name="fKode" type="text" class="text" id="fKode" style="width:120px; font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod?>"/></td>
    </tr>
    <tr> 
      <td width="16">&nbsp;</td>
      <td width="121">NAMA SUBSUBR</td>
      <td width="21">:</td>
      <td><input name="fNama" type="text" class="text" id="fNama" style="width:470px; font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gNma?>" /></td>
    </tr>
    ...
    <tr> 
      ...
      <td width="21">:</td>
      <td><input name="fMasa" type="text" class="text" id="fMasa" style=" text-align:center; width:40px; font-family: Calibri; font-size: 11pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gMas?>"/>&nbsp;&nbsp;Tahun</td>
    </tr>
    <!--tr>
      <td>&nbsp;</td>
      <td colspan="3">&nbsp;</td>
