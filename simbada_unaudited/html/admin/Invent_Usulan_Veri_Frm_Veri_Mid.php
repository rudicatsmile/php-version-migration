...
require('Invent_Usulan_Veri_Frm_Veri_Imp.php');
...
<table border="0" class="table-link" cellspacing="0" cellpadding="0" align="center" style="width:1080px; height:120px; background-color:#D2DAC4">
  ...
  <tr height="25">
	...
	<? if ($UID=='creator'){?>
	<input type="button" name="B39233" value="Verifikasi All (CREATOR)" onClick="creatorEXE('<?=$mRo0?>','<?=$IdL?>')" style="width: 150px; height: 21px; color:#FF0000" />
	<? } ?>
	</td>
  </tr>
  <tr height="15">
