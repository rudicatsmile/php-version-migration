  ...
  <tr>
    ...
    <td><input type="button" name="B39" <?=$DisA?> value="SAVE" onclick="Save('<?=$stLOCK?>')" style="width: 80px; height: 21px" />
	  ...
	  <input type="button" name="B13" value="DAFTAR USULAN" onclick="showDATANew('<?=$_GET['IdL']?>')" style="width: 130px; height: 21px" />
	  	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="button" name="B14" <?php if ($IdT=="") {echo "disabled";}?> value="CETAK RINCI ( I )" onclick="P_Dokumen('800','400','<?=$gUBH?>','RKBMD_New_Dokumen','<?=$IdT?>','<?=$_GET['IdL']?>')" style="width: 120px; height: 21px; color:#0000FF" />
	  <input type="button" name="B14" <?php if ($IdT=="") {echo "disabled";}?> value="CETAK RINCI ( II )" onclick="P_Dokumen('800','400','<?=$gUBH?>','RKBMD_New_Dokumen_ii','<?=$IdT?>','<?=$_GET['IdL']?>')" style="width: 120px; height: 21px; color:#0000FF" />
