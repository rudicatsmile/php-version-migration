...
<form name="myfrm" method="post" action="<?php echo "Inventarisasi_KIB-B_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="900px">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td align="right"><input type="button" name="B37" value="EXPORT DATA" onclick="P_ToExcel('800','400','center','ToExcel/KIB_B_ToExcel')" style="width: 90px; height: 24px; border: 1px solid #C0C0C0; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
    </tr>
    <tr> 
      <td width="92">UPB</td>
      <td width="519"> 
    ...
    <tr> 
      ...
      <td valign="middle"> <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            ...
            <td width="8%">CARI</td>
            <td width="49%"> <input class="text" type="text" name="fFind" value="<? echo $gFin?>" style="font-family: Calibri; font-size: 10pt; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
            <td width="3%">&nbsp;</td>
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
        ...
        <th width="76" align="left">Kode</th>
              
        <th width="59" align="left">Register</th>
              
        <th width="264" align="left">Nama Barang</th>
              
        <th width="104" align="left">Merk</th>
              
        <th width="330" align="left">Uraian</th>
              
        <th width="72" class="ar">Harga Perolehan</th>
              
        <th width="84" class="ar">Nilai Akhir </th>
		...
		if ($gFin!="")
		{$fFindSy = "AND (Harga LIKE '%".$gFin."%' OR Referensi LIKE '%".$gFin."%' OR Nomor_Polisi LIKE '%".$gFin."%' OR Nomor_Rangka LIKE '%".$gFin."%' OR Nomor_BPKB LIKE '%".$gFin."%' OR Nomor_Mesin LIKE '%".$gFin."%' OR Kd_Aset LIKE '%".$gFin."%' OR Keterangan LIKE '%".$gFin."%' OR Merk LIKE '%".$gFin."%')";}
		else
		{$fFindSy = "";}
		
		$nSQL= "SELECT * FROM ta_kib_b WHERE Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Kd_Aset, No_Register LIMIT $Offset, $DataPerPage";
		...
		do
			...
			<tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
              <td style="border-bottom: #999999 dotted 1px"><? echo $iG?>.</td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><? echo $mRo['Kd_Aset']?></td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><? echo $mRo['No_Register']?></td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><? echo $NmB ?></td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"><? echo $mRo['Merk']?></td>
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <?
				if  ((int) strlen($mRo['Keterangan']) > 60)
				{echo substr($mRo['Keterangan'],0,60)." .....";}
				else
				{echo $mRo['Keterangan'];}
				?>
              </td>
              <td style="border-bottom: #999999 dotted 1px" class="ar" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <? echo fConvertToRupiah($mRo['Harga'])?>
              </td>
              <td style="border-bottom: #999999 dotted 1px" class="ar" onclick="$(&#39;#detail<? echo $iG?>&#39;).toggle(&#39;past&#39;)" <? echo $ClR?>> 
                <? echo fConvertToRupiah($gNIL)?>
              </td>
      ...
      <tr> 
		...
		?>
          ...
          <!-- Pagging -->
          <?
			$nSQL= "SELECT COUNT(*) as JmlRc FROM ta_kib_b WHERE Kd_UPB LIKE '".$zUpb."' AND Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy;
...
<script language="javascript">
			...
			if (win!=null)
    			{
      				win.window.document.open()       			
					<?
						$URL_Top = "Find_Acc_Top.php?CrAcc=Inventarisasi_KIB-B&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
						$URL_Mid = "Find_Acc_Mid.php?CrAcc=Inventarisasi_KIB-B&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
	...
	function InventData(w,h,pos,IDT)
	{
		...
		if (win!=null)
		{
			...
			URL_Mid = "Form_Invent_Asset_Opt.php?rKib=Kib_B&rIDT="+IDT+"<?="&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
