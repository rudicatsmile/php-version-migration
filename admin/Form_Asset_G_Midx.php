...
<?php if ($KeY=='Y') { echo "<div style='float:right'><img src='css/images/keys.png' /></div>";}?></td>
            <td width="6%"> 
...
<select name="fThnD" class="boxs" id="select8" style="width: 60px" tabindex="0">
  ...
  <?php
    ...
    <tr> 
      <td>KETERANGAN</td>
      <td><textarea name="fKeterangan" cols="57" rows="4" id="textarea" style="border: 1px solid #C0C0C0"><?php echo $gKTR ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
