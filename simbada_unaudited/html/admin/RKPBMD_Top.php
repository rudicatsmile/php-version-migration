...
<form name="myfrm" method="post" action="<?php echo "RKPBMD_Top.php?IdL=".$_REQUEST['IdL'] ?>">
...
<table border="0" width="1313" cellpadding="0" style="border-collapse: collapse">
  <tr>
	...
	<td width="1140" height="30" style="font-family: Agency FB; font-size: 14pt; font-weight: bold; color: #E1F986; font-style:italic">RKPBMD (Rencana Kebutuhan Pemeliharaan Barang Milik Daerah) TAHUN <? echo $gThn?></td>
	</tr>
  <tr>
...
<table border="0" width="1265" height="30" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse; font-weight:bold; background:#333333" cellpadding="0">
	<tr>
		<td width="58" style="" align="center">NO</td>
		<td width="98" style="">KODE</td>
		<td width="60" style="">NOREG</td>
		<td width="362" style="">NAMA BARANG</td>
		<td width="250" style="">MERK/TYPE/UKURAN</td>
		<td width="53" style="">TAHUN</td>
		<td width="127" style="">KEPEMILIKAN</td>
		<td width="118" style="">KONDISI</td>
		<td style="" align="right">NILAI ASET </td>
...
<script language="JavaScript">
	...
	function P_ViewRKBMD(w,h,pos)
	{
		...
		<?
		$URL="RKPBMD_Dokumen.php?zKeg=".$zKeg."&zUpb=".$zUpb."&zThn=".$gThn."&IdL=".$_REQUEST['IdL'];
		?>
...
<? if ($_REQUEST['Simpan']=="View") {?>
	<script language="JavaScript">
		window.open("<? echo "RKPBMD_Mid.php?JusV=1&IdL=".$_REQUEST['IdL'] ?>","WinOpenRKPB_Mid");
	</script>
<? } ?>
<? if ($_REQUEST['Simpan']=="Next") {?>
	<script language="JavaScript">
		window.open("<? echo "RKPBMD_Mid.php?JusV=0&zKeg=".$zKeg."&zUpb=".$zUpb."&zThn=".$gThn."&IdL=".$_REQUEST['IdL'] ?>","WinOpenRKPB_Mid");
	</script>
<? } ?>