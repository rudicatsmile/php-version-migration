    ...
    <tr> 
      ...
      <td valign="middle"> <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
          <tr> 
            ...
            <td width="8%">CARI</td>
            <td width="34%"> <input class="text" type="text" name="fFind" value="<?php echo $gFin?>" style="font-family: Calibri; font-size: 10pt; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" /></td>
            <td width="2%">&nbsp;</td>
	  ...
	  <table align="center" border="0" class="table-list" cellspacing="0" cellpadding="0" style="width:99%">
		...
		do
			...
			<tr height="23" style="cursor: pointer" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
              ...
              <td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)"><?php echo $mRo['Merk']?></td>
              <td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-left:2px; padding-right:2px" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)"> <?=$mRo['Keterangan']?></td>
              <td style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; text-align:center" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)"> <?=fConvertDateShort($mRo['Tgl_Perolehan'])?></td>
              ...
              <td align="right" style="border-bottom: #999999 dotted 1px; border-right:#999999 dotted 1px; padding-right:2px" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)" <?php echo $ClR?>><?php echo fConvertToRupiah($gNIL)?></td>
		...
		<table id="detail<?php echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <tr> 
              ...
              <td width="10">:</td>
              <td width="200"> 
                <?php echo fGlobal("Nm_Aset","Ref_Rek_Aset2","Kd_Aset",substr($mRo['Kd_Aset'],0,5),"=","","")?>              xxxxxx</td>
              <td width="10">&nbsp;</td>
              <td width="40">Merk</td>
              <td width="9">:</td>
              <td width="100">
