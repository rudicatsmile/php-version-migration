      ...
      <td>&nbsp;</td>
		...
		do
			...
			<tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
              ...
              <td style="border-bottom: #999999 dotted 1px" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)"><?php echo $mRo['Merk']?></td>
              ...
              <td style="border-bottom: #999999 dotted 1px" class="ar" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)"> 
                <?php echo fConvertToRupiah($mRo['Harga'])?>
              </td>
              <td style="border-bottom: #999999 dotted 1px" class="ar" onclick="$(&#39;#detail<?php echo $iG?>&#39;).toggle(&#39;past&#39;)" <?php echo $ClR?>> 
                <?php echo fConvertToRupiah($gNIL)?>
              </td>
