...
if ($gCod=="02" || $gCod=="03" || $gCod=="04"){
	$ReaD="";
}
else{
	$ReaD="readonly";
}
if ($Lev>1){$ReaD="readonly";}
...
<form name="myfrm" method="post" action="<?php echo "Form_Kode_Aset1_Mid_.php?IdL=".$_REQUEST['IdL']."&rIDT=".$rIDT ?>">
  ...
  <table border="0" width="663" cellspacing="1" style="font-family: Calibri; font-size: 10pt; border-collapse: collapse">
    ...
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="140">KODE BIDANG</td>
      <td width="16">:</td>
      <td><input name="fKode" type="text" class="text" id="fKode" style="font-family: Calibri; font-size: 11pt; width:25px; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<? echo $gCod?>" maxlength="2" /></td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="140">NAMA BIDANG</td>
      <td width="16">:</td>
    ...
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="140">EKSTRA KOMTABLE (Rp.)</td>
      <td width="16">:</td>
      <td><input name="fExtra" type="text" class="text" id="fExtra" <?=$ReaD?> style="font-family: Calibri; font-size: 11pt; width:120px; text-align:right; border: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #E1F986" value="<?=fConvertToRupiah($gExt)?>" /></td>
    </tr>
    <tr> 
      <td width="24">&nbsp;</td>
      <td width="140">&nbsp;</td>
