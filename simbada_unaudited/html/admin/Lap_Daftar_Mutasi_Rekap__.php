	...
	<tr>
	  <td><table border="1" width="1200" cellspacing="1" style="font-family: Calibri; font-size: 9pt; border-collapse: collapse" id="table1" bordercolor="#000000">
        ...
        <tr>
          ...
          <td width="50" align="center"><? if ($x5!=0) {echo $xB.fConvertToRupiahBulat($x5);} else {echo "-";}?></td>
          <td width="100" align="right"><? if ($x6!=0) {echo $xB.fConvertToRupiah($x6);} else {echo "-";}?></td>
          <td width="50" align="center"><? if ($x7!=0) {echo $xB.fConvertToRupiahBulat($x7);} else {echo "-";}?></td>
          <td width="100" align="right"><? if ($x8!=0) {echo $xB.fConvertToRupiah($x8);} else {echo "-";}?></td>
          <td width="50" align="center"><? if ($x9!=0) {echo $xB.fConvertToRupiahBulat($x9);} else {echo "-";}?></td>
          <td width="100" align="right"><? if ($x10!=0) {echo $xB.fConvertToRupiah($x10);} else {echo "-";}?></td>
          <td width="50" align="center"><? if ($x11!=0) {echo $xB.fConvertToRupiahBulat($x11);} else {echo "-";}?></td>
          <td width="100" align="right"><? if ($x12!=0) {echo $xB.fConvertToRupiah($x12);} else {echo "-";}?></td>
          <td><?=$xB.$x13?></td>
        </tr>
        <? } ?>
        <? function ViewBlank() {?>
        ...
        <tr height="30">
          ...
          <td width="50" align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($fAWL!=0) {echo fConvertToRupiahBulat($fAWL);}?></td>
          <td width="100" align="right" style="font-weight:bold; border-top: 3px double #000000"><? if ($tAWL!=0) {echo fConvertToRupiah($tAWL);}?></td>
          <td width="50" align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($fKRG!=0) {echo fConvertToRupiahBulat($fKRG);}?></td>
          <td width="100" align="right" style="font-weight:bold; border-top: 3px double #000000"><? if ($tKRG!=0) {echo fConvertToRupiah($tKRG);}?></td>
          <td width="50" align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($fTMB!=0) {echo fConvertToRupiahBulat($fTMB);}?></td>
          <td width="100" align="right" style="font-weight:bold; border-top: 3px double #000000"><? if ($tTMB!=0) {echo fConvertToRupiah($tTMB);}?></td>
          <td width="50" align="center" style="font-weight:bold; border-top: 3px double #000000"><? if ($fAKH!=0) {echo fConvertToRupiahBulat($fAKH);}?></td>
          <td width="100" align="right" style="font-weight:bold; border-top: 3px double #000000"><? if ($tAKH!=0) {echo fConvertToRupiah($tAKH);}?></td>
