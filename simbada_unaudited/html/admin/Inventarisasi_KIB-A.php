...
<form name="myfrm" method="post" action="<?php echo "Inventarisasi_KIB-A_.php?FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL'] ?>">
  ...
  <table border="0" align="center" width="900px">
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td align="right"><input type="button" name="B37" value="EXPORT DATA" onclick="P_ToExcel('800','400','center','ToExcel/KIB_A_ToExcel')" style="width: 90px; height: 24px; border: 1px solid #C0C0C0; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px" /></td>
    </tr>
    <tr> 
      <td width="92">UPB</td>
      <td width="519"> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <th width="31" align="left">No</th>
        <th width="70" align="left">Kode</th>
        <th width="63" align="left">Register</th>
        <th width="232" align="left">Nama Barang</th>
        <th width="9" align="left">&nbsp;</th>
        <th width="343" align="left">Uraian</th>
        <th width="87" class="ar">Harga Perolehan</th>
        <th width="83" class="ar">Nilai Akhir </th>
        <th width="105" class="ac">Actions</th>
      </tr>
      <?
		...
		$nSQL= "SELECT * FROM ta_kib_a WHERE Kd_UPB LIKE '".$zUpb."' and Kd_Aset LIKE '".$rBid.".".$rKel.".".$rOBJ.".".$rRin."' AND Tgl_Perolehan LIKE '".$rThn."-__-__' ".$fFindSy." ORDER BY Kd_Aset, No_Register LIMIT $Offset, $DataPerPage";
      ...
      <tr style="cursor: pointer" title="clik disini untuk melihat rincian...!" onmouseover="this.style.cursor=&#39;pointer&#39" <?=fBackCLR($iG)?>> 
		...
		<a href="#" class="ico edit" onclick="InventData('550','400','center','<?=$mRo['IDT']?>'); return false">INVENTARISASI</a></td>
      </tr>
      <tr> 
        <td colspan="9">
		<table id="detail<? echo $iG?>" cellpadding="3" border="0" width="900" style="border:1px solid #C0C0C0; font-family: Calibri; font-size: 9pt; font-style: Italic; color: #800000; display: none; border-collapse:collapse">
            <tr> 
              ...
              <td width="9">:</td>
              <td width="100"><? echo fConvertToRupiah($mRo['Luas_M2'])?>&nbsp;m<sup>2</sup></td>
              <td width="4">&nbsp;</td>
              <td width="60">Sertifikat Tanggal</td>
              <td width="9">:</td>
              <td width="200">
                <? echo fConvertDateShort($mRo['Sertifikat_Tanggal'])?>
              </td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
            ...
            <tr> 
              ...
              <td>Lokasi</td>
              <td>:</td>
              <td valign="top"><? echo $mRo['Alamat']?></td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>Rincian</td>
...
<script language="javascript">
			...
			if (win!=null)
    			{
      				win.window.document.open()       			
					<?
						$URL_Top = "Find_Acc_Top.php?CrAcc=Inventarisasi_KIB-A&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
						$URL_Mid = "Find_Acc_Mid.php?CrAcc=Inventarisasi_KIB-A&FrmG=".$_GET['FrmG']."&gUnt=".$zUnt."&gSub=".$zSub."&gUpb=".$zUpb."&IdL=".$_GET['IdL'];
	...
	function InventData(w,h,pos,IDT)
	{
		...
		if (win!=null)
		{
			...
			URL_Mid = "Form_Invent_Asset_Opt.php?rKib=Kib_A&rIDT="+IDT+"<?="&FrmG=".$_GET['FrmG']."&IdL=".$_GET['IdL']?>";
